/*
 * $Id: opendir.c,v 1.4 1999/12/09 13:46:56 jdurand Exp $
 */
...
#ifndef lint
static char sccsid[] = "@(#)$RCSfile: opendir.c,v $ $Revision: 1.4 $ $Date: 1999/12/09 13:46:56 $ CERN/IT/PDP/DM Olof Barring";
#endif /* not lint */
