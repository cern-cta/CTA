/*
 * $Id: open.c,v 1.5 1999/12/10 19:44:56 baran Exp $
 */
...
#ifndef lint
static char sccsid[] = "@(#)$RCSfile: open.c,v $ $Revision: 1.5 $ $Date: 1999/12/10 19:44:56 $ CERN/IT/PDP/DM F. Hemmer, A. Trannoy, F. Hassine";
#endif /* not lint */
