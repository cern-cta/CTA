/*
 * $Id: rfrm.c,v 1.2 1999/07/20 12:48:19 jdurand Exp $
 *
 * $Log: rfrm.c,v $
 * Revision 1.2  1999/07/20 12:48:19  jdurand
...
#ifndef lint
static char sccsid[] = "@(#)rfrm.c	1.7 08 Jan 1999  CERN IT-PDP/DM Olof Barring";
#endif /* not lint */
