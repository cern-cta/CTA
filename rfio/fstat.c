/*
 * $Id: fstat.c,v 1.16 2005/02/22 13:28:24 jdurand Exp $
 */
...
#ifndef lint
static char sccsid[] = "@(#)$RCSfile: fstat.c,v $ $Revision: 1.16 $ $Date: 2005/02/22 13:28:24 $ CERN/IT/PDP/DM F. Hemmer, A. Trannoy";
#endif /* not lint */
