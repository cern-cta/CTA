/*
 * $Id: fstat.c,v 1.6 2000/05/29 16:42:01 obarring Exp $
 */
...
#ifndef lint
static char sccsid[] = "@(#)$RCSfile: fstat.c,v $ $Revision: 1.6 $ $Date: 2000/05/29 16:42:01 $ CERN/IT/PDP/DM F. Hemmer, A. Trannoy";
#endif /* not lint */
