...
public:
   ...
   */
  SchedulingInfosLsStream(const frontend::AdminCmdStream& requestMsg,
...
private:
   ...
   */
  virtual bool isDone() const { return m_schedulingInfoList.empty() && m_potentialMountList.empty(); }
...
SchedulingInfosLsStream::SchedulingInfosLsStream(const frontend::AdminCmdStream& requestMsg,
                                                 cta::catalogue::Catalogue& catalogue,
                                                 cta::Scheduler& scheduler,
                                                 log::LogContext& lc) :
