...
for WORKFLOW in sync::create.default sync::closew.default sync::archived.default archive_failed.default sync::prepare.default closew.retrieve_written retrieve_failed.default sync::delete.default
do
