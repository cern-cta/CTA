...
echo "taped MountCriteria 1, 1" >> "${TAPED_CONF_FILE}"
echo "taped WatchdogIdleSessionTimer 1" >> "${TAPED_CONF_FILE}" # Make tape servers more responsive, thus improving CI test speed
...
echo "taped ArchiveFetchBytesFiles 80000000000,10000" >> "${TAPED_CONF_FILE}"
echo "taped NbDiskThreads 10" >> "${TAPED_CONF_FILE}"
