...
echo "taped ArchiveFlushBytesFiles 32000000000,500" >> "${TAPED_CONF_FILE}"
echo "taped ArchiveFetchBytesFiles 80000000000,4000" >> "${TAPED_CONF_FILE}"
echo "taped NbDiskThreads 2" >> "${TAPED_CONF_FILE}"
echo "taped WatchdogIdleSessionTimer 1" >> "${TAPED_CONF_FILE}"
