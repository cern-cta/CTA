...
EXTERN_C int Cns_closex (const struct Cns_fileid *, const u_signed64, const char *, const char *, const time_t, const double, struct Cns_filestatcs *);
...
EXTERN_C int Cns_openx (const uid_t, const gid_t, const char *, const int, const mode_t, const int, int *, struct Cns_fileid *, struct Cns_filestatcs *, double *);
