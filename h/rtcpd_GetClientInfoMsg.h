...
/**
 * Gets a client-info message from the specified connection socket.
 *
 * Please note that this function does not send any reply or close the
 * connection.
 *
 * @param connSock   The connection socket.
 * @param netTimeout The timeout in seconds to be used for network operations.
 * @param msgHdr     Out parameter: Message header structure to be written into
 *                   by this function.
