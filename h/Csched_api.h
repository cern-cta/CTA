...
EXTERN_C int    Csched_Getschedparam (char *, int, int, int *, Csched_param_t *);
EXTERN_C int    Csched_Setschedparam (char *, int, int, int, Csched_param_t *);
EXTERN_C int    Csched_Get_priority_min (char *, int, int);
EXTERN_C int    Csched_Get_priority_mid (char *, int, int);
EXTERN_C int    Csched_Get_priority_max (char *, int, int);
