/*
 * $RCSfile: rfio_api.h,v $ $Revision: 1.37 $ $Date: 2002/08/28 05:32:06 $ CERN IT-PDP/DM Olof Barring
 */
...
EXTERN_C int DLL_DECL rfio_HsmIf_open_limbysz _PROTO((const char *, int, mode_t, U_HYPER));
