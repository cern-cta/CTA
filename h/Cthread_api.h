...
EXTERN_C int   DLL_DECL  Cthread_Create _PROTO((const char *, int, void *(*)(void *), void *));
EXTERN_C int   DLL_DECL  Cthread_Create_Detached _PROTO((const char *, int, void *(*)(void *), void *)); 
EXTERN_C int   DLL_DECL  Cthread_Join _PROTO((const char *, int, int , int  **));
EXTERN_C int   DLL_DECL  Cthread_Lock_Mtx _PROTO((const char *, int, void *, int));
EXTERN_C int   DLL_DECL  Cthread_Lock_Mtx_init _PROTO((void *, int));
EXTERN_C int   DLL_DECL  Cthread_Mutex_Unlock _PROTO((const char *, int, void *));
EXTERN_C int   DLL_DECL  Cthread_Mutex_Unlock_init _PROTO((void *));
EXTERN_C int   DLL_DECL  Cthread_Mutex_Unlock_ext _PROTO((const char *, int, void *));
EXTERN_C int   DLL_DECL  Cthread_Wait_Condition _PROTO((const char *, int, void *, int));
EXTERN_C int   DLL_DECL  Cthread_Wait_Condition_ext _PROTO((const char *, int, void *, int));
EXTERN_C int   DLL_DECL  Cthread_Cond_Broadcast _PROTO((const char *, int, void *));
EXTERN_C int   DLL_DECL  Cthread_Cond_Broadcast_ext _PROTO((const char *, int, void *));
EXTERN_C int   DLL_DECL  Cthread_Detach _PROTO((const char *, int, int));
EXTERN_C int   DLL_DECL  Cthread_Mutex_Destroy _PROTO((const char *, int, void *));
EXTERN_C int   DLL_DECL  Cthread_Self _PROTO((const char *, int));
EXTERN_C int   DLL_DECL  Cthread_Self0 _PROTO((void));
EXTERN_C int   DLL_DECL _Cthread_self _PROTO((void));
EXTERN_C int   DLL_DECL  Cthread_Getspecific _PROTO((const char *, int, int *, void **));
EXTERN_C int   DLL_DECL  Cthread_Getspecific0 _PROTO((int *, void **));
EXTERN_C int   DLL_DECL  Cthread_Getspecific_init _PROTO((int *, void **));
EXTERN_C int   DLL_DECL  Cthread_Setspecific _PROTO((const char *, int, int *, void *));
...
EXTERN_C void  DLL_DECL *Cthread_Lock_Mtx_addr _PROTO((const char *, int, void *));
EXTERN_C int   DLL_DECL  Cthread_Lock_Mtx_ext _PROTO((const char *, int, void *, int));
EXTERN_C int   DLL_DECL  Cthread_Kill _PROTO((const char *, int, int, int));
EXTERN_C void  DLL_DECL  Cthread_Exit _PROTO((const char *, int, void *));
