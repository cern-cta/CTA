...
enum RtcpcldMessageNo {
    ...
    RTCPCLD_MSG_RESERVED62,
    RTCPCLD_MSG_RESERVED63,
    RTCPCLD_MSG_RESERVED64,
    RTCPCLD_MSG_RESERVED65,
    RTCPCLD_MSG_RESERVED66,
    RTCPCLD_MSG_RESERVED67,
    RTCPCLD_MSG_RESERVED68,
    RTCPCLD_MSG_RESERVED69,
    RTCPCLD_MSG_RESERVED70
};
...
struct RtcpcldMessages rtcpcldMessages[] = {
    ...
    { RTCPCLD_MSG_TOOMANYSEGMS, DLF_LVL_ERROR,"Too many segments for tape copy (should be 1)"},
    ...
    { RTCPCLD_MSG_RESERVED62, DLF_LVL_DEBUG,""},
    { RTCPCLD_MSG_RESERVED63, DLF_LVL_DEBUG,""},
    { RTCPCLD_MSG_RESERVED64, DLF_LVL_DEBUG,""},
    { RTCPCLD_MSG_RESERVED65, DLF_LVL_DEBUG,""},
    { RTCPCLD_MSG_RESERVED66, DLF_LVL_DEBUG,""},
    { RTCPCLD_MSG_RESERVED67, DLF_LVL_DEBUG,""},
    { RTCPCLD_MSG_RESERVED68, DLF_LVL_DEBUG,""},
    { RTCPCLD_MSG_RESERVED69, DLF_LVL_DEBUG,""},
    { RTCPCLD_MSG_RESERVED70, DLF_LVL_DEBUG,""}
};
#else /* RTCPCLD_COMMON */
