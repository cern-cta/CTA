...
enum RtcpcldMessageNo {
    ...
    RTCPCLD_MSG_RESERVED2,
    RTCPCLD_MSG_RESERVED3,
    RTCPCLD_MSG_RESERVED4,
    RTCPCLD_MSG_RESERVED5,
    RTCPCLD_MSG_RESERVED6,
    RTCPCLD_MSG_RESERVED7,
    RTCPCLD_MSG_RESERVED8,
    RTCPCLD_MSG_RESERVED9
};
...
struct RtcpcldMessages rtcpcldMessages[] = {
    ...
    { RTCPCLD_MSG_RESERVED2, DLF_LVL_DEBUG,""},
    { RTCPCLD_MSG_RESERVED3, DLF_LVL_DEBUG,""},
    { RTCPCLD_MSG_RESERVED4, DLF_LVL_DEBUG,""},
    { RTCPCLD_MSG_RESERVED5, DLF_LVL_DEBUG,""},
    { RTCPCLD_MSG_RESERVED6, DLF_LVL_DEBUG,""},
    { RTCPCLD_MSG_RESERVED7, DLF_LVL_DEBUG,""},
    { RTCPCLD_MSG_RESERVED8, DLF_LVL_DEBUG,""},
    { RTCPCLD_MSG_RESERVED9, DLF_LVL_DEBUG,""}
};
#else /* RTCPCLD_COMMON */
