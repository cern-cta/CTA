...
enum RtcpcldMessageNo {
    ...
    RTCPCLD_MSG_MIGRATOR_CFLOCKONMIGRATED_INVALID,
    RTCPCLD_MSG_MIGRATOR_CFLOCKONMIGRATED,
...
struct RtcpcldMessages rtcpcldMessages[] = {
    ...
    /* RTCPCLD_MSG_MIGRATOR_CFLOCKONMIGRATED_INVALID */ {DLF_LVL_ERROR, "The value of CFLOCKONMIGRATED is invalid"},
    /* RTCPCLD_MSG_MIGRATOR_CFLOCKONMIGRATED */ {DLF_LVL_SYSTEM, "Value of CFLOCKONMIGRATED"},
    ...
    /* Mark the end of the array */ {0, NULL}
};
#else /* RTCPCLD_COMMON */
