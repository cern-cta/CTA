...
struct RtcpcldMessages rtcpcldMessages[] = {
    ...
    { RTCPCLD_MSG_INTERNAL, DLF_LVL_ERROR, "Internal error"},
    { RTCPCLD_MSG_CALLBACK_POS, DLF_LVL_SYSTEM, "File position callback"},
    { RTCPCLD_MSG_CALLBACK_CP, DLF_LVL_DEBUG, "File copy callback"},
    ...
    { RTCPCLD_MSG_CALLBACK_GETW, DLF_LVL_SYSTEM, "Get more work callback: add file"},
