...
EXTERN_C int stager_getDbSvc (struct C_Services_t ***);
EXTERN_C int stager_getStgAndDbSvc (struct Cstager_IStagerSvc_t ***, struct C_Services_t ***);
EXTERN_C int stager_getJobSvc (struct Cstager_IJobSvc_t ***);
