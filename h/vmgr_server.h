...
EXTERN_C int vmgr_srv_deletedenmap _PROTO((char *, char *, struct vmgr_srv_thread_info *));
EXTERN_C int vmgr_srv_deletedgnmap _PROTO((char *, char *, struct vmgr_srv_thread_info *));
EXTERN_C int vmgr_srv_deletelibrary _PROTO((char *, char *, struct vmgr_srv_thread_info *));
EXTERN_C int vmgr_srv_deletemodel _PROTO((char *, char *, struct vmgr_srv_thread_info *));
EXTERN_C int vmgr_srv_deletepool _PROTO((char *, char *, struct vmgr_srv_thread_info *));
EXTERN_C int vmgr_srv_deletetape _PROTO((char *, char *, struct vmgr_srv_thread_info *));
EXTERN_C int vmgr_srv_deltag _PROTO((char *, char *, struct vmgr_srv_thread_info *));
EXTERN_C int vmgr_srv_enterdenmap _PROTO((int, char *, char *, struct vmgr_srv_thread_info *));
EXTERN_C int vmgr_srv_enterdgnmap _PROTO((char *, char *, struct vmgr_srv_thread_info *));
EXTERN_C int vmgr_srv_enterlibrary _PROTO((char *, char *, struct vmgr_srv_thread_info *));
EXTERN_C int vmgr_srv_entermodel _PROTO((int, char *, char *, struct vmgr_srv_thread_info *));
EXTERN_C int vmgr_srv_enterpool _PROTO((char *, char *, struct vmgr_srv_thread_info *));
EXTERN_C int vmgr_srv_entertape _PROTO((char *, char *, struct vmgr_srv_thread_info *));
EXTERN_C int vmgr_srv_gettag _PROTO((char *, char *, struct vmgr_srv_thread_info *));
...
EXTERN_C int vmgr_srv_listdgnmap _PROTO((char *, char *, struct vmgr_srv_thread_info *, int, DBLISTPTR *));
EXTERN_C int vmgr_srv_listlibrary _PROTO((char *, char *, struct vmgr_srv_thread_info *, int, DBLISTPTR *));
EXTERN_C int vmgr_srv_listmodel _PROTO((int, char *, char *, struct vmgr_srv_thread_info *, int, DBLISTPTR *));
EXTERN_C int vmgr_srv_listpool _PROTO((char *, char *, struct vmgr_srv_thread_info *, int, DBLISTPTR *));
EXTERN_C int vmgr_srv_listtape _PROTO((int, char *, char *, struct vmgr_srv_thread_info *, struct vmgr_tape_info *, int, DBLISTPTR *));
EXTERN_C int vmgr_srv_modifylibrary _PROTO((char *, char *, struct vmgr_srv_thread_info *));
EXTERN_C int vmgr_srv_modifymodel _PROTO((int, char *, char *, struct vmgr_srv_thread_info *));
EXTERN_C int vmgr_srv_modifypool _PROTO((char *, char *, struct vmgr_srv_thread_info *));
EXTERN_C int vmgr_srv_modifytape _PROTO((char *, char *, struct vmgr_srv_thread_info *));
EXTERN_C int vmgr_srv_querypool _PROTO((char *, char *, struct vmgr_srv_thread_info *));
EXTERN_C int vmgr_srv_querylibrary _PROTO((char *, char *, struct vmgr_srv_thread_info *));
...
EXTERN_C int vmgr_srv_reclaim _PROTO((char *, char *, struct vmgr_srv_thread_info *));
EXTERN_C int vmgr_srv_settag _PROTO((char *, char *, struct vmgr_srv_thread_info *));
