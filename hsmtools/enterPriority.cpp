 ...
 *
 * @(#)$RCSfile: enterPriority.cpp,v $ $Revision: 1.1 $ $Release$ $Date: 2008/05/28 08:07:11 $ $Author: gtaur $
 *
 * 
 *
...
int main(int argc, char *argv[]) {
  ...
  try {
    ...
    if (mpriority == -1 || muid==-1 || mgid==-1){
      std::cout <<" you have to provide the uid, gid and the priority as input."<< std::endl;;
      usage(progName);
      return 0;
