 ...
 *
 * @(#)$RCSfile: deleteFileClass.c,v $ $Revision: 1.4 $ $Release$ $Date: 2005/08/11 14:30:51 $ $Author: itglp $
 *
 * 
 *
 * @author Olof Barring
...
#ifndef lint
static char sccsid[] = "@(#)$RCSfile: deleteFileClass.c,v $ $Revision: 1.4 $ $Release$ $Date: 2005/08/11 14:30:51 $ Olof Barring";
#endif /* not lint */
