 ...
 *
 * @(#)$RCSfile: printFileClass.c,v $ $Revision: 1.2 $ $Release$ $Date: 2005/07/21 09:13:06 $ $Author: itglp $
 *
 * 
 *
 * @author Olof Barring
...
#ifndef lint
static char sccsid[] = "@(#)$RCSfile: printFileClass.c,v $ $Revision: 1.2 $ $Release$ $Date: 2005/07/21 09:13:06 $ Olof Barring";
#endif /* not lint */
...
int main(int argc, char *argv[]) 
{
  ...
  rc = Cstager_IFSSvc_selectFileClass(fsSvc,&fileClass,name);
