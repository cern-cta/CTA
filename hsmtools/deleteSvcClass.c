 ...
 *
 * @(#)$RCSfile $ $Revision: 1.3 $ $Release$ $Date: 2005/07/21 09:13:06 $ $Author: itglp $
 *
 * 
 *
 * @author Olof Barring
...
#ifndef lint
static char sccsid[] = "@(#)$RCSfile: deleteSvcClass.c,v $ $Revision: 1.3 $ $Release$ $Date: 2005/07/21 09:13:06 $ Olof Barring";
#endif /* not lint */
