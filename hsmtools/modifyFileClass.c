 ...
 *
 * @(#)$RCSfile: modifyFileClass.c,v $ $Revision: 1.1 $ $Release$ $Date: 2005/01/20 13:34:37 $ $Author: obarring $
 *
 * 
 *
 * @author Olof Barring
...
#ifndef lint
static char sccsid[] = "@(#)$RCSfile: modifyFileClass.c,v $ $Revision: 1.1 $ $Release$ $Date: 2005/01/20 13:34:37 $ Olof Barring";
#endif /* not lint */
