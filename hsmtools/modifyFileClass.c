 ...
 *
 * @(#)$RCSfile: modifyFileClass.c,v $ $Revision: 1.2 $ $Release$ $Date: 2005/05/02 13:19:46 $ $Author: obarring $
 *
 * 
 *
 * @author Olof Barring
...
#ifndef lint
static char sccsid[] = "@(#)$RCSfile: modifyFileClass.c,v $ $Revision: 1.2 $ $Release$ $Date: 2005/05/02 13:19:46 $ Olof Barring";
#endif /* not lint */
