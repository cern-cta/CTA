/*
 * $Id: Cpool_test2.c,v 1.2 1999/12/09 13:47:48 jdurand Exp $
 */
...
#ifndef lint
static char sccsid[] = "@(#)$RCSfile: Cpool_test2.c,v $ $Revision: 1.2 $ $Date: 1999/12/09 13:47:48 $ CERN/IT/PDP/DM Jean-Damien Durand";
#endif /* not lint */
