...
CastorTestDir = /castor/cern.ch/dev/c/canoc3
...
# file classes to be used by the test suite. Either names or ids are valid values
TapeFileClass = 95 
DiskOnlyFileClass = 58
...
# Nameserver related
# Must use full hostname
CNS_HOST = lxc2dev9.cern.ch
...
# user shall be able to issue all kind of requests to the stager and to
# write on the namespace (via ACLs, see CastorTestDir tag), but shall
# NOT have CUPV_ADMIN privileges.
