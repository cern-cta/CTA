...
dirCastor=myCastor+"RfioClient"+ticket+"/"
...
class RfioRfcpCastorBasic(unittest.TestCase):          
        def localToCastor(self):
	        cmd=["rfcp /etc/group "+dirCastor+"fileLocalToCastor"+myTag+ticket]
		UtilityForCastorTest.saveOnFile(localDir+"RfioLocalToCastor"+myTag,cmd,caseScen)
	...
	def castorToLocal(self):
                cmd=["rfcp /etc/group "+dirCastor+"fileCastorToLocal"+myTag+ticket,"rfcp "+dirCastor+"fileCastorToLocal"+myTag+ticket+" "+localDir+"fileCastorToLocal"+myTag,"diff /etc/group "+localDir+"fileCastorToLocal"+myTag]

		
		UtilityForCastorTest.saveOnFile(localDir+"RfioCastorToLocal"+myTag,cmd,caseScen)
        ...
        def remoteToCastor(self):
                cmd=["rfcp /etc/group "+myRemoteDir+"fileRemoteToCastor1"+myTag+ticket,"rfcp "+myRemoteDir+"fileRemoteToCastor1"+myTag+ticket+" "+dirCastor+"fileRemoteToCastor2"+myTag+ticket,"rfcp "+dirCastor+"fileRemoteToCastor2"+myTag+ticket+" "+localDir+"fileRemoteToCastor"+myTag,"diff /etc/group "+localDir+"fileRemoteToCastor"+myTag]


		UtilityForCastorTest.saveOnFile(localDir+"RfioRemoteToCastor"+myTag,cmd,caseScen)
        ...
        def castorToRemote(self):
                ...
                cmd=["rfcp /etc/group "+dirCastor+"fileCastorToRemote1"+myTag+ticket,"rfcp "+dirCastor+"fileCastorToRemote1"+myTag+ticket+" "+myRemoteDir+"fileCastorToRemote2"+myTag+ticket,"rfcp "+myRemoteDir+"fileCastorToRemote2"+myTag+ticket+" "+localDir+"fileCastorToRemote"+myTag,"diff /etc/group "+localDir+"fileCastorToRemote"+myTag]

		UtilityForCastorTest.saveOnFile(localDir+"RfioCastorToRemote"+myTag,cmd,caseScen)
        ...
        def castorToCastor(self):
                ...
                cmd=["rfcp /etc/group "+dirCastor+"fileCastorToCastor1"+myTag+ticket,"rfcp "+dirCastor+"fileCastorToCastor1"+myTag+ticket+" "+dirCastor+"fileCastorToCastor2"+myTag+ticket,"rfcp "+dirCastor+"fileCastorToCastor2"+myTag+ticket+" "+localDir+"fileCastorToCastor"+myTag,"diff /etc/group "+localDir+"fileCastorToCastor"+myTag]

		UtilityForCastorTest.saveOnFile(localDir+"RfioCastorToCastor"+myTag,cmd,caseScen)
...
class RfioRfcpCastorBasicFancyTurl(unittest.TestCase):
		...
		UtilityForCastorTest.saveOnFile(localDir+"RfioFancyLocalToCastor"+myTag,cmd,caseScen)	
	...
	def castorToLocal(self):
		...
		UtilityForCastorTest.saveOnFile(localDir+"RfioFancyCastorToLocal"+myTag,cmd,caseScen)
        ...
        def remoteToCastor(self):
                cmd=["rfcp /etc/group "+myRemoteDir+"fileRemoteToCastor1"+myTag+ticket,"rfcp "+myRemoteDir+"fileRemoteToCastor1"+myTag+ticket+" "+myTurl+"fileRemoteToCastor1"+myTag+ticket,"rfcp "+myTurl+"fileRemoteToCastor1"+myTag+ticket+" "+localDir+"fileRemoteToCastor"+myTag+ticket,"diff /etc/group "+localDir+"fileRemoteToCastor"+myTag+ticket]

		UtilityForCastorTest.saveOnFile(localDir+"RfioFancyRemoteToCastor"+myTag,cmd,caseScen)
		...
		cmd=["rfcp /etc/group "+myTurl+"fileCastorToRemote1"+myTag+ticket,"rfcp "+myTurl+"fileCastorToRemote1"+myTag+ticket+" "+myRemoteDir+"fileCastorToRemote2"+myTag+ticket,"rfcp "+myRemoteDir+"fileCastorToRemote2"+myTag+ticket+" "+localDir+"fileCastorToRemote"+myTag+ticket,"diff /etc/group "+localDir+"fileCastorToRemote"+myTag+ticket]

		UtilityForCastorTest.saveOnFile(localDir+"RfioFancyCastorToRemote"+myTag,cmd,caseScen)
		...
		UtilityForCastorTest.saveOnFile(localDir+"RfioFancyCastorToCastor"+myTag,cmd,caseScen)
