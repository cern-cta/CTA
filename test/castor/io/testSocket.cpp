 ...
 *
 * @(#)$RCSfile: testSocket.cpp,v $ $Revision: 1.1 $ $Release$ $Date: 2004/07/19 15:12:43 $ $Author: bcouturi $
 *
 * 
 *
 * @author testSocket.cpp
 *****************************************************************************/
...
int main (int argc, char** argv) {
  ...
  if (argc > 1) {
	...
	exit(1);
      ...
      castor::io::ClientSocket *client = new castor::io::ClientSocket(7777, *cn);
    ...
    try {
      ...
      castor::io::ServerSocket *server = new castor::io::ServerSocket(7777, false);
      server->listen();
