/******************************************************************************
 *                test/castor/tape/mighunter/migrationPolicyStressTestMain.cpp
 *
...
#include "test/castor/tape/mighunter/MigrationPolicyStressTest.hpp"
...
int main() {
  ...
  castor::tape::utils::appendPathToEnvVar(envVarName, currentDir);

  castor::tape::python::initializePython();

  runner.addTest(registry.makeTest());
  runnerRunRc = runner.run();
