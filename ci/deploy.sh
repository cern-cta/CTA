...
usage() {
  ...
  echo "      --cta-config <path>:              Custom Values file to pass to the CTA Helm chart."
...
deploy() {
  ...
  local eos_image_tag=""
  local cta_image_tag=""
  local cta_config="presets/dev-cta-common.yaml,presets/frontend-wfe/auth-jwt.yaml,presets/frontend-admin/auth-jwt.yaml"
  local eos_config="presets/eos/auth-jwt.yaml"
