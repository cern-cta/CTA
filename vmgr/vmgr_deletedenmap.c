...
#ifndef lint
static char sccsid[] = "@(#)$RCSfile: vmgr_deletedenmap.c,v $ $Revision: 1.3 $ $Date: 2000/07/07 06:08:16 $ CERN IT-PDP/DM Jean-Philippe Baud";
#endif /* not lint */
...
vmgr_deletedenmap(const char *model, char *media_letter, char *density)
{
	int c;
	char func[18];
	gid_t gid;
