...
#ifndef lint
static char sccsid[] = "@(#)$RCSfile: vmgr_modifymodel.c,v $ $Revision: 1.2 $ $Date: 2000/01/10 14:39:24 $ CERN IT-PDP/DM Jean-Philippe Baud";
#endif /* not lint */
...
vmgr_modifymodel(const char *model, char *media_letter, int native_capacity, int media_cost)
{
	int c;
	char func[17];
	gid_t gid;
