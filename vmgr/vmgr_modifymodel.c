...
#ifndef lint
static char sccsid[] = "@(#)$RCSfile: vmgr_modifymodel.c,v $ $Revision: 1.6 $ $Date: 2003/10/29 07:48:59 $ CERN IT-PDP/DM Jean-Philippe Baud";
#endif /* not lint */
...
vmgr_modifymodel(const char *model, char *media_letter, int media_cost)
{
	int c;
	char func[17];
	gid_t gid;
