...
//         $Id: XrdCS2DCM.hh,v 1.1 2008/02/25 15:15:46 apeters Exp $
...
int olbdsock;
struct sockaddr_un olbdsockname;
...
pid_t           Parent;
time_t          UpTime;
struct stage_options Opts;  // Stage options for stage_open
};
#endif
