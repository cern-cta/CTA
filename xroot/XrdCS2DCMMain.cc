...
//           $Id: XrdCS2DCMMain.cc,v 1.1 2008/02/25 15:15:46 apeters Exp $

const char *XrdCS2DCMMainCVSID = "$Id: XrdCS2DCMMain.cc,v 1.1 2008/02/25 15:15:46 apeters Exp $";

/* This is the Castor2 end-point stager interface. The syntax is:

   XrdCS2d [options] <mdir>

   options: [-d] [-l <lfile>] [-q <lim>] [-s <service-class>]
