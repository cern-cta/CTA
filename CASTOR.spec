...
for this in BuildCupvDaemon BuildDlfDaemon BuildDlfWeb BuildNameServerDaemon BuildRHCpp BuildRepack BuildRtcpclientd BuildSchedPlugin BuildVolumeMgrDaemon UseOracle UseScheduler BuildOraCpp BuildStageDaemon BuildVDQMCpp BuildDbTools BuildCleaning; do
