...
TEST_P(cta_catalogue_RequesterGroupMountRuleTest, modifyRequesterGroupMountRulePolicy) {
  ...
  m_catalogue->RequesterGroupMountRule()->modifyRequesterGroupMountRulePolicy(m_admin,
                                                                              diskInstanceName,
                                                                              requesterGroupName,
...
TEST_P(cta_catalogue_RequesterGroupMountRuleTest, modifyRequesterGroupMountRulePolicy_nonExistentRequester) {
  ...
  ASSERT_THROW(m_catalogue->RequesterGroupMountRule()->modifyRequesterGroupMountRulePolicy(m_admin,
                                                                                           diskInstanceName,
                                                                                           requesterGroupName,
                                                                                           mountPolicyName),
...
TEST_P(cta_catalogue_RequesterGroupMountRuleTest, modifyRequesterGroupMountRuleComment) {
  ...
  m_catalogue->RequesterGroupMountRule()->modifyRequesterGroupMountRuleComment(m_admin,
                                                                               diskInstanceName,
                                                                               requesterGroupName,
                                                                               modifiedComment);
...
TEST_P(cta_catalogue_RequesterGroupMountRuleTest, modifyRequesterGroupMountRuleComment_nonExistentRequester) {
  ...
  ASSERT_THROW(m_catalogue->RequesterGroupMountRule()->modifyRequesterGroupMountRuleComment(m_admin,
                                                                                            diskInstanceName,
                                                                                            requesterGroupName,
                                                                                            comment),
               cta::exception::UserError);
...
TEST_P(cta_catalogue_RequesterGroupMountRuleTest, createRequesterGroupMountRule_same_twice) {
  ...
  m_catalogue->RequesterGroupMountRule()->createRequesterGroupMountRule(m_admin,
                                                                        ...
                                                                        requesterGroupName,
                                                                        comment);
  ASSERT_THROW(m_catalogue->RequesterGroupMountRule()->createRequesterGroupMountRule(m_admin,
                                                                                     mountPolicyName,
                                                                                     diskInstanceName,
                                                                                     requesterGroupName,
                                                                                     comment),
