...
TEST_P(cta_catalogue_MountPolicyTest, modifyMountPolicyArchiveMinRequestAge) {
  ...
  m_catalogue->MountPolicy()->modifyMountPolicyArchiveMinRequestAge(m_admin,
...
TEST_P(cta_catalogue_MountPolicyTest, modifyMountPolicyRetrievePriority) {
  ...
  m_catalogue->MountPolicy()->modifyMountPolicyRetrievePriority(m_admin,
                                                                mountPolicyToAdd.name,
...
TEST_P(cta_catalogue_MountPolicyTest, modifyMountPolicyRetrieveMinRequestAge) {
  ...
  m_catalogue->MountPolicy()->modifyMountPolicyRetrieveMinRequestAge(m_admin,
                                                                     mountPolicyToAdd.name,
