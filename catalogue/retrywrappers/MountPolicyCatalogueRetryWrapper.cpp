...
void MountPolicyCatalogueRetryWrapper::createMountPolicy(const common::dataStructures::SecurityIdentity &admin,
  ...
  return retryOnLostConnection(m_log, [this,&admin,&mountPolicy]{ return m_catalogue->MountPolicy()->createMountPolicy(admin, mountPolicy); },
    m_maxTriesToConnect);
}

std::list<common::dataStructures::MountPolicy> MountPolicyCatalogueRetryWrapper::getMountPolicies() const {
  return retryOnLostConnection(m_log, [this]{ return m_catalogue->MountPolicy()->getMountPolicies(); }, m_maxTriesToConnect);
}
...
std::optional<common::dataStructures::MountPolicy> MountPolicyCatalogueRetryWrapper::getMountPolicy(
  ...
  return retryOnLostConnection(m_log, [this,&mountPolicyName]{ return m_catalogue->MountPolicy()->getMountPolicy(mountPolicyName); },
    m_maxTriesToConnect);
}


std::list<common::dataStructures::MountPolicy> MountPolicyCatalogueRetryWrapper::getCachedMountPolicies() const {
  return retryOnLostConnection(m_log, [this]{ return m_catalogue->MountPolicy()->getCachedMountPolicies(); },
    m_maxTriesToConnect);
}

void MountPolicyCatalogueRetryWrapper::deleteMountPolicy(const std::string &name) {
  return retryOnLostConnection(m_log, [this,&name]{ return m_catalogue->MountPolicy()->deleteMountPolicy(name); },
    m_maxTriesToConnect);
}
...
void MountPolicyCatalogueRetryWrapper::modifyMountPolicyArchivePriority(
  ...
  return retryOnLostConnection(m_log, [this,&admin,&name,&archivePriority] {
...
void MountPolicyCatalogueRetryWrapper::modifyMountPolicyArchiveMinRequestAge(
  ...
  return retryOnLostConnection(m_log, [this,&admin,&name,&minArchiveRequestAge] {
...
void MountPolicyCatalogueRetryWrapper::modifyMountPolicyRetrievePriority(
  ...
  return retryOnLostConnection(m_log, [this,&admin,&name,&retrievePriority] {
...
void MountPolicyCatalogueRetryWrapper::modifyMountPolicyRetrieveMinRequestAge(
  ...
  return retryOnLostConnection(m_log, [this,&admin,&name,&minRetrieveRequestAge] {
