...
void MountPolicyCatalogueRetryWrapper::createMountPolicy(const common::dataStructures::SecurityIdentity& admin,
  ...
  return retryOnLostConnection(
    m_log, [&] { return m_catalogue->MountPolicy()->createMountPolicy(admin, mountPolicy); }, m_maxTriesToConnect);
}

std::list<common::dataStructures::MountPolicy> MountPolicyCatalogueRetryWrapper::getMountPolicies() const {
  return retryOnLostConnection(
    m_log, [&] { return m_catalogue->MountPolicy()->getMountPolicies(); }, m_maxTriesToConnect);
}
...
std::optional<common::dataStructures::MountPolicy>
  ...
  return retryOnLostConnection(
    m_log, [&] { return m_catalogue->MountPolicy()->getMountPolicy(mountPolicyName); }, m_maxTriesToConnect);
}

std::list<common::dataStructures::MountPolicy> MountPolicyCatalogueRetryWrapper::getCachedMountPolicies() const {
  return retryOnLostConnection(
    m_log, [&] { return m_catalogue->MountPolicy()->getCachedMountPolicies(); }, m_maxTriesToConnect);
}

void MountPolicyCatalogueRetryWrapper::deleteMountPolicy(const std::string& name) {
  return retryOnLostConnection(
    m_log, [&] { return m_catalogue->MountPolicy()->deleteMountPolicy(name); }, m_maxTriesToConnect);
}
...
void MountPolicyCatalogueRetryWrapper::modifyMountPolicyArchivePriority(
  ...
  return retryOnLostConnection(
    m_log, [&] { return m_catalogue->MountPolicy()->modifyMountPolicyArchivePriority(admin, name, archivePriority); },
    m_maxTriesToConnect);
}
...
void MountPolicyCatalogueRetryWrapper::modifyMountPolicyRetrievePriority(
  ...
  return retryOnLostConnection(
    m_log, [&] { return m_catalogue->MountPolicy()->modifyMountPolicyRetrievePriority(admin, name, retrievePriority); },
    m_maxTriesToConnect);
}
...
void MountPolicyCatalogueRetryWrapper::modifyMountPolicyComment(const common::dataStructures::SecurityIdentity& admin,
  ...
  return retryOnLostConnection(
    m_log, [&] { return m_catalogue->MountPolicy()->modifyMountPolicyComment(admin, name, comment); },
    m_maxTriesToConnect);
}
