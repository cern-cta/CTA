...
void DiskInstanceSpaceCatalogueRetryWrapper::deleteDiskInstanceSpace(const std::string& name,
  ...
  return retryOnLostConnection(
    m_log, [&] { return m_catalogue->DiskInstanceSpace()->deleteDiskInstanceSpace(name, diskInstance); },
    m_maxTriesToConnect);
}
...
void DiskInstanceSpaceCatalogueRetryWrapper::createDiskInstanceSpace(
  ...
  return retryOnLostConnection(
    m_log,
    [&] {
      return m_catalogue->DiskInstanceSpace()->createDiskInstanceSpace(admin, name, diskInstance, freeSpaceQueryURL,
...
std::list<common::dataStructures::DiskInstanceSpace>
  ...
  return retryOnLostConnection(
    m_log, [&] { return m_catalogue->DiskInstanceSpace()->getAllDiskInstanceSpaces(); }, m_maxTriesToConnect);
}
...
void DiskInstanceSpaceCatalogueRetryWrapper::modifyDiskInstanceSpaceRefreshInterval(
  ...
  return retryOnLostConnection(
    m_log,
    [&] {
      return m_catalogue->DiskInstanceSpace()->modifyDiskInstanceSpaceRefreshInterval(admin, name, diskInstance,
                                                                                      refreshInterval);
    },
    m_maxTriesToConnect);
}
...
void DiskInstanceSpaceCatalogueRetryWrapper::modifyDiskInstanceSpaceQueryURL(
  ...
  return retryOnLostConnection(
    m_log,
    [&] {
      return m_catalogue->DiskInstanceSpace()->modifyDiskInstanceSpaceQueryURL(admin, name, diskInstance,
                                                                               freeSpaceQueryURL);
    },
    m_maxTriesToConnect);
}
