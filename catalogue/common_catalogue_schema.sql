...
CREATE TABLE DISK_SPACE_RESERVATION(
  DRIVE_NAME                  VARCHAR(100)       CONSTRAINT DISK_SPACE_RESERVATION_DN_NN NOT NULL,
  DISK_SYSTEM_NAME            VARCHAR(100)       CONSTRAINT DISK_SPACE_RESERVATION_DSN_NN NOT NULL,
  RESERVED_BYTES              UINT64TYPE         CONSTRAINT DISK_SPACE_RESERVATION_RB_NN NOT NULL,
  USER_COMMENT                VARCHAR(1000)      CONSTRAINT DISK_SPACE_RESERVATION_UC_NN   NOT NULL,
  CREATION_LOG_USER_NAME      VARCHAR(100)       CONSTRAINT DISK_SPACE_RESERVATION_CLUN_NN NOT NULL,
  CREATION_LOG_HOST_NAME      VARCHAR(100)       CONSTRAINT DISK_SPACE_RESERVATION_CLHN_NN NOT NULL,
  CREATION_LOG_TIME           UINT64TYPE         CONSTRAINT DISK_SPACE_RESERVATION_CLT_NN  NOT NULL,
  LAST_UPDATE_USER_NAME       VARCHAR(100)       CONSTRAINT DISK_SPACE_RESERVATION_LUUN_NN NOT NULL,
  LAST_UPDATE_HOST_NAME       VARCHAR(100)       CONSTRAINT DISK_SPACE_RESERVATION_LUHN_NN NOT NULL,
  LAST_UPDATE_TIME            UINT64TYPE         CONSTRAINT DISK_SPACE_RESERVATION_LUT_NN  NOT NULL,
  CONSTRAINT DISK_SPACE_RESERVATION_DSN_PK PRIMARY KEY(DISK_SYSTEM_NAME)
);
...
CREATE TABLE DRIVE_CONFIG (
  ...
  USER_COMMENT                VARCHAR(1000)      CONSTRAINT DRIVE_CONFIG_UC_NN   NOT NULL,
  CREATION_LOG_USER_NAME      VARCHAR(100)       CONSTRAINT DRIVE_CONFIG_CLUN_NN NOT NULL,
  CREATION_LOG_HOST_NAME      VARCHAR(100)       CONSTRAINT DRIVE_CONFIG_CLHN_NN NOT NULL,
  CREATION_LOG_TIME           UINT64TYPE         CONSTRAINT DRIVE_CONFIG_CLT_NN  NOT NULL,
  LAST_UPDATE_USER_NAME       VARCHAR(100)       CONSTRAINT DRIVE_CONFIG_LUUN_NN NOT NULL,
  LAST_UPDATE_HOST_NAME       VARCHAR(100)       CONSTRAINT DRIVE_CONFIG_LUHN_NN NOT NULL,
  LAST_UPDATE_TIME            UINT64TYPE         CONSTRAINT DRIVE_CONFIG_LUT_NN  NOT NULL,
...
CREATE TABLE DRIVE_STATE (
  ...
  DRIVE_STATUS                UINT32TYPE      CONSTRAINT DRIVE_STATE_DS_NN NOT NULL,
  ...
  NEXT_VO                     VARCHAR(100),
  USER_COMMENT                VARCHAR(1000)   CONSTRAINT DRIVE_STATE_UC_NN   NOT NULL,
  CREATION_LOG_USER_NAME      VARCHAR(100)    CONSTRAINT DRIVE_STATE_CLUN_NN NOT NULL,
  CREATION_LOG_HOST_NAME      VARCHAR(100)    CONSTRAINT DRIVE_STATE_CLHN_NN NOT NULL,
  CREATION_LOG_TIME           UINT64TYPE      CONSTRAINT DRIVE_STATE_CLT_NN  NOT NULL,
  LAST_UPDATE_USER_NAME       VARCHAR(100)    CONSTRAINT DRIVE_STATE_LUUN_NN NOT NULL,
  LAST_UPDATE_HOST_NAME       VARCHAR(100)    CONSTRAINT DRIVE_STATE_LUHN_NN NOT NULL,
  LAST_UPDATE_TIME            UINT64TYPE      CONSTRAINT DRIVE_STATE_LUT_NN  NOT NULL,
...
CREATE TABLE DRIVE_STATE_POINTER (
  DRIVE_NAME                  VARCHAR(100)    CONSTRAINT DRIVE_STATE_POINTER_DN_NN   NOT NULL,
  DRIVE_STATE_ADDRESS         VARCHAR(100)    CONSTRAINT DRIVE_STATE_POINTER_DSA_NN  NOT NULL,
  USER_COMMENT                VARCHAR(1000)   CONSTRAINT DRIVE_STATE_POINTER_UC_NN   NOT NULL,
  CREATION_LOG_USER_NAME      VARCHAR(100)    CONSTRAINT DRIVE_STATE_POINTER_CLUN_NN NOT NULL,
  CREATION_LOG_HOST_NAME      VARCHAR(100)    CONSTRAINT DRIVE_STATE_POINTER_CLHN_NN NOT NULL,
  CREATION_LOG_TIME           UINT64TYPE      CONSTRAINT DRIVE_STATE_POINTER_CLT_NN  NOT NULL,
  LAST_UPDATE_USER_NAME       VARCHAR(100)    CONSTRAINT DRIVE_STATE_POINTER_LUUN_NN NOT NULL,
  LAST_UPDATE_HOST_NAME       VARCHAR(100)    CONSTRAINT DRIVE_STATE_POINTER_LUHN_NN NOT NULL,
  LAST_UPDATE_TIME            UINT64TYPE      CONSTRAINT DRIVE_STATE_POINTER_LUT_NN  NOT NULL,
  CONSTRAINT DRIVE_STATE_POINTER_DSA_PK PRIMARY KEY(DRIVE_STATE_ADDRESS)
);
