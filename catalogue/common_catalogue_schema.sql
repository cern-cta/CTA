...
CREATE TABLE DISK_SYSTEM(
  ...
  FREE_SPACE_QUERY_URL     VARCHAR(1000)   , -- DEPRECATED to be removed after catalogue 5.0 is deployed
  REFRESH_INTERVAL         UINT64TYPE      , -- DEPRECATED to be removed after catalogue 5.0 is deployed
...
CREATE TABLE REQUESTER_ACTIVITY_MOUNT_RULE(
  ...
  CREATION_LOG_TIME      UINT64TYPE      CONSTRAINT RQSTER_ACT_RULE_CLT_NN  NOT NULL,
...
CREATE TABLE DRIVE_STATE (
  ...
  SESSION_ELAPSED_TIME        UINT64TYPE,
