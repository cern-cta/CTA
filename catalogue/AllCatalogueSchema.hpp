...

{
  ...
  "  PRIMARY_DENSITY_CODE   NUMERIC(3, 0)     CONSTRAINT MEDIA_TYPE_PDC_NN  NOT NULL,"
  "  SECONDARY_DENSITY_CODE NUMERIC(3, 0)     CONSTRAINT MEDIA_TYPE_SDC_NN  NOT NULL,"
  ...
  "  PRIMARY_DENSITY_CODE   TINYINT UNSIGNED     CONSTRAINT MEDIA_TYPE_PDC_NN  NOT NULL,"
  "  SECONDARY_DENSITY_CODE TINYINT UNSIGNED     CONSTRAINT MEDIA_TYPE_SDC_NN  NOT NULL,"
  ...
  "  PRIMARY_DENSITY_CODE   INTEGER     CONSTRAINT MEDIA_TYPE_PDC_NN  NOT NULL,"
  "  SECONDARY_DENSITY_CODE INTEGER     CONSTRAINT MEDIA_TYPE_SDC_NN  NOT NULL,"
  "  NB_WRAPS               INTEGER,"
  "  MIN_LPOS               INTEGER,"
  "  MAX_LPOS               INTEGER,"
  "  USER_COMMENT           VARCHAR(1000) CONSTRAINT MEDIA_TYPE_UC_NN   NOT NULL,"
