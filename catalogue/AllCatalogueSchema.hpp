...

{
  ...
  "  IS_EXPORTED             CHAR(1)         DEFAULT '0' CONSTRAINT TAPE_IE_NN   NOT NULL,"
  "  DIRTY                   CHAR(1)         DEFAULT '1' CONSTRAINT TAPE_DIRTY_NN NOT NULL,"
  "  NB_COPY_NB1             NUMERIC(20, 0)      DEFAULT 0 CONSTRAINT TAPE_NB_COPY_NB1_NN NOT NULL,"
  "  COPY_NB1_IN_BYTES       NUMERIC(20, 0)      DEFAULT 0 CONSTRAINT TAPE_COPY_NB1_IN_BYTES_NN NOT NULL,"
  "  NB_COPY_NB_GT1          NUMERIC(20, 0)      DEFAULT 0 CONSTRAINT TAPE_NB_COPY_NB_GT1_NN NOT NULL,"
  "  COPY_NB_GT1_IN_BYTES    NUMERIC(20, 0)      DEFAULT 0 CONSTRAINT TAPE_COPY_NB_GT1_IN_BYTES_NN NOT NULL,"
  "  LABEL_DRIVE             VARCHAR2(100),"
  "  LABEL_TIME              NUMERIC(20, 0)    ,"
  "  LAST_READ_DRIVE         VARCHAR2(100),"
  "  LAST_READ_TIME          NUMERIC(20, 0)    ,"
  ...
  "  IS_EXPORTED             CHAR(1)         DEFAULT '0' CONSTRAINT TAPE_IE_NN   NOT NULL,"
  "  DIRTY                   CHAR(1)         DEFAULT '1' CONSTRAINT TAPE_DIRTY_NN NOT NULL,"
  "  NB_COPY_NB1             BIGINT UNSIGNED      DEFAULT 0 CONSTRAINT TAPE_NB_COPY_NB1_NN NOT NULL,"
  "  COPY_NB1_IN_BYTES       BIGINT UNSIGNED      DEFAULT 0 CONSTRAINT TAPE_COPY_NB1_IN_BYTES_NN NOT NULL,"
  "  NB_COPY_NB_GT1          BIGINT UNSIGNED      DEFAULT 0 CONSTRAINT TAPE_NB_COPY_NB_GT1_NN NOT NULL,"
  "  COPY_NB_GT1_IN_BYTES    BIGINT UNSIGNED      DEFAULT 0 CONSTRAINT TAPE_COPY_NB_GT1_IN_BYTES_NN NOT NULL,"
  "  LABEL_DRIVE             VARCHAR(100),"
  "  LABEL_TIME              BIGINT UNSIGNED    ,"
  "  LAST_READ_DRIVE         VARCHAR(100),"
  "  LAST_READ_TIME          BIGINT UNSIGNED    ,"
  ...
  "  IS_EXPORTED             CHAR(1)         DEFAULT '0' CONSTRAINT TAPE_IE_NN   NOT NULL,"
  "  DIRTY                   CHAR(1)         DEFAULT '1' CONSTRAINT TAPE_DIRTY_NN NOT NULL,"
  "  NB_COPY_NB1             INTEGER      DEFAULT 0 CONSTRAINT TAPE_NB_COPY_NB1_NN NOT NULL,"
  "  COPY_NB1_IN_BYTES       INTEGER      DEFAULT 0 CONSTRAINT TAPE_COPY_NB1_IN_BYTES_NN NOT NULL,"
  "  NB_COPY_NB_GT1          INTEGER      DEFAULT 0 CONSTRAINT TAPE_NB_COPY_NB_GT1_NN NOT NULL,"
  "  COPY_NB_GT1_IN_BYTES    INTEGER      DEFAULT 0 CONSTRAINT TAPE_COPY_NB_GT1_IN_BYTES_NN NOT NULL,"
  "  LABEL_DRIVE             VARCHAR(100),"
  "  LABEL_TIME              INTEGER    ,"
  "  LAST_READ_DRIVE         VARCHAR(100),"
  "  LAST_READ_TIME          INTEGER    ,"
