...
CREATE TABLE REQUESTER_ACTIVITY_MOUNT_RULE(
  ...
  CREATION_LOG_TIME      BIGINT UNSIGNED      CONSTRAINT RQSTER_ACT_RULE_CLT_NN  NOT NULL,
  ...
  LAST_UPDATE_TIME       BIGINT UNSIGNED      CONSTRAINT RQSTER_ACT_RULE_LUT_NN  NOT NULL,
