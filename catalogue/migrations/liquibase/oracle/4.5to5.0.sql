...
--preconditions onFail:HALT onError:HALT
--precondition-sql-check expectedResult:"4.5" SELECT CONCAT(CONCAT(CAST(SCHEMA_VERSION_MAJOR as VARCHAR(10)),'.'), CAST(SCHEMA_VERSION_MINOR AS VARCHAR(10))) AS CATALOGUE_VERSION FROM CTA_CATALOGUE;
ALTER TABLE DISK_SYSTEM DROP (REFRESH_INTERVAL, FREE_SPACE_QUERY_URL); 
ALTER TABLE DISK_SYSTEM ADD (DISK_INSTANCE_NAME VARCHAR(100) CONSTRAINT DISK_SYSTEM_DINM_NN  NOT NULL, DISK_INSTANCE_SPACE_NAME VARCHAR(100) CONSTRAINT DISK_SYSTEM_DISNM_NN NOT NULL);
...
--rollback ALTER TABLE DISK_SYSTEM DROP (DISK_INSTANCE_NAME, DISK_INSTANCE_SPACE_NAME);
--rollback ALTER TABLE DISK_SYSTEM ADD (FREE_SPACE_QUERY_URL VARCHAR(1000) CONSTRAINT DISK_SYSTEM_FSQU_NN NOT NULL, REFRESH_INTERVAL UINT64TYPE CONSTRAINT DISK_SYSTEM_RI_NN NOT NULL);
