...
common::dataStructures::VidToTapeMap DummyTapeCatalogue::getTapesByVid(const std::set<std::string>& vids,
...
std::map<std::string, std::string> DummyTapeCatalogue::getVidToLogicalLibrary(const std::set<std::string>& vids) const {
  throw exception::Exception(std::string("In ") + __PRETTY_FUNCTION__ + ": not implemented");
}
