...
CREATE TABLE STORAGE_CLASS(
  ...
  LAST_UPDATE_HOST_NAME   VARCHAR2(100)  NOT NULL,
  LAST_UPDATE_TIME        INTEGER        NOT NULL,
  CONSTRAINT STORAGE_CLASS_PK PRIMARY KEY(DISK_INSTANCE, STORAGE_CLASS_NAME)
);
...
CREATE TABLE ARCHIVE_ROUTE(
  ...
  LAST_UPDATE_HOST_NAME   VARCHAR2(100)  NOT NULL,
  LAST_UPDATE_TIME        INTEGER        NOT NULL,
  CONSTRAINT ARCHIVE_ROUTE_PK PRIMARY KEY(DISK_INSTANCE, STORAGE_CLASS_NAME, COPY_NB),
  CONSTRAINT ARCHIVE_ROUTE_STORAGE_CLASS_FK FOREIGN KEY(DISK_INSTANCE, STORAGE_CLASS_NAME)
    REFERENCES STORAGE_CLASS(DISK_INSTANCE, STORAGE_CLASS_NAME),
...
CREATE TABLE REQUESTER_MOUNT_RULE(
  ...
  LAST_UPDATE_HOST_NAME  VARCHAR2(100)  NOT NULL,
  LAST_UPDATE_TIME       INTEGER        NOT NULL,
  CONSTRAINT RQSTER_RULE_PK PRIMARY KEY(DISK_INSTANCE, REQUESTER_NAME),
...
CREATE TABLE ARCHIVE_FILE(
  ...
  CONSTRAINT ARCHIVE_FILE_STORAGE_CLASS_FK FOREIGN KEY(DISK_INSTANCE, STORAGE_CLASS_NAME)
    REFERENCES STORAGE_CLASS(DISK_INSTANCE, STORAGE_CLASS_NAME),
