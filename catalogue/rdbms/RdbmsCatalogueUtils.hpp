...
public:
  ...
  static bool requesterActivityMountRuleExists(rdbms::Conn& conn,
  ...
  static bool
    requesterMountRuleExists(rdbms::Conn& conn, const std::string& diskInstanceName, const std::string& requesterName);
  static bool requesterGroupMountRuleExists(rdbms::Conn& conn,
                                            const std::string& diskInstanceName,
  ...
  static void updateTape(rdbms::Conn& conn,
