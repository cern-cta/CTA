...
void RdbmsSchemaCatalogue::verifySchemaVersion() {
  const std::set<int> supported_versions {SUPPORTED_CTA_CATALOGUE_SCHEMA_VERSIONS_ARRAY,
                                          SUPPORTED_CTA_CATALOGUE_SCHEMA_VERSIONS_ARRAY
                                            + SUPPORTED_CTA_CATALOGUE_SCHEMA_VERSIONS_COUNT};
