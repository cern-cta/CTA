...
public:
  RepackReportThread(Scheduler& scheduler, log::LogContext &lc, int timeout):m_scheduler(scheduler),m_lc(lc), m_softTimeout(timeout){}
...
public:
  RetrieveSuccessesRepackReportThread(Scheduler& scheduler,log::LogContext& lc, int timeout):RepackReportThread(scheduler,lc,timeout) {}
private:
...
public:
  ArchiveSuccessesRepackReportThread(Scheduler& scheduler,log::LogContext& lc, int timeout):RepackReportThread(scheduler,lc,timeout) {}
private:
  virtual cta::Scheduler::RepackReportBatch getNextRepackReportBatch(log::LogContext &lc);
...
public:
  RetrieveFailedRepackReportThread(Scheduler& scheduler,log::LogContext& lc, int timeout):RepackReportThread(scheduler,lc,timeout) {}
private:
  virtual cta::Scheduler::RepackReportBatch getNextRepackReportBatch(log::LogContext &lc);
...
public:
  ArchiveFailedRepackReportThread(Scheduler& scheduler,log::LogContext& lc, int timeout):RepackReportThread(scheduler,lc,timeout) {}
private:
  virtual cta::Scheduler::RepackReportBatch getNextRepackReportBatch(log::LogContext &lc);
  virtual std::string getReportingType(){ return "ArchiveFailed"; }
};

} // namesapce cta::maintenance
