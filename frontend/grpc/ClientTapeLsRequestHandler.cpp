  ...
  if (!bOk) {
    switch (m_streamState) {
      ...
      case StreamState::HEADER: {
        ...
        lc.log(cta::log::ERR,
               "In grpc::client::TapeLsRequestHandler::next(): Server has been shut down before receiving a matching "
               "request.");
      } break;
      ...
      default: {
        ...
        params.add("tag", m_tag);
        lc.log(cta::log::INFO,
               "In grpc::client::TapeLsRequestHandler::next(): Request processing aborted, call is cancelled or "
