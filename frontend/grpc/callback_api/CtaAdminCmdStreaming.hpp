 ...
 */
 ...
 class CtaAdminCmdStreaming
 {
 public:
    CtaAdminCmdStreaming(int argc, const char *const *const argv);
   ...
   //  class ReaderTapeLs : public grpc::ClientReadReactor<cta::xrd::StreamResponse>
   //  {
   //    ReaderTapeLs(CtaRpcStream::Stub* stub);
 ...
 private:
    ...
    static constexpr const char* const LOG_SUFFIX  = "CtaAdminCmdStreaming";    //!< Identifier for log messages
 };
