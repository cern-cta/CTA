...
CtaAdminServerWriteReactor::CtaAdminServerWriteReactor(cta::catalogue::Catalogue &catalogue, cta::Scheduler &scheduler, const std::string& instanceName, cta::admin::HeaderType headerType)
