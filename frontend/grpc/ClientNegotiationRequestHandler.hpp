...
public:
  ...
  NegotiationRequestHandler(cta::log::Logger& log, cta::xrd::Negotiation::Stub& stub, ::grpc::CompletionQueue& completionQueue, const std::string& strSpn);
...
private:
  ...
  std::unique_ptr<::grpc::ClientAsyncReaderWriter<cta::xrd::KerberosAuthenticationRequest, cta::xrd::KerberosAuthenticationResponse>> m_uprwNegotiation;
