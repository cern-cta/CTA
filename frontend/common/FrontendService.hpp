...
private:
  ...
  std::optional<uint64_t>
    m_tapeCacheMaxAgeSecs;  //!< Option to override the tape cache timeout value in the scheduler DB
  std::optional<uint64_t>
    m_retrieveQueueCacheMaxAgeSecs;     //!< Option to override the retrieve queue timeout value in the scheduler DB
  ...
  std::vector<std::string>
    m_zeroLengthFilesForbidden_voExceptions;  //!< If 0-length files are rejected by default, do not apply check to these VOs
