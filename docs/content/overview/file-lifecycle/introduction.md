...
When cancelling archive and retrieve requests, in the objectstore implementation, the request is marked as invalid
but not removed from the queue until the job is popped. This is handled more consistently by the PostgreSQL Scheduler DB.
