...
This section explains the system, its terminology, and the boundary between CTA and the disk system. For deployment and day-to-day procedures, use [Operations](../ops/index.md). Source code, interfaces, and contribution workflows belong in [Development](../dev/index.md).
