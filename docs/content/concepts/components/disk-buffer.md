...
the disk buffer and writes it to tape. When the operation is completed, the disk system can evict the disk replica according to its retention policy while preserving the namespace entry.
