...
This page defines the packaging conventions for CTA RPM SPEC files, systemd units, and logrotate policies. For the resulting operator-visible behavior, see [RPM Packages and Services](../../ops/deployment/installation/rpm-packages.md).
