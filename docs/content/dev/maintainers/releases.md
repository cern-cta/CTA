...
- **unstable**: [package repository](https://cta-public-repo.web.cern.ch/unstable/)
    - These versions have passed CI and have been stress-tested, but have not been deployed in production.
- **testing**: [package repository](https://cta-public-repo.web.cern.ch/testing/)
...
- **stable**: [package repository](https://cta-public-repo.web.cern.ch/stable/)
