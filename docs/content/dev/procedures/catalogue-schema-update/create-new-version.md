...
!!! warning
    `SCHEMA_VERSION_MAJOR` should be modified only if the changes made to the schema are [not backward-compatible](./backward-incompatible-upgrades.md#definition) with the currently running version of CTA.
