# Testing Logs, Metrics, and Health Checks
...
!!! info "Documentation outline"
    Add checks for log context, severity, and failure-path output.

## Health-check tests

!!! info "Documentation outline"
    Cover readiness and liveness transitions, dependency recovery, and shutdown.
