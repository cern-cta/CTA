...
**Developers** who need to make changes to the catalogue schema should refer to [Modifying the CTA Catalogue Schema](../../procedures/catalogue-schema-update/index.md).

**Operators** who need to upgrade the schema on a CTA production or pre-production instance should refer to [Upgrading the schema](../../..//ops/procedures/upgrading-cta-catalogue-schema/index.md).
