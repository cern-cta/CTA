...
- [Creating a new version of the schema](new-version.md)
- Modifying the schema, following the [naming conventions](naming.md)
...
- Identify the changes that have been made to the schema: are they [backward-compatible](compatible-changes.md) or [backward-incompatible](incompatible-changes.md)?
- Create the [Liquibase migration/upgrade changelog file](migration-scripts.md). These are basically SQL scripts.
