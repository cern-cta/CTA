...
In CTA, a Mount Policy is named and defined in the Catalogue (see the [description](../catalogue/index.md#mount-policy-table)).
...
This is what you can then find in the Catalogue Mount Policy table, see the [Catalogue Mount Policy Table](../catalogue/index.md#mount-policy-table).
