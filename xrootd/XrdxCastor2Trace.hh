//         $Id: XrdxCastor2Trace.hh,v 1.1 2008/09/15 10:04:02 apeters Exp $

#ifndef ___XCASTOR2TRACE_H___
#define ___XCASTOR2TRACE_H___
...
#define GTRACE(act)         xCastor2FsTrace.What & TRACE_ ## act

#define TRACES(x) \
        {xCastor2FsTrace.Beg(epname,tident); cerr <<x; xCastor2FsTrace.End();}
