/*
 * $Id: stager_usrmsg.c,v 1.6 2000/05/23 07:18:02 jdurand Exp $
 */
...
#ifndef lint
static char cvsId[] = "@(#)$RCSfile: stager_usrmsg.c,v $ $Revision: 1.6 $ $Date: 2000/05/23 07:18:02 $ CERN/IT/PDP/DM Jean-Damien Durand";
#endif /* not lint */
