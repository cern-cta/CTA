/*
 * $Id: stager_usrmsg.c,v 1.8 2000/07/04 14:32:13 jdurand Exp $
 */
...
#ifndef lint
static char cvsId[] = "@(#)$RCSfile: stager_usrmsg.c,v $ $Revision: 1.8 $ $Date: 2000/07/04 14:32:13 $ CERN/IT/PDP/DM Jean-Damien Durand";
#endif /* not lint */
