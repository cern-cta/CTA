/*
 * $Id: stage_api.c,v 1.69 2003/11/03 06:35:17 jdurand Exp $
 */
...
#ifndef lint
static char sccsid[] = "@(#)$RCSfile: stage_api.c,v $ $Revision: 1.69 $ $Date: 2003/11/03 06:35:17 $ CERN IT/DS/HSM Jean-Damien Durand";
#endif /* not lint */
