/*
 * $Id: stage_api.c,v 1.70 2004/03/02 09:20:38 jdurand Exp $
 */
...
#ifndef lint
static char sccsid[] = "@(#)$RCSfile: stage_api.c,v $ $Revision: 1.70 $ $Date: 2004/03/02 09:20:38 $ CERN IT/DS/HSM Jean-Damien Durand";
#endif /* not lint */
