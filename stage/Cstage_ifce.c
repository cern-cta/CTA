/*
 * $Id: Cstage_ifce.c,v 1.6 2000/02/02 09:37:56 jdurand Exp $
 */
...
#ifndef lint
static char sccsid[] = "@(#)$RCSfile: Cstage_ifce.c,v $ $Revision: 1.6 $ $Date: 2000/02/02 09:37:56 $ CERN IT-PDP/DM Jean-Damien Durand";
#endif /* not lint */
