...
#
for this in BuildCppTest BuildExamples BuildGcDaemon BuildTest ClientLogging HasNis SecMakeStaticLibrary UseAdns UseDMSCapi UseHpss UseMtx UseMySQL UseKRB4 UseHeimdalKrb5 BuildSecureCupv BuildSecureRtcopy BuildSecureStage BuildSecureTape BuildSecureVdqm BuildSecureVmgr; do
