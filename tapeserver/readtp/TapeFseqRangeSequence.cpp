...
// constructor
//------------------------------------------------------------------------------
TapeFseqRangeSequence::TapeFseqRangeSequence(const TapeFseqRange& range) noexcept {
  reset(range);
}
...
// reset
//------------------------------------------------------------------------------
void TapeFseqRangeSequence::reset(const TapeFseqRange& range) noexcept {
  m_range = range;
...
// range
//------------------------------------------------------------------------------
const TapeFseqRange& TapeFseqRangeSequence::range() const noexcept {
  return m_range;
}
