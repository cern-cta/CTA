...
namespace castor {
  ...
  namespace db {
    ...
    namespace cnv {
      ...
      /**
       * class DbStageRmRequestCnv
       * A converter for storing/retrieving StageRmRequest into/from a generic database
       */
      class DbStageRmRequestCnv : public DbBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        DbStageRmRequestCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~DbStageRmRequestCnv() throw();
      ...
      }; // end of class DbStageRmRequestCnv
