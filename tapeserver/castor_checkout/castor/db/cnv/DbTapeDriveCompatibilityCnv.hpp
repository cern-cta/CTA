...
namespace castor {
  ...
  namespace db {
    ...
    namespace cnv {
      ...
      /**
       * class DbTapeDriveCompatibilityCnv
       * A converter for storing/retrieving TapeDriveCompatibility into/from a generic
       * database
       */
      class DbTapeDriveCompatibilityCnv : public DbBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        DbTapeDriveCompatibilityCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~DbTapeDriveCompatibilityCnv() throw();
      ...
      private:
        ...
        static const std::string s_insertTapeDriveStatementString;

        /// SQL insert statement object for member 
        castor::db::IDbStatement *m_insertTapeDriveStatement;
      ...
      }; // end of class DbTapeDriveCompatibilityCnv
