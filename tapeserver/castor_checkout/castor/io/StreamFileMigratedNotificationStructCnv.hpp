...
namespace castor {
  ...
  namespace io {
    ...
    /**
     * class StreamFileMigratedNotificationStructCnv
     * A converter for marshalling/unmarshalling FileMigratedNotificationStruct
     * into/from stl streams
     */
    class StreamFileMigratedNotificationStructCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Constructor
       */
      StreamFileMigratedNotificationStructCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamFileMigratedNotificationStructCnv() throw();
