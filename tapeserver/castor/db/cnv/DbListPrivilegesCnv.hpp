...
namespace castor {
  ...
  namespace db {
    ...
    namespace cnv {
      ...
      /**
       * class DbListPrivilegesCnv
       * A converter for storing/retrieving ListPrivileges into/from a generic database
       */
      class DbListPrivilegesCnv : public DbBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        DbListPrivilegesCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~DbListPrivilegesCnv() throw();
      ...
      }; // end of class DbListPrivilegesCnv
