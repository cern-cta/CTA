...
namespace castor {
  ...
  namespace db {
    ...
    namespace cnv {
      ...
      /**
       * class DbNsFilesDeletedCnv
       * A converter for storing/retrieving NsFilesDeleted into/from a generic database
       */
      class DbNsFilesDeletedCnv : public DbBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        DbNsFilesDeletedCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~DbNsFilesDeletedCnv() throw();
      ...
      }; // end of class DbNsFilesDeletedCnv
