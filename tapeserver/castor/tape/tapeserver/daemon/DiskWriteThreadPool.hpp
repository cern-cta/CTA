...
private:
  ...
  public:
    explicit DiskWriteWorkerThread(DiskWriteThreadPool& manager) :
      ...
      cta::telemetry::metrics::tapedThreadCount->Add(1, {{cta::semconv::kTransferDirection, cta::semconv::kTransferDirectionArchive}, {cta::semconv::kThreadPoolName, cta::semconv::kThreadPoolNameDisk}});
