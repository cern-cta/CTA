...
private:
  ...
  public:
    explicit DiskWriteWorkerThread(DiskWriteThreadPool& manager) :
      ...
      cta::telemetry::metrics::ctaTapedThreadPoolSize->Add(1, {{cta::semconv::attr::kCtaTransferDirection, cta::semconv::attr::CtaTransferDirectionValues::kArchive}, {cta::semconv::attr::kThreadPoolName, cta::semconv::attr::ThreadPoolNameValues::kDisk}});
