...
public:
  ...
  const unsigned char* get() const { return m_data.get(); }
   ...
   */
  void write(cta::disk::WriteFile& to) { to.write(m_data.get(), m_size); }
  /**
  ...
  /**
    ...
    */
  unsigned long adler32(unsigned long previous) { return ::adler32(previous, m_data.get(), m_size); }
  /**
