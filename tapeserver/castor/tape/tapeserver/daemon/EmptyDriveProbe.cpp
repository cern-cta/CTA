...
// constructor
//------------------------------------------------------------------------------
castor::tape::tapeserver::daemon::EmptyDriveProbe::EmptyDriveProbe(cta::log::Logger& log,
...
bool castor::tape::tapeserver::daemon::EmptyDriveProbe::driveIsEmpty() throw() {
  ...
  std::list<cta::log::Param> params = {cta::log::Param("tapeDrive", m_driveConfig.unitName),
