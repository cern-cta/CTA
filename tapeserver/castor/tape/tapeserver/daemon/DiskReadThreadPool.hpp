...
private:
  ...
  public:
    explicit DiskReadWorkerThread(DiskReadThreadPool& parent) :
      ...
      cta::telemetry::metrics::ctaTapedThreadPoolSize->Add(1, {{cta::semconv::kTransferDirection, cta::semconv::TransferDirectionValues::kRetrieve}, {cta::semconv::kThreadPoolName, cta::semconv::ThreadPoolNameValues::kDisk}});
