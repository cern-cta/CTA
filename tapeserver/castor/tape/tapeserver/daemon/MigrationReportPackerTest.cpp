...
TEST_F(castor_tape_tapeserver_daemon_MigrationReportPackerTest, MigrationReportPackerNominal) {
  ...
  m_catalogue->LogicalLibrary()->createLogicalLibrary(admin, logicalLibraryName, logicalLibraryIsDisabled,
  ...
  job1->archiveFile.checksumBlob.insert(
    cta::checksum::MD5, cta::checksum::ChecksumBlob::HexToByteArray("b170288bf1f61b26a648358866f4d6c6"));
...
TEST_F(castor_tape_tapeserver_daemon_MigrationReportPackerTest, MigrationReportPackerBadFile) {
  ...
  m_catalogue->LogicalLibrary()->createLogicalLibrary(admin, logicalLibraryName, logicalLibraryIsDisabled,
                                                      "Create logical library");
  m_catalogue->TapePool()->createTapePool(admin, tapePoolName, vo.name, nbPartialTapes, isEncrypted, supply,
                                          "Create tape pool");
  createMediaType(mediaType);
  ...
  cta::log::StringLogger log("dummy", "castor_tape_tapeserver_daemon_MigrationReportPackerOneByteFile",
                             cta::log::DEBUG);
  cta::log::LogContext lc(log);
  tapeserver::daemon::MigrationReportPacker mrp(&tam, lc);
  mrp.startThreads();
