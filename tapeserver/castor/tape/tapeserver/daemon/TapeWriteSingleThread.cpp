...
castor::tape::tapeserver::daemon::TapeWriteSingleThread::TapeWriteSingleThread(
  ...
  cta::telemetry::metrics::tapedThreadCount->Add(1, {{cta::semconv::kTransferDirection, cta::semconv::TransferDirectionValues::kArchive}, {cta::semconv::kThreadPoolName, cta::semconv::ThreadPoolNameValues::kTape}});
}
