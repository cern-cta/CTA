...
int System::stDeviceFile::ioctlLogSelect(sg_io_hdr_t* sgio_h) {
  ...
  SCSI::Structures::logSelectCDB_t& cdb = *(SCSI::Structures::logSelectCDB_t*) sgio_h->cmdp;
...
int System::stOracleT10000Device::ioctlInquiry(sg_io_hdr_t* sgio_h) {
  ...
  SCSI::Structures::inquiryCDB_t& cdb = *(SCSI::Structures::inquiryCDB_t*) sgio_h->cmdp;
