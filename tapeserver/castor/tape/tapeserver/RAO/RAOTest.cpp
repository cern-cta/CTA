...
TEST_F(RAOTest, RAOSLTFAlgorithm) {
  ...
  filePositionEstimator.reset(
    new rao::InterpolationFilePositionEstimator(RAOTestEnvironment::getLTO7MEndOfWrapPositions(),
                                                RAOTestEnvironment::getLTO7MMediaType()));
