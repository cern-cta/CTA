...
class EnstoreLargeRetrieveJob : public cta::RetrieveJob {
public:
  EnstoreLargeRetrieveJob()
...
class EnstoreLargeReaderTest : public ::testing::Test {
protected:
  EnstoreLargeReaderTest() : m_sWrapper(), m_dev() {}
...
TEST_F(EnstoreLargeReaderTest, ReadEnstoreLargeTape) {
  createDrive();

  using LabelFormat = cta::common::dataStructures::Label::Format;
  const auto labelFormat = LabelFormat::EnstoreLarge;
  ...
  EnstoreLargeRetrieveJob fileToRecall;
