...
/**
  ...
  */
class CtaReadSession1 : public ReadSession {
public:
  /**
    ...
    */
  CtaReadSession1(tapeserver::drive::DriveInterface &drive, const tapeserver::daemon::VolumeInfo &volInfo,
    const bool useLbp);

  ~CtaReadSession1() override = default;
};
