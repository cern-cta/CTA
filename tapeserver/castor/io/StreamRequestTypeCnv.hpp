...
namespace castor {
  ...
  namespace io {
    ...
    /**
     * class StreamRequestTypeCnv
     * A converter for marshalling/unmarshalling RequestType into/from stl streams
     */
    class StreamRequestTypeCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Constructor
       */
      StreamRequestTypeCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamRequestTypeCnv() throw();
