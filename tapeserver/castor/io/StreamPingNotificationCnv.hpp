...
namespace castor {
  ...
  namespace io {
    ...
    /**
     * class StreamPingNotificationCnv
     * A converter for marshalling/unmarshalling PingNotification into/from stl
     * streams
     */
    class StreamPingNotificationCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Constructor
       */
      StreamPingNotificationCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamPingNotificationCnv() throw();
