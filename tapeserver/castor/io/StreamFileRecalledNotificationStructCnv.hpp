...
namespace castor {
  ...
  namespace io {
    ...
    /**
     * class StreamFileRecalledNotificationStructCnv
     * A converter for marshalling/unmarshalling FileRecalledNotificationStruct
     * into/from stl streams
     */
    class StreamFileRecalledNotificationStructCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Constructor
       */
      StreamFileRecalledNotificationStructCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamFileRecalledNotificationStructCnv() throw();
