...
namespace castor {
  ...
  namespace io {
    ...
    /**
     * class StreamAbortResponseCnv
     * A converter for marshalling/unmarshalling AbortResponse into/from stl streams
     */
    class StreamAbortResponseCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Constructor
       */
      StreamAbortResponseCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamAbortResponseCnv() throw();
