...
namespace castor {
  ...
  namespace io {
    ...
    /**
     * class StreamEndNotificationCnv
     * A converter for marshalling/unmarshalling EndNotification into/from stl streams
     */
    class StreamEndNotificationCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Constructor
       */
      StreamEndNotificationCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamEndNotificationCnv() throw();
