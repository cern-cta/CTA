...
namespace castor {
  ...
  namespace io {
    ...
    /**
     * class StreamTapeServerCnv
     * A converter for marshalling/unmarshalling TapeServer into/from stl streams
     */
    class StreamTapeServerCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Constructor
       */
      StreamTapeServerCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamTapeServerCnv() throw();
