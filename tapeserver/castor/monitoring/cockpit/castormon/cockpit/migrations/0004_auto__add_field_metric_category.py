...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Metric.category'
        db.add_column('cockpit_metric', 'category', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Metric.category'
        db.delete_column('cockpit_metric', 'category')
    ...
    models = {
        'cockpit.metric': {
            ...
            'unit': ('django.db.models.fields.TextField', [], {'default': "''"}),
