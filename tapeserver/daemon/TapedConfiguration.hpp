...
struct TapedConfiguration {
  static TapedConfiguration createFromCtaConf(const std::string& generalConfigPath,
  ...
  cta::SourcedParameter<std::string> tpConfigPath {"taped", "TpConfigPath", "/etc/cta/TPCONFIG",
  ...
  cta::SourcedParameter<std::string> raoLtoOptions {"taped", "RAOLTOAlgorithmOptions", "cost_heuristic_name:cta",
                                                    "Compile time default"};
  //----------------------------------------------------------------------------
  // External script to get free disk space in the Retrieve buffer
  //----------------------------------------------------------------------------
  cta::SourcedParameter<std::string> externalFreeDiskSpaceScript {"taped", "externalFreeDiskSpaceScript", "",
                                                                  "Compile time default"};
  //----------------------------------------------------------------------------
  ...
  cta::SourcedParameter<time_t> wdNoBlockMoveMaxSecs {"taped", "WatchdogNoBlockMoveMaxSecs", 10 * 60,
                                                      "Compile time default"};
  ...
  cta::SourcedParameter<time_t> wdGlobalLockAcqMaxSecs {"taped", "WatchdogGlobalLockAcqMaxSecs", 15 * 60,
                                                        "Compile time default"};
  //----------------------------------------------------------------------------
  ...
  cta::SourcedParameter<std::string> fileCatalogConfigFile {"taped", "CatalogueConfigFile",
                                                            "/etc/cta/cta-catalogue.conf", "Compile time default"};
  ...
  cta::SourcedParameter<std::string> useRepackManagement {"taped", "UseRepackManagement", "yes",
                                                          "Compile time default"};

  /// Usage of MaintenanceProcess for repack-related operations, Garbage collection and disk reporting
  cta::SourcedParameter<std::string> useMaintenanceProcess {"taped", "UseMaintenanceProcess", "yes",
                                                            "Compile time default"};
  ...
  cta::SourcedParameter<std::string> externalEncryptionKeyScript {"taped", "externalEncryptionKeyScript", "",
                                                                  "Compile time default"};
