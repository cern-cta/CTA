...
struct TapedConfiguration {
  ...
  cta::SourcedParameter<std::string> useRepackManagement {"taped",
                                                          "UseRepackManagement",
                                                          "yes",
                                                          "Compile time default"};

  /// Usage of MaintenanceProcess for repack-related operations, Garbage collection and disk reporting
  cta::SourcedParameter<std::string> useMaintenanceProcess {"taped",
                                                            "UseMaintenanceProcess",
                                                            "yes",
                                                            "Compile time default"};

  /// Max number of repacks to promote to ToExpand state.
  cta::SourcedParameter<std::uint64_t> repackMaxRequestsToExpand {"taped",
  ...
  cta::SourcedParameter<std::string> schedulerBackendName {"general", "SchedulerBackendName"};
