...
#ifndef lint
static char sccsid[] = "@(#)$RCSfile: Cns_modifygrpmap.c,v $ $Revision: 1.2 $ $Date: 2006/01/26 15:36:19 $ CERN IT-GD/SC Jean-Philippe Baud";
#endif /* not lint */

/*      Cns_modifygrpmap - modify group entry corresponding to a given gid */
