/*
 * $Id: stager_qry.c,v 1.5 2005/06/21 13:03:26 sponcec3 Exp $
 */
...
#ifndef lint
static char sccsid[] = "@(#)$RCSfile: stager_qry.c,v $ $Revision: 1.5 $ $Date: 2005/06/21 13:03:26 $ CERN IT-FIO/DS Benjamin Couturier";
#endif /* not lint */
