 ...
 *------------------------------------------------------------------------
 */
const char* sys_mserrlist[EMSMAXERR - EMSBASEOFF + 2] = {"Error 0",
 ...
 *------------------------------------------------------------------------
 */
const char* sys_nserrlist[ENSMAXERR - ENSBASEOFF + 2] = {"Error 0",
 ...
 *------------------------------------------------------------------------
 */
const char* sys_rferrlist[ERFMAXERR - ERFBASEOFF + 2] = {"Error 0",
 ...
 *------------------------------------------------------------------------
 */
const char* sys_rterrlist[ERTMAXERR - ERTBASEOFF + 2] = {"Error 0",
                                                         "TMS error",
 ...
 *------------------------------------------------------------------------
 */
const char* sys_sterrlist[ESTMAXERR - ESTBASEOFF + 2] = {"Error 0",
                                                         "Aborted",
                                                         "Enough free space",
 ...
 *------------------------------------------------------------------------
 */
const char* sys_sqerrlist[ESQMAXERR - ESQBASEOFF + 2] = {"Error 0", "TMS not active", "BAD ERROR NUMBER"};
 ...
 *------------------------------------------------------------------------
 */
const char* sys_terrlist[ETMAXERR - ETBASEOFF + 2] = {"Error 0",
 ...
 *------------------------------------------------------------------------
 */
const char* sys_vaerrlist[EVMMAXERR - EVMBASEOFF + 2] = {"Error 0",
 ...
 *------------------------------------------------------------------------
 */
const char* sys_uperrlist[EUPMAXERR - EUPBASEOFF + 2] = {"Error 0", "UPV not active", "BAD ERROR NUMBER"};
 ...
 *------------------------------------------------------------------------
 */
const char* sys_vqerrlist[EVQMAXERR - EVQBASEOFF + 2] = {"Error 0",
                                                         "Failed system call",
 ...
 *------------------------------------------------------------------------
 */
const char* sys_monerrlist[EMONMAXERR - EMONBASEOFF + 2] = {"Error 0",
                                                            "System Error",
 ...
 *------------------------------------------------------------------------
 */
const char* sys_secerrlist[ESECMAXERR - ESECBASEOFF + 2] = {"Error 0",
                                                            "System error",
                                                            "Bad credentials",
