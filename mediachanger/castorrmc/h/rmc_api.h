...
EXTERN_C int rmc_find_cartridge(const char* const server,
...
EXTERN_C int rmc_read_elem_status(const char* const server,
                                  const int type,
                                  const int startaddr,
                                  const int nbelem,
                                  struct smc_element_info* const element_info);
...
EXTERN_C int send2rmc(const char* const host,
