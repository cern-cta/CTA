...
struct hostent* Cgethostbyname(name) const char* name;
{
...
struct hostent* Cgethostbyaddr(addr, len, type) const void* addr;
size_t len;
int type;
{
#if defined(__APPLE__)
...
struct servent* Cgetservbyname(name, proto) const char* name;
const char* proto;
{
#if defined(__APPLE__)
  /*
