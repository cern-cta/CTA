...
bool RetrieveJobToAdd::operator==(const RetrieveJobToAdd &rhs) const {
  return copyNb == rhs.copyNb &&
    fSeq == rhs.fSeq &&
    retrieveRequestAddress == rhs.retrieveRequestAddress &&
...
std::ostream &operator<<(std::ostream &os, const RetrieveJobToAdd &obj) {
  os << "(copyNb=" << static_cast<unsigned int>(obj.copyNb)
     << " fSeq=" << static_cast<unsigned int>(obj.fSeq)
     << " retrieveRequestAddress=" << obj.retrieveRequestAddress
     << " fileSize=" << static_cast<unsigned int>(obj.fileSize)
     << " policy=" << obj.policy
