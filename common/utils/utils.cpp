...
bool getDumpableProcessAttribute() {
  ...
  switch (rc) {
    ...
    default: {
      cta::exception::Exception ex;
      ex.getMessage() << "Failed to get the dumpable attribute of the process: unknown value returned by prctl(): rc="
                      << rc;
      throw ex;
    }
  }
...
void setDumpableProcessAttribute(const bool dumpable) {
  ...
  switch (rc) {
    ...
    default: {
      cta::exception::Exception ex;
      ex.getMessage() << "Failed to set the dumpable attribute of the process: unknown value returned by prctl(): rc="
                      << rc;
      throw ex;
    }
  }
