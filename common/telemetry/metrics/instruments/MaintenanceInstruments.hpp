 ...
 */
extern std::unique_ptr<opentelemetry::metrics::Counter<uint64_t>> ctaMaintenanceRepackReportingCount;

/**
 * Number of retrieval jobs created by the expansion of repack repack requests
 * in one pass of the maintenance runner.
 */
extern std::unique_ptr<opentelemetry::metrics::Counter<uint64_t>> ctaMaintenanceRepackExpansionCount;
