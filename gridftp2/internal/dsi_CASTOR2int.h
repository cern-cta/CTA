 ...
 *
 * @(#)$RCSfile: dsi_CASTOR2int.h,v $ $Revision: 1.1 $ $Release$ $Date: 2006/10/18 07:46:26 $ $Author: itglp $
 *
 *
 *
...
typedef struct globus_l_gfs_CASTOR2int_handle_s
   ...
   char *                       access_mode;
   checksum_block_list_t *      checksum_list; /* we have to save all blocs checksums for on the fly calculation */
