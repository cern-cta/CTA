  ...
  namespace job {
    ...
    namespace d2dtransfer {
      ...
      public:
        ...
        /**
         * Returns the size of the source file represented in bytes. This is
         * size of the file on disk as given by a stat() call which may or may
         * not be difference to the size reported for the castorfile in the
         ...
         * source/destination of a disk2disk copy. Note: it is not mandatory
         * for the mover to provide this information.
         */
