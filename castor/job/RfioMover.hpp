...
// Include files
#include "castor/job/BaseMover.hpp"
...
namespace castor {
  ...
  namespace job {
     ...
     * Rfio Mover
     */
    class RfioMover : public castor::job::BaseMover {
	...
	throw(castor::exception::Exception);
       ...
       * with a transfer and to gracefully handle error conditions. For example,
       * failure to close the destination/output file descriptor will result in
       * the removal/unlinking of the file.
