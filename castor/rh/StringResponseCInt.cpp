...
extern "C" {
  ...
  //----------------------------------------------------------------------------
  // Crh_StringResponse_reqAssociated
  //----------------------------------------------------------------------------
  int Crh_StringResponse_reqAssociated(castor::rh::StringResponse* instance, const char** var) {
    *var = instance->reqAssociated().c_str();
    return 0;
  }

  //----------------------------------------------------------------------------
  // Crh_StringResponse_setReqAssociated
  //----------------------------------------------------------------------------
  int Crh_StringResponse_setReqAssociated(castor::rh::StringResponse* instance, const char* new_var) {
    std::string snew_var(new_var, strlen(new_var));
