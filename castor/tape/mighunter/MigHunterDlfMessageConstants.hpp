/* This file was generated by ./MigHunterDlfMessagesCodeGenerator on Thu Sep  9 15:33:51 CEST 2010
 */
...
NOT_ENOUGH_DATA_TO_CREATE_STREAMS=8, /* "not enough data to create streams" */
NO_DRIVES=9, /* "no drive assigned to this service class" */
MIGRATION_POLICY_INPUT=10, /* "input to call the migration policy" */
ALLOWED_WITHOUT_POLICY=11, /* "allowed without policy" */
ALLOWED_BY_POLICY=12, /* "allowed by policy" */
NOT_ALLOWED=13, /* "not allowed" */
MIGRATION_POLICY_RESULT=14, /* "summary of migration policy results" */
...
GRACEFUL_SHUTDOWN_DUE_TO_ERROR=42, /* "Graceful shutdown due to error" */
APPLY_STREAM_POLICY_TO_SVCCLASS_EXCEPT=43, /* "Exception raised when applying stream-policy to service-class" */
GOT_TAPE_POOLS_FOR_STREAM_POLICY=44, /* "Got the tape-pools for the stream-policy" */
FAILED_TO_FIND_TAPE_POOL_FOR_STREAM=45, /* "Failed to find tape-pool for stream" */
FAILED_TO_MOVE_CREATED_STREAMS_TO_STOPPED=46, /* "Failed to move created streams with tape-copies to stopped" */
FOUND_CREATED_STREAMS_WITH_TAPECOPIES=47 /* "Found newly-created streams with tape-copies attached to them" */
}; // enum MighunterDlfMessages
} // namespace mighunter
} // namespace tape
} // namespace castor
