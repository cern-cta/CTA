...
{PRODUCER_NO_TAPE, "VdqmRequestsProducer: tape retrieved"},
...
{MIG_ERROR_NO_TAPECOPY, "MigratorErrorHandlerThread: no tapecopy found"},
...
{REC_ERROR_NO_TAPECOPY, "RecallerErrorHandlerThread: no tapecopy found"},
