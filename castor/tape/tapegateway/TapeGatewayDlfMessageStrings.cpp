...
{ORA_IMPOSSIBLE_TO_SEND_RMMASTER_REPORT_NOT_USED, "Deleted Message - Should not be used"},
...
{LINKER_SESSION_IN_THE_WAY, "TapeMigrationMountLinker: found existing session for same tape and ended it"},
{WORKER_RECALL_LIST_RETRIEVED, "Worker: files to recall retrieved in bulk from db"},
{-1, ""}};
