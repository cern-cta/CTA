...
/******************************************************************************
 *                      castor/tape/tapegateway/EndTransferRequest.hpp
 *
 ...
 *
 * @(#)$RCSfile: EndTransferRequest.hpp,v $ $Revision: 1.3 $ $Release$ $Date: 2009/02/09 13:31:16 $ $Author: gtaur $
 *
 * 
 *
...
#ifndef CASTOR_TAPE_TAPEGATEWAY_ENDTRANSFERREQUEST_HPP
#define CASTOR_TAPE_TAPEGATEWAY_ENDTRANSFERREQUEST_HPP
...
namespace castor {
  ...
  namespace tape {
    ...
    namespace tapegateway {
      ...
      /**
       * class EndTransferRequest
       */
      class EndTransferRequest : public virtual castor::IObject {
      ...
      public:
         ...
         * Empty Constructor
         */
        EndTransferRequest() throw();

        /**
         * Empty Destructor
         */
        virtual ~EndTransferRequest() throw();
      ...
      }; /* end of class EndTransferRequest */
...
#endif // CASTOR_TAPE_TAPEGATEWAY_ENDTRANSFERREQUEST_HPP
