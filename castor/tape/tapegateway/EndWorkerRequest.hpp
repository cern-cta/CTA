...
/******************************************************************************
 *                      castor/tape/tapegateway/EndWorkerRequest.hpp
 *
 ...
 *
 * @(#)$RCSfile: EndWorkerRequest.hpp,v $ $Revision: 1.5 $ $Release$ $Date: 2009/01/30 07:12:05 $ $Author: gtaur $
 *
 * 
 *
...
#ifndef CASTOR_TAPE_TAPEGATEWAY_ENDWORKERREQUEST_HPP
#define CASTOR_TAPE_TAPEGATEWAY_ENDWORKERREQUEST_HPP
...
namespace castor {
  ...
  namespace tape {
    ...
    namespace tapegateway {
      ...
      /**
       * class EndWorkerRequest
       */
      class EndWorkerRequest : public virtual castor::IObject {
      ...
      public:
         ...
         * Empty Constructor
         */
        EndWorkerRequest() throw();

        /**
         * Empty Destructor
         */
        virtual ~EndWorkerRequest() throw();
...
#endif // CASTOR_TAPE_TAPEGATEWAY_ENDWORKERREQUEST_HPP
