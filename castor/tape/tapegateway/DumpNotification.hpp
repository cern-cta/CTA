...
/******************************************************************************
 *                      castor/tape/tapegateway/DumpNotification.hpp
 *
...
namespace castor {
  ...
  namespace tape {
    ...
    namespace tapegateway {
       ...
       */
      class DumpNotification : public virtual GatewayMessage {
      ...
      public:
         ...
         * Empty Constructor
         */
        DumpNotification() throw();

        /**
         * Empty Destructor
         */
        virtual ~DumpNotification() throw();
