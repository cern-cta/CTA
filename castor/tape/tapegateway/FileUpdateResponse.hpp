...
/******************************************************************************
 *                      castor/tape/tapegateway/FileUpdateResponse.hpp
 *
 ...
 *
 * @(#)$RCSfile: FileUpdateResponse.hpp,v $ $Revision: 1.3 $ $Release$ $Date: 2009/01/27 16:08:03 $ $Author: gtaur $
 *
 * 
 *
...
#ifndef CASTOR_TAPE_TAPEGATEWAY_FILEUPDATERESPONSE_HPP
#define CASTOR_TAPE_TAPEGATEWAY_FILEUPDATERESPONSE_HPP
...
namespace castor {
  ...
  namespace tape {
    ...
    namespace tapegateway {
       ...
       */
      class FileUpdateResponse : public virtual castor::IObject {
      ...
      public:
         ...
         * Empty Constructor
         */
        FileUpdateResponse() throw();

        /**
         * Empty Destructor
         */
        virtual ~FileUpdateResponse() throw();
...
#endif // CASTOR_TAPE_TAPEGATEWAY_FILEUPDATERESPONSE_HPP
