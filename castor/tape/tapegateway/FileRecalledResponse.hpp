...
/******************************************************************************
 *                      castor/tape/tapegateway/FileRecalledResponse.hpp
 *
 ...
 *
 * @(#)$RCSfile: FileRecalledResponse.hpp,v $ $Revision: 1.5 $ $Release$ $Date: 2009/01/30 07:12:05 $ $Author: gtaur $
 *
 * 
 *
...
#ifndef CASTOR_TAPE_TAPEGATEWAY_FILERECALLEDRESPONSE_HPP
#define CASTOR_TAPE_TAPEGATEWAY_FILERECALLEDRESPONSE_HPP
...
namespace castor {
  ...
  namespace tape {
    ...
    namespace tapegateway {
       ...
       */
      class FileRecalledResponse : public virtual castor::IObject {
      ...
      public:
         ...
         * Empty Constructor
         */
        FileRecalledResponse() throw();

        /**
         * Empty Destructor
         */
        virtual ~FileRecalledResponse() throw();
...
#endif // CASTOR_TAPE_TAPEGATEWAY_FILERECALLEDRESPONSE_HPP
