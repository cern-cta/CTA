...
#ifndef CASTOR_TAPE_TAPEGATEWAY_ENDNOTIFICATION_HPP
#define CASTOR_TAPE_TAPEGATEWAY_ENDNOTIFICATION_HPP
...
namespace castor {
  ...
  namespace tape {
    ...
    namespace tapegateway {
       ...
       */
      class EndNotification : public virtual castor::IObject {
...
#endif // CASTOR_TAPE_TAPEGATEWAY_ENDNOTIFICATION_HPP
