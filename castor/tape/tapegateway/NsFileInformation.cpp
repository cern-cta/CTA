...
/******************************************************************************
 *                      castor/tape/tapegateway/NsFileInformation.cpp
 *
 ...
 *
 * @(#)$RCSfile: NsFileInformation.cpp,v $ $Revision: 1.4 $ $Release$ $Date: 2009/01/28 15:42:30 $ $Author: gtaur $
 *
 * 
 *
...
// Constructor
//------------------------------------------------------------------------------
castor::tape::tapegateway::NsFileInformation::NsFileInformation() throw() :
  m_nshost(""),
  m_fileid(0),
  m_fileSize(0),
...
// print
//------------------------------------------------------------------------------
void castor::tape::tapegateway::NsFileInformation::print(std::ostream& stream,
                                                         std::string indent,
...
// print
//------------------------------------------------------------------------------
void castor::tape::tapegateway::NsFileInformation::print() const {
...
// TYPE
//------------------------------------------------------------------------------
int castor::tape::tapegateway::NsFileInformation::TYPE() {
  return OBJ_NsFileInformation;
}

//------------------------------------------------------------------------------
// type
//------------------------------------------------------------------------------
int castor::tape::tapegateway::NsFileInformation::type() const {
  return TYPE();
}
...
// clone
//------------------------------------------------------------------------------
castor::IObject* castor::tape::tapegateway::NsFileInformation::clone() {
  return new NsFileInformation(*this);
}
