...
/******************************************************************************
 *                      castor/tape/tapegateway/EndTransferResponse.hpp
 *
 ...
 *
 * @(#)$RCSfile: EndTransferResponse.hpp,v $ $Revision: 1.3 $ $Release$ $Date: 2009/02/09 13:31:16 $ $Author: gtaur $
 *
 * 
 *
...
#ifndef CASTOR_TAPE_TAPEGATEWAY_ENDTRANSFERRESPONSE_HPP
#define CASTOR_TAPE_TAPEGATEWAY_ENDTRANSFERRESPONSE_HPP
...
namespace castor {
  ...
  namespace tape {
    ...
    namespace tapegateway {
      ...
      /**
       * class EndTransferResponse
       */
      class EndTransferResponse : public virtual castor::IObject {
      ...
      public:
         ...
         * Empty Constructor
         */
        EndTransferResponse() throw();

        /**
         * Empty Destructor
         */
        virtual ~EndTransferResponse() throw();
      ...
      }; /* end of class EndTransferResponse */
...
#endif // CASTOR_TAPE_TAPEGATEWAY_ENDTRANSFERRESPONSE_HPP
