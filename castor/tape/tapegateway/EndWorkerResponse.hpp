...
/******************************************************************************
 *                      castor/tape/tapegateway/EndWorkerResponse.hpp
 *
 ...
 *
 * @(#)$RCSfile: EndWorkerResponse.hpp,v $ $Revision: 1.3 $ $Release$ $Date: 2009/01/27 16:08:01 $ $Author: gtaur $
 *
 * 
 *
...
#ifndef CASTOR_TAPE_TAPEGATEWAY_ENDWORKERRESPONSE_HPP
#define CASTOR_TAPE_TAPEGATEWAY_ENDWORKERRESPONSE_HPP
...
namespace castor {
  ...
  namespace tape {
    ...
    namespace tapegateway {
      ...
      /**
       * class EndWorkerResponse
       */
      class EndWorkerResponse : public virtual castor::IObject {
      ...
      public:
         ...
         * Empty Constructor
         */
        EndWorkerResponse() throw();

        /**
         * Empty Destructor
         */
        virtual ~EndWorkerResponse() throw();
      ...
      }; /* end of class EndWorkerResponse */
...
#endif // CASTOR_TAPE_TAPEGATEWAY_ENDWORKERRESPONSE_HPP
