...
#ifndef CASTOR_TAPE_LEGACYMSG_RTCPTAPERQSTMSGBODY_HPP
#define CASTOR_TAPE_LEGACYMSG_RTCPTAPERQSTMSGBODY_HPP 1
...
struct RtcpTapeRqstMsgBody {
   ...
   * Constructor.
   *
   * Sets all integer member-variables to 0, all string member-varibles to the
   * empty string and all Cuuid_t member-variables to nullCuuid.
   */
  RtcpTapeRqstMsgBody() throw();
