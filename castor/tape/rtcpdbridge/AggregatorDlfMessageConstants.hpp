...
AGGREGATOR_CLOSED_RTCPD_DISK_TAPE_CONNECTION_DUE_TO_PEER=113, /* "Closed rtcpd disk/tape IO control connection due to rtcpd closing its end" */
AGGREGATOR_TOO_MANY_DRIVES_IN_TPCONFIG=114 /* "There are more drives in the TPCONFIG file than there were when aggregatord was started.  Please restart aggregatord." */
}; // enum AggregatorDlfMessages
} // namespace aggregator
} // namespace tape
} // namespace castor
