/* This file was generated by ./DlfMessagesCodeGenerator on Thu Jun 20 18:11:19 CEST 2013
 */
...
{TAPEBRIDGE_RECEIVED_NOMOREFILES, "Received NoMoreFiles from client"},
{TAPEBRIDGE_RECEIVED_ACK_OF_NOTIFICATION, "Received acknowledge of notification from client"},
...
{TAPEBRIDGE_DROPPING_RTCP_FINISHED_DUE_TO_SHUTTING_DOWN, "Dropping RTCP_FINISHED message from rtcpd daemon because the rtcpd session is being shutdown"},
{TAPEBRIDGE_DROPPING_TAPEBRIDGE_FLUSHEDTOTAPE_DUE_TO_SHUTTING_DOWN, "Dropping TAPEBRIDGE_FLUSHEDTOTAPE message from rtcpd daemon because the rtcpd session is being shutdown"},
{TAPEBRIDGE_FIRST_SESSION_ERROR, "The first session-error has occurred"},
{TAPEBRIDGE_NO_MOUNT_DUE_TO_NO_TAPE, "Mount not started because the client did not give the tape to be mounted"},
{TAPEBRIDGE_EMPTY_MIGRATION_MOUNT, "Empty migration mount"},
{TAPEBRIDGE_EMPTY_RECALL_MOUNT, "Empty recall mount"},
{-1, ""}};
