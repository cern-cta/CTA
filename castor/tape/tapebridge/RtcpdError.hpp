...
/**
 * An error that occurred during the session with the rtcpd daemon.  The
 * error may have been received from the rtcpd daemon or it may have been
 * generated by the tapebridged daemon, for example in response to detecting a
 * a file size of zero.
 */
class RtcpdError {
public:
