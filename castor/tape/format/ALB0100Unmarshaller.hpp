...
public:
  ...
  // Header field's names
  static const char *headerName_V0[];                        // Structure containing the Block Header fields names 

  bool m_errorList[25];                                // Structure to check in case of Erros, where they are
