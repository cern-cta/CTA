...
{AGGREGATOR_SENT_VOLUME, "Sent volume to RTCPD"},
{AGGREGATOR_FAILED_TO_SEND_VOLUME, "Failed to send volume to RTCPD"},
{AGGREGATOR_SENT_FILE, "Send file to RTCPD"},
{AGGREGATOR_FAILED_TO_SEND_FILE, "Failed to send file to RTCPD"},
{-1, ""}};
