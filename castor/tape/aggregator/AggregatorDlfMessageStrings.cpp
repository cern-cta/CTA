...
{AGGREGATOR_GAVE_VOLUME_INFO_TO_RTCPD, "Gave volume information to RTCPD"},
{AGGREGATOR_GAVE_FILE_INFO_TO_RTCPD, "Gave file information to RTCPD"},
{AGGREGATOR_FAILED_TO_GIVE_FILE_INFO_TO_RTCPD, "Failed to give file information to RTCPD"},
...
{AGGREGATOR_GET_VOLUME_FROM_GATEWAY, "Getting the volume from the tape gateway"},
{AGGREGATOR_GOT_VOLUME_FROM_GATEWAY, "Got a volume from the tape gateway"},
{AGGREGATOR_GOT_NO_VOLUME_FROM_GATEWAY, "Asked for, but did not get a volume from the tape gateway"},
{AGGREGATOR_GET_FIRST_FILE_TO_MIGRATE_FROM_GATEWAY, "Getting first file to migratefrom tape gateway"},
{AGGREGATOR_GOT_FIRST_FILE_TO_MIGRATE_FROM_GATEWAY, "Got first file to migrate from tape gateway"},
{AGGREGATOR_GOT_NO_FIRST_FILE_TO_MIGRATE_FROM_GATEWAY, "Asked for, but did not get the first file to migrate from tape gateway"},
{AGGREGATOR_GIVE_VOLUME_TO_RTCPD, "Giving volume to RTCPD"},
{AGGREGATOR_GAVE_VOLUME_TO_RTCPD, "Gave volume to RTCPD"},
{AGGREGATOR_ASK_RTCPD_TO_RQST_MORE_WORK, "Asking RTCPD to request more work"},
{AGGREGATOR_ASKED_RTCPD_TO_RQST_MORE_WORK, "Asked RTCPD to request more work"},
...
{AGGREGATOR_GIVE_FILE_TO_RTCPD, "Giving file to RTCPD"},
{AGGREGATOR_GAVE_FILE_TO_RTCPD, "Gave file to RTCPD"},
