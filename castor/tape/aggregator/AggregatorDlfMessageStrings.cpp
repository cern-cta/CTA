...
{AGGRRGATOR_FAILED_TO_TELL_GATEWAY_TO_START_TRANSFER, "Failed to tell tape gateway to start transfer"},
{AGGREGATOR_RECEIVED_START_TRANSFER_ERROR, "Received start transfer error from tape gateway"},
{-1, ""}};
