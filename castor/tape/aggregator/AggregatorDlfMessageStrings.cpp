...
{AGGREGATOR_SEND_DELAYED_REQUEST_MORE_WORK_ACK_TO_RTCPD, "Sending delayed acknowlegde of request for more work to RTCPD"},
{AGGREGATOR_SENT_DELAYED_REQUEST_MORE_WORK_ACK_TO_RTCPD, "Sent delayed acknowlegde of request for more work to RTCPD"},
...
{AGGREGATOR_NOTIFY_GATEWAY_FILE_RECALLED, "Notify tape gateway file recalled"},
{AGGREGATOR_NOTIFIED_GATEWAY_FILE_RECALLED, "Notified tape gateway file recalled"},
{AGGREGATOR_NOTIFY_GATEWAY_END_OF_SESSION, "Notify tape gateway end of session"},
