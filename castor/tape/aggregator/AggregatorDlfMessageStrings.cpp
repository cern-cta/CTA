...
{AGGREGATOR_GET_VOLUME_FROM_GATEWAY, "Getting volume from client"},
{AGGREGATOR_GOT_VOLUME_FROM_GATEWAY, "Got volume from client"},
{AGGREGATOR_GOT_NO_VOLUME_FROM_GATEWAY, "Got no volume from client"},
{AGGREGATOR_GET_FILE_TO_MIGRATE_FROM_GATEWAY, "Getting file to migrate from client"},
{AGGREGATOR_GOT_FILE_TO_MIGRATE_FROM_GATEWAY, "Got file to migrate from client"},
{AGGREGATOR_NO_MORE_FILES_TO_MIGRATE, "No more files to migrate"},
{AGGREGATOR_GET_FILE_TO_RECALL_FROM_GATEWAY, "Getting file to recall from client"},
{AGGREGATOR_GOT_FILE_TO_RECALL_FROM_GATEWAY, "Got file to recall from client"},
