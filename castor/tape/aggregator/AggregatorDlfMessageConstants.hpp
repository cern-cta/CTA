/* This file was generated by ./AggregatorDlfMessagesCodeGenerator on Fri Jul 24 16:54:28 CEST 2009
 */
...
AGGREGATOR_NOTIFY_GATEWAY_FILE_MIGRATED=88, /* "Notifying tape gateway file migrated" */
AGGREGATOR_NOTIFIED_GATEWAY_FILE_MIGRATED=89, /* "Notified tape gateway file migrated" */
AGGREGATOR_NOTIFY_GATEWAY_FILE_RECALLED=90, /* "Notifying tape gateway file recalled" */
AGGREGATOR_NOTIFIED_GATEWAY_FILE_RECALLED=91, /* "Notified tape gateway file recalled" */
AGGREGATOR_NOTIFY_GATEWAY_END_OF_SESSION=92, /* "Notifying tape gateway end of session" */
AGGREGATOR_NOTIFIED_GATEWAY_END_OF_SESSION=93, /* "Notified tape gateway end of session" */
AGGREGATOR_NOTIFY_GATEWAY_DUMP_MESSAGE=94, /* "Notifying tape gateway dump message" */
AGGREGATOR_NOTIFIED_GATEWAY_DUMP_MESSAGE=95, /* "Notified tape gateway dump message" */
AGGREGATOR_FAILED_TO_NOTIFY_GATEWAY_END_OF_SESSION=96, /* "Failed to notify gateway end of session" */
AGGREGATOR_NOTIFY_GATEWAY_END_OF_FAILED_SESSION=97, /* "Notifying tape gateway end of failed session" */
AGGREGATOR_NOTIFIED_GATEWAY_END_OF_FAILED_SESSION=98, /* "Notified tape gateway end of failed session" */
AGGREGATOR_FAILED_TO_NOTIFY_GATEWAY_END_OF_FAILED_SESSION=99, /* "Failed to notify gateway end of failed session" */
