...
AGGREGATOR_VDQM_REQUEST_HANDLER_SOCKET_IS_NULL=4, /* "The VdqmRequestHandler has been passed a NULL socket pointer" */
...
AGGREGATOR_SIGNALLED_NO_MORE_REQUESTS=27, /* "Signalled no more requests to RTCPD" */
AGGREGATOR_FAILED_TO_COORDINATE_REMOTE_COPY=28, /* "Failed to coordinate remote copy" */
AGGREGATOR_TRANSFER_FAILED=29, /* "Transfer failed" */
AGGREGATOR_PINGED_RTCPD=30, /* "Pinged RTCPD" */
