/* This file was generated by ./AggregatorDlfMessagesCodeGenerator on Wed Apr 29 14:24:38 CEST 2009
 */
...
AGGREGATOR_GOT_NO_VOLUME_FROM_GATEWAY=43, /* "Got no volume from tape gateway" */
AGGREGATOR_GET_FILE_TO_MIGRATE_FROM_GATEWAY=44, /* "Getting file to migrate from tape gateway" */
AGGREGATOR_GOT_FILE_TO_MIGRATE_FROM_GATEWAY=45, /* "Got file to migrate from tape gateway" */
AGGREGATOR_NO_MORE_FILES_TO_MIGRATE=46, /* "No more files to migrate" */
AGGREGATOR_GET_FILE_TO_RECALL_FROM_GATEWAY=47, /* "Getting file to recall from tape gateway" */
AGGREGATOR_GOT_FILE_TO_RECALL_FROM_GATEWAY=48, /* "Got file to recall from tape gateway" */
...
AGGREGATOR_ASK_RTCPD_TO_RQST_MORE_RECALL_WORK=52, /* "Asking RTCPD to request more recall work" */
AGGREGATOR_ASKED_RTCPD_TO_RQST_MORE_RECALL_WORK=53, /* "Asked RTCPD to request more recall work" */
AGGREGATOR_ASK_RTCPD_TO_RQST_MORE_MIGRATE_WORK=54, /* "Asking RTCPD to request more migrate work" */
AGGREGATOR_ASKED_RTCPD_TO_RQST_MORE_MIGRATE_WORK=55, /* "Asked RTCPD to request more migrate work" */
...
AGGREGATOR_RECEIVE_TAPERQSTERRBODY=67, /* "Receiving tape request message body with error appendix" */
AGGREGATOR_RECEIVED_TAPERQSTERRBODY=68, /* "Received tape request message body with error appendix" */
AGGREGATOR_CREATED_RTCPD_CALLBACK_PORT=69, /* "Created TCP/IP port for RTCPD callbacks" */
AGGREGATOR_CONNECTION_CLOSED_BY_RTCPD=70, /* "Connection closed by RTCPD" */
AGGREGATOR_CLOSED_CONNECTION=71, /* "Connection closed by aggregator" */
AGGREGATOR_FINISHED_RTCOPY_SESSION=72, /* "Finished remote tape copy session" */
AGGREGATOR_NOTIFY_GATEWAY_FILE_MIGRATED=73, /* "Notifying tape gateway file migrated" */
AGGREGATOR_NOTIFIED_GATEWAY_FILE_MIGRATED=74, /* "Notified tape gateway file migrated" */
AGGREGATOR_NOTIFY_GATEWAY_FILE_RECALLED=75, /* "Notify tape gateway file recalled" */
AGGREGATOR_NOTIFIED_GATEWAY_FILE_RECALLED=76, /* "Notified tape gateway file recalled" */
AGGREGATOR_NOTIFY_GATEWAY_END_OF_SESSION=77, /* "Notify tape gateway end of session" */
AGGREGATOR_NOTIFIED_GATEWAY_END_OF_SESSION=78 /* "Notified tape gateway end of session" */
}; // enum AggregatorDlfMessages
} // namespace aggregator
} // namespace tape
} // namespace castor
