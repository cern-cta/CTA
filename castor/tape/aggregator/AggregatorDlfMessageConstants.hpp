/* This file was generated by ./AggregatorDlfMessagesCodeGenerator on Wed May  6 11:41:28 CEST 2009
 */
...
AGGREGATOR_SEND_DELAYED_REQUEST_MORE_WORK_ACK_TO_RTCPD=76, /* "Sending delayed acknowlegde of request for more work to RTCPD" */
AGGREGATOR_SENT_DELAYED_REQUEST_MORE_WORK_ACK_TO_RTCPD=77, /* "Sent delayed acknowlegde of request for more work to RTCPD" */
...
AGGREGATOR_FINISHED_RTCOPY_SESSION=81, /* "Finished remote tape copy session" */
...
AGGREGATOR_NOTIFY_GATEWAY_FILE_RECALLED=84, /* "Notify tape gateway file recalled" */
AGGREGATOR_NOTIFIED_GATEWAY_FILE_RECALLED=85, /* "Notified tape gateway file recalled" */
AGGREGATOR_NOTIFY_GATEWAY_END_OF_SESSION=86, /* "Notify tape gateway end of session" */
