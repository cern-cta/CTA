/* This file was generated by ./AggregatorDlfMessagesCodeGenerator on Thu Dec 25 18:41:50 CET 2008
 */
...
AGGREGATOR_GOT_VOLREQID=23, /* "Got volume request ID from RTCPD" */
AGGREGATOR_FAILED_TO_GET_VOLREQID=24, /* "Failed to get volume request ID from RTCPD" */
...
AGGREGATOR_SENT_VOLUME=27, /* "Sent volume to RTCPD" */
AGGREGATOR_FAILED_TO_SEND_VOLUME=28 /* "Failed to send volume to RTCPD" */
}; // enum AggregatorDlfMessages
} // namespace aggregator
} // namespace tape
} // namespace castor
