/* This file was generated by ./AggregatorDlfMessagesCodeGenerator on Tue Mar  3 22:53:17 CET 2009
 */
...
AGGREGATOR_GET_VOLUME_FROM_GATEWAY=44, /* "Getting the volume from the tape gateway" */
AGGREGATOR_GOT_VOLUME_FROM_GATEWAY=45, /* "Got a volume from the tape gateway" */
AGGREGATOR_GOT_NO_VOLUME_FROM_GATEWAY=46, /* "Asked for, but did not get a volume from the tape gateway" */
AGGREGATOR_FIRST_FILE_TO_MIGRATE=47, /* "First file to migrate" */
AGGREGATOR_NO_FIRST_FILE_TO_MIGRATE=48, /* "No file for the first migration" */
AGGREGATOR_NO_MORE_FILES_TO_MIGRATE=49, /* "No more files to migrate" */
AGGREGATOR_NO_MORE_FILES_TO_RECALL=50, /* "No more files to recall" */
AGGREGATOR_FILE_TO_MIGRATE=51, /* "File to migrate" */
AGGREGATOR_FILE_TO_RECALL=52 /* "File to recall" */
}; // enum AggregatorDlfMessages
} // namespace aggregator
} // namespace tape
} // namespace castor
