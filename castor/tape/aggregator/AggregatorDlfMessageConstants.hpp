/* This file was generated by ./AggregatorDlfMessagesCodeGenerator on Fri Feb  6 10:04:48 CET 2009
 */
...
AGGREGATOR_TAPE_POSITIONED_FILE_REQ=41, /* "Tape positioned" */
AGGREGATOR_TAPE_POSITIONED_TAPE_REQ=42, /* "Tape positioned (tape request)" */
AGGREGATOR_FILE_TRANSFERED=43, /* "File transfered" */
AGGREGATOR_TOLD_GATEWAY_TO_START_TRANSFER=44, /* "Told tape gateway to start transfer" */
AGGRRGATOR_FAILED_TO_TELL_GATEWAY_TO_START_TRANSFER=45, /* "Failed to tell tape gateway to start transfer" */
AGGREGATOR_RECEIVED_START_TRANSFER_ERROR=46 /* "Received start transfer error from tape gateway" */
}; // enum AggregatorDlfMessages
} // namespace aggregator
} // namespace tape
} // namespace castor
