/* This file was generated by ./AggregatorDlfMessagesCodeGenerator on Fri Jul 17 16:58:41 CEST 2009
 */
...
AGGREGATOR_NOTIFY_GATEWAY_FILE_MIGRATED=86, /* "Notifying tape gateway file migrated" */
AGGREGATOR_NOTIFIED_GATEWAY_FILE_MIGRATED=87, /* "Notified tape gateway file migrated" */
AGGREGATOR_NOTIFY_GATEWAY_FILE_RECALLED=88, /* "Notifying tape gateway file recalled" */
AGGREGATOR_NOTIFIED_GATEWAY_FILE_RECALLED=89, /* "Notified tape gateway file recalled" */
AGGREGATOR_NOTIFY_GATEWAY_END_OF_SESSION=90, /* "Notifying tape gateway end of session" */
AGGREGATOR_NOTIFIED_GATEWAY_END_OF_SESSION=91, /* "Notified tape gateway end of session" */
AGGREGATOR_NOTIFY_GATEWAY_DUMP_MESSAGE=92, /* "Notifying tape gateway dump message" */
AGGREGATOR_NOTIFIED_GATEWAY_DUMP_MESSAGE=93, /* "Notified tape gateway dump message" */
AGGREGATOR_FAILED_TO_NOTIFY_GATEWAY_END_OF_SESSION=94, /* "Failed to notify gateway end of session" */
AGGREGATOR_NOTIFY_GATEWAY_END_OF_FAILED_SESSION=95, /* "Notifying tape gateway end of failed session" */
AGGREGATOR_NOTIFIED_GATEWAY_END_OF_FAILED_SESSION=96, /* "Notified tape gateway end of failed session" */
AGGREGATOR_FAILED_TO_NOTIFY_GATEWAY_END_OF_FAILED_SESSION=97, /* "Failed to notify gateway end of failed session" */
AGGREGATOR_FAILED_TO_PROCESS_RTCPD_SOCKETS=98 /* "Failed to process RTCPD sockets" */
}; // enum AggregatorDlfMessages
} // namespace aggregator
} // namespace tape
} // namespace castor
