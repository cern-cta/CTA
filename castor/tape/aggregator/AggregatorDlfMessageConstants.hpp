/* This file was generated by ./AggregatorDlfMessagesCodeGenerator on Thu Mar 12 15:36:44 CET 2009
 */
...
AGGREGATOR_PINGED_RTCPD=31, /* "Pinged RTCPD" */
AGGREGATOR_MAIN_SELECT_FAILED=32, /* "The select of the main select loop encountered an error other than an interruption" */
AGGREGATOR_GAVE_REQUEST_FOR_MORE_WORK=33, /* "Gave request for more work to RTCPD" */
AGGREGATOR_DATA_ON_INITIAL_RTCPD_CONNECTION=34, /* "Data has arrived on the initial RTCPD connection" */
AGGREGATOR_RECEIVED_RTCP_ENDOF_REQ=35, /* "Received RTCP_ENDOF_REQ" */
AGGREGATOR_TAPE_POSITIONED_FILE_REQ=36, /* "Tape positioned" */
AGGREGATOR_TAPE_POSITIONED_TAPE_REQ=37, /* "Tape positioned (tape request)" */
AGGREGATOR_FILE_TRANSFERED=38, /* "File transfered" */
AGGREGATOR_GET_REQUEST_INFO_FROM_RTCPD=39, /* "Getting request information from RTCPD" */
AGGREGATOR_GOT_REQUEST_INFO_FROM_RTCPD=40, /* "Got request information from RTCPD" */
AGGREGATOR_TOLD_GATEWAY_TO_START_TRANSFER=41, /* "Told tape gateway to start the transfer protocol" */
AGGREGATOR_GET_VOLUME_FROM_GATEWAY=42, /* "Getting volume from tape gateway" */
AGGREGATOR_GOT_VOLUME_FROM_GATEWAY=43, /* "Got volume from tape gateway" */
AGGREGATOR_GOT_NO_VOLUME_FROM_GATEWAY=44, /* "Asked for, but did not get a volume from the tape gateway" */
AGGREGATOR_GET_FIRST_FILE_TO_MIGRATE_FROM_GATEWAY=45, /* "Getting first file to migrate from tape gateway" */
AGGREGATOR_GOT_FIRST_FILE_TO_MIGRATE_FROM_GATEWAY=46, /* "Got first file to migrate from tape gateway" */
AGGREGATOR_GOT_NO_FIRST_FILE_TO_MIGRATE_FROM_GATEWAY=47, /* "Asked for, but did not get the first file to migrate from tape gateway" */
...
AGGREGATOR_GIVE_RECALL_FILE_TO_RTCPD=56, /* "Giving recall file to RTCPD" */
AGGREGATOR_GAVE_RECALL_FILE_TO_RTCPD=57, /* "Gave recall file to RTCPD" */
AGGREGATOR_GIVE_MIGRATE_FILE_TO_RTCPD=58, /* "Giving migrate file to RTCPD" */
AGGREGATOR_GAVE_MIGRATE_FILE_TO_RTCPD=59, /* "Gave migrate file to RTCPD" */
AGGREGATOR_NO_MORE_FILES_TO_MIGRATE=60, /* "No more files to migrate" */
AGGREGATOR_NO_MORE_FILES_TO_RECALL=61, /* "No more files to recall" */
AGGREGATOR_FILE_TO_MIGRATE=62, /* "File to migrate" */
AGGREGATOR_FILE_TO_RECALL=63, /* "File to recall" */
AGGREGATOR_PROCESSING_TAPE_DISK_RQST=64 /* "Processing a tape/disk IO request from RTCPD" */
}; // enum AggregatorDlfMessages
} // namespace aggregator
} // namespace tape
} // namespace castor
