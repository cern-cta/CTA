/* This file was generated by ./AggregatorDlfMessagesCodeGenerator on Wed Jul  8 13:49:49 CEST 2009
 */
...
AGGREGATOR_NOTIFY_GATEWAY_FILE_RECALLED=82, /* "Notifying tape gateway file recalled" */
AGGREGATOR_NOTIFIED_GATEWAY_FILE_RECALLED=83, /* "Notified tape gateway file recalled" */
AGGREGATOR_NOTIFY_GATEWAY_END_OF_SESSION=84, /* "Notifying tape gateway end of session" */
AGGREGATOR_NOTIFIED_GATEWAY_END_OF_SESSION=85, /* "Notified tape gateway end of session" */
AGGREGATOR_FAILED_TO_NOTIFY_GATEWAY_END_OF_SESSION=86, /* "Failed to notify gateway end of session" */
AGGREGATOR_NOTIFY_GATEWAY_END_OF_FAILED_SESSION=87, /* "Notifying tape gateway end of failed session" */
AGGREGATOR_NOTIFIED_GATEWAY_END_OF_FAILED_SESSION=88, /* "Notified tape gateway end of failed session" */
AGGREGATOR_FAILED_TO_NOTIFY_GATEWAY_END_OF_FAILED_SESSION=89, /* "Failed to notify gateway end of failed session" */
AGGREGATOR_FAILED_TO_PROCESS_RTCPD_SOCKETS=90 /* "Failed to process RTCPD sockets" */
}; // enum AggregatorDlfMessages
} // namespace aggregator
} // namespace tape
} // namespace castor
