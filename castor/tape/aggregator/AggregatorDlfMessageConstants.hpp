/* This file was generated by ./AggregatorDlfMessagesCodeGenerator on Tue Mar  3 17:02:15 CET 2009
 */
...
AGGREGATOR_GET_REQUEST_INFO_FROM_RTCPD=42, /* "Getting request information from RTCPD" */
AGGREGATOR_GOT_REQUEST_INFO_FROM_RTCPD=43, /* "Got request information from RTCPD" */
AGGREGATOR_TOLD_GATEWAY_TO_START_TRANSFER=44, /* "Told tape gateway to start the transfer protocol" */
AGGREGATOR_GET_VOLUME_FROM_GATEWAY=45, /* "Getting the volume from the tape gateway" */
AGGREGATOR_GOT_VOLUME_FROM_GATEWAY=46, /* "Got a volume from the tape gateway" */
AGGREGATOR_GOT_NO_VOLUME_FROM_GATEWAY=47, /* "Asked for, but did not get a volume from the tape gateway" */
AGGREGATOR_FIRST_FILE_TO_MIGRATE=48, /* "First file to migrate" */
AGGREGATOR_NO_FIRST_FILE_TO_MIGRATE=49, /* "No file for the first migration" */
AGGREGATOR_NO_MORE_FILES_TO_MIGRATE=50, /* "No more files to migrate" */
AGGREGATOR_NO_MORE_FILES_TO_RECALL=51, /* "No more files to recall" */
AGGREGATOR_FILE_TO_MIGRATE=52, /* "File to migrate" */
AGGREGATOR_FILE_TO_RECALL=53 /* "File to recall" */
}; // enum AggregatorDlfMessages
} // namespace aggregator
} // namespace tape
} // namespace castor
