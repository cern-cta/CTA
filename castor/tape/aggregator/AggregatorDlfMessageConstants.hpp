/* This file was generated by ./AggregatorDlfMessagesCodeGenerator on Wed Aug  5 18:30:11 CEST 2009
 */
...
AGGREGATOR_GET_VOLUME_FROM_GATEWAY=39, /* "Getting volume from client" */
AGGREGATOR_GOT_VOLUME_FROM_GATEWAY=40, /* "Got volume from client" */
AGGREGATOR_GOT_NO_VOLUME_FROM_GATEWAY=41, /* "Got no volume from client" */
AGGREGATOR_GET_FILE_TO_MIGRATE_FROM_GATEWAY=42, /* "Getting file to migrate from client" */
AGGREGATOR_GOT_FILE_TO_MIGRATE_FROM_GATEWAY=43, /* "Got file to migrate from client" */
AGGREGATOR_NO_MORE_FILES_TO_MIGRATE=44, /* "No more files to migrate" */
AGGREGATOR_GET_FILE_TO_RECALL_FROM_GATEWAY=45, /* "Getting file to recall from client" */
AGGREGATOR_GOT_FILE_TO_RECALL_FROM_GATEWAY=46, /* "Got file to recall from client" */
