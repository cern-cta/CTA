/* This file was generated by ./AggregatorDlfMessagesCodeGenerator on Fri Apr 24 09:53:30 CEST 2009
 */
...
AGGREGATOR_RECEIVED_TAPERQSTERRBODY=69, /* "Received tape request message body with error appendix" */
AGGREGATOR_CREATED_RTCPD_CALLBACK_PORT=70, /* "Created TCP/IP port for RTCPD callbacks" */
AGGREGATOR_CONNECTION_CLOSED_BY_RTCPD=71, /* "Connection closed by RTCPD" */
AGGREGATOR_CLOSED_CONNECTION=72, /* "Connection closed by aggregator" */
AGGREGATOR_FINISHED_RTCOPY_SESSION=73 /* "Finished remote tape copy session" */
}; // enum AggregatorDlfMessages
} // namespace aggregator
} // namespace tape
} // namespace castor
