/******************************************************************************
 *                castor/tape/aggregator/LegacyTxRx.cpp
 *
...
#include "castor/tape/aggregator_non_blocking/LegacyTxRx.hpp"
...
// sendMsgHeader
//-----------------------------------------------------------------------------
void castor::tape::aggregator::LegacyTxRx::sendMsgHeader(
...
// receiveMsgHeader
//-----------------------------------------------------------------------------
void castor::tape::aggregator::LegacyTxRx::receiveMsgHeader(
  const Cuuid_t &cuuid, const uint32_t volReqId, const int socketFd,
...
//-----------------------------------------------------------------------------
void castor::tape::aggregator::LegacyTxRx::receiveMsgHeaderFromCloseable(
