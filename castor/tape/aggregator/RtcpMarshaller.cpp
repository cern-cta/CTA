/******************************************************************************
 *                      castor/tape/aggregator/RtcpMarshaller.cpp
 *
...
// marshallUint8
//------------------------------------------------------------------------------
void castor::tape::aggregator::RtcpMarshaller::marshallUint8(uint8_t src,
...
// unmarshallUint8
//------------------------------------------------------------------------------
void castor::tape::aggregator::RtcpMarshaller::unmarshallUint8(const char * &src,
...
// marshallUint16
//------------------------------------------------------------------------------
void castor::tape::aggregator::RtcpMarshaller::marshallUint16(uint16_t src,
  char * &dst) throw(castor::exception::Exception) {
...
// unmarshallUint16
//------------------------------------------------------------------------------
void castor::tape::aggregator::RtcpMarshaller::unmarshallUint16(const char * &src,
...
// marshallUint32
//------------------------------------------------------------------------------
void castor::tape::aggregator::RtcpMarshaller::marshallUint32(uint32_t src,
  char * &dst) throw(castor::exception::Exception) {
...
// unmarshallUint32
//------------------------------------------------------------------------------
void castor::tape::aggregator::RtcpMarshaller::unmarshallUint32(const char * &src,
...
// marshallInt32
//------------------------------------------------------------------------------
void castor::tape::aggregator::RtcpMarshaller::marshallInt32(int32_t src,
  char * &dst) throw(castor::exception::Exception) {
...
// unmarshallInt32
//------------------------------------------------------------------------------
void castor::tape::aggregator::RtcpMarshaller::unmarshallInt32(const char * &src,
...
// marshallUint64
//------------------------------------------------------------------------------
void castor::tape::aggregator::RtcpMarshaller::marshallUint64(uint64_t src,
  char * &dst) throw(castor::exception::Exception) {
...
// unmarshallUint64
//------------------------------------------------------------------------------
void castor::tape::aggregator::RtcpMarshaller::unmarshallUint64(const char * &src,
...
// marshallString
//------------------------------------------------------------------------------
void castor::tape::aggregator::RtcpMarshaller::marshallString(const char * src,
  char * &dst) throw(castor::exception::Exception) {
...
// marshallString
//------------------------------------------------------------------------------
void castor::tape::aggregator::RtcpMarshaller::marshallString(
...
// unmarshallString
//------------------------------------------------------------------------------
void castor::tape::aggregator::RtcpMarshaller::unmarshallString(const char * &src,
...
//-----------------------------------------------------------------------------
void castor::tape::aggregator::RtcpMarshaller::unmarshall(const char * &src,
  size_t &srcLen, RcpJobReplyMsgBody &dst) throw(castor::exception::Exception) {

  // Unmarshall the status number
  RtcpMarshaller::unmarshallUint32(src, srcLen, dst.status);
...
void castor::tape::aggregator::RtcpMarshaller::unmarshall(const char * &src,
  ...
  unmarshall(src, srcLen, (RtcpTapeRqstMsgBody&)dst);
...
void castor::tape::aggregator::RtcpMarshaller::unmarshall(const char * &src,
  ...
  throw(castor::exception::Exception) {
  unmarshall(src, srcLen, (RtcpFileRqstMsgBody&)dst);
  unmarshallString(src, srcLen, dst.err.errorMsg);
  unmarshallUint32(src, srcLen, dst.err.severity);
  unmarshallUint32(src, srcLen, dst.err.errorCode);
  unmarshallInt32(src, srcLen, dst.err.maxTpRetry);
