...
/******************************************************************************
 *                      castor/io/StreamOldStartResponseCnv.hpp
 *
 ...
 *
 * @(#)$RCSfile: StreamOldStartResponseCnv.hpp,v $ $Revision: 1.1 $ $Release$ $Date: 2006/08/18 10:00:38 $ $Author: gtaur $
 *
 * 
 *
...
namespace castor {
  ...
  namespace io {
    ...
    /**
     * class StreamOldStartResponseCnv
     * A converter for marshalling/unmarshalling StartResponse into/from stl streams
     */
    class StreamOldStartResponseCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Constructor
       */
      StreamOldStartResponseCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamOldStartResponseCnv() throw();
    ...
    }; // end of class StreamOldStartResponseCnv
