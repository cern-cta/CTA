/******************************************************************************
 *                      castor/io/StreamStageFileQueryRequestCnv.hpp
 *
...
#ifndef CASTOR_IO_STAGEFILEQUERYREQUEST_HPP
#define CASTOR_IO_STAGEFILEQUERYREQUEST_HPP
...
namespace castor {
  ...
  namespace io {
    ...
    /**
     * class StreamStageFileQueryRequestCnv
     * A converter for marshalling/unmarshalling StageFileQueryRequest into/from stl
     * streams
     */
    class StreamStageFileQueryRequestCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Constructor
       */
      StreamStageFileQueryRequestCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamStageFileQueryRequestCnv() throw();
...
#endif // CASTOR_IO_STAGEFILEQUERYREQUEST_HPP
