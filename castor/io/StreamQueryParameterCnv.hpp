/******************************************************************************
 *                      castor/io/StreamQueryParameterCnv.hpp
 *
...
#ifndef CASTOR_IO_QUERYPARAMETER_HPP
#define CASTOR_IO_QUERYPARAMETER_HPP
...
namespace castor {
  ...
  namespace io {
    ...
    /**
     * class StreamQueryParameterCnv
     * A converter for marshalling/unmarshalling QueryParameter into/from stl streams
     */
    class StreamQueryParameterCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Constructor
       */
      StreamQueryParameterCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamQueryParameterCnv() throw();
...
#endif // CASTOR_IO_QUERYPARAMETER_HPP
