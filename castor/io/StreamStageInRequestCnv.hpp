/******************************************************************************
 *                      castor/io/StreamStageInRequestCnv.hpp
 *
 ...
 *
 * @(#)$RCSfile: StreamStageInRequestCnv.hpp,v $ $Revision: 1.5 $ $Release$ $Date: 2004/10/14 16:34:46 $ $Author: sponcec3 $
 *
 * 
 *
...
#ifndef CASTOR_IO_STAGEINREQUEST_HPP
#define CASTOR_IO_STAGEINREQUEST_HPP
...
namespace castor {
  ...
  namespace io {
    ...
    /**
     * class StreamStageInRequestCnv
     * A converter for marshalling/unmarshalling StageInRequest into/from stl streams
     */
    class StreamStageInRequestCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Destructor
       */
      virtual ~StreamStageInRequestCnv() throw();
    ...
    }; // end of class StreamStageInRequestCnv

  }; // end of namespace io

}; // end of namespace castor

#endif // CASTOR_IO_STAGEINREQUEST_HPP
