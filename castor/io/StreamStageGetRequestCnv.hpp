/******************************************************************************
 *                      castor/io/StreamStageGetRequestCnv.hpp
 *
...
#ifndef CASTOR_IO_STAGEGETREQUEST_HPP
#define CASTOR_IO_STAGEGETREQUEST_HPP
...
namespace castor {
  ...
  namespace io {
    ...
    /**
     * class StreamStageGetRequestCnv
     * A converter for marshalling/unmarshalling StageGetRequest into/from stl streams
     */
    class StreamStageGetRequestCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Destructor
       */
      virtual ~StreamStageGetRequestCnv() throw();
...
#endif // CASTOR_IO_STAGEGETREQUEST_HPP
