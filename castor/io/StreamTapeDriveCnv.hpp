...
/******************************************************************************
 *                      castor/io/StreamTapeDriveCnv.hpp
 *
...
#ifndef CASTOR_IO_TAPEDRIVE_HPP
#define CASTOR_IO_TAPEDRIVE_HPP
...
namespace castor {
  ...
  namespace io {
    ...
    /**
     * class StreamTapeDriveCnv
     * A converter for marshalling/unmarshalling TapeDrive into/from stl streams
     */
    class StreamTapeDriveCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Constructor
       */
      StreamTapeDriveCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamTapeDriveCnv() throw();
