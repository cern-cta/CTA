...
/******************************************************************************
 *                      castor/io/StreamOldClientCnv.hpp
 *
 ...
 *
 * @(#)$RCSfile: StreamOldClientCnv.hpp,v $ $Revision: 1.2 $ $Release$ $Date: 2007/07/11 14:58:40 $ $Author: sponcec3 $
 *
 * 
 *
...
namespace castor {
  ...
  namespace io {
    ...
    public:
       ...
       * Constructor
       */
      StreamOldClientCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamOldClientCnv() throw();
    ...
    }; // end of class StreamOldClientCnv
