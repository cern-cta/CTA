...
/******************************************************************************
 *                      castor/io/StreamChangePrivilegeCnv.cpp
 *
...
// Include Files
#include "StreamChangePrivilegeCnv.hpp"
...
// Constructor
//------------------------------------------------------------------------------
castor::io::StreamChangePrivilegeCnv::StreamChangePrivilegeCnv(castor::ICnvSvc* cnvSvc) :
 StreamBaseCnv(cnvSvc) {}

//------------------------------------------------------------------------------
// Destructor
//------------------------------------------------------------------------------
castor::io::StreamChangePrivilegeCnv::~StreamChangePrivilegeCnv() throw() {
}
...
castor::IObject* castor::io::StreamChangePrivilegeCnv::unmarshalObject(castor::io::biniostream& stream,
  ...
  unsigned int usersNb;
  ad.stream() >> usersNb;
  for (unsigned int i = 0; i < usersNb; i++) {
    ad.setObjType(castor::OBJ_INVALID);
    castor::IObject* objUsers = cnvSvc()->unmarshalObject(ad, newlyCreated);
    obj->addUsers(dynamic_cast<castor::bwlist::BWUser*>(objUsers));
  }
  unsigned int requestTypesNb;
  ad.stream() >> requestTypesNb;
  for (unsigned int i = 0; i < requestTypesNb; i++) {
    ad.setObjType(castor::OBJ_INVALID);
    castor::IObject* objRequestTypes = cnvSvc()->unmarshalObject(ad, newlyCreated);
    obj->addRequestTypes(dynamic_cast<castor::bwlist::RequestType*>(objRequestTypes));
  }
  return object;
}
