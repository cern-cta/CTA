/******************************************************************************
 *                      castor/io/StreamDiskCopyCnv.hpp
 *
...
#ifndef CASTOR_IO_DISKCOPY_HPP
#define CASTOR_IO_DISKCOPY_HPP
...
namespace castor {
  ...
  namespace io {
    ...
    /**
     * class StreamDiskCopyCnv
     * A converter for marshalling/unmarshalling DiskCopy into/from stl streams
     */
    class StreamDiskCopyCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Constructor
       */
      StreamDiskCopyCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamDiskCopyCnv() throw();
    ...
    }; // end of class StreamDiskCopyCnv

  }; // end of namespace io

}; // end of namespace castor

#endif // CASTOR_IO_DISKCOPY_HPP
