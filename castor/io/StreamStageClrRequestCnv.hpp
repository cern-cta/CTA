/******************************************************************************
 *                      castor/io/StreamStageClrRequestCnv.hpp
 *
 ...
 *
 * @(#)$RCSfile: StreamStageClrRequestCnv.hpp,v $ $Revision: 1.8 $ $Release$ $Date: 2004/11/05 17:47:25 $ $Author: sponcec3 $
 *
 * 
 *
...
#ifndef CASTOR_IO_STAGECLRREQUEST_HPP
#define CASTOR_IO_STAGECLRREQUEST_HPP
...
namespace castor {
  ...
  namespace io {
    ...
    /**
     * class StreamStageClrRequestCnv
     * A converter for marshalling/unmarshalling StageClrRequest into/from stl streams
     */
    class StreamStageClrRequestCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Constructor
       */
      StreamStageClrRequestCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamStageClrRequestCnv() throw();
    ...
    }; // end of class StreamStageClrRequestCnv

  }; // end of namespace io

}; // end of namespace castor

#endif // CASTOR_IO_STAGECLRREQUEST_HPP
