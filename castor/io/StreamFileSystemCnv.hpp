/******************************************************************************
 *                      castor/io/StreamFileSystemCnv.hpp
 *
...
#ifndef CASTOR_IO_FILESYSTEM_HPP
#define CASTOR_IO_FILESYSTEM_HPP
...
namespace castor {
  ...
  namespace io {
    ...
    /**
     * class StreamFileSystemCnv
     * A converter for marshalling/unmarshalling FileSystem into/from stl streams
     */
    class StreamFileSystemCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Constructor
       */
      StreamFileSystemCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamFileSystemCnv() throw();
