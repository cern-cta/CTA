...
const castor::ICnvFactory& StreamTapeCnvFactory = 
  s_factoryStreamTapeCnv;

//------------------------------------------------------------------------------
// Constructor
//------------------------------------------------------------------------------
castor::io::StreamTapeCnv::StreamTapeCnv(castor::ICnvSvc* cnvSvc) :
...
// marshalObject
//------------------------------------------------------------------------------
void castor::io::StreamTapeCnv::marshalObject(castor::IObject* object,
...
// unmarshalObject
//------------------------------------------------------------------------------
castor::IObject* castor::io::StreamTapeCnv::unmarshalObject(castor::io::biniostream& stream,
