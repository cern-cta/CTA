...
/******************************************************************************
 *                      castor/io/StreamSetFileGCWeightCnv.hpp
 *
...
#ifndef CASTOR_IO_SETFILEGCWEIGHT_HPP
#define CASTOR_IO_SETFILEGCWEIGHT_HPP
...
namespace castor {
  ...
  namespace io {
    ...
    /**
     * class StreamSetFileGCWeightCnv
     * A converter for marshalling/unmarshalling SetFileGCWeight into/from stl streams
     */
    class StreamSetFileGCWeightCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Constructor
       */
      StreamSetFileGCWeightCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamSetFileGCWeightCnv() throw();
...
#endif // CASTOR_IO_SETFILEGCWEIGHT_HPP
