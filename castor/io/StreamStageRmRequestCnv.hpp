/******************************************************************************
 *                      castor/io/StreamStageRmRequestCnv.hpp
 *
...
#ifndef CASTOR_IO_STAGERMREQUEST_HPP
#define CASTOR_IO_STAGERMREQUEST_HPP
...
namespace castor {
  ...
  namespace io {
    ...
    /**
     * class StreamStageRmRequestCnv
     * A converter for marshalling/unmarshalling StageRmRequest into/from stl streams
     */
    class StreamStageRmRequestCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Constructor
       */
      StreamStageRmRequestCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamStageRmRequestCnv() throw();
