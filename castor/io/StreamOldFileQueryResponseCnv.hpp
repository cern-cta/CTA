...
/******************************************************************************
 *                      castor/io/StreamOldFileQueryResponseCnv.hpp
 *
 ...
 *
 * @(#)$RCSfile: StreamOldFileQueryResponseCnv.hpp,v $ $Revision: 1.1 $ $Release$ $Date: 2006/08/18 10:00:38 $ $Author: gtaur $
 *
 * 
 *
...
namespace castor {
  ...
  namespace io {
    ...
    /**
     * class StreamOldFileQueryResponseCnv
     * A converter for marshalling/unmarshalling FileQueryResponse into/from stl
     */
    class StreamOldFileQueryResponseCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Constructor
       */
      StreamOldFileQueryResponseCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamOldFileQueryResponseCnv() throw();
    ...
    }; // end of class StreamOldFileQueryResponseCnv
