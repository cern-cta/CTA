/******************************************************************************
 *                      castor/io/StreamOldSubRequestCnv.hpp
 *
 ...
 *
 * @(#)$RCSfile: StreamOldSubRequestCnv.hpp,v $ $Revision: 1.1 $ $Release$ $Date: 2006/05/12 08:15:02 $ $Author: felixehm $
 *
 * 
 *
...
#ifndef CASTOR_IO_OLDSUBREQUEST_HPP
#define CASTOR_IO_OLDSUBREQUEST_HPP
...
namespace castor {
  ...
  namespace io {
     ...
     */
    class StreamOldSubRequestCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Constructor
       */
      StreamOldSubRequestCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamOldSubRequestCnv() throw();
...
#endif // CASTOR_IO_OLDSUBREQUEST_HPP
