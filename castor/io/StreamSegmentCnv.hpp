/******************************************************************************
 *                      castor/io/StreamSegmentCnv.hpp
 *
...
#ifndef CASTOR_IO_SEGMENT_HPP
#define CASTOR_IO_SEGMENT_HPP
...
namespace castor {
  ...
  namespace io {
    ...
    /**
     * class StreamSegmentCnv
     * A converter for marshalling/unmarshalling Segment into/from stl streams
     */
    class StreamSegmentCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Constructor
       */
      StreamSegmentCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamSegmentCnv() throw();
    ...
    }; // end of class StreamSegmentCnv

  }; // end of namespace io

}; // end of namespace castor

#endif // CASTOR_IO_SEGMENT_HPP
