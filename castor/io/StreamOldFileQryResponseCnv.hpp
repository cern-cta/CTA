...
/******************************************************************************
 *                      castor/io/StreamOldFileQryResponseCnv.hpp
 *
 ...
 *
 * @(#)$RCSfile: StreamOldFileQryResponseCnv.hpp,v $ $Revision: 1.1 $ $Release$ $Date: 2006/08/18 10:00:38 $ $Author: gtaur $
 *
 * 
 *
...
namespace castor {
  ...
  namespace io {
    ...
    /**
     * class StreamOldFileQryResponseCnv
     * A converter for marshalling/unmarshalling FileQryResponse into/from stl streams
     */
    class StreamOldFileQryResponseCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Constructor
       */
      StreamOldFileQryResponseCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamOldFileQryResponseCnv() throw();
    ...
    }; // end of class StreamOldFileQryResponseCnv
