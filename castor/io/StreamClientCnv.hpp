...
namespace castor {
  ...
  namespace io {
     ...
     * A converter for marshalling/unmarshalling Client into/from stl streams
     */
    class StreamClientCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Constructor
       */
      StreamClientCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamClientCnv() throw();
