/******************************************************************************
 *                      castor/io/StreamFindReqResponseCnv.hpp
 *
...
#ifndef CASTOR_IO_FINDREQRESPONSE_HPP
#define CASTOR_IO_FINDREQRESPONSE_HPP
...
namespace castor {
  ...
  namespace io {
    ...
    /**
     * class StreamFindReqResponseCnv
     * A converter for marshalling/unmarshalling FindReqResponse into/from stl streams
     */
    class StreamFindReqResponseCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Constructor
       */
      StreamFindReqResponseCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamFindReqResponseCnv() throw();
    ...
    }; // end of class StreamFindReqResponseCnv

  }; // end of namespace io

}; // end of namespace castor

#endif // CASTOR_IO_FINDREQRESPONSE_HPP
