/******************************************************************************
 *                      castor/io/StreamStageUpdateRequestCnv.hpp
 *
...
#ifndef CASTOR_IO_STAGEUPDATEREQUEST_HPP
#define CASTOR_IO_STAGEUPDATEREQUEST_HPP
...
namespace castor {
  ...
  namespace io {
    ...
    /**
     * class StreamStageUpdateRequestCnv
     * A converter for marshalling/unmarshalling StageUpdateRequest into/from stl
     * streams
     */
    class StreamStageUpdateRequestCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Constructor
       */
      StreamStageUpdateRequestCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamStageUpdateRequestCnv() throw();
    ...
    }; // end of class StreamStageUpdateRequestCnv

  }; // end of namespace io

}; // end of namespace castor

#endif // CASTOR_IO_STAGEUPDATEREQUEST_HPP
