/******************************************************************************
 *                      castor/io/StreamCastorFileCnv.hpp
 *
...
#ifndef CASTOR_IO_CASTORFILE_HPP
#define CASTOR_IO_CASTORFILE_HPP
...
namespace castor {
  ...
  namespace io {
    ...
    /**
     * class StreamCastorFileCnv
     * A converter for marshalling/unmarshalling CastorFile into/from stl streams
     */
    class StreamCastorFileCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Constructor
       */
      StreamCastorFileCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamCastorFileCnv() throw();
    ...
    }; // end of class StreamCastorFileCnv

  }; // end of namespace io

}; // end of namespace castor

#endif // CASTOR_IO_CASTORFILE_HPP
