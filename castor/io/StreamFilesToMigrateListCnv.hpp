...
/******************************************************************************
 *                      castor/io/StreamFilesToMigrateListCnv.hpp
 *
...
#ifndef CASTOR_IO_FILESTOMIGRATELIST_HPP
#define CASTOR_IO_FILESTOMIGRATELIST_HPP
...
namespace castor {
  ...
  namespace io {
    ...
    /**
     * class StreamFilesToMigrateListCnv
     * A converter for marshalling/unmarshalling FilesToMigrateList into/from stl
     * streams
     */
    class StreamFilesToMigrateListCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Constructor
       */
      StreamFilesToMigrateListCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamFilesToMigrateListCnv() throw();
...
#endif // CASTOR_IO_FILESTOMIGRATELIST_HPP
