...
/******************************************************************************
 *                      castor/io/StreamRepackCommandCodeCnv.hpp
 *
...
#ifndef CASTOR_IO_REPACKCOMMANDCODE_HPP
#define CASTOR_IO_REPACKCOMMANDCODE_HPP
...
namespace castor {
  ...
  namespace io {
...
#endif
    /**
     * class StreamRepackCommandCodeCnv
     * A converter for marshalling/unmarshalling RepackCommandCode into/from stl
     * streams
     */
    class StreamRepackCommandCodeCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Constructor
       */
      StreamRepackCommandCodeCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamRepackCommandCodeCnv() throw();
    ...
    }; // end of class StreamRepackCommandCodeCnv
...
#endif
#endif /* CASTOR_IO_REPACKCOMMANDCODE_HPP */
