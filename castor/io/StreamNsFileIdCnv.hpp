...
/******************************************************************************
 *                      castor/io/StreamNsFileIdCnv.hpp
 *
...
#ifndef CASTOR_IO_NSFILEID_HPP
#define CASTOR_IO_NSFILEID_HPP
...
namespace castor {
  ...
  namespace io {
    ...
    /**
     * class StreamNsFileIdCnv
     * A converter for marshalling/unmarshalling NsFileId into/from stl streams
     */
    class StreamNsFileIdCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Constructor
       */
      StreamNsFileIdCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamNsFileIdCnv() throw();
