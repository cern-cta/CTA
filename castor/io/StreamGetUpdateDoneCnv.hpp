/******************************************************************************
 *                      castor/io/StreamGetUpdateDoneCnv.hpp
 *
...
#ifndef CASTOR_IO_GETUPDATEDONE_HPP
#define CASTOR_IO_GETUPDATEDONE_HPP
...
namespace castor {
  ...
  namespace io {
    ...
    /**
     * class StreamGetUpdateDoneCnv
     * A converter for marshalling/unmarshalling GetUpdateDone into/from stl streams
     */
    class StreamGetUpdateDoneCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Constructor
       */
      StreamGetUpdateDoneCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamGetUpdateDoneCnv() throw();
...
#endif // CASTOR_IO_GETUPDATEDONE_HPP
