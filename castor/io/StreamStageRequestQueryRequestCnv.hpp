/******************************************************************************
 *                      castor/io/StreamStageRequestQueryRequestCnv.hpp
 *
...
#ifndef CASTOR_IO_STAGEREQUESTQUERYREQUEST_HPP
#define CASTOR_IO_STAGEREQUESTQUERYREQUEST_HPP
...
namespace castor {
  ...
  namespace io {
    ...
    /**
     * class StreamStageRequestQueryRequestCnv
     * A converter for marshalling/unmarshalling StageRequestQueryRequest into/from stl
     * streams
     */
    class StreamStageRequestQueryRequestCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Constructor
       */
      StreamStageRequestQueryRequestCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamStageRequestQueryRequestCnv() throw();
    ...
    }; // end of class StreamStageRequestQueryRequestCnv

  }; // end of namespace io

}; // end of namespace castor

#endif // CASTOR_IO_STAGEREQUESTQUERYREQUEST_HPP
