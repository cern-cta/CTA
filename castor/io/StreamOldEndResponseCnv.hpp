...
/******************************************************************************
 *                      castor/io/StreamOldEndResponseCnv.hpp
 *
 ...
 *
 * @(#)$RCSfile: StreamOldEndResponseCnv.hpp,v $ $Revision: 1.1 $ $Release$ $Date: 2006/08/18 10:00:38 $ $Author: gtaur $
 *
 * 
 *
...
namespace castor {
  ...
  namespace io {
    ...
    /**
     * class StreamOldEndResponseCnv
     * A converter for marshalling/unmarshalling EndResponse into/from stl streams
     */
    class StreamOldEndResponseCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Constructor
       */
      StreamOldEndResponseCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamOldEndResponseCnv() throw();
    ...
    }; // end of class StreamOldEndResponseCnv
