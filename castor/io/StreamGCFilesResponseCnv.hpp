/******************************************************************************
 *                      castor/io/StreamGCFilesResponseCnv.hpp
 *
...
#ifndef CASTOR_IO_GCFILESRESPONSE_HPP
#define CASTOR_IO_GCFILESRESPONSE_HPP
...
namespace castor {
  ...
  namespace io {
    ...
    /**
     * class StreamGCFilesResponseCnv
     * A converter for marshalling/unmarshalling GCFilesResponse into/from stl streams
     */
    class StreamGCFilesResponseCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Constructor
       */
      StreamGCFilesResponseCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamGCFilesResponseCnv() throw();
...
#endif // CASTOR_IO_GCFILESRESPONSE_HPP
