...
/******************************************************************************
 *                      castor/io/StreamDeviceGroupNameCnv.hpp
 *
...
#ifndef CASTOR_IO_DEVICEGROUPNAME_HPP
#define CASTOR_IO_DEVICEGROUPNAME_HPP
...
namespace castor {
  ...
  namespace io {
    ...
    /**
     * class StreamDeviceGroupNameCnv
     * A converter for marshalling/unmarshalling DeviceGroupName into/from stl streams
     */
    class StreamDeviceGroupNameCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Constructor
       */
      StreamDeviceGroupNameCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamDeviceGroupNameCnv() throw();
