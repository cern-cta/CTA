...
/******************************************************************************
 *                      castor/io/StreamOldGCFilesResponseCnv.hpp
 *
 ...
 *
 * @(#)$RCSfile: StreamOldGCFilesResponseCnv.hpp,v $ $Revision: 1.1 $ $Release$ $Date: 2006/08/18 10:00:38 $ $Author: gtaur $
 *
 * 
 *
...
namespace castor {
  ...
  namespace io {
    ...
    /**
     * class StreamOldGCFilesResponseCnv
     * A converter for marshalling/unmarshalling GCFilesResponse into/from stl streams
     */
    class StreamOldGCFilesResponseCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Constructor
       */
      StreamOldGCFilesResponseCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamOldGCFilesResponseCnv() throw();
    ...
    }; // end of class StreamOldGCFilesResponseCnv
