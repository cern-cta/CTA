...
/******************************************************************************
 *                      castor/io/StreamOldFindReqResponseCnv.hpp
 *
 ...
 *
 * @(#)$RCSfile: StreamOldFindReqResponseCnv.hpp,v $ $Revision: 1.1 $ $Release$ $Date: 2006/08/18 10:00:38 $ $Author: gtaur $
 *
 * 
 *
...
namespace castor {
  ...
  namespace io {
    ...
    /**
     * class StreamOldFindReqResponseCnv
     * A converter for marshalling/unmarshalling FindReqResponse into/from stl streams
     */
    class StreamOldFindReqResponseCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Constructor
       */
      StreamOldFindReqResponseCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamOldFindReqResponseCnv() throw();
    ...
    }; // end of class StreamOldFindReqResponseCnv
