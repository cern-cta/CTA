...
/******************************************************************************
 *                      castor/io/StreamRepackRequestCnv.hpp
 *
...
#ifndef CASTOR_IO_REPACKREQUEST_HPP
#define CASTOR_IO_REPACKREQUEST_HPP
...
namespace castor {
  ...
  namespace io {
    ...
    /**
     * class StreamRepackRequestCnv
     * A converter for marshalling/unmarshalling RepackRequest into/from stl streams
     */
    class StreamRepackRequestCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Constructor
       */
      StreamRepackRequestCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamRepackRequestCnv() throw();
    ...
    }; // end of class StreamRepackRequestCnv

  }; // end of namespace io

}; // end of namespace castor

#endif // CASTOR_IO_REPACKREQUEST_HPP
