...
/******************************************************************************
 *                      castor/io/StreamGatewayMessageCnv.hpp
 *
 ...
 *
 * @(#)$RCSfile: StreamGatewayMessageCnv.hpp,v $ $Revision: 1.1 $ $Release$ $Date: 2009/07/06 09:27:27 $ $Author: gtaur $
 *
 * 
 *
...
#ifndef CASTOR_IO_GATEWAYMESSAGE_HPP
#define CASTOR_IO_GATEWAYMESSAGE_HPP
...
namespace castor {
  ...
  namespace io {
    ...
    /**
     * class StreamGatewayMessageCnv
     * A converter for marshalling/unmarshalling GatewayMessage into/from stl streams
     */
    class StreamGatewayMessageCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Constructor
       */
      StreamGatewayMessageCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamGatewayMessageCnv() throw();
    ...
    }; // end of class StreamGatewayMessageCnv

  } /* end of namespace io */

} /* end of namespace castor */

#endif // CASTOR_IO_GATEWAYMESSAGE_HPP
