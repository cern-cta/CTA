...
#ifndef CASTOR_IO_BWUSER_HPP
#define CASTOR_IO_BWUSER_HPP
...
namespace castor {
  ...
  namespace io {
    ...
    /**
     * class StreamBWUserCnv
     * A converter for marshalling/unmarshalling BWUser into/from stl streams
     */
    class StreamBWUserCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Constructor
       */
      StreamBWUserCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamBWUserCnv() throw();
