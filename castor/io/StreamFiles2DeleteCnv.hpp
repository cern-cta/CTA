/******************************************************************************
 *                      castor/io/StreamFiles2DeleteCnv.hpp
 *
...
#ifndef CASTOR_IO_FILES2DELETE_HPP
#define CASTOR_IO_FILES2DELETE_HPP
...
namespace castor {
  ...
  namespace io {
    ...
    /**
     * class StreamFiles2DeleteCnv
     * A converter for marshalling/unmarshalling Files2Delete into/from stl streams
     */
    class StreamFiles2DeleteCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Constructor
       */
      StreamFiles2DeleteCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamFiles2DeleteCnv() throw();
