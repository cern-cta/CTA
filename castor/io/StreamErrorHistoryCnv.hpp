...
/******************************************************************************
 *                      castor/io/StreamErrorHistoryCnv.hpp
 *
...
#ifndef CASTOR_IO_ERRORHISTORY_HPP
#define CASTOR_IO_ERRORHISTORY_HPP
...
namespace castor {
  ...
  namespace io {
    ...
    /**
     * class StreamErrorHistoryCnv
     * A converter for marshalling/unmarshalling ErrorHistory into/from stl streams
     */
    class StreamErrorHistoryCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Constructor
       */
      StreamErrorHistoryCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamErrorHistoryCnv() throw();
    ...
    }; // end of class StreamErrorHistoryCnv

  }; // end of namespace io

}; // end of namespace castor

#endif // CASTOR_IO_ERRORHISTORY_HPP
