/******************************************************************************
 *                      castor/io/StreamStagePrepareToGetRequestCnv.hpp
 *
...
#ifndef CASTOR_IO_STAGEPREPARETOGETREQUEST_HPP
#define CASTOR_IO_STAGEPREPARETOGETREQUEST_HPP
...
namespace castor {
  ...
  namespace io {
    ...
    /**
     * class StreamStagePrepareToGetRequestCnv
     * A converter for marshalling/unmarshalling StagePrepareToGetRequest into/from stl
     * streams
     */
    class StreamStagePrepareToGetRequestCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Constructor
       */
      StreamStagePrepareToGetRequestCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamStagePrepareToGetRequestCnv() throw();
...
#endif // CASTOR_IO_STAGEPREPARETOGETREQUEST_HPP
