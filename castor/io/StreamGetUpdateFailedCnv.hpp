/******************************************************************************
 *                      castor/io/StreamGetUpdateFailedCnv.hpp
 *
...
#ifndef CASTOR_IO_GETUPDATEFAILED_HPP
#define CASTOR_IO_GETUPDATEFAILED_HPP
...
namespace castor {
  ...
  namespace io {
    ...
    /**
     * class StreamGetUpdateFailedCnv
     * A converter for marshalling/unmarshalling GetUpdateFailed into/from stl streams
     */
    class StreamGetUpdateFailedCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Constructor
       */
      StreamGetUpdateFailedCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamGetUpdateFailedCnv() throw();
...
#endif // CASTOR_IO_GETUPDATEFAILED_HPP
