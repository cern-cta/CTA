/******************************************************************************
 *                      castor/io/StreamGCLocalFileCnv.hpp
 *
...
#ifndef CASTOR_IO_GCLOCALFILE_HPP
#define CASTOR_IO_GCLOCALFILE_HPP
...
namespace castor {
  ...
  namespace io {
    ...
    /**
     * class StreamGCLocalFileCnv
     * A converter for marshalling/unmarshalling GCLocalFile into/from stl streams
     */
    class StreamGCLocalFileCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Constructor
       */
      StreamGCLocalFileCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamGCLocalFileCnv() throw();
...
#endif // CASTOR_IO_GCLOCALFILE_HPP
