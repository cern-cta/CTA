/******************************************************************************
 *                      castor/io/StreamStringResponseCnv.hpp
 *
...
#ifndef CASTOR_IO_STRINGRESPONSE_HPP
#define CASTOR_IO_STRINGRESPONSE_HPP
...
namespace castor {
  ...
  namespace io {
    ...
    /**
     * class StreamStringResponseCnv
     * A converter for marshalling/unmarshalling StringResponse into/from stl streams
     */
    class StreamStringResponseCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Constructor
       */
      StreamStringResponseCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamStringResponseCnv() throw();
...
#endif // CASTOR_IO_STRINGRESPONSE_HPP
