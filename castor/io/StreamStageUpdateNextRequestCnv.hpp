/******************************************************************************
 *                      castor/io/StreamStageUpdateNextRequestCnv.hpp
 *
...
#ifndef CASTOR_IO_STAGEUPDATENEXTREQUEST_HPP
#define CASTOR_IO_STAGEUPDATENEXTREQUEST_HPP
...
namespace castor {
  ...
  namespace io {
    ...
    public:
       ...
       * Constructor
       */
      StreamStageUpdateNextRequestCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamStageUpdateNextRequestCnv() throw();
    ...
    }; // end of class StreamStageUpdateNextRequestCnv

  }; // end of namespace io

}; // end of namespace castor

#endif // CASTOR_IO_STAGEUPDATENEXTREQUEST_HPP
