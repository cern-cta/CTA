/******************************************************************************
 *                      castor/io/StreamBasicResponseCnv.hpp
 *
...
#ifndef CASTOR_IO_BASICRESPONSE_HPP
#define CASTOR_IO_BASICRESPONSE_HPP
...
namespace castor {
  ...
  namespace io {
    ...
    /**
     * class StreamBasicResponseCnv
     * A converter for marshalling/unmarshalling BasicResponse into/from stl streams
     */
    class StreamBasicResponseCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Constructor
       */
      StreamBasicResponseCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamBasicResponseCnv() throw();
...
#endif // CASTOR_IO_BASICRESPONSE_HPP
