...
/******************************************************************************
 *                      castor/io/StreamStgFilesDeletedCnv.cpp
 *
...
// Include Files
#include "StreamStgFilesDeletedCnv.hpp"
...
//------------------------------------------------------------------------------
static castor::CnvFactory<castor::io::StreamStgFilesDeletedCnv>* s_factoryStreamStgFilesDeletedCnv =
  new castor::CnvFactory<castor::io::StreamStgFilesDeletedCnv>();

//------------------------------------------------------------------------------
// Constructor
//------------------------------------------------------------------------------
castor::io::StreamStgFilesDeletedCnv::StreamStgFilesDeletedCnv(castor::ICnvSvc* cnvSvc) :
 StreamBaseCnv(cnvSvc) {}

//------------------------------------------------------------------------------
// Destructor
//------------------------------------------------------------------------------
castor::io::StreamStgFilesDeletedCnv::~StreamStgFilesDeletedCnv() throw() {
}

//------------------------------------------------------------------------------
// ObjType
//------------------------------------------------------------------------------
const unsigned int castor::io::StreamStgFilesDeletedCnv::ObjType() {
  return castor::stager::StgFilesDeleted::TYPE();
}

//------------------------------------------------------------------------------
// objType
//------------------------------------------------------------------------------
const unsigned int castor::io::StreamStgFilesDeletedCnv::objType() const {
  return ObjType();
}
...
// createRep
//------------------------------------------------------------------------------
void castor::io::StreamStgFilesDeletedCnv::createRep(castor::IAddress* address,
...
castor::IObject* castor::io::StreamStgFilesDeletedCnv::createObj(castor::IAddress* address)
  ...
  castor::stager::StgFilesDeleted* object = new castor::stager::StgFilesDeleted();
...
castor::IObject* castor::io::StreamStgFilesDeletedCnv::unmarshalObject(castor::io::biniostream& stream,
  ...
  for (unsigned int i = 0; i < filesNb; i++) {
    ...
    obj->addFiles(dynamic_cast<castor::stager::GCFile*>(objFiles));
  }
  ad.setObjType(castor::OBJ_INVALID);
