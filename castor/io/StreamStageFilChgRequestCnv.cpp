 ...
 *
 * @(#)$RCSfile: StreamStageFilChgRequestCnv.cpp,v $ $Revision: 1.14 $ $Release$ $Date: 2004/11/05 17:47:25 $ $Author: sponcec3 $
 *
 * 
 *
...
const castor::ICnvFactory& StreamStageFilChgRequestCnvFactory = 
  s_factoryStreamStageFilChgRequestCnv;

//------------------------------------------------------------------------------
// Constructor
//------------------------------------------------------------------------------
castor::io::StreamStageFilChgRequestCnv::StreamStageFilChgRequestCnv(castor::ICnvSvc* cnvSvc) :
