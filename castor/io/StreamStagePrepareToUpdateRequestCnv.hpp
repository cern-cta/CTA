/******************************************************************************
 *                      castor/io/StreamStagePrepareToUpdateRequestCnv.hpp
 *
...
#ifndef CASTOR_IO_STAGEPREPARETOUPDATEREQUEST_HPP
#define CASTOR_IO_STAGEPREPARETOUPDATEREQUEST_HPP
...
namespace castor {
  ...
  namespace io {
    ...
    /**
     * class StreamStagePrepareToUpdateRequestCnv
     * A converter for marshalling/unmarshalling StagePrepareToUpdateRequest into/from
     * stl streams
     */
    class StreamStagePrepareToUpdateRequestCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Constructor
       */
      StreamStagePrepareToUpdateRequestCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamStagePrepareToUpdateRequestCnv() throw();
