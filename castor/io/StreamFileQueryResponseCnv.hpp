/******************************************************************************
 *                      castor/io/StreamFileQueryResponseCnv.hpp
 *
...
#ifndef CASTOR_IO_FILEQUERYRESPONSE_HPP
#define CASTOR_IO_FILEQUERYRESPONSE_HPP
...
namespace castor {
  ...
  namespace io {
    ...
    /**
     * class StreamFileQueryResponseCnv
     * A converter for marshalling/unmarshalling FileQueryResponse into/from stl
     * streams
     */
    class StreamFileQueryResponseCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Constructor
       */
      StreamFileQueryResponseCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamFileQueryResponseCnv() throw();
    ...
    }; // end of class StreamFileQueryResponseCnv

  }; // end of namespace io

}; // end of namespace castor

#endif // CASTOR_IO_FILEQUERYRESPONSE_HPP
