...
/******************************************************************************
 *                      castor/io/StreamOldGetUpdateStartResponseCnv.hpp
 *
 ...
 *
 * @(#)$RCSfile: StreamOldGetUpdateStartResponseCnv.hpp,v $ $Revision: 1.1 $ $Release$ $Date: 2006/08/18 10:00:38 $ $Author: gtaur $
 *
 * 
 *
...
namespace castor {
  ...
  namespace io {
    ...
    /**
     * class StreamOldGetUpdateStartResponseCnv
     * A converter for marshalling/unmarshalling GetUpdateStartResponse into/from stl
     */
    class StreamOldGetUpdateStartResponseCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Constructor
       */
      StreamOldGetUpdateStartResponseCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamOldGetUpdateStartResponseCnv() throw();
    ...
    }; // end of class StreamOldGetUpdateStartResponseCnv
