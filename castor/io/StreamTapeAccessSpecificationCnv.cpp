...
/******************************************************************************
 *                      castor/io/StreamTapeAccessSpecificationCnv.cpp
 *
...
// Include Files
#include "StreamTapeAccessSpecificationCnv.hpp"
...
//------------------------------------------------------------------------------
static castor::CnvFactory<castor::io::StreamTapeAccessSpecificationCnv> s_factoryStreamTapeAccessSpecificationCnv;
const castor::ICnvFactory& StreamTapeAccessSpecificationCnvFactory = 
  s_factoryStreamTapeAccessSpecificationCnv;
...
// Destructor
//------------------------------------------------------------------------------
castor::io::StreamTapeAccessSpecificationCnv::~StreamTapeAccessSpecificationCnv() throw() {
}
...
castor::IObject* castor::io::StreamTapeAccessSpecificationCnv::createObj(castor::IAddress* address)
  ...
  std::string tapeModel;
  ad->stream() >> tapeModel;
  object->setTapeModel(tapeModel);
  u_signed64 id;
  ad->stream() >> id;
  object->setId(id);
  return object;
