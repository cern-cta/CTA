 ...
 *
 * @(#)$RCSfile: StreamStageFilChgRequestCnv.hpp,v $ $Revision: 1.8 $ $Release$ $Date: 2004/11/05 17:47:25 $ $Author: sponcec3 $
 *
 * 
 *
...
namespace castor {
  ...
  namespace io {
    ...
    public:
       ...
       * Constructor
       */
      StreamStageFilChgRequestCnv(castor::ICnvSvc* cnvSvc);
