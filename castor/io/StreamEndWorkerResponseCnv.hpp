...
/******************************************************************************
 *                      castor/io/StreamEndWorkerResponseCnv.hpp
 *
 ...
 *
 * @(#)$RCSfile: StreamEndWorkerResponseCnv.hpp,v $ $Revision: 1.1 $ $Release$ $Date: 2009/01/19 17:33:01 $ $Author: gtaur $
 *
 * 
 *
...
#ifndef CASTOR_IO_ENDWORKERRESPONSE_HPP
#define CASTOR_IO_ENDWORKERRESPONSE_HPP
...
namespace castor {
  ...
  namespace io {
    ...
    /**
     * class StreamEndWorkerResponseCnv
     * A converter for marshalling/unmarshalling EndWorkerResponse into/from stl
     * streams
     */
    class StreamEndWorkerResponseCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Constructor
       */
      StreamEndWorkerResponseCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamEndWorkerResponseCnv() throw();
    ...
    }; // end of class StreamEndWorkerResponseCnv

  } /* end of namespace io */

} /* end of namespace castor */

#endif // CASTOR_IO_ENDWORKERRESPONSE_HPP
