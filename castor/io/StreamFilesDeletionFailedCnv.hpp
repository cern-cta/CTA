...
/******************************************************************************
 *                      castor/io/StreamFilesDeletionFailedCnv.hpp
 *
...
#ifndef CASTOR_IO_FILESDELETIONFAILED_HPP
#define CASTOR_IO_FILESDELETIONFAILED_HPP
...
namespace castor {
  ...
  namespace io {
    ...
    public:
       ...
       * Constructor
       */
      StreamFilesDeletionFailedCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamFilesDeletionFailedCnv() throw();
...
#endif // CASTOR_IO_FILESDELETIONFAILED_HPP
