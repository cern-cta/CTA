...
/******************************************************************************
 *                      castor/io/StreamOldStringResponseCnv.hpp
 *
 ...
 *
 * @(#)$RCSfile: StreamOldStringResponseCnv.hpp,v $ $Revision: 1.1 $ $Release$ $Date: 2006/08/18 10:00:38 $ $Author: gtaur $
 *
 * 
 *
...
namespace castor {
  ...
  namespace io {
    ...
    /**
     * class StreamOldStringResponseCnv
     * A converter for marshalling/unmarshalling StringResponse into/from stl streams
     */
    class StreamOldStringResponseCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Constructor
       */
      StreamOldStringResponseCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamOldStringResponseCnv() throw();
    ...
    }; // end of class StreamOldStringResponseCnv
