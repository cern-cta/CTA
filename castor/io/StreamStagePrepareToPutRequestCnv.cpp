/******************************************************************************
 *                      castor/io/StreamStagePrepareToPutRequestCnv.cpp
 *
...
// Include Files
#include "StreamStagePrepareToPutRequestCnv.hpp"
...
//------------------------------------------------------------------------------
static castor::CnvFactory<castor::io::StreamStagePrepareToPutRequestCnv> s_factoryStreamStagePrepareToPutRequestCnv;
const castor::ICnvFactory& StreamStagePrepareToPutRequestCnvFactory = 
  s_factoryStreamStagePrepareToPutRequestCnv;

//------------------------------------------------------------------------------
// Constructor
//------------------------------------------------------------------------------
castor::io::StreamStagePrepareToPutRequestCnv::StreamStagePrepareToPutRequestCnv(castor::ICnvSvc* cnvSvc) :
  StreamBaseCnv(cnvSvc) {}

//------------------------------------------------------------------------------
// Destructor
//------------------------------------------------------------------------------
castor::io::StreamStagePrepareToPutRequestCnv::~StreamStagePrepareToPutRequestCnv() throw() {
}

//------------------------------------------------------------------------------
// ObjType
//------------------------------------------------------------------------------
const unsigned int castor::io::StreamStagePrepareToPutRequestCnv::ObjType() {
...
// objType
//------------------------------------------------------------------------------
const unsigned int castor::io::StreamStagePrepareToPutRequestCnv::objType() const {
  return ObjType();
}
...
// createRep
//------------------------------------------------------------------------------
void castor::io::StreamStagePrepareToPutRequestCnv::createRep(castor::IAddress* address,
