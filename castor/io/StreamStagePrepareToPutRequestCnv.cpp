...
const castor::IFactory<castor::IConverter>& StreamStagePrepareToPutRequestCnvFactory = 
  s_factoryStreamStagePrepareToPutRequestCnv;

//------------------------------------------------------------------------------
// Constructor
//------------------------------------------------------------------------------
castor::io::StreamStagePrepareToPutRequestCnv::StreamStagePrepareToPutRequestCnv() :
  StreamBaseCnv() {}
