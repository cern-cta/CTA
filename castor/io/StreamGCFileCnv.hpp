...
#ifndef CASTOR_IO_GCFILE_HPP
#define CASTOR_IO_GCFILE_HPP
...
namespace castor {
  ...
  namespace io {
    ...
    /**
     * class StreamGCFileCnv
     * A converter for marshalling/unmarshalling GCFile into/from stl streams
     */
    class StreamGCFileCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Constructor
       */
      StreamGCFileCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamGCFileCnv() throw();
