...
/******************************************************************************
 *                      castor/io/StreamOldAbortResponseCnv.hpp
 *
 ...
 *
 * @(#)$RCSfile: StreamOldAbortResponseCnv.hpp,v $ $Revision: 1.1 $ $Release$ $Date: 2006/08/18 10:00:37 $ $Author: gtaur $
 *
 * 
 *
...
namespace castor {
  ...
  namespace io {
    ...
    /**
     * class StreamOldAbortResponseCnv
     * A converter for marshalling/unmarshalling AbortResponse into/from stl streams
     */
    class StreamOldAbortResponseCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Constructor
       */
      StreamOldAbortResponseCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamOldAbortResponseCnv() throw();
    ...
    }; // end of class StreamOldAbortResponseCnv
