/******************************************************************************
 *                      castor/io/StreamStageQryRequestCnv.hpp
 *
 ...
 *
 * @(#)$RCSfile: StreamStageQryRequestCnv.hpp,v $ $Revision: 1.8 $ $Release$ $Date: 2004/11/05 17:47:26 $ $Author: sponcec3 $
 *
 * 
 *
...
#define CASTOR_IO_STAGEQRYREQUEST_HPP
...
namespace castor {
  ...
  namespace io {
    ...
    /**
     * class StreamStageQryRequestCnv
     * A converter for marshalling/unmarshalling StageQryRequest into/from stl streams
     */
    class StreamStageQryRequestCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Constructor
       */
      StreamStageQryRequestCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamStageQryRequestCnv() throw();
    ...
    }; // end of class StreamStageQryRequestCnv

  }; // end of namespace io

}; // end of namespace castor

#endif // CASTOR_IO_STAGEQRYREQUEST_HPP
