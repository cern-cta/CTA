/******************************************************************************
 *                      castor/io/StreamGCRemovedFileCnv.hpp
 *
 ...
 *
 * @(#)$RCSfile: StreamGCRemovedFileCnv.hpp,v $ $Revision: 1.1 $ $Release$ $Date: 2005/02/09 17:05:39 $ $Author: sponcec3 $
 *
 * 
 *
...
#ifndef CASTOR_IO_GCREMOVEDFILE_HPP
#define CASTOR_IO_GCREMOVEDFILE_HPP
...
namespace castor {
  ...
  namespace io {
    ...
    /**
     * class StreamGCRemovedFileCnv
     * A converter for marshalling/unmarshalling GCRemovedFile into/from stl streams
     */
    class StreamGCRemovedFileCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Constructor
       */
      StreamGCRemovedFileCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamGCRemovedFileCnv() throw();
    ...
    }; // end of class StreamGCRemovedFileCnv

  }; // end of namespace io

}; // end of namespace castor

#endif // CASTOR_IO_GCREMOVEDFILE_HPP
