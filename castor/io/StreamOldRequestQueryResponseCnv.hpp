...
/******************************************************************************
 *                      castor/io/StreamOldRequestQueryResponseCnv.hpp
 *
 ...
 *
 * @(#)$RCSfile: StreamOldRequestQueryResponseCnv.hpp,v $ $Revision: 1.1 $ $Release$ $Date: 2006/08/18 10:00:38 $ $Author: gtaur $
 *
 * 
 *
...
namespace castor {
  ...
  namespace io {
    ...
    /**
     * class StreamOldRequestQueryResponseCnv
     * A converter for marshalling/unmarshalling RequestQueryResponse into/from stl
     */
    class StreamOldRequestQueryResponseCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Constructor
       */
      StreamOldRequestQueryResponseCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamOldRequestQueryResponseCnv() throw();
    ...
    }; // end of class StreamOldRequestQueryResponseCnv
