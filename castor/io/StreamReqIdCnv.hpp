 ...
 *
 * @(#)$RCSfile: StreamReqIdCnv.hpp,v $ $Revision: 1.8 $ $Release$ $Date: 2004/11/05 17:47:25 $ $Author: sponcec3 $
 *
 * 
 *
...
#ifndef CASTOR_IO_REQID_HPP
#define CASTOR_IO_REQID_HPP
...
namespace castor {
  ...
  namespace io {
    ...
    /**
     * class StreamReqIdCnv
     * A converter for marshalling/unmarshalling ReqId into/from stl streams
     */
    class StreamReqIdCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Constructor
       */
      StreamReqIdCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamReqIdCnv() throw();
    ...
    }; // end of class StreamReqIdCnv

  }; // end of namespace io

}; // end of namespace castor

#endif // CASTOR_IO_REQID_HPP
