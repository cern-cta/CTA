/******************************************************************************
 *                      castor/io/StreamStagePutNextRequestCnv.hpp
 *
...
#ifndef CASTOR_IO_STAGEPUTNEXTREQUEST_HPP
#define CASTOR_IO_STAGEPUTNEXTREQUEST_HPP
...
namespace castor {
  ...
  namespace io {
    ...
    /**
     * class StreamStagePutNextRequestCnv
     * A converter for marshalling/unmarshalling StagePutNextRequest into/from stl
     * streams
     */
    class StreamStagePutNextRequestCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Constructor
       */
      StreamStagePutNextRequestCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamStagePutNextRequestCnv() throw();
    ...
    }; // end of class StreamStagePutNextRequestCnv

  }; // end of namespace io

}; // end of namespace castor

#endif // CASTOR_IO_STAGEPUTNEXTREQUEST_HPP
