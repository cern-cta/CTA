/******************************************************************************
 *                      castor/io/StreamTapePoolCnv.hpp
 *
...
#ifndef CASTOR_IO_TAPEPOOL_HPP
#define CASTOR_IO_TAPEPOOL_HPP
...
namespace castor {
  ...
  namespace io {
    ...
    /**
     * class StreamTapePoolCnv
     * A converter for marshalling/unmarshalling TapePool into/from stl streams
     */
    class StreamTapePoolCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Constructor
       */
      StreamTapePoolCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamTapePoolCnv() throw();
    ...
    }; // end of class StreamTapePoolCnv

  }; // end of namespace io

}; // end of namespace castor

#endif // CASTOR_IO_TAPEPOOL_HPP
