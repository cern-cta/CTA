 ...
 *
 * @(#)$RCSfile: StreamStageOutRequestCnv.cpp,v $ $Revision: 1.14 $ $Release$ $Date: 2004/11/05 17:47:26 $ $Author: sponcec3 $
 *
 * 
 *
...
const castor::ICnvFactory& StreamStageOutRequestCnvFactory = 
  s_factoryStreamStageOutRequestCnv;

//------------------------------------------------------------------------------
// Constructor
//------------------------------------------------------------------------------
castor::io::StreamStageOutRequestCnv::StreamStageOutRequestCnv(castor::ICnvSvc* cnvSvc) :
