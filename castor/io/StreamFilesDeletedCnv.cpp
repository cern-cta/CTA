/******************************************************************************
 *                      castor/io/StreamFilesDeletedCnv.cpp
 *
...
// Include Files
#include "StreamFilesDeletedCnv.hpp"
...
//------------------------------------------------------------------------------
static castor::CnvFactory<castor::io::StreamFilesDeletedCnv> s_factoryStreamFilesDeletedCnv;
const castor::ICnvFactory& StreamFilesDeletedCnvFactory = 
  s_factoryStreamFilesDeletedCnv;

//------------------------------------------------------------------------------
// Constructor
//------------------------------------------------------------------------------
castor::io::StreamFilesDeletedCnv::StreamFilesDeletedCnv(castor::ICnvSvc* cnvSvc) :
  StreamBaseCnv(cnvSvc) {}

//------------------------------------------------------------------------------
// Destructor
//------------------------------------------------------------------------------
castor::io::StreamFilesDeletedCnv::~StreamFilesDeletedCnv() throw() {
}

//------------------------------------------------------------------------------
// ObjType
//------------------------------------------------------------------------------
const unsigned int castor::io::StreamFilesDeletedCnv::ObjType() {
...
// objType
//------------------------------------------------------------------------------
const unsigned int castor::io::StreamFilesDeletedCnv::objType() const {
  return ObjType();
}
...
// createRep
//------------------------------------------------------------------------------
void castor::io::StreamFilesDeletedCnv::createRep(castor::IAddress* address,
...
castor::IObject* castor::io::StreamFilesDeletedCnv::unmarshalObject(castor::io::biniostream& stream,
  ...
  for (unsigned int i = 0; i < filesNb; i++) {
    ...
    obj->addFiles(dynamic_cast<castor::stager::GCRemovedFile*>(objFiles));
  }
  return object;
}
