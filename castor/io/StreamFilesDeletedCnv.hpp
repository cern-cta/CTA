/******************************************************************************
 *                      castor/io/StreamFilesDeletedCnv.hpp
 *
...
#ifndef CASTOR_IO_FILESDELETED_HPP
#define CASTOR_IO_FILESDELETED_HPP
...
namespace castor {
  ...
  namespace io {
    ...
    /**
     * class StreamFilesDeletedCnv
     * A converter for marshalling/unmarshalling FilesDeleted into/from stl streams
     */
    class StreamFilesDeletedCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Constructor
       */
      StreamFilesDeletedCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamFilesDeletedCnv() throw();
...
#endif // CASTOR_IO_FILESDELETED_HPP
