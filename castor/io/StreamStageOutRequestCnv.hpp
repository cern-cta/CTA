/******************************************************************************
 *                      castor/io/StreamStageOutRequestCnv.hpp
 *
 ...
 *
 * @(#)$RCSfile: StreamStageOutRequestCnv.hpp,v $ $Revision: 1.8 $ $Release$ $Date: 2004/11/05 17:47:26 $ $Author: sponcec3 $
 *
 * 
 *
...
#ifndef CASTOR_IO_STAGEOUTREQUEST_HPP
#define CASTOR_IO_STAGEOUTREQUEST_HPP
...
namespace castor {
  ...
  namespace io {
    ...
    /**
     * class StreamStageOutRequestCnv
     * A converter for marshalling/unmarshalling StageOutRequest into/from stl streams
     */
    class StreamStageOutRequestCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Constructor
       */
      StreamStageOutRequestCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamStageOutRequestCnv() throw();
    ...
    }; // end of class StreamStageOutRequestCnv

  }; // end of namespace io

}; // end of namespace castor

#endif // CASTOR_IO_STAGEOUTREQUEST_HPP
