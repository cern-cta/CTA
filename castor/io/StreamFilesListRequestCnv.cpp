...
/******************************************************************************
 *                      castor/io/StreamFilesListRequestCnv.cpp
 *
...
// Include Files
#include "StreamFilesListRequestCnv.hpp"
...
//------------------------------------------------------------------------------
static castor::CnvFactory<castor::io::StreamFilesListRequestCnv>* s_factoryStreamFilesListRequestCnv =
  new castor::CnvFactory<castor::io::StreamFilesListRequestCnv>();

//------------------------------------------------------------------------------
// Constructor
//------------------------------------------------------------------------------
castor::io::StreamFilesListRequestCnv::StreamFilesListRequestCnv(castor::ICnvSvc* cnvSvc) :
 StreamBaseCnv(cnvSvc) {}

//------------------------------------------------------------------------------
// Destructor
//------------------------------------------------------------------------------
castor::io::StreamFilesListRequestCnv::~StreamFilesListRequestCnv() throw() {
}

//------------------------------------------------------------------------------
// ObjType
//------------------------------------------------------------------------------
unsigned int castor::io::StreamFilesListRequestCnv::ObjType() {
  return castor::tape::tapegateway::FilesListRequest::TYPE();
}

//------------------------------------------------------------------------------
// objType
//------------------------------------------------------------------------------
unsigned int castor::io::StreamFilesListRequestCnv::objType() const {
  return ObjType();
}
...
// createRep
//------------------------------------------------------------------------------
void castor::io::StreamFilesListRequestCnv::createRep(castor::IAddress* address,
...
castor::IObject* castor::io::StreamFilesListRequestCnv::createObj(castor::IAddress* address)
  ...
  castor::tape::tapegateway::FilesListRequest* object = new castor::tape::tapegateway::FilesListRequest();
