...
/******************************************************************************
 *                      castor/io/StreamTapeFileNsAttributeCnv.hpp
 *
 ...
 *
 * @(#)$RCSfile: StreamTapeFileNsAttributeCnv.hpp,v $ $Revision: 1.1 $ $Release$ $Date: 2009/01/19 17:33:01 $ $Author: gtaur $
 *
 * 
 *
...
#ifndef CASTOR_IO_TAPEFILENSATTRIBUTE_HPP
#define CASTOR_IO_TAPEFILENSATTRIBUTE_HPP
...
namespace castor {
  ...
  namespace io {
    ...
    /**
     * class StreamTapeFileNsAttributeCnv
     * A converter for marshalling/unmarshalling TapeFileNsAttribute into/from stl
     * streams
     */
    class StreamTapeFileNsAttributeCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Constructor
       */
      StreamTapeFileNsAttributeCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamTapeFileNsAttributeCnv() throw();
    ...
    }; // end of class StreamTapeFileNsAttributeCnv

  } /* end of namespace io */

} /* end of namespace castor */

#endif // CASTOR_IO_TAPEFILENSATTRIBUTE_HPP
