...
/******************************************************************************
 *                      castor/io/StreamOldFileResponseCnv.hpp
 *
 ...
 *
 * @(#)$RCSfile: StreamOldFileResponseCnv.hpp,v $ $Revision: 1.1 $ $Release$ $Date: 2006/08/18 10:00:38 $ $Author: gtaur $
 *
 * 
 *
...
namespace castor {
  ...
  namespace io {
    ...
    /**
     * class StreamOldFileResponseCnv
     * A converter for marshalling/unmarshalling FileResponse into/from stl streams
     */
    class StreamOldFileResponseCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Constructor
       */
      StreamOldFileResponseCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamOldFileResponseCnv() throw();
    ...
    }; // end of class StreamOldFileResponseCnv
