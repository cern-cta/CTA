...
#ifndef CASTOR_IO_VOLUME_HPP
#define CASTOR_IO_VOLUME_HPP
...
namespace castor {
  ...
  namespace io {
    ...
    /**
     * class StreamVolumeCnv
     * A converter for marshalling/unmarshalling Volume into/from stl streams
     */
    class StreamVolumeCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Constructor
       */
      StreamVolumeCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamVolumeCnv() throw();
