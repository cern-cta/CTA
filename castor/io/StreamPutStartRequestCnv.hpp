/******************************************************************************
 *                      castor/io/StreamPutStartRequestCnv.hpp
 *
...
#ifndef CASTOR_IO_PUTSTARTREQUEST_HPP
#define CASTOR_IO_PUTSTARTREQUEST_HPP
...
namespace castor {
  ...
  namespace io {
    ...
    /**
     * class StreamPutStartRequestCnv
     * A converter for marshalling/unmarshalling PutStartRequest into/from stl streams
     */
    class StreamPutStartRequestCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Constructor
       */
      StreamPutStartRequestCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamPutStartRequestCnv() throw();
...
#endif // CASTOR_IO_PUTSTARTREQUEST_HPP
