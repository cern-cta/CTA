/******************************************************************************
 *                      castor/io/StreamStageFindRequestRequestCnv.hpp
 *
...
#ifndef CASTOR_IO_STAGEFINDREQUESTREQUEST_HPP
#define CASTOR_IO_STAGEFINDREQUESTREQUEST_HPP
...
namespace castor {
  ...
  namespace io {
    ...
    /**
     * class StreamStageFindRequestRequestCnv
     * A converter for marshalling/unmarshalling StageFindRequestRequest into/from stl
     * streams
     */
    class StreamStageFindRequestRequestCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Constructor
       */
      StreamStageFindRequestRequestCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamStageFindRequestRequestCnv() throw();
    ...
    }; // end of class StreamStageFindRequestRequestCnv

  }; // end of namespace io

}; // end of namespace castor

#endif // CASTOR_IO_STAGEFINDREQUESTREQUEST_HPP
