...
/******************************************************************************
 *                      castor/io/StreamRepackSubRequestCnv.hpp
 *
...
#ifndef CASTOR_IO_REPACKSUBREQUEST_HPP
#define CASTOR_IO_REPACKSUBREQUEST_HPP
...
namespace castor {
  ...
  namespace io {
     ...
     * A converter for marshalling/unmarshalling RepackSubRequest into/from stl streams
     */
    ...
    public:
       ...
       * Constructor
       */
      StreamRepackSubRequestCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamRepackSubRequestCnv() throw();
