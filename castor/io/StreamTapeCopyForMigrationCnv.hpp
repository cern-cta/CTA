/******************************************************************************
 *                      castor/io/StreamTapeCopyForMigrationCnv.hpp
 *
...
#ifndef CASTOR_IO_TAPECOPYFORMIGRATION_HPP
#define CASTOR_IO_TAPECOPYFORMIGRATION_HPP
...
namespace castor {
  ...
  namespace io {
    ...
    public:
       ...
       * Constructor
       */
      StreamTapeCopyForMigrationCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamTapeCopyForMigrationCnv() throw();
    ...
    }; // end of class StreamTapeCopyForMigrationCnv

  }; // end of namespace io

}; // end of namespace castor

#endif // CASTOR_IO_TAPECOPYFORMIGRATION_HPP
