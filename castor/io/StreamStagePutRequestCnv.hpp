/******************************************************************************
 *                      castor/io/StreamStagePutRequestCnv.hpp
 *
...
#ifndef CASTOR_IO_STAGEPUTREQUEST_HPP
#define CASTOR_IO_STAGEPUTREQUEST_HPP
...
namespace castor {
  ...
  namespace io {
    ...
    /**
     * class StreamStagePutRequestCnv
     * A converter for marshalling/unmarshalling StagePutRequest into/from stl streams
     */
    class StreamStagePutRequestCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Constructor
       */
      StreamStagePutRequestCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamStagePutRequestCnv() throw();
...
#endif // CASTOR_IO_STAGEPUTREQUEST_HPP
