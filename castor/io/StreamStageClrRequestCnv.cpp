 ...
 *
 * @(#)$RCSfile: StreamStageClrRequestCnv.cpp,v $ $Revision: 1.14 $ $Release$ $Date: 2004/11/05 17:47:25 $ $Author: sponcec3 $
 *
 * 
 *
...
const castor::ICnvFactory& StreamStageClrRequestCnvFactory = 
  s_factoryStreamStageClrRequestCnv;

//------------------------------------------------------------------------------
// Constructor
//------------------------------------------------------------------------------
castor::io::StreamStageClrRequestCnv::StreamStageClrRequestCnv(castor::ICnvSvc* cnvSvc) :
