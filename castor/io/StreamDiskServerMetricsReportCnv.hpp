...
/******************************************************************************
 *                      castor/io/StreamDiskServerMetricsReportCnv.hpp
 *
...
#ifndef CASTOR_IO_DISKSERVERMETRICSREPORT_HPP
#define CASTOR_IO_DISKSERVERMETRICSREPORT_HPP
...
namespace castor {
  ...
  namespace io {
    ...
    public:
       ...
       * Constructor
       */
      StreamDiskServerMetricsReportCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamDiskServerMetricsReportCnv() throw();
    ...
    }; // end of class StreamDiskServerMetricsReportCnv

  }; // end of namespace io

}; // end of namespace castor

#endif // CASTOR_IO_DISKSERVERMETRICSREPORT_HPP
