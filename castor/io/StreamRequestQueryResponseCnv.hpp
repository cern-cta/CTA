/******************************************************************************
 *                      castor/io/StreamRequestQueryResponseCnv.hpp
 *
...
#ifndef CASTOR_IO_REQUESTQUERYRESPONSE_HPP
#define CASTOR_IO_REQUESTQUERYRESPONSE_HPP
...
namespace castor {
  ...
  namespace io {
    ...
    /**
     * class StreamRequestQueryResponseCnv
     * A converter for marshalling/unmarshalling RequestQueryResponse into/from stl
     * streams
     */
    class StreamRequestQueryResponseCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Constructor
       */
      StreamRequestQueryResponseCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamRequestQueryResponseCnv() throw();
    ...
    }; // end of class StreamRequestQueryResponseCnv

  }; // end of namespace io

}; // end of namespace castor

#endif // CASTOR_IO_REQUESTQUERYRESPONSE_HPP
