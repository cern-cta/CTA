/******************************************************************************
 *                      castor/io/StreamStageGetNextRequestCnv.hpp
 *
...
#ifndef CASTOR_IO_STAGEGETNEXTREQUEST_HPP
#define CASTOR_IO_STAGEGETNEXTREQUEST_HPP
...
namespace castor {
  ...
  namespace io {
    ...
    /**
     * class StreamStageGetNextRequestCnv
     * A converter for marshalling/unmarshalling StageGetNextRequest into/from stl
     * streams
     */
    class StreamStageGetNextRequestCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Constructor
       */
      StreamStageGetNextRequestCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamStageGetNextRequestCnv() throw();
    ...
    }; // end of class StreamStageGetNextRequestCnv

  }; // end of namespace io

}; // end of namespace castor

#endif // CASTOR_IO_STAGEGETNEXTREQUEST_HPP
