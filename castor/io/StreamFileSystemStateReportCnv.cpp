...
/******************************************************************************
 *                      castor/io/StreamFileSystemStateReportCnv.cpp
 *
...
// Include Files
#include "StreamFileSystemStateReportCnv.hpp"
...
//------------------------------------------------------------------------------
static castor::CnvFactory<castor::io::StreamFileSystemStateReportCnv>* s_factoryStreamFileSystemStateReportCnv =
  new castor::CnvFactory<castor::io::StreamFileSystemStateReportCnv>();

//------------------------------------------------------------------------------
// Constructor
//------------------------------------------------------------------------------
castor::io::StreamFileSystemStateReportCnv::StreamFileSystemStateReportCnv(castor::ICnvSvc* cnvSvc) :
 StreamBaseCnv(cnvSvc) {}

//------------------------------------------------------------------------------
// Destructor
//------------------------------------------------------------------------------
castor::io::StreamFileSystemStateReportCnv::~StreamFileSystemStateReportCnv() throw() {
}
...
// createObj
//------------------------------------------------------------------------------
castor::IObject* castor::io::StreamFileSystemStateReportCnv::createObj(castor::IAddress* address)
  throw (castor::exception::Exception) {
  StreamAddress* ad = 
    dynamic_cast<StreamAddress*>(address);
  // create the new Object
  castor::monitoring::FileSystemStateReport* object = new castor::monitoring::FileSystemStateReport();
...
// marshalObject
//------------------------------------------------------------------------------
void castor::io::StreamFileSystemStateReportCnv::marshalObject(castor::IObject* object,
...
// unmarshalObject
//------------------------------------------------------------------------------
castor::IObject* castor::io::StreamFileSystemStateReportCnv::unmarshalObject(castor::io::biniostream& stream,
  ...
  obj->setDiskServer(dynamic_cast<castor::monitoring::DiskServerStateReport*>(objDiskServer));
  return object;
}
