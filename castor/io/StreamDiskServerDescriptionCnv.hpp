...
/******************************************************************************
 *                      castor/io/StreamDiskServerDescriptionCnv.hpp
 *
...
#ifndef CASTOR_IO_DISKSERVERDESCRIPTION_HPP
#define CASTOR_IO_DISKSERVERDESCRIPTION_HPP
...
namespace castor {
  ...
  namespace io {
    ...
    public:
       ...
       * Constructor
       */
      StreamDiskServerDescriptionCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamDiskServerDescriptionCnv() throw();
...
#endif // CASTOR_IO_DISKSERVERDESCRIPTION_HPP
