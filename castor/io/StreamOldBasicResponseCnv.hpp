...
/******************************************************************************
 *                      castor/io/StreamOldBasicResponseCnv.hpp
 *
 ...
 *
 * @(#)$RCSfile: StreamOldBasicResponseCnv.hpp,v $ $Revision: 1.1 $ $Release$ $Date: 2006/08/18 10:00:38 $ $Author: gtaur $
 *
 * 
 *
...
namespace castor {
  ...
  namespace io {
    ...
    /**
     * class StreamOldBasicResponseCnv
     * A converter for marshalling/unmarshalling BasicResponse into/from stl streams
     */
    class StreamOldBasicResponseCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Constructor
       */
      StreamOldBasicResponseCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamOldBasicResponseCnv() throw();
    ...
    }; // end of class StreamOldBasicResponseCnv
