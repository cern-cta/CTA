...
/******************************************************************************
 *                      castor/io/StreamFileToMigrateResponseCnv.hpp
 *
 ...
 *
 * @(#)$RCSfile: StreamFileToMigrateResponseCnv.hpp,v $ $Revision: 1.6 $ $Release$ $Date: 2009/02/06 09:21:50 $ $Author: gtaur $
 *
 * 
 *
...
#ifndef CASTOR_IO_FILETOMIGRATERESPONSE_HPP
#define CASTOR_IO_FILETOMIGRATERESPONSE_HPP
...
namespace castor {
  ...
  namespace io {
    ...
    /**
     * class StreamFileToMigrateResponseCnv
     * A converter for marshalling/unmarshalling FileToMigrateResponse into/from stl
     * streams
     */
    class StreamFileToMigrateResponseCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Constructor
       */
      StreamFileToMigrateResponseCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamFileToMigrateResponseCnv() throw();
    ...
    }; // end of class StreamFileToMigrateResponseCnv

  } /* end of namespace io */

} /* end of namespace castor */

#endif // CASTOR_IO_FILETOMIGRATERESPONSE_HPP
