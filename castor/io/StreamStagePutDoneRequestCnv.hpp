/******************************************************************************
 *                      castor/io/StreamStagePutDoneRequestCnv.hpp
 *
...
#ifndef CASTOR_IO_STAGEPUTDONEREQUEST_HPP
#define CASTOR_IO_STAGEPUTDONEREQUEST_HPP
...
namespace castor {
  ...
  namespace io {
    ...
    /**
     * class StreamStagePutDoneRequestCnv
     * A converter for marshalling/unmarshalling StagePutDoneRequest into/from stl
     * streams
     */
    class StreamStagePutDoneRequestCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Constructor
       */
      StreamStagePutDoneRequestCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamStagePutDoneRequestCnv() throw();
...
#endif // CASTOR_IO_STAGEPUTDONEREQUEST_HPP
