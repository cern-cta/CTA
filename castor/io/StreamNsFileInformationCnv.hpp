...
/******************************************************************************
 *                      castor/io/StreamNsFileInformationCnv.hpp
 *
 ...
 *
 * @(#)$RCSfile: StreamNsFileInformationCnv.hpp,v $ $Revision: 1.8 $ $Release$ $Date: 2009/02/09 13:31:15 $ $Author: gtaur $
 *
 * 
 *
...
#ifndef CASTOR_IO_NSFILEINFORMATION_HPP
#define CASTOR_IO_NSFILEINFORMATION_HPP
...
namespace castor {
  ...
  namespace io {
    ...
    /**
     * class StreamNsFileInformationCnv
     * A converter for marshalling/unmarshalling NsFileInformation into/from stl
     * streams
     */
    class StreamNsFileInformationCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Constructor
       */
      StreamNsFileInformationCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamNsFileInformationCnv() throw();
    ...
    }; // end of class StreamNsFileInformationCnv

  } /* end of namespace io */

} /* end of namespace castor */

#endif // CASTOR_IO_NSFILEINFORMATION_HPP
