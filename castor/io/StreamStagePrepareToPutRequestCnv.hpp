/******************************************************************************
 *                      castor/io/StreamStagePrepareToPutRequestCnv.hpp
 *
...
#ifndef CASTOR_IO_STAGEPREPARETOPUTREQUEST_HPP
#define CASTOR_IO_STAGEPREPARETOPUTREQUEST_HPP
...
namespace castor {
  ...
  namespace io {
    ...
    /**
     * class StreamStagePrepareToPutRequestCnv
     * A converter for marshalling/unmarshalling StagePrepareToPutRequest into/from stl
     * streams
     */
    class StreamStagePrepareToPutRequestCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Constructor
       */
      StreamStagePrepareToPutRequestCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamStagePrepareToPutRequestCnv() throw();
...
#endif // CASTOR_IO_STAGEPREPARETOPUTREQUEST_HPP
