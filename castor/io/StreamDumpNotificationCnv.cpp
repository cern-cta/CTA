...
/******************************************************************************
 *                      castor/io/StreamDumpNotificationCnv.cpp
 *
...
// Include Files
#include "StreamDumpNotificationCnv.hpp"
...
//------------------------------------------------------------------------------
static castor::CnvFactory<castor::io::StreamDumpNotificationCnv>* s_factoryStreamDumpNotificationCnv =
  new castor::CnvFactory<castor::io::StreamDumpNotificationCnv>();

//------------------------------------------------------------------------------
// Constructor
//------------------------------------------------------------------------------
castor::io::StreamDumpNotificationCnv::StreamDumpNotificationCnv(castor::ICnvSvc* cnvSvc) :
 StreamBaseCnv(cnvSvc) {}

//------------------------------------------------------------------------------
// Destructor
//------------------------------------------------------------------------------
castor::io::StreamDumpNotificationCnv::~StreamDumpNotificationCnv() throw() {
}
...
castor::IObject* castor::io::StreamDumpNotificationCnv::createObj(castor::IAddress* address)
  ...
  castor::tape::tapegateway::DumpNotification* object = new castor::tape::tapegateway::DumpNotification();
