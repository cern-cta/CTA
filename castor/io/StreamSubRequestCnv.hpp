/******************************************************************************
 *                      castor/io/StreamSubRequestCnv.hpp
 *
...
#ifndef CASTOR_IO_SUBREQUEST_HPP
#define CASTOR_IO_SUBREQUEST_HPP
...
namespace castor {
  ...
  namespace io {
    ...
    /**
     * class StreamSubRequestCnv
     * A converter for marshalling/unmarshalling SubRequest into/from stl streams
     */
    class StreamSubRequestCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Constructor
       */
      StreamSubRequestCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamSubRequestCnv() throw();
...
#endif // CASTOR_IO_SUBREQUEST_HPP
