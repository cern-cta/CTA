/******************************************************************************
 *                      castor/io/StreamStageReleaseFilesRequestCnv.hpp
 *
...
#ifndef CASTOR_IO_STAGERELEASEFILESREQUEST_HPP
#define CASTOR_IO_STAGERELEASEFILESREQUEST_HPP
...
namespace castor {
  ...
  namespace io {
    ...
    /**
     * class StreamStageReleaseFilesRequestCnv
     * A converter for marshalling/unmarshalling StageReleaseFilesRequest into/from stl
     * streams
     */
    class StreamStageReleaseFilesRequestCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Constructor
       */
      StreamStageReleaseFilesRequestCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamStageReleaseFilesRequestCnv() throw();
    ...
    }; // end of class StreamStageReleaseFilesRequestCnv

  }; // end of namespace io

}; // end of namespace castor

#endif // CASTOR_IO_STAGERELEASEFILESREQUEST_HPP
