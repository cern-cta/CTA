...
/******************************************************************************
 *                      castor/io/StreamEndNotificationErrorReportCnv.hpp
 *
...
#ifndef CASTOR_IO_ENDNOTIFICATIONERRORREPORT_HPP
#define CASTOR_IO_ENDNOTIFICATIONERRORREPORT_HPP
...
namespace castor {
  ...
  namespace io {
    ...
    /**
     * class StreamEndNotificationErrorReportCnv
     * A converter for marshalling/unmarshalling EndNotificationErrorReport into/from
     * stl streams
     */
    class StreamEndNotificationErrorReportCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Constructor
       */
      StreamEndNotificationErrorReportCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamEndNotificationErrorReportCnv() throw();
...
#endif // CASTOR_IO_ENDNOTIFICATIONERRORREPORT_HPP
