...
const castor::IFactory<castor::IConverter>& StreamStageFindRequestRequestCnvFactory = 
  s_factoryStreamStageFindRequestRequestCnv;

//------------------------------------------------------------------------------
// Constructor
//------------------------------------------------------------------------------
castor::io::StreamStageFindRequestRequestCnv::StreamStageFindRequestRequestCnv() :
  StreamBaseCnv() {}
