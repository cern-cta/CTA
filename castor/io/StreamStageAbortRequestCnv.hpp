/******************************************************************************
 *                      castor/io/StreamStageAbortRequestCnv.hpp
 *
...
#ifndef CASTOR_IO_STAGEABORTREQUEST_HPP
#define CASTOR_IO_STAGEABORTREQUEST_HPP
...
namespace castor {
  ...
  namespace io {
    ...
    /**
     * class StreamStageAbortRequestCnv
     * A converter for marshalling/unmarshalling StageAbortRequest into/from stl
     * streams
     */
    class StreamStageAbortRequestCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Constructor
       */
      StreamStageAbortRequestCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamStageAbortRequestCnv() throw();
...
#endif // CASTOR_IO_STAGEABORTREQUEST_HPP
