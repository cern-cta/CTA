...
/******************************************************************************
 *                      castor/io/StreamOldIOResponseCnv.hpp
 *
 ...
 *
 * @(#)$RCSfile: StreamOldIOResponseCnv.hpp,v $ $Revision: 1.1 $ $Release$ $Date: 2006/08/18 10:00:38 $ $Author: gtaur $
 *
 * 
 *
...
namespace castor {
  ...
  namespace io {
    ...
    /**
     * class StreamOldIOResponseCnv
     * A converter for marshalling/unmarshalling IOResponse into/from stl streams
     */
    class StreamOldIOResponseCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Constructor
       */
      StreamOldIOResponseCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamOldIOResponseCnv() throw();
    ...
    }; // end of class StreamOldIOResponseCnv
