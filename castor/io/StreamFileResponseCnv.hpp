/******************************************************************************
 *                      castor/io/StreamFileResponseCnv.hpp
 *
...
#ifndef CASTOR_IO_FILERESPONSE_HPP
#define CASTOR_IO_FILERESPONSE_HPP
...
namespace castor {
  ...
  namespace io {
    ...
    /**
     * class StreamFileResponseCnv
     * A converter for marshalling/unmarshalling FileResponse into/from stl streams
     */
    class StreamFileResponseCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Constructor
       */
      StreamFileResponseCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamFileResponseCnv() throw();
...
#endif // CASTOR_IO_FILERESPONSE_HPP
