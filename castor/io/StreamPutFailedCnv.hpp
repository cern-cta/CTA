/******************************************************************************
 *                      castor/io/StreamPutFailedCnv.hpp
 *
...
#ifndef CASTOR_IO_PUTFAILED_HPP
#define CASTOR_IO_PUTFAILED_HPP
...
namespace castor {
  ...
  namespace io {
    ...
    /**
     * class StreamPutFailedCnv
     * A converter for marshalling/unmarshalling PutFailed into/from stl streams
     */
    class StreamPutFailedCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Constructor
       */
      StreamPutFailedCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamPutFailedCnv() throw();
