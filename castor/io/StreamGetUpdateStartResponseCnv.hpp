/******************************************************************************
 *                      castor/io/StreamGetUpdateStartResponseCnv.hpp
 *
...
#ifndef CASTOR_IO_GETUPDATESTARTRESPONSE_HPP
#define CASTOR_IO_GETUPDATESTARTRESPONSE_HPP
...
namespace castor {
  ...
  namespace io {
    ...
    public:
       ...
       * Constructor
       */
      StreamGetUpdateStartResponseCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamGetUpdateStartResponseCnv() throw();
