/******************************************************************************
 *                      castor/io/StreamStageUpdcRequestCnv.hpp
 *
 ...
 *
 * @(#)$RCSfile: StreamStageUpdcRequestCnv.hpp,v $ $Revision: 1.8 $ $Release$ $Date: 2004/11/05 17:47:27 $ $Author: sponcec3 $
 *
 * 
 *
...
#ifndef CASTOR_IO_STAGEUPDCREQUEST_HPP
...
namespace castor {
  ...
  namespace io {
     ...
     * A converter for marshalling/unmarshalling StageUpdcRequest into/from stl streams
     */
    class StreamStageUpdcRequestCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Constructor
       */
      StreamStageUpdcRequestCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamStageUpdcRequestCnv() throw();
...
#endif // CASTOR_IO_STAGEUPDCREQUEST_HPP
