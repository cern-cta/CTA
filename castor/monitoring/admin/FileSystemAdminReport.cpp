...
/******************************************************************************
 *                      castor/monitoring/admin/FileSystemAdminReport.cpp
 *
...
// print
//------------------------------------------------------------------------------
void castor::monitoring::admin::FileSystemAdminReport::print(std::ostream& stream,
                                                             std::string indent,
                                                             castor::ObjectSet& alreadyPrinted) const {
  stream << indent << "[# FileSystemAdminReport #]" << std::endl;
...
// print
//------------------------------------------------------------------------------
void castor::monitoring::admin::FileSystemAdminReport::print() const {
...
// TYPE
//------------------------------------------------------------------------------
int castor::monitoring::admin::FileSystemAdminReport::TYPE() {
  return OBJ_FileSystemAdminReport;
}

//------------------------------------------------------------------------------
// type
//------------------------------------------------------------------------------
int castor::monitoring::admin::FileSystemAdminReport::type() const {
  return TYPE();
}
...
// clone
//------------------------------------------------------------------------------
castor::IObject* castor::monitoring::admin::FileSystemAdminReport::clone() {
  return new FileSystemAdminReport(*this);
}
