...
namespace castor {
  ...
  namespace bwlist {
    ...
    public:
      ...
      /*********************************/
      /**
       * Get the value of m_isAdd
       * Whether the change is an addition of privilege. If not, it is a deletion.
       * @return the value of m_isAdd
       */
      bool isAdd() const {
        return m_isAdd;
      }
      ...
      /**
       * Set the value of m_isAdd
       * Whether the change is an addition of privilege. If not, it is a deletion.
       * @param new_var the new value of m_isAdd
       */
      void setIsAdd(bool new_var) {
        m_isAdd = new_var;
      }
