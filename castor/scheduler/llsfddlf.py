...
msgs = enum('ABORTEREXCEPTION', 'SYNCHROFAILED', 'SYNCHROEXCEPTION',
            ...
            'BJOBSCALLED', 'BKILLCALLED', 'BKILLINTERNALCALLED',
            'JOBSKILLEDCALLED', 'JOBSCANCELEDCALLED', 'JOBSTARTINGCALLED',
            'GETQUEUINGJOBSCALLED', 'GETRUNNINGD2DSOURCEJOBSCALLED', 'D2DENDCALLED',
            'DRAINCALLED', 'SYNCHROKILLEDJOB', 'FAILJOBEXCEPTION',
