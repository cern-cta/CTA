...
# *
# * command line to display the state of the different service classes
# *
...
counts = rpcconn.root.bqueues(svcClass)
print 'SVCCLASS          MAX  PEND   RUN'
for row in counts:
    print '%-15s%6d%6d%6d' % row
