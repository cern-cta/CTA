 ...
 *
 * @(#)$RCSfile: ObjectCatalog.hpp,v $ $Revision: 1.1.1.1 $ $Release$ $Date: 2004/05/12 12:13:34 $ $Author: sponcec3 $
 *
 * 
 *
...
namespace castor {
   ...
   * from 1 and going up.
   */
  class ObjectCatalog : public std::map<unsigned long, castor::IObject*> {
