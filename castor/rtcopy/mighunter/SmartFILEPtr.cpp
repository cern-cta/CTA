/******************************************************************************
 *                      castor/rtcopy/mighunter/SmartFILEPtr.cpp
 *
...
// constructor
//-----------------------------------------------------------------------------
castor::rtcopy::mighunter::SmartFILEPtr::SmartFILEPtr() throw() :
  m_file(NULL) {
}
...
castor::rtcopy::mighunter::SmartFILEPtr
  &castor::rtcopy::mighunter::SmartFILEPtr::operator=(SmartFILEPtr& obj) throw() {
...
// get
//-----------------------------------------------------------------------------
FILE *castor::rtcopy::mighunter::SmartFILEPtr::get() const throw() {
