...
#include "castor/acs/TestingAcsQueryVolumeCmd.hpp"
...
class castor_acs_AcsQueryVolumeCmdTest: public ::testing::Test {
protected:
...
}; // class castor_acs_AcsQueryVolumeCmdTest

TEST_F(castor_acs_AcsQueryVolumeCmdTest, parceCmdLineWithNoArgs) {
...
TEST_F(castor_acs_AcsQueryVolumeCmdTest, parceCmdLineWithValidVolId) {
  using namespace castor::acs;
  Argcv *args = new Argcv();
  m_argsList.push_back(args);
  args->argc = 2;
...
TEST_F(castor_acs_AcsQueryVolumeCmdTest, parceCmdLineWithShortHelp) {
  using namespace castor::acs;
  Argcv *args = new Argcv();
  m_argsList.push_back(args);
  args->argc = 2;
...
TEST_F(castor_acs_AcsQueryVolumeCmdTest, parceCmdLineWithLongHelp) {
  using namespace castor::acs;
  Argcv *args = new Argcv();
  m_argsList.push_back(args);
  args->argc = 2;
...
TEST_F(castor_acs_AcsQueryVolumeCmdTest, parceCmdLineWithShortDebug) {
  using namespace castor::acs;
  Argcv *args = new Argcv();
  m_argsList.push_back(args);
  args->argc = 3;
...
TEST_F(castor_acs_AcsQueryVolumeCmdTest, parceCmdLineWithLongDebug) {
  using namespace castor::acs;
  Argcv *args = new Argcv();
  m_argsList.push_back(args);
  args->argc = 3;
...
TEST_F(castor_acs_AcsQueryVolumeCmdTest, parceCmdLineWithTooLongVolId) {
  using namespace castor::acs;
  Argcv *args = new Argcv();
  m_argsList.push_back(args);
  args->argc = 2;
...
TEST_F(castor_acs_AcsQueryVolumeCmdTest, parceCmdLineWithShortTimeout) {
  using namespace castor::acs;
  Argcv *args = new Argcv();
  m_argsList.push_back(args);
  args->argc = 4;
...
TEST_F(castor_acs_AcsQueryVolumeCmdTest, parceCmdLineWithLongTimeout) {
  using namespace castor::acs;
  Argcv *args = new Argcv();
  m_argsList.push_back(args);
  args->argc = 4;
...
TEST_F(castor_acs_AcsQueryVolumeCmdTest, parceCmdLineWith0Timeout) {
  using namespace castor::acs;
  Argcv *args = new Argcv();
  m_argsList.push_back(args);
  args->argc = 4;
...
TEST_F(castor_acs_AcsQueryVolumeCmdTest, parceCmdLineWithShortQuery) {
  using namespace castor::acs;
  Argcv *args = new Argcv();
  m_argsList.push_back(args);
  args->argc = 4;
...
TEST_F(castor_acs_AcsQueryVolumeCmdTest, parceCmdLineWithLongQuery) {
  using namespace castor::acs;
  Argcv *args = new Argcv();
  m_argsList.push_back(args);
  args->argc = 4;
...
TEST_F(castor_acs_AcsQueryVolumeCmdTest, parceCmdLineWith0Query) {
  using namespace castor::acs;
  Argcv *args = new Argcv();
  m_argsList.push_back(args);
  args->argc = 4;
