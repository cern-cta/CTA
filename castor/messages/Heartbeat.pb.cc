...
void Heartbeat::SharedCtor() {
  ...
  nbblocksmoved_ = GOOGLE_ULONGLONG(0);
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) return false
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      // required uint64 nbblocksmoved = 2;
      case 2: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
...
void Heartbeat::SerializeWithCachedSizes(
  ...
  // required uint64 nbblocksmoved = 2;
  if (_has_bit(1)) {
    ::google::protobuf::internal::WireFormatLite::WriteUInt64(2, this->nbblocksmoved(), output);
  }
...
::google::protobuf::uint8* Heartbeat::SerializeWithCachedSizesToArray(
  ...
  // required uint64 nbblocksmoved = 2;
  if (_has_bit(1)) {
    target = ::google::protobuf::internal::WireFormatLite::WriteUInt64ToArray(2, this->nbblocksmoved(), target);
  }
