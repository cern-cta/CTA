...
CREATE TABLE RepackSegment (fileid INTEGER, compression NUMBER, segsize INTEGER, filesec INTEGER, copyno NUMBER, id INTEGER PRIMARY KEY, vid INTEGER) INITRANS 50 PCTFREE 50;

/* SQL statements for type RepackRequest */
CREATE TABLE RepackRequest (machine VARCHAR2(2048), userName VARCHAR2(2048), creationTime NUMBER, serviceclass VARCHAR2(2048), pid INTEGER, command NUMBER, id INTEGER PRIMARY KEY) INITRANS 50 PCTFREE 50;

/*******************************************************************
 *
 * @(#)$RCSfile: castor_oracle_create.sql,v $ $Revision: 1.66 $ $Release$ $Date: 2006/08/02 14:46:47 $ $Author: gtaur $
 *
...
INSERT INTO CastorVersion VALUES ('2_0_3_0', '$Revision: 1.66 $ $Date: 2006/08/02 14:46:47 $');
