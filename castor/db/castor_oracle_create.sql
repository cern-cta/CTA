...
CREATE TABLE FileSystem (free INTEGER, weight float, fsDeviation float, mountPoint VARCHAR2(2048), deltaWeight float, deltaFree INTEGER, reservedSpace INTEGER, minFreeSpace float, minAllowedFreeSpace float, maxFreeSpace float, spaceToBeFreed INTEGER, totalSize INTEGER, id INTEGER PRIMARY KEY, diskPool INTEGER, diskserver INTEGER, status INTEGER) INITRANS 50 PCTFREE 50;
...
/*******************************************************************
 *
 * @(#)$RCSfile: castor_oracle_create.sql,v $ $Revision: 1.73 $ $Release$ $Date: 2007/01/11 10:08:31 $ $Author: itglp $
 *
...
INSERT INTO CastorVersion VALUES ('2_0_3_0', '$Revision: 1.73 $ $Date: 2007/01/11 10:08:31 $');
