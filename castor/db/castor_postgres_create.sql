...
CREATE TABLE GetUpdateDone (flags INT8, userName VARCHAR(2048), euid INT4, egid INT4, mask INT4, pid INT4, machine VARCHAR(2048), svcClassName VARCHAR(2048), userTag VARCHAR(2048), reqId VARCHAR(2048), creationTime INT8, lastModificationTime INT8, subReqId INT8, id INT8 PRIMARY KEY, svcClass INTEGER, client INTEGER);

/* SQL statements for type GetUpdateFailed */
CREATE TABLE GetUpdateFailed (flags INT8, userName VARCHAR(2048), euid INT4, egid INT4, mask INT4, pid INT4, machine VARCHAR(2048), svcClassName VARCHAR(2048), userTag VARCHAR(2048), reqId VARCHAR(2048), creationTime INT8, lastModificationTime INT8, subReqId INT8, id INT8 PRIMARY KEY, svcClass INTEGER, client INTEGER);

/* SQL statements for type PutFailed */
CREATE TABLE PutFailed (flags INT8, userName VARCHAR(2048), euid INT4, egid INT4, mask INT4, pid INT4, machine VARCHAR(2048), svcClassName VARCHAR(2048), userTag VARCHAR(2048), reqId VARCHAR(2048), creationTime INT8, lastModificationTime INT8, subReqId INT8, id INT8 PRIMARY KEY, svcClass INTEGER, client INTEGER);

/* SQL statements for type Files2Delete */
CREATE TABLE Files2Delete (flags INT8, userName VARCHAR(2048), euid INT4, egid INT4, mask INT4, pid INT4, machine VARCHAR(2048), svcClassName VARCHAR(2048), userTag VARCHAR(2048), reqId VARCHAR(2048), creationTime INT8, lastModificationTime INT8, diskServer VARCHAR(2048), id INT8 PRIMARY KEY, svcClass INTEGER, client INTEGER);

/* SQL statements for type FilesDeleted */
CREATE TABLE FilesDeleted (flags INT8, userName VARCHAR(2048), euid INT4, egid INT4, mask INT4, pid INT4, machine VARCHAR(2048), svcClassName VARCHAR(2048), userTag VARCHAR(2048), reqId VARCHAR(2048), creationTime INT8, lastModificationTime INT8, id INT8 PRIMARY KEY, svcClass INTEGER, client INTEGER);

/* SQL statements for type FilesDeletionFailed */
CREATE TABLE FilesDeletionFailed (flags INT8, userName VARCHAR(2048), euid INT4, egid INT4, mask INT4, pid INT4, machine VARCHAR(2048), svcClassName VARCHAR(2048), userTag VARCHAR(2048), reqId VARCHAR(2048), creationTime INT8, lastModificationTime INT8, id INT8 PRIMARY KEY, svcClass INTEGER, client INTEGER);

/* SQL statements for type GCFile */
CREATE TABLE GCFile (diskCopyId INT8, id INT8 PRIMARY KEY, request INTEGER);
...
CREATE TABLE QueryParameter (value VARCHAR(2048), id INT8 PRIMARY KEY, query INTEGER, queryType INTEGER);

/* SQL statements for type StagePrepareToGetRequest */
CREATE TABLE StagePrepareToGetRequest (flags INT8, userName VARCHAR(2048), euid INT4, egid INT4, mask INT4, pid INT4, machine VARCHAR(2048), svcClassName VARCHAR(2048), userTag VARCHAR(2048), reqId VARCHAR(2048), creationTime INT8, lastModificationTime INT8, id INT8 PRIMARY KEY, svcClass INTEGER, client INTEGER);

/* SQL statements for type StagePrepareToPutRequest */
CREATE TABLE StagePrepareToPutRequest (flags INT8, userName VARCHAR(2048), euid INT4, egid INT4, mask INT4, pid INT4, machine VARCHAR(2048), svcClassName VARCHAR(2048), userTag VARCHAR(2048), reqId VARCHAR(2048), creationTime INT8, lastModificationTime INT8, id INT8 PRIMARY KEY, svcClass INTEGER, client INTEGER);

/* SQL statements for type StagePrepareToUpdateRequest */
CREATE TABLE StagePrepareToUpdateRequest (flags INT8, userName VARCHAR(2048), euid INT4, egid INT4, mask INT4, pid INT4, machine VARCHAR(2048), svcClassName VARCHAR(2048), userTag VARCHAR(2048), reqId VARCHAR(2048), creationTime INT8, lastModificationTime INT8, id INT8 PRIMARY KEY, svcClass INTEGER, client INTEGER);

/* SQL statements for type StageGetRequest */
CREATE TABLE StageGetRequest (flags INT8, userName VARCHAR(2048), euid INT4, egid INT4, mask INT4, pid INT4, machine VARCHAR(2048), svcClassName VARCHAR(2048), userTag VARCHAR(2048), reqId VARCHAR(2048), creationTime INT8, lastModificationTime INT8, id INT8 PRIMARY KEY, svcClass INTEGER, client INTEGER);

/* SQL statements for type StagePutRequest */
CREATE TABLE StagePutRequest (flags INT8, userName VARCHAR(2048), euid INT4, egid INT4, mask INT4, pid INT4, machine VARCHAR(2048), svcClassName VARCHAR(2048), userTag VARCHAR(2048), reqId VARCHAR(2048), creationTime INT8, lastModificationTime INT8, id INT8 PRIMARY KEY, svcClass INTEGER, client INTEGER);

/* SQL statements for type StageUpdateRequest */
CREATE TABLE StageUpdateRequest (flags INT8, userName VARCHAR(2048), euid INT4, egid INT4, mask INT4, pid INT4, machine VARCHAR(2048), svcClassName VARCHAR(2048), userTag VARCHAR(2048), reqId VARCHAR(2048), creationTime INT8, lastModificationTime INT8, id INT8 PRIMARY KEY, svcClass INTEGER, client INTEGER);

/* SQL statements for type StageRmRequest */
CREATE TABLE StageRmRequest (flags INT8, userName VARCHAR(2048), euid INT4, egid INT4, mask INT4, pid INT4, machine VARCHAR(2048), svcClassName VARCHAR(2048), userTag VARCHAR(2048), reqId VARCHAR(2048), creationTime INT8, lastModificationTime INT8, id INT8 PRIMARY KEY, svcClass INTEGER, client INTEGER);

/* SQL statements for type StagePutDoneRequest */
CREATE TABLE StagePutDoneRequest (flags INT8, userName VARCHAR(2048), euid INT4, egid INT4, mask INT4, pid INT4, machine VARCHAR(2048), svcClassName VARCHAR(2048), userTag VARCHAR(2048), reqId VARCHAR(2048), creationTime INT8, lastModificationTime INT8, parentUuid VARCHAR(2048), id INT8 PRIMARY KEY, svcClass INTEGER, client INTEGER, parent INTEGER);

/* SQL statements for type StageFileQueryRequest */
CREATE TABLE StageFileQueryRequest (flags INT8, userName VARCHAR(2048), euid INT4, egid INT4, mask INT4, pid INT4, machine VARCHAR(2048), svcClassName VARCHAR(2048), userTag VARCHAR(2048), reqId VARCHAR(2048), creationTime INT8, lastModificationTime INT8, fileName VARCHAR(2048), id INT8 PRIMARY KEY, svcClass INTEGER, client INTEGER);

/* SQL statements for type StageRequestQueryRequest */
CREATE TABLE StageRequestQueryRequest (flags INT8, userName VARCHAR(2048), euid INT4, egid INT4, mask INT4, pid INT4, machine VARCHAR(2048), svcClassName VARCHAR(2048), userTag VARCHAR(2048), reqId VARCHAR(2048), creationTime INT8, lastModificationTime INT8, id INT8 PRIMARY KEY, svcClass INTEGER, client INTEGER);
...
CREATE TABLE Tape (vid VARCHAR(2048), side INT4, tpmode INT4, errMsgTxt VARCHAR(2048), errorCode INT4, severity INT4, vwAddress VARCHAR(2048), id INT8 PRIMARY KEY, stream INTEGER, status INTEGER);

/* SQL statements for type Segment */
CREATE TABLE Segment (fseq INT4, offset INT8, bytes_in INT8, bytes_out INT8, host_bytes INT8, segmCksumAlgorithm VARCHAR(2048), segmCksum INT4, errMsgTxt VARCHAR(2048), errorCode INT4, severity INT4, blockId0 INT4, blockId1 INT4, blockId2 INT4, blockId3 INT4, id INT8 PRIMARY KEY, tape INTEGER, copy INTEGER, status INTEGER);

/* SQL statements for type TapePool */
CREATE TABLE TapePool (name VARCHAR(2048), id INT8 PRIMARY KEY);
...
CREATE TABLE FileSystem (free INT8, weight float, fsDeviation float, mountPoint VARCHAR(2048), deltaWeight float, deltaFree INT4, reservedSpace INT4, minFreeSpace float, maxFreeSpace float, spaceToBeFreed INT8, totalSize INT8, id INT8 PRIMARY KEY, diskPool INTEGER, diskserver INTEGER, status INTEGER);
...
CREATE TABLE DiskPool (name VARCHAR(2048), id INT8 PRIMARY KEY);
...
CREATE TABLE Stream (initialSizeToTransfer INT8, id INT8 PRIMARY KEY, tape INTEGER, tapePool INTEGER, status INTEGER);
...
CREATE TABLE FileClass (name VARCHAR(2048), minFileSize INT8, maxFileSize INT8, nbCopies INT4, id INT8 PRIMARY KEY);
...
CREATE TABLE TapeServer (serverName VARCHAR(2048), id INT8 PRIMARY KEY, actingMode INTEGER);

/* SQL statements for type TapeRequest */
CREATE TABLE TapeRequest (priority INT4, modificationTime INT8, creationTime INT8, id INT8 PRIMARY KEY, tape INTEGER, tapeAccessSpecification INTEGER, requestedSrv INTEGER, tapeDrive INTEGER, deviceGroupName INTEGER, client INTEGER);

/* SQL statements for type TapeDrive */
CREATE TABLE TapeDrive (jobID INT4, modificationTime INT8, resettime INT8, usecount INT4, errcount INT4, transferredMB INT4, totalMB INT8, driveName VARCHAR(2048), tapeAccessMode INT4, id INT8 PRIMARY KEY, tape INTEGER, runningTapeReq INTEGER, deviceGroupName INTEGER, status INTEGER, tapeServer INTEGER);
...
CREATE TABLE ErrorHistory (errorMessage VARCHAR(2048), timeStamp INT8, id INT8 PRIMARY KEY, tapeDrive INTEGER, tape INTEGER);

/* SQL statements for type TapeDriveDedication */
CREATE TABLE TapeDriveDedication (clientHost VARCHAR(2048), euid INT4, egid INT4, vid VARCHAR(2048), accessMode INT4, startTime INT8, endTime INT8, reason VARCHAR(2048), id INT8 PRIMARY KEY, tapeDrive INTEGER);
...
INSERT INTO CastorVersion VALUES ('2_0_1_1');
...
/* A little function base index to speed up subrequestToDo -- not supported in PostgreSQL */
...
CREATE OR REPLACE FUNCTION getTime RETURN INT8 IS
  ret INT8;
BEGIN
...
/* This table keeps track of the INT8 of TapeCopy to migrate
 ...
 * of the INT8 of triggers ensuring consistency of the whole database */
DROP TABLE NbTapeCopiesInFS;
CREATE TABLE NbTapeCopiesInFS (FS INT8, Stream INT8, NbTapeCopies INT8);
...
CREATE OR REPLACE PROCEDURE makeSubRequestWait(subreqId IN INT4, dci IN INT4) AS
BEGIN
 UPDATE SubRequest
...
CREATE OR REPLACE PROCEDURE archiveSubReq(srId IN INT4) AS
  rid INT4;
  rtype INT4;
  rclient INT4;
  nb INT4;
 ...
 *   AND ROWNUM < 2;  */
CREATE OR REPLACE PROCEDURE anyTapeCopyForStream(streamId IN INT4, res OUT INT4) AS
  unused INT4;
BEGIN
...
(ds IN INT4, fs IN INT4,
 deviation IN INT4, fileSize IN INT4) AS
BEGIN
...
(fs IN INT4, reservation IN INT4, fileSize IN INT4) AS
BEGIN
...
CREATE TABLE LockTable (DiskServerId INT8 PRIMARY KEY, TheLock INT8);
...
CREATE OR REPLACE PROCEDURE bestTapeCopyForStream(streamId IN INT4,
                                                  diskServerName OUT VARCHAR, mountPoint OUT VARCHAR,
                                                  path OUT VARCHAR, dci OUT INT4,
                                                  castorFileId OUT INT4, fileId OUT INT4,
                                                  nsHost OUT VARCHAR, fileSize OUT INT4,
                                                  tapeCopyId OUT INT4) AS
 fileSystemId INT4;
 dsid INT8;
 deviation INT8;
 fsDiskServer INT8;
...
CREATE OR REPLACE PROCEDURE bestFileSystemForSegment(segmentId IN INT4, diskServerName OUT VARCHAR,
...
CREATE OR REPLACE PROCEDURE fileRecalled(tapecopyId IN INT4) AS
  SubRequestId INT8;
  dci INT8;
  fsId INT8;
  fileSize INT8;
...
CREATE OR REPLACE PROCEDURE fileRecallFailed(tapecopyId IN INT4) AS
 SubRequestId INT8;
 dci INT8;
 fsId INT8;
 fileSize INT8;
...
CREATE OR REPLACE PACKAGE castor AS
  ...
  TYPE "strList" IS TABLE OF VARCHAR(2048) index by binary_INT4;
  TYPE "cnumList" IS TABLE OF INT8 index by binary_INT4;
  TYPE QueryLine IS RECORD (
        fileid INT4,
        nshost VARCHAR(2048),
        diskCopyId INT4,
        diskCopyPath VARCHAR(2048),
        filesize INT4,
        diskCopyStatus INT4,
        tapeStatus INT4,
        segmentStatus INT4,
...
CREATE OR REPLACE PROCEDURE buildPathFromFileId(fid IN INT4,
                                                nsHost IN VARCHAR,
                                                dcid IN INT4,
                                                path OUT VARCHAR) AS
BEGIN
...
CREATE OR REPLACE PROCEDURE getUpdateStart
        (srId IN INT4, fileSystemId IN INT4,
         dci OUT INT4, rpath OUT VARCHAR,
         rstatus OUT INT8, sources OUT castor.DiskCopy_Cur,
         reuid OUT INT4, regid OUT INT4) AS
  cfid INT4;
  fid INT4;
  nh VARCHAR(2048);
  unused CastorFile%ROWTYPE;
...
CREATE OR REPLACE PROCEDURE putStart
        (srId IN INT4, fileSystemId IN INT4,
         rdcId OUT INT4, rdcStatus OUT INT4,
...
CREATE OR REPLACE PROCEDURE putDoneStartProc
        (srId IN INT4, dcId OUT INT4,
         dcStatus OUT INT4, dcPath OUT VARCHAR) AS
  reqId INT8;
  cfId INT8;
  ty INT8;
BEGIN
...
CREATE OR REPLACE PROCEDURE updateAndCheckSubRequest(srId IN INT4, newStatus IN INT4, result OUT INT4) AS
  reqId INT4;
BEGIN
...
(dcId IN INT4, dcStatus IN INT4) AS
BEGIN
  -- update DiskCopy
...
CREATE OR REPLACE PROCEDURE recreateCastorFile(cfId IN INT4,
                                               srId IN INT4,
                                               dcId OUT INT4,
                                               rstatus OUT INT4,
                                               rmountPoint OUT VARCHAR,
...
CREATE OR REPLACE PROCEDURE putDoneFunc (cfId IN INT4,
                                         fs IN INT4,
					 context IN INT4) AS
  nc INT4;
  tcId INT4;
  fsId INT4;
BEGIN
 -- get INT8 of TapeCopies to create
...
CREATE OR REPLACE PROCEDURE prepareForMigration (srId IN INT4,
                                                 fs IN INT4,
                                                 fId OUT INT8,
                                                 nh OUT VARCHAR,
                                                 userId OUT INT4,
...
CREATE OR REPLACE PROCEDURE selectCastorFile (fId IN INT4,
                                              nh IN VARCHAR,
                                              sc IN INT4,
                                              fc IN INT4,
                                              fs IN INT4,
...
CREATE OR REPLACE PROCEDURE resetStream (sid IN INT4) AS
  nbRes INT8;
  unused Stream%ROWTYPE;
BEGIN
  BEGIN
...
(fileSystems IN castor."strList", machines IN castor."strList",
 minFree IN castor."cnumList", rMountPoint OUT VARCHAR,
 rDiskServer OUT VARCHAR) AS
 ds INT8;
 fs INT8;
 dev INT8;
 TYPE cursorContent IS RECORD
   (mountPoint VARCHAR(2048), dsName VARCHAR(2048),
    dsId INT8, fsId INT8, deviation INT8);
...
(tapeId IN INT4, segments OUT castor.Segment_Cur) AS
  segs "numList";
BEGIN
...
CREATE OR REPLACE PROCEDURE putFailedProc(srId IN INT8) AS
  dcId INT4;
  fsId INT4;
  cfId INT4;
  unused INT4;
...
CREATE OR REPLACE PROCEDURE stageRelease (fid IN INT4,
                                          nh IN VARCHAR,
                                          ret OUT INT4) AS
  cfId INT4;
  nbRes INT4;
...
CREATE OR REPLACE PROCEDURE stageRm (fid IN INT4,
                                     nh IN VARCHAR,
                                     ret OUT INT4) AS
  cfId INT4;
  nbRes INT4;
...
CREATE OR REPLACE PACKAGE castorGC AS
  TYPE GCItem IS RECORD (dcId INT4, fileSize INT8, utility INT8);
  ...
  TYPE policiesList IS TABLE OF VARCHAR(2048);
END castorGC;
 ...
 * the INT8 of accesses to the file. Namely we garbage
 ...
 */
CREATE OR REPLACE PROCEDURE garbageCollectFS(fsId INT4) AS
  toBeFreed INT4;
  freed INT4 := 0;
  dpID INT4;
