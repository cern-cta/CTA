...
CREATE TABLE RepackSubRequest (vid VARCHAR(2048), xsize INT8, status INT4, cuuid VARCHAR(2048), filesMigrating INT4, filesStaging INT4, files INT4, filesFailed INT4, id INT8 PRIMARY KEY, requestID INTEGER);

/* SQL statements for type RepackSegment */
CREATE TABLE RepackSegment (fileid INT8, compression INT4, segsize INT8, filesec INT8, copyno INT4, id INT8 PRIMARY KEY, vid INTEGER);

/* SQL statements for type RepackRequest */
CREATE TABLE RepackRequest (machine VARCHAR(2048), userName VARCHAR(2048), creationTime INT4, serviceclass VARCHAR(2048), pid INT8, command INT4, id INT8 PRIMARY KEY);
