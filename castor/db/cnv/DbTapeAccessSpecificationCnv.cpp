...
const std::string castor::db::cnv::DbTapeAccessSpecificationCnv::s_bulkInsertStatementString =
"INSERT /* bulk */ INTO TapeAccessSpecification (accessMode, density, tapeModel, id) VALUES (:1,:2,:3,ids_seq.nextval) RETURNING id INTO :4";
...
"DECLARE \
   TYPE RecordType IS RECORD (accessMode NUMBER, density VARCHAR2(2048), tapeModel VARCHAR2(2048), id INTEGER); \
...
const std::string castor::db::cnv::DbTapeAccessSpecificationCnv::s_storeTypeBulkStatementString =
