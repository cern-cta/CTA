...
namespace castor {
  ...
  namespace db {
    ...
    namespace cnv {
      ...
      /**
       * class DbVolumePriorityCnv
       * A converter for storing/retrieving VolumePriority into/from a generic database
       */
      class DbVolumePriorityCnv : public DbBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        DbVolumePriorityCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~DbVolumePriorityCnv() throw();
      ...
      }; // end of class DbVolumePriorityCnv
