...
namespace castor {
  ...
  namespace db {
    ...
    namespace cnv {
      ...
      /**
       * class DbStagePrepareToPutRequestCnv
       * A converter for storing/retrieving StagePrepareToPutRequest into/from a generic
       */
      class DbStagePrepareToPutRequestCnv : public DbBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        DbStagePrepareToPutRequestCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~DbStagePrepareToPutRequestCnv() throw();
      ...
      }; // end of class DbStagePrepareToPutRequestCnv
