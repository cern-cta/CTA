...
const std::string castor::db::cnv::DbTapeRequestCnv::s_bulkInsertStatementString =
"INSERT /* bulk */ INTO TapeRequest (priority, modificationTime, creationTime, errorCode, errorMessage, remoteCopyType, id, tape, tapeAccessSpecification, requestedSrv, tapeDrive, deviceGroupName, status, client) VALUES (:1,:2,:3,:4,:5,:6,ids_seq.nextval,:7,:8,:9,:10,:11,:12,:13) RETURNING id INTO :14";
...
const std::string castor::db::cnv::DbTapeRequestCnv::s_storeTypeBulkStatementString =
