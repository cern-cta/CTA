...
/******************************************************************************
 *                      castor/db/cnv/DbStageReleaseFilesRequestCnv.hpp
 *
...
#ifndef CASTOR_DB_CNV_STAGERELEASEFILESREQUEST_HPP
#define CASTOR_DB_CNV_STAGERELEASEFILESREQUEST_HPP
...
namespace castor {
  ...
  namespace db {
    ...
    namespace cnv {
      ...
      /**
       * class DbStageReleaseFilesRequestCnv
       * A converter for storing/retrieving StageReleaseFilesRequest into/from a generic
       */
      class DbStageReleaseFilesRequestCnv : public DbBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        DbStageReleaseFilesRequestCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~DbStageReleaseFilesRequestCnv() throw();
      ...
      }; // end of class DbStageReleaseFilesRequestCnv
...
#endif // CASTOR_DB_CNV_STAGERELEASEFILESREQUEST_HPP
