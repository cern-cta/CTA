...
/******************************************************************************
 *                      castor/db/cnv/DbStageRepackRequestCnv.hpp
 *
...
#ifndef CASTOR_DB_CNV_STAGEREPACKREQUEST_HPP
#define CASTOR_DB_CNV_STAGEREPACKREQUEST_HPP
...
namespace castor {
  ...
  namespace db {
    ...
    namespace cnv {
      ...
      /**
       * class DbStageRepackRequestCnv
       * A converter for storing/retrieving StageRepackRequest into/from a generic
       * database
       */
      class DbStageRepackRequestCnv : public DbBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        DbStageRepackRequestCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~DbStageRepackRequestCnv() throw();
      ...
      }; // end of class DbStageRepackRequestCnv
...
#endif // CASTOR_DB_CNV_STAGEREPACKREQUEST_HPP
