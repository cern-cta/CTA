...
/******************************************************************************
 *                      castor/db/cnv/DbTapeRequestStateCnv.hpp
 *
...
#ifndef CASTOR_DB_CNV_TAPEREQUESTSTATE_HPP
#define CASTOR_DB_CNV_TAPEREQUESTSTATE_HPP
...
namespace castor {
  ...
  namespace db {
    ...
    namespace cnv {
      ...
      /**
       * class DbTapeRequestStateCnv
       * A converter for storing/retrieving TapeRequestState into/from a generic
       * database
       */
      class DbTapeRequestStateCnv : public DbBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        DbTapeRequestStateCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~DbTapeRequestStateCnv() throw();
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillRepStream(castor::tape::tapegateway::TapeRequestState* obj)
          throw (castor::exception::Exception);
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillRepTape(castor::tape::tapegateway::TapeRequestState* obj)
          throw (castor::exception::Exception);
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillObjStream(castor::tape::tapegateway::TapeRequestState* obj)
          throw (castor::exception::Exception);
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillObjTape(castor::tape::tapegateway::TapeRequestState* obj)
          throw (castor::exception::Exception);
      ...
      }; // end of class DbTapeRequestStateCnv
...
#endif // CASTOR_DB_CNV_TAPEREQUESTSTATE_HPP
