...
namespace castor {
  ...
  namespace db {
    ...
    namespace cnv {
      ...
      /**
       * class DbSvcClassCnv
       * A converter for storing/retrieving SvcClass into/from a generic database
       */
      class DbSvcClassCnv : public DbBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        DbSvcClassCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~DbSvcClassCnv() throw();
