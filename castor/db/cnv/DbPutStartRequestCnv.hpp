...
namespace castor {
  ...
  namespace db {
    ...
    namespace cnv {
      ...
      /**
       * class DbPutStartRequestCnv
       * A converter for storing/retrieving PutStartRequest into/from a generic database
       */
      class DbPutStartRequestCnv : public DbBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        DbPutStartRequestCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~DbPutStartRequestCnv() throw();
      ...
      }; // end of class DbPutStartRequestCnv
