...
/******************************************************************************
 *                      castor/db/cnv/DbFileSystemCnv.hpp
 *
...
#ifndef CASTOR_DB_CNV_FILESYSTEM_HPP
#define CASTOR_DB_CNV_FILESYSTEM_HPP
...
namespace castor {
  ...
  namespace db {
    ...
    namespace cnv {
      ...
      /**
       * class DbFileSystemCnv
       * A converter for storing/retrieving FileSystem into/from a generic database
       */
      class DbFileSystemCnv : public DbBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        DbFileSystemCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~DbFileSystemCnv() throw();
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillObjDiskCopy(castor::stager::FileSystem* obj)
          throw (castor::exception::Exception);

        /**
         * Retrieve from the database objects of type DiskServer refered by a given object.
         * @param obj the original object
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillObjDiskServer(castor::stager::FileSystem* obj)
          throw (castor::exception::Exception);
      ...
      private:
        ...
        castor::db::IDbStatement *m_checkDiskPoolExistStatement;
        ...
        castor::db::IDbStatement *m_updateDiskPoolStatement;
        ...
        castor::db::IDbStatement *m_checkDiskServerExistStatement;
        ...
        castor::db::IDbStatement *m_updateDiskServerStatement;

      }; // end of class DbFileSystemCnv
...
#endif // CASTOR_DB_CNV_FILESYSTEM_HPP
