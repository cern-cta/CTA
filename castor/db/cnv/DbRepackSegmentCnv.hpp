...
<<<<<<< DbRepackSegmentCnv.hpp
/******************************************************************************
 *                      castor/db/cnv/DbRepackSegmentCnv.hpp
 *
...
=======
>>>>>>> 1.4.4.1
#ifndef CASTOR_DB_CNV_REPACKSEGMENT_HPP
#define CASTOR_DB_CNV_REPACKSEGMENT_HPP
...
namespace castor {
  ...
  namespace db {
    ...
    namespace cnv {
      ...
      /**
       * class DbRepackSegmentCnv
       * A converter for storing/retrieving RepackSegment into/from a generic database
       */
      class DbRepackSegmentCnv : public DbBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        DbRepackSegmentCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~DbRepackSegmentCnv() throw();
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillRepRepackSubRequest(castor::repack::RepackSegment* obj)
          throw (castor::exception::Exception);
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillObjRepackSubRequest(castor::repack::RepackSegment* obj)
          throw (castor::exception::Exception);
      ...
      private:
        ...
        /// SQL checkExist statement for member vid
        static const std::string s_checkRepackSubRequestExistStatementString;

        /// SQL checkExist statement object for member vid
        ...
        /// SQL update statement object for member vid
...
#endif // CASTOR_DB_CNV_REPACKSEGMENT_HPP
