...
namespace castor {
  ...
  namespace db {
    ...
    namespace cnv {
      ...
      /**
       * class DbNsFileIdCnv
       * A converter for storing/retrieving NsFileId into/from a generic database
       */
      class DbNsFileIdCnv : public DbBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        DbNsFileIdCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~DbNsFileIdCnv() throw();
      ...
      private:
        ...
        static const std::string s_checkStageAbortRequestExistStatementString;

        /// SQL checkExist statement object for member request
        castor::db::IDbStatement *m_checkStageAbortRequestExistStatement;

        /// SQL update statement for member request
        static const std::string s_updateStageAbortRequestStatementString;

        /// SQL update statement object for member request
        castor::db::IDbStatement *m_updateStageAbortRequestStatement;

      }; // end of class DbNsFileIdCnv
