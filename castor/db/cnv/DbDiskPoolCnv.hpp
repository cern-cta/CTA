...
/******************************************************************************
 *                      castor/db/cnv/DbDiskPoolCnv.hpp
 *
...
#ifndef CASTOR_DB_CNV_DISKPOOL_HPP
#define CASTOR_DB_CNV_DISKPOOL_HPP
...
namespace castor {
  ...
  namespace db {
    ...
    namespace cnv {
      ...
      /**
       * class DbDiskPoolCnv
       * A converter for storing/retrieving DiskPool into/from a generic database
       */
      class DbDiskPoolCnv : public DbBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        DbDiskPoolCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~DbDiskPoolCnv() throw();
...
#endif // CASTOR_DB_CNV_DISKPOOL_HPP
