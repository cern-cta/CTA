...
/******************************************************************************
 *                      castor/db/cnv/DbGetUpdateFailedCnv.hpp
 *
...
#ifndef CASTOR_DB_CNV_GETUPDATEFAILED_HPP
#define CASTOR_DB_CNV_GETUPDATEFAILED_HPP
...
namespace castor {
  ...
  namespace db {
    ...
    namespace cnv {
      ...
      /**
       * class DbGetUpdateFailedCnv
       * A converter for storing/retrieving GetUpdateFailed into/from a generic database
       */
      class DbGetUpdateFailedCnv : public DbBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        DbGetUpdateFailedCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~DbGetUpdateFailedCnv() throw();
      ...
      }; // end of class DbGetUpdateFailedCnv
...
#endif // CASTOR_DB_CNV_GETUPDATEFAILED_HPP
