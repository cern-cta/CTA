...
namespace castor {
  ...
  namespace db {
    ...
    namespace cnv {
      ...
      /**
       * class DbSetFileGCWeightCnv
       * A converter for storing/retrieving SetFileGCWeight into/from a generic database
       */
      class DbSetFileGCWeightCnv : public DbBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        DbSetFileGCWeightCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~DbSetFileGCWeightCnv() throw();
      ...
      }; // end of class DbSetFileGCWeightCnv
