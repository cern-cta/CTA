...
namespace castor {
  ...
  namespace db {
    ...
    namespace cnv {
      ...
      /**
       * class DbRequestTypeCnv
       * A converter for storing/retrieving RequestType into/from a generic database
       */
      class DbRequestTypeCnv : public DbBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        DbRequestTypeCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~DbRequestTypeCnv() throw();
