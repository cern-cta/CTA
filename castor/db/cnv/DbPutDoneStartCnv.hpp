...
/******************************************************************************
 *                      castor/db/cnv/DbPutDoneStartCnv.hpp
 *
...
#ifndef CASTOR_DB_CNV_PUTDONESTART_HPP
#define CASTOR_DB_CNV_PUTDONESTART_HPP
...
namespace castor {
  ...
  namespace db {
    ...
    namespace cnv {
      ...
      /**
       * class DbPutDoneStartCnv
       * A converter for storing/retrieving PutDoneStart into/from a generic database
       */
      class DbPutDoneStartCnv : public DbBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        DbPutDoneStartCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~DbPutDoneStartCnv() throw();
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillRepSvcClass(castor::stager::PutDoneStart* obj)
          throw (castor::exception::Exception);
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillRepIClient(castor::stager::PutDoneStart* obj)
          throw (castor::exception::Exception);
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillObjSvcClass(castor::stager::PutDoneStart* obj)
          throw (castor::exception::Exception);
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillObjIClient(castor::stager::PutDoneStart* obj)
          throw (castor::exception::Exception);
      ...
      }; // end of class DbPutDoneStartCnv
...
#endif // CASTOR_DB_CNV_PUTDONESTART_HPP
