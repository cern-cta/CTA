...
namespace castor {
  ...
  namespace db {
    ...
    namespace cnv {
      ...
      /**
       * class DbTape2DriveDedicationCnv
       * A converter for storing/retrieving Tape2DriveDedication into/from a generic
       * database
       */
      class DbTape2DriveDedicationCnv : public DbBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        DbTape2DriveDedicationCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~DbTape2DriveDedicationCnv() throw();
      ...
      }; // end of class DbTape2DriveDedicationCnv
