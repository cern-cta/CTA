...
namespace castor {
  ...
  namespace db {
    ...
    namespace cnv {
      ...
      /**
       * class DbSubRequestCnv
       * A converter for storing/retrieving SubRequest into/from a generic database
       */
      class DbSubRequestCnv : public DbBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        DbSubRequestCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~DbSubRequestCnv() throw();
      ...
      private:
        ...
        castor::db::IDbStatement *m_checkCastorFileExistStatement;
        ...
        castor::db::IDbStatement *m_updateFileRequestStatement;

      }; // end of class DbSubRequestCnv
