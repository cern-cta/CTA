...
void castor::db::cnv::DbStageDiskCopyReplicaRequestCnv::bulkCreateRep(castor::IAddress* address,
  ...
  try {
    ...
    free(clientBuffer);
    free(clientBufLens);
    // release the buffers for sourceSvcClass
    free(sourceSvcClassBuffer);
    free(sourceSvcClassBufLens);
    // release the buffers for destDiskCopy
    free(destDiskCopyBuffer);
    free(destDiskCopyBufLens);
    // release the buffers for sourceDiskCopy
    free(sourceDiskCopyBuffer);
    free(sourceDiskCopyBufLens);
