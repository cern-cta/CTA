...
namespace castor {
  ...
  namespace db {
    ...
    namespace cnv {
      ...
      /**
       * class DbStageFileQueryRequestCnv
       * A converter for storing/retrieving StageFileQueryRequest into/from a generic
       */
      class DbStageFileQueryRequestCnv : public DbBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        DbStageFileQueryRequestCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~DbStageFileQueryRequestCnv() throw();
      ...
      }; // end of class DbStageFileQueryRequestCnv
