...
// bulkCreateRep
//------------------------------------------------------------------------------
void castor::db::cnv::DbGCFileCnv::bulkCreateRep(castor::IAddress* address,
  ...
  try {
    ...
    m_insertStatement->setDataBuffer
      (1, diskCopyIdBuffer, DBTYPE_UINT64, sizeof(diskCopyIdBuffer[0]), diskCopyIdBufLens);
    ...
    m_insertStatement->setDataBuffer
      (2, requestBuffer, DBTYPE_UINT64, sizeof(requestBuffer[0]), requestBufLens);
    ...
    // release the buffers for request
    free(requestBuffer);
    free(requestBufLens);
