...
const castor::ICnvFactory& DbGCFileCnvFactory = 
  s_factoryDbGCFileCnv;
...
void castor::db::cnv::DbGCFileCnv::fillRepGCFileList(castor::stager::GCFile* obj)
  ...
  // Update local object
  m_updateGCFileListStatement->setInt64(1, 0 == obj->request() ? 0 : obj->request()->id());
  m_updateGCFileListStatement->setInt64(2, obj->id());
...
void castor::db::cnv::DbGCFileCnv::createRep(castor::IAddress* address,
  ...
  try {
    ...
    m_insertStatement->setInt64(1, obj->diskCopyId());
    m_insertStatement->setInt64(2, (type == OBJ_GCFileList && obj->request() != 0) ? obj->request()->id() : 0);
...
void castor::db::cnv::DbGCFileCnv::updateRep(castor::IAddress* address,
  ...
  try {
    ...
    m_updateStatement->setInt64(1, obj->diskCopyId());
...
castor::IObject* castor::db::cnv::DbGCFileCnv::createObj(castor::IAddress* address)
  ...
  try {
    ...
    object->setDiskCopyId(rset->getInt64(1));
