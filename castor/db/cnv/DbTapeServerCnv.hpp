...
namespace castor {
  ...
  namespace db {
    ...
    namespace cnv {
      ...
      /**
       * class DbTapeServerCnv
       * A converter for storing/retrieving TapeServer into/from a generic database
       */
      class DbTapeServerCnv : public DbBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        DbTapeServerCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~DbTapeServerCnv() throw();
