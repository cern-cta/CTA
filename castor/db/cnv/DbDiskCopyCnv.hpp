...
/******************************************************************************
 *                      castor/db/cnv/DbDiskCopyCnv.hpp
 *
...
#ifndef CASTOR_DB_CNV_DISKCOPY_HPP
#define CASTOR_DB_CNV_DISKCOPY_HPP
...
namespace castor {
  ...
  namespace db {
    ...
    namespace cnv {
      ...
      /**
       * class DbDiskCopyCnv
       * A converter for storing/retrieving DiskCopy into/from a generic database
       */
      class DbDiskCopyCnv : public DbBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        DbDiskCopyCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~DbDiskCopyCnv() throw();
