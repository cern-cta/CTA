...
const castor::ICnvFactory& DbMoverCloseRequestCnvFactory = 
  s_factoryDbMoverCloseRequestCnv;
...
void castor::db::cnv::DbMoverCloseRequestCnv::createRep(castor::IAddress* address,
  ...
  try {
    ...
    m_insertStatement->setInt64(14, obj->fileSize());
...
void castor::db::cnv::DbMoverCloseRequestCnv::updateRep(castor::IAddress* address,
  ...
  try {
    ...
    m_updateStatement->setInt64(13, obj->fileSize());
...
castor::IObject* castor::db::cnv::DbMoverCloseRequestCnv::createObj(castor::IAddress* address)
  ...
  try {
    ...
    object->setFileSize(rset->getInt64(14));
