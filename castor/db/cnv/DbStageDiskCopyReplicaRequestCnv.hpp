...
/******************************************************************************
 *                      castor/db/cnv/DbStageDiskCopyReplicaRequestCnv.hpp
 *
...
#ifndef CASTOR_DB_CNV_STAGEDISKCOPYREPLICAREQUEST_HPP
#define CASTOR_DB_CNV_STAGEDISKCOPYREPLICAREQUEST_HPP
...
namespace castor {
  ...
  namespace db {
    ...
    namespace cnv {
      ...
      /**
       * class DbStageDiskCopyReplicaRequestCnv
       * A converter for storing/retrieving StageDiskCopyReplicaRequest into/from a
       * generic database
       */
      class DbStageDiskCopyReplicaRequestCnv : public DbBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        DbStageDiskCopyReplicaRequestCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~DbStageDiskCopyReplicaRequestCnv() throw();
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillRepSubRequest(castor::stager::StageDiskCopyReplicaRequest* obj)
          throw (castor::exception::Exception);
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillRepIClient(castor::stager::StageDiskCopyReplicaRequest* obj)
          throw (castor::exception::Exception);
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillObjSubRequest(castor::stager::StageDiskCopyReplicaRequest* obj)
          throw (castor::exception::Exception);
...
#endif // CASTOR_DB_CNV_STAGEDISKCOPYREPLICAREQUEST_HPP
