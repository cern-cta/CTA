...
"DECLARE \
   TYPE CurType IS REF CURSOR RETURN BaseAddress%ROWTYPE; \
...
// bulkCreateRep
//------------------------------------------------------------------------------
void castor::db::cnv::DbBaseAddressCnv::bulkCreateRep(castor::IAddress* address,
  ...
  try {
    ...
    m_insertStatement->setDataBuffer
      (1, objTypeBuffer, DBTYPE_INT, sizeof(objTypeBuffer[0]), objTypeBufLens);
    ...
    m_insertStatement->setDataBuffer
      (2, cnvSvcNameBuffer, DBTYPE_STRING, cnvSvcNameMaxLen, cnvSvcNameBufLens);
    ...
    m_insertStatement->setDataBuffer
      (3, cnvSvcTypeBuffer, DBTYPE_INT, sizeof(cnvSvcTypeBuffer[0]), cnvSvcTypeBufLens);
    ...
    m_insertStatement->setDataBuffer
      (4, targetBuffer, DBTYPE_UINT64, sizeof(targetBuffer[0]), targetBufLens);
    ...
    // release the buffers for objType
    free(objTypeBuffer);
    free(objTypeBufLens);
    // release the buffers for cnvSvcName
    free(cnvSvcNameBuffer);
    free(cnvSvcNameBufLens);
    // release the buffers for cnvSvcType
    free(cnvSvcTypeBuffer);
    free(cnvSvcTypeBufLens);
    // release the buffers for target
    free(targetBuffer);
    free(targetBufLens);
