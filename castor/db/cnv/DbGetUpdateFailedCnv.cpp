...
void castor::db::cnv::DbGetUpdateFailedCnv::bulkCreateRep(castor::IAddress* address,
  ...
  try {
    ...
    m_insertStatement->setDataBuffer
      (13, subReqIdBuffer, DBTYPE_UINT64, sizeof(subReqIdBuffer[0]), subReqIdBufLens);
    ...
    m_insertStatement->setDataBuffer
      (14, fileIdBuffer, DBTYPE_UINT64, sizeof(fileIdBuffer[0]), fileIdBufLens);
    ...
    m_insertStatement->setDataBuffer
      (15, nsHostBuffer, DBTYPE_STRING, nsHostMaxLen, nsHostBufLens);
