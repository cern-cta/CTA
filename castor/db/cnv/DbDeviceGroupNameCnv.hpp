...
/******************************************************************************
 *                      castor/db/cnv/DbDeviceGroupNameCnv.hpp
 *
...
#ifndef CASTOR_DB_CNV_DEVICEGROUPNAME_HPP
#define CASTOR_DB_CNV_DEVICEGROUPNAME_HPP
...
namespace castor {
  ...
  namespace db {
    ...
    namespace cnv {
      ...
      /**
       * class DbDeviceGroupNameCnv
       * A converter for storing/retrieving DeviceGroupName into/from a generic database
       */
      class DbDeviceGroupNameCnv : public DbBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        DbDeviceGroupNameCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~DbDeviceGroupNameCnv() throw();
