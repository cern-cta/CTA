...
/******************************************************************************
 *                      castor/db/cnv/DbFiles2DeleteCnv.hpp
 *
...
namespace castor {
  ...
  namespace db {
    ...
    namespace cnv {
      ...
      /**
       * class DbFiles2DeleteCnv
       * A converter for storing/retrieving Files2Delete into/from a generic database
       */
      class DbFiles2DeleteCnv : public DbBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        DbFiles2DeleteCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~DbFiles2DeleteCnv() throw();
      ...
      }; // end of class DbFiles2DeleteCnv
