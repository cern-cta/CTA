...
// bulkCreateRep
//------------------------------------------------------------------------------
void castor::db::cnv::DbDiskPoolQueryCnv::bulkCreateRep(castor::IAddress* address,
  ...
  try {
    ...
    // release the buffers for diskPoolName
    free(diskPoolNameBuffer);
    free(diskPoolNameBufLens);
