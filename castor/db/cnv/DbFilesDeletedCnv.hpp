...
/******************************************************************************
 *                      castor/db/cnv/DbFilesDeletedCnv.hpp
 *
...
#ifndef CASTOR_DB_CNV_FILESDELETED_HPP
#define CASTOR_DB_CNV_FILESDELETED_HPP
...
namespace castor {
  ...
  namespace db {
    ...
    namespace cnv {
      ...
      /**
       * class DbFilesDeletedCnv
       * A converter for storing/retrieving FilesDeleted into/from a generic database
       */
      class DbFilesDeletedCnv : public DbBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        DbFilesDeletedCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~DbFilesDeletedCnv() throw();
      ...
      }; // end of class DbFilesDeletedCnv
...
#endif // CASTOR_DB_CNV_FILESDELETED_HPP
