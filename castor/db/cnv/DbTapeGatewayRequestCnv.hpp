...
/******************************************************************************
 *                      castor/db/cnv/DbTapeGatewayRequestCnv.hpp
 *
...
#ifndef CASTOR_DB_CNV_TAPEGATEWAYREQUEST_HPP
#define CASTOR_DB_CNV_TAPEGATEWAYREQUEST_HPP
...
namespace castor {
  ...
  namespace db {
    ...
    namespace cnv {
      ...
      /**
       * class DbTapeGatewayRequestCnv
       * A converter for storing/retrieving TapeGatewayRequest into/from a generic
       * database
       */
      class DbTapeGatewayRequestCnv : public DbBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        DbTapeGatewayRequestCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~DbTapeGatewayRequestCnv() throw();
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillRepStream(castor::tape::tapegateway::TapeGatewayRequest* obj)
          throw (castor::exception::Exception);
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillRepTape(castor::tape::tapegateway::TapeGatewayRequest* obj)
          throw (castor::exception::Exception);
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillObjStream(castor::tape::tapegateway::TapeGatewayRequest* obj)
          throw (castor::exception::Exception);
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillObjTape(castor::tape::tapegateway::TapeGatewayRequest* obj)
          throw (castor::exception::Exception);
      ...
      private:
        ...
        /// SQL checkExist statement for member streamMigration
        static const std::string s_checkStreamExistStatementString;

        /// SQL checkExist statement object for member streamMigration
        ...
        /// SQL update statement object for member streamMigration
        castor::db::IDbStatement *m_updateStreamStatement;

        /// SQL checkExist statement for member tapeRecall
        static const std::string s_checkTapeExistStatementString;

        /// SQL checkExist statement object for member tapeRecall
        ...
        /// SQL update statement object for member tapeRecall
        castor::db::IDbStatement *m_updateTapeStatement;

      }; // end of class DbTapeGatewayRequestCnv
...
#endif // CASTOR_DB_CNV_TAPEGATEWAYREQUEST_HPP
