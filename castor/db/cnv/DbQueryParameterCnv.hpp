...
namespace castor {
  ...
  namespace db {
    ...
    namespace cnv {
      ...
      /**
       * class DbQueryParameterCnv
       * A converter for storing/retrieving QueryParameter into/from a generic database
       */
      class DbQueryParameterCnv : public DbBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        DbQueryParameterCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~DbQueryParameterCnv() throw();
      ...
      private:
        ...
        castor::db::IDbStatement *m_updateQryRequestStatement;
