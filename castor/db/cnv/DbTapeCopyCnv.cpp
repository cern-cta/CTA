...
"INSERT INTO TapeCopy (copyNb, errorCode, nbRetry, missingCopies, fseq, tapeGatewayRequestId, vid, id, diskCopy, castorFile, status) VALUES (:1,:2,:3,:4,:5,:6,:7,ids_seq.nextval,:8,:9,:10) RETURNING id INTO :11";
...
"SELECT copyNb, errorCode, nbRetry, missingCopies, fseq, tapeGatewayRequestId, vid, id, diskCopy, castorFile, status FROM TapeCopy WHERE id = :1";

/// SQL statement for bulk request selection
const std::string castor::db::cnv::DbTapeCopyCnv::s_bulkSelectStatementString =
"DECLARE \
   TYPE RecordType IS RECORD (copyNb NUMBER, errorCode NUMBER, nbRetry NUMBER, missingCopies NUMBER, fseq NUMBER, tapeGatewayRequestId NUMBER, vid VARCHAR2(2048), id INTEGER, diskCopy INTEGER, castorFile INTEGER, status INTEGER); \
   ...
   BEGIN \
     ...
     OPEN objs FOR SELECT copyNb, errorCode, nbRetry, missingCopies, fseq, tapeGatewayRequestId, vid, id, diskCopy, castorFile, status \
...
"UPDATE TapeCopy SET copyNb = :1, errorCode = :2, nbRetry = :3, missingCopies = :4, fseq = :5, tapeGatewayRequestId = :6, vid = :7, status = :8 WHERE id = :9";
...
// ObjType
//------------------------------------------------------------------------------
unsigned int castor::db::cnv::DbTapeCopyCnv::ObjType() {
...
// objType
//------------------------------------------------------------------------------
unsigned int castor::db::cnv::DbTapeCopyCnv::objType() const {
  return ObjType();
}
...
// fillRep
//------------------------------------------------------------------------------
void castor::db::cnv::DbTapeCopyCnv::fillRep(castor::IAddress*,
...
// fillObj
//------------------------------------------------------------------------------
void castor::db::cnv::DbTapeCopyCnv::fillObj(castor::IAddress*,
                                             castor::IObject* object,
                                             unsigned int type,
                                             bool endTransaction)
  throw (castor::exception::Exception) {
...
void castor::db::cnv::DbTapeCopyCnv::fillObjDiskCopy(castor::stager::TapeCopy* obj)
  ...
  u_signed64 diskCopyId = rset->getInt64(9);
  // Close ResultSet
  delete rset;
...
// createRep
//------------------------------------------------------------------------------
void castor::db::cnv::DbTapeCopyCnv::createRep(castor::IAddress*,
                                               castor::IObject* object,
                                               bool endTransaction,
                                               unsigned int type)
  throw (castor::exception::Exception) {
  ...
  try {
    ...
    m_insertStatement->setInt(5, obj->fseq());
    m_insertStatement->setInt(6, obj->tapeGatewayRequestId());
    m_insertStatement->setString(7, obj->vid());
    m_insertStatement->setUInt64(8, (type == OBJ_DiskCopy && obj->diskCopy() != 0) ? obj->diskCopy()->id() : 0);
    ...
    ex.getMessage() << "Error in insert request :"
                    ...
                    << "  tapeGatewayRequestId : " << obj->tapeGatewayRequestId() << std::endl
...
// bulkCreateRep
//------------------------------------------------------------------------------
void castor::db::cnv::DbTapeCopyCnv::bulkCreateRep(castor::IAddress*,
  ...
  try {
    ...
    m_insertStatement->setDataBuffer
      (5, fseqBuffer, castor::db::DBTYPE_INT, sizeof(fseqBuffer[0]), fseqBufLens);
    // build the buffers for tapeGatewayRequestId
    int* tapeGatewayRequestIdBuffer = (int*) malloc(nb * sizeof(int));
    if (tapeGatewayRequestIdBuffer == 0) {
      castor::exception::OutOfMemory e;
      throw e;
    }
    allocMem.push_back(tapeGatewayRequestIdBuffer);
    unsigned short* tapeGatewayRequestIdBufLens = (unsigned short*) malloc(nb * sizeof(unsigned short));
    if (tapeGatewayRequestIdBufLens == 0) {
      castor::exception::OutOfMemory e;
      throw e;
    }
    allocMem.push_back(tapeGatewayRequestIdBufLens);
    for (int i = 0; i < nb; i++) {
      tapeGatewayRequestIdBuffer[i] = objs[i]->tapeGatewayRequestId();
      tapeGatewayRequestIdBufLens[i] = sizeof(int);
    }
    m_insertStatement->setDataBuffer
      (6, tapeGatewayRequestIdBuffer, castor::db::DBTYPE_INT, sizeof(tapeGatewayRequestIdBuffer[0]), tapeGatewayRequestIdBufLens);
    ...
    m_insertStatement->setDataBuffer
      (7, vidBuffer, castor::db::DBTYPE_STRING, vidMaxLen, vidBufLens);
    ...
    m_insertStatement->setDataBuffer
      (8, diskCopyBuffer, castor::db::DBTYPE_UINT64, sizeof(diskCopyBuffer[0]), diskCopyBufLens);
...
// updateRep
//------------------------------------------------------------------------------
void castor::db::cnv::DbTapeCopyCnv::updateRep(castor::IAddress*,
                                               castor::IObject* object,
                                               bool endTransaction)
  throw (castor::exception::Exception) {
  castor::stager::TapeCopy* obj = 
  ...
  try {
    ...
    m_updateStatement->setInt(5, obj->fseq());
    m_updateStatement->setInt(6, obj->tapeGatewayRequestId());
    m_updateStatement->setString(7, obj->vid());
...
// deleteRep
//------------------------------------------------------------------------------
void castor::db::cnv::DbTapeCopyCnv::deleteRep(castor::IAddress*,
                                               castor::IObject* object,
                                               bool endTransaction)
  throw (castor::exception::Exception) {
  castor::stager::TapeCopy* obj = 
...
castor::IObject* castor::db::cnv::DbTapeCopyCnv::createObj(castor::IAddress* address)
  ...
  try {
    ...
    object->setFseq(rset->getInt(5));
    object->setTapeGatewayRequestId(rset->getInt(6));
