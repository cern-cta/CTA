...
const std::string castor::db::cnv::DbTapeCopyCnv::s_bulkInsertStatementString =
"INSERT /* bulk */ INTO TapeCopy (copyNb, errorCode, nbRetry, missingCopies, id, castorFile, status) VALUES (:1,:2,:3,:4,ids_seq.nextval,:5,:6) RETURNING id INTO :7";
...
"DECLARE \
   TYPE RecordType IS RECORD (copyNb NUMBER, errorCode NUMBER, nbRetry NUMBER, missingCopies NUMBER, id INTEGER, castorFile INTEGER, status INTEGER); \
...
const std::string castor::db::cnv::DbTapeCopyCnv::s_storeTypeBulkStatementString =
