...
/******************************************************************************
 *                      castor/db/cnv/DbTapeGatewaySubRequestCnv.hpp
 *
...
#ifndef CASTOR_DB_CNV_TAPEGATEWAYSUBREQUEST_HPP
#define CASTOR_DB_CNV_TAPEGATEWAYSUBREQUEST_HPP
...
namespace castor {
  ...
  namespace db {
    ...
    namespace cnv {
      ...
      /**
       * class DbTapeGatewaySubRequestCnv
       * A converter for storing/retrieving TapeGatewaySubRequest into/from a generic
       * database
       */
      class DbTapeGatewaySubRequestCnv : public DbBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        DbTapeGatewaySubRequestCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~DbTapeGatewaySubRequestCnv() throw();
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillRepTapeCopy(castor::tape::tapegateway::TapeGatewaySubRequest* obj)
          throw (castor::exception::Exception);

        /**
         * Fill the database with objects of type TapeGatewayRequest refered by a given
         * object.
         * @param obj the original object
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillRepTapeGatewayRequest(castor::tape::tapegateway::TapeGatewaySubRequest* obj)
          throw (castor::exception::Exception);
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillRepDiskCopy(castor::tape::tapegateway::TapeGatewaySubRequest* obj)
          throw (castor::exception::Exception);
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillObjTapeCopy(castor::tape::tapegateway::TapeGatewaySubRequest* obj)
          throw (castor::exception::Exception);

        /**
         * Retrieve from the database objects of type TapeGatewayRequest refered by a given
         * object.
         * @param obj the original object
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillObjTapeGatewayRequest(castor::tape::tapegateway::TapeGatewaySubRequest* obj)
          throw (castor::exception::Exception);
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillObjDiskCopy(castor::tape::tapegateway::TapeGatewaySubRequest* obj)
          throw (castor::exception::Exception);
      ...
      private:
        ...
        static const std::string s_checkTapeGatewayRequestExistStatementString;

        /// SQL checkExist statement object for member request
        castor::db::IDbStatement *m_checkTapeGatewayRequestExistStatement;

        /// SQL update statement for member request
        static const std::string s_updateTapeGatewayRequestStatementString;

        /// SQL update statement object for member request
        castor::db::IDbStatement *m_updateTapeGatewayRequestStatement;
      ...
      }; // end of class DbTapeGatewaySubRequestCnv
...
#endif // CASTOR_DB_CNV_TAPEGATEWAYSUBREQUEST_HPP
