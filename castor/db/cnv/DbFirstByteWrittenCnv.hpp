...
/******************************************************************************
 *                      castor/db/cnv/DbFirstByteWrittenCnv.hpp
 *
...
#ifndef CASTOR_DB_CNV_FIRSTBYTEWRITTEN_HPP
#define CASTOR_DB_CNV_FIRSTBYTEWRITTEN_HPP
...
namespace castor {
  ...
  namespace db {
    ...
    namespace cnv {
      ...
      /**
       * class DbFirstByteWrittenCnv
       * A converter for storing/retrieving FirstByteWritten into/from a generic
       * database
       */
      class DbFirstByteWrittenCnv : public DbBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        DbFirstByteWrittenCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~DbFirstByteWrittenCnv() throw();
      ...
      }; // end of class DbFirstByteWrittenCnv
...
#endif // CASTOR_DB_CNV_FIRSTBYTEWRITTEN_HPP
