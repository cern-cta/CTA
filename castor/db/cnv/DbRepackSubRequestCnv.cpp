...
<<<<<<< DbRepackSubRequestCnv.cpp
"INSERT INTO RepackSubRequest (vid, xsize, status, cuuid, filesMigrating, filesStaging, files, id, requestID) VALUES (:1,:2,:3,:4,:5,:6,:7,ids_seq.nextval,:8) RETURNING id INTO :9";
=======
...
<<<<<<< DbRepackSubRequestCnv.cpp
"SELECT vid, xsize, status, cuuid, filesMigrating, filesStaging, files, id, requestID FROM RepackSubRequest WHERE id = :1";
=======
...
<<<<<<< DbRepackSubRequestCnv.cpp
"UPDATE RepackSubRequest SET vid = :1, xsize = :2, status = :3, cuuid = :4, filesMigrating = :5, filesStaging = :6, files = :7 WHERE id = :8";
=======
...
void castor::db::cnv::DbRepackSubRequestCnv::reset() throw() {
  ...
  try {
    ...
    delete m_deleteRepackSegmentStatement;
    delete m_selectRepackSegmentStatement;
    delete m_remoteUpdateRepackSegmentStatement;
    delete m_checkRepackRequestExistStatement;
    delete m_updateRepackRequestStatement;
...
void castor::db::cnv::DbRepackSubRequestCnv::fillRepRepackSegment(castor::repack::RepackSubRequest* obj)
  ...
  m_selectRepackSegmentStatement->setInt64(1, obj->id());
  ...
  for (std::vector<castor::repack::RepackSegment*>::iterator it = obj->segment().begin();
    ...
    if (0 == (*it)->id()) {
      ...
      m_remoteUpdateRepackSegmentStatement->setInt64(1, obj->id());
      m_remoteUpdateRepackSegmentStatement->setInt64(2, (*it)->id());
  ...
  for (std::set<int>::iterator it = segmentList.begin();
    ...
    m_deleteRepackSegmentStatement->setInt64(1, *it);
...
void castor::db::cnv::DbRepackSubRequestCnv::fillRepRepackRequest(castor::repack::RepackSubRequest* obj)
  ...
  if (0 != obj->requestID()) {
    ...
    m_checkRepackRequestExistStatement->setInt64(1, obj->requestID()->id());
  ...
  // Update local object
  m_updateRepackRequestStatement->setInt64(1, 0 == obj->requestID() ? 0 : obj->requestID()->id());
  m_updateRepackRequestStatement->setInt64(2, obj->id());
...
<<<<<<< DbRepackSubRequestCnv.cpp
  u_signed64 requestIDId = rset->getInt64(9);
=======
...
<<<<<<< DbRepackSubRequestCnv.cpp
    ...
    m_insertStatement->setInt64(8, (type == OBJ_RepackRequest && obj->requestID() != 0) ? obj->requestID()->id() : 0);
=======
