...
/******************************************************************************
 *                      castor/db/cnv/DbDiskServerCnv.hpp
 *
...
#ifndef CASTOR_DB_CNV_DISKSERVER_HPP
#define CASTOR_DB_CNV_DISKSERVER_HPP
...
namespace castor {
  ...
  namespace db {
    ...
    namespace cnv {
      ...
      /**
       * class DbDiskServerCnv
       * A converter for storing/retrieving DiskServer into/from a generic database
       */
      class DbDiskServerCnv : public DbBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        DbDiskServerCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~DbDiskServerCnv() throw();
      ...
      private:
        ...
        castor::db::IDbStatement *m_deleteFileSystemStatement;
        ...
        castor::db::IDbStatement *m_remoteUpdateFileSystemStatement;

      }; // end of class DbDiskServerCnv
...
#endif // CASTOR_DB_CNV_DISKSERVER_HPP
