...
/******************************************************************************
 *                      castor/db/cnv/DbStageGetNextRequestCnv.cpp
 *
...
// Include Files
#include "DbStageGetNextRequestCnv.hpp"
...
//------------------------------------------------------------------------------
static castor::CnvFactory<castor::db::cnv::DbStageGetNextRequestCnv>* s_factoryDbStageGetNextRequestCnv =
  new castor::CnvFactory<castor::db::cnv::DbStageGetNextRequestCnv>();

//------------------------------------------------------------------------------
// Static constants initialization
//------------------------------------------------------------------------------
/// SQL statement for request insertion
const std::string castor::db::cnv::DbStageGetNextRequestCnv::s_insertStatementString =
...
const std::string castor::db::cnv::DbStageGetNextRequestCnv::s_deleteStatementString =
"DELETE FROM StageGetNextRequest WHERE id = :1";

/// SQL statement for request selection
const std::string castor::db::cnv::DbStageGetNextRequestCnv::s_selectStatementString =
...
const std::string castor::db::cnv::DbStageGetNextRequestCnv::s_bulkSelectStatementString =
"DECLARE \
   TYPE CurType IS REF CURSOR RETURN StageGetNextRequest%ROWTYPE; \
   ...
   BEGIN \
     ...
     OPEN objs FOR SELECT parentUuid, flags, userName, euid, egid, mask, pid, machine, svcClassName, userTag, reqId, creationTime, lastModificationTime, id, parent, svcClass, client \
                     FROM StageGetNextRequest t, bulkSelectHelper h \
                    WHERE t.id = h.objId; \
...
const std::string castor::db::cnv::DbStageGetNextRequestCnv::s_updateStatementString =
...
const std::string castor::db::cnv::DbStageGetNextRequestCnv::s_insertNewReqStatementString =
"INSERT INTO newRequests (id, type, creation) VALUES (:1, :2, SYSDATE)";

/// SQL update statement for member parent
const std::string castor::db::cnv::DbStageGetNextRequestCnv::s_updateFileRequestStatementString =
"UPDATE StageGetNextRequest SET parent = :1 WHERE id = :2";

/// SQL existence statement for member svcClass
const std::string castor::db::cnv::DbStageGetNextRequestCnv::s_checkSvcClassExistStatementString =
"SELECT id FROM SvcClass WHERE id = :1";

/// SQL update statement for member svcClass
const std::string castor::db::cnv::DbStageGetNextRequestCnv::s_updateSvcClassStatementString =
"UPDATE StageGetNextRequest SET svcClass = :1 WHERE id = :2";

/// SQL update statement for member client
const std::string castor::db::cnv::DbStageGetNextRequestCnv::s_updateIClientStatementString =
"UPDATE StageGetNextRequest SET client = :1 WHERE id = :2";

//------------------------------------------------------------------------------
// Constructor
//------------------------------------------------------------------------------
castor::db::cnv::DbStageGetNextRequestCnv::DbStageGetNextRequestCnv(castor::ICnvSvc* cnvSvc) :
  DbBaseCnv(cnvSvc),
  m_insertStatement(0),
  m_deleteStatement(0),
  m_selectStatement(0),
...
// Destructor
//------------------------------------------------------------------------------
castor::db::cnv::DbStageGetNextRequestCnv::~DbStageGetNextRequestCnv() throw() {
  reset();
}
...
// reset
//------------------------------------------------------------------------------
void castor::db::cnv::DbStageGetNextRequestCnv::reset() throw() {
...
// ObjType
//------------------------------------------------------------------------------
const unsigned int castor::db::cnv::DbStageGetNextRequestCnv::ObjType() {
...
// objType
//------------------------------------------------------------------------------
const unsigned int castor::db::cnv::DbStageGetNextRequestCnv::objType() const {
  return ObjType();
}
...
// fillRep
//------------------------------------------------------------------------------
void castor::db::cnv::DbStageGetNextRequestCnv::fillRep(castor::IAddress* address,
...
// fillRepFileRequest
//------------------------------------------------------------------------------
void castor::db::cnv::DbStageGetNextRequestCnv::fillRepFileRequest(castor::stager::StageGetNextRequest* obj)
  throw (castor::exception::Exception) {
...
// fillRepSvcClass
//------------------------------------------------------------------------------
void castor::db::cnv::DbStageGetNextRequestCnv::fillRepSvcClass(castor::stager::StageGetNextRequest* obj)
  throw (castor::exception::Exception) {
  if (0 != obj->svcClass()) {
...
// fillRepIClient
//------------------------------------------------------------------------------
void castor::db::cnv::DbStageGetNextRequestCnv::fillRepIClient(castor::stager::StageGetNextRequest* obj)
  throw (castor::exception::Exception) {
  // Check update statement
...
// fillObj
//------------------------------------------------------------------------------
void castor::db::cnv::DbStageGetNextRequestCnv::fillObj(castor::IAddress* address,
                                                        castor::IObject* object,
                                                        unsigned int type,
                                                        bool endTransaction)
  throw (castor::exception::Exception) {
...
// fillObjFileRequest
//------------------------------------------------------------------------------
void castor::db::cnv::DbStageGetNextRequestCnv::fillObjFileRequest(castor::stager::StageGetNextRequest* obj)
  throw (castor::exception::Exception) {
...
// fillObjSvcClass
//------------------------------------------------------------------------------
void castor::db::cnv::DbStageGetNextRequestCnv::fillObjSvcClass(castor::stager::StageGetNextRequest* obj)
  throw (castor::exception::Exception) {
  // Check whether the statement is ok
  if (0 == m_selectStatement) {
    m_selectStatement = createStatement(s_selectStatementString);
...
// fillObjIClient
//------------------------------------------------------------------------------
void castor::db::cnv::DbStageGetNextRequestCnv::fillObjIClient(castor::stager::StageGetNextRequest* obj)
  throw (castor::exception::Exception) {
  // Check whether the statement is ok
  if (0 == m_selectStatement) {
    m_selectStatement = createStatement(s_selectStatementString);
...
// createRep
//------------------------------------------------------------------------------
void castor::db::cnv::DbStageGetNextRequestCnv::createRep(castor::IAddress* address,
                                                          castor::IObject* object,
                                                          bool endTransaction,
                                                          unsigned int type)
  throw (castor::exception::Exception) {
...
// bulkCreateRep
//------------------------------------------------------------------------------
void castor::db::cnv::DbStageGetNextRequestCnv::bulkCreateRep(castor::IAddress* address,
  ...
  if (0 == nb) return;
  // Casts all objects
  std::vector<castor::stager::StageGetNextRequest*> objs;
  for (int i = 0; i < nb; i++) {
    objs.push_back(dynamic_cast<castor::stager::StageGetNextRequest*>(objects[i]));
  }
  try {
    // Check whether the statements are ok
    if (0 == m_insertStatement) {
    ...
    // release the buffers for parentUuid
    free(parentUuidBuffer);
    free(parentUuidBufLens);
    // release the buffers for flags
    free(flagsBuffer);
    free(flagsBufLens);
    ...
    free(machineBuffer);
    free(machineBufLens);
    // release the buffers for svcClassName
    free(svcClassNameBuffer);
    free(svcClassNameBufLens);
    // release the buffers for userTag
    free(userTagBuffer);
    free(userTagBufLens);
    // release the buffers for reqId
    free(reqIdBuffer);
    free(reqIdBufLens);
    // release the buffers for creationTime
    free(creationTimeBuffer);
    free(creationTimeBufLens);
    // release the buffers for lastModificationTime
    free(lastModificationTimeBuffer);
    free(lastModificationTimeBufLens);
    // release the buffers for parent
    free(parentBuffer);
    free(parentBufLens);
...
// updateRep
//------------------------------------------------------------------------------
void castor::db::cnv::DbStageGetNextRequestCnv::updateRep(castor::IAddress* address,
                                                          castor::IObject* object,
                                                          bool endTransaction)
  throw (castor::exception::Exception) {
  castor::stager::StageGetNextRequest* obj = 
...
// deleteRep
//------------------------------------------------------------------------------
void castor::db::cnv::DbStageGetNextRequestCnv::deleteRep(castor::IAddress* address,
                                                          castor::IObject* object,
                                                          bool endTransaction)
  throw (castor::exception::Exception) {
  castor::stager::StageGetNextRequest* obj = 
...
// createObj
//------------------------------------------------------------------------------
castor::IObject* castor::db::cnv::DbStageGetNextRequestCnv::createObj(castor::IAddress* address)
  throw (castor::exception::Exception) {
  castor::BaseAddress* ad = 
...
castor::db::cnv::DbStageGetNextRequestCnv::bulkCreateObj(castor::IAddress* address)
  throw (castor::exception::Exception) {
  // Prepare result
...
// updateObj
//------------------------------------------------------------------------------
void castor::db::cnv::DbStageGetNextRequestCnv::updateObj(castor::IObject* obj)
  throw (castor::exception::Exception) {
  try {
    // Check whether the statement is ok
    if (0 == m_selectStatement) {
