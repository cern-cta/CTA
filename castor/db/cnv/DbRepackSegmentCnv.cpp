...
const std::string castor::db::cnv::DbRepackSegmentCnv::s_bulkInsertStatementString =
"INSERT /* bulk */ INTO RepackSegment (fileid, segsize, compression, filesec, copyno, blockid, fileseq, errorCode, errorMessage, id, repacksubrequest) VALUES (:1,:2,:3,:4,:5,:6,:7,:8,:9,ids_seq.nextval,:10) RETURNING id INTO :11";
...
"DECLARE \
   TYPE RecordType IS RECORD (fileid INTEGER, segsize INTEGER, compression NUMBER, filesec NUMBER, copyno NUMBER, blockid INTEGER, fileseq INTEGER, errorCode NUMBER, errorMessage VARCHAR2(2048), id INTEGER, repacksubrequest INTEGER); \
...
const std::string castor::db::cnv::DbRepackSegmentCnv::s_storeTypeBulkStatementString =
