...
=======
"INSERT INTO RepackSegment (fileid, compression, segsize, filesec, id, vid) VALUES (:1,:2,:3,:4,ids_seq.nextval,:5) RETURNING id INTO :6";
>>>>>>> 1.4.4.1
...
=======
"SELECT fileid, compression, segsize, filesec, id, vid FROM RepackSegment WHERE id = :1";
>>>>>>> 1.4.4.1
...
=======
"UPDATE RepackSegment SET fileid = :1, compression = :2, segsize = :3, filesec = :4 WHERE id = :5";
>>>>>>> 1.4.4.1
...
void castor::db::cnv::DbRepackSegmentCnv::reset() throw() {
  ...
  try {
    ...
    delete m_checkRepackSubRequestExistStatement;
    delete m_updateRepackSubRequestStatement;
...
void castor::db::cnv::DbRepackSegmentCnv::fillRepRepackSubRequest(castor::repack::RepackSegment* obj)
  ...
  if (0 != obj->vid()) {
    ...
    m_checkRepackSubRequestExistStatement->setInt64(1, obj->vid()->id());
  ...
  // Update local object
  m_updateRepackSubRequestStatement->setInt64(1, 0 == obj->vid() ? 0 : obj->vid()->id());
  m_updateRepackSubRequestStatement->setInt64(2, obj->id());
...
=======
    ...
    m_insertStatement->setInt64(3, obj->segsize());
    m_insertStatement->setInt64(4, obj->filesec());
    m_insertStatement->setInt64(5, (type == OBJ_RepackSubRequest && obj->vid() != 0) ? obj->vid()->id() : 0);
>>>>>>> 1.4.4.1
