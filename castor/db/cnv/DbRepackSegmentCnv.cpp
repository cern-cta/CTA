...
#include "castor/repack/RepackSegmentStatusCode.hpp"
...
"INSERT INTO RepackSegment (fileid, segsize, compression, filesec, copyno, blockid, fileseq, errorCode, id, status, repacksubrequest) VALUES (:1,:2,:3,:4,:5,:6,:7,:8,ids_seq.nextval,:9,:10) RETURNING id INTO :11";
...
"SELECT fileid, segsize, compression, filesec, copyno, blockid, fileseq, errorCode, id, status, repacksubrequest FROM RepackSegment WHERE id = :1";

/// SQL statement for request update
const std::string castor::db::cnv::DbRepackSegmentCnv::s_updateStatementString =
"UPDATE RepackSegment SET fileid = :1, segsize = :2, compression = :3, filesec = :4, copyno = :5, blockid = :6, fileseq = :7, errorCode = :8, status = :9 WHERE id = :10";
...
castor::IObject* castor::db::cnv::DbRepackSegmentCnv::createObj(castor::IAddress* address)
  ...
  try {
    ...
    object->setStatus((enum castor::repack::RepackSegmentStatusCode)rset->getInt(10));
    delete rset;
    return object;
  } catch (castor::exception::SQLError e) {
    castor::exception::InvalidArgument ex;
