...
/******************************************************************************
 *                      castor/db/cnv/DbPriorityMapCnv.hpp
 *
...
#ifndef CASTOR_DB_CNV_PRIORITYMAP_HPP
#define CASTOR_DB_CNV_PRIORITYMAP_HPP
...
namespace castor {
  ...
  namespace db {
    ...
    namespace cnv {
      ...
      /**
       * class DbPriorityMapCnv
       * A converter for storing/retrieving PriorityMap into/from a generic database
       */
      class DbPriorityMapCnv : public DbBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        DbPriorityMapCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~DbPriorityMapCnv() throw();
...
#endif // CASTOR_DB_CNV_PRIORITYMAP_HPP
