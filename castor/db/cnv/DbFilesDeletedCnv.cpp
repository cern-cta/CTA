...
const castor::ICnvFactory& DbFilesDeletedCnvFactory = 
  s_factoryDbFilesDeletedCnv;
...
void castor::db::cnv::DbFilesDeletedCnv::reset() throw() {
  ...
  try {
    ...
    delete m_deleteGCFileStatement;
    delete m_selectGCFileStatement;
    delete m_remoteUpdateGCFileStatement;
