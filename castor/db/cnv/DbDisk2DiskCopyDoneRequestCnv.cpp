...
void castor::db::cnv::DbDisk2DiskCopyDoneRequestCnv::createRep(castor::IAddress* address,
  ...
  try {
    ...
    m_insertStatement->setInt64(13, obj->diskCopyId());
...
void castor::db::cnv::DbDisk2DiskCopyDoneRequestCnv::updateRep(castor::IAddress* address,
  ...
  try {
    ...
    m_updateStatement->setInt64(12, obj->diskCopyId());
    m_updateStatement->setInt(13, obj->status());
    m_updateStatement->setInt64(14, obj->id());
...
castor::IObject* castor::db::cnv::DbDisk2DiskCopyDoneRequestCnv::createObj(castor::IAddress* address)
  ...
  try {
    ...
    object->setDiskCopyId(rset->getInt64(13));
