...
void castor::db::cnv::DbDisk2DiskCopyDoneRequestCnv::bulkCreateRep(castor::IAddress* address,
  ...
  try {
    ...
    m_insertStatement->setDataBuffer
      (13, diskCopyIdBuffer, DBTYPE_UINT64, sizeof(diskCopyIdBuffer[0]), diskCopyIdBufLens);
    ...
    m_insertStatement->setDataBuffer
      (14, sourceDiskCopyIdBuffer, DBTYPE_UINT64, sizeof(sourceDiskCopyIdBuffer[0]), sourceDiskCopyIdBufLens);
    ...
    m_insertStatement->setDataBuffer
      (15, fileIdBuffer, DBTYPE_UINT64, sizeof(fileIdBuffer[0]), fileIdBufLens);
    ...
    m_insertStatement->setDataBuffer
      (16, nsHostBuffer, DBTYPE_STRING, nsHostMaxLen, nsHostBufLens);
    ...
    m_insertStatement->setDataBuffer
      (19, idBuffer, DBTYPE_UINT64, sizeof(double), idBufLens);
