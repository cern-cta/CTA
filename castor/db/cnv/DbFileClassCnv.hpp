...
/******************************************************************************
 *                      castor/db/cnv/DbFileClassCnv.hpp
 *
...
#ifndef CASTOR_DB_CNV_FILECLASS_HPP
#define CASTOR_DB_CNV_FILECLASS_HPP
...
namespace castor {
  ...
  namespace db {
    ...
    namespace cnv {
      ...
      /**
       * class DbFileClassCnv
       * A converter for storing/retrieving FileClass into/from a generic database
       */
      class DbFileClassCnv : public DbBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        DbFileClassCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~DbFileClassCnv() throw();
      ...
      private:
        ...
        castor::db::IDbStatement *m_selectCastorFileStatement;
        ...
        castor::db::IDbStatement *m_deleteCastorFileStatement;
...
#endif // CASTOR_DB_CNV_FILECLASS_HPP
