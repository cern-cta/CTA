...
#ifndef CASTOR_DB_CNV_TAPE_HPP
#define CASTOR_DB_CNV_TAPE_HPP
...
namespace castor {
  ...
  namespace db {
    ...
    namespace cnv {
      ...
      /**
       * class DbTapeCnv
       * A converter for storing/retrieving Tape into/from a generic database
       */
      class DbTapeCnv : public DbBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        DbTapeCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~DbTapeCnv() throw();
