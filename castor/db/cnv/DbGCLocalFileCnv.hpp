...
/******************************************************************************
 *                      castor/db/cnv/DbGCLocalFileCnv.hpp
 *
...
#ifndef CASTOR_DB_CNV_GCLOCALFILE_HPP
#define CASTOR_DB_CNV_GCLOCALFILE_HPP
...
namespace castor {
  ...
  namespace db {
    ...
    namespace cnv {
      ...
      /**
       * class DbGCLocalFileCnv
       * A converter for storing/retrieving GCLocalFile into/from a generic database
       */
      class DbGCLocalFileCnv : public DbBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        DbGCLocalFileCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~DbGCLocalFileCnv() throw();
...
#endif // CASTOR_DB_CNV_GCLOCALFILE_HPP
