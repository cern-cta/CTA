...
/******************************************************************************
 *                      castor/db/cnv/DbTapePoolCnv.hpp
 *
...
#ifndef CASTOR_DB_CNV_TAPEPOOL_HPP
#define CASTOR_DB_CNV_TAPEPOOL_HPP
...
namespace castor {
  ...
  namespace db {
    ...
    namespace cnv {
      ...
      /**
       * class DbTapePoolCnv
       * A converter for storing/retrieving TapePool into/from a generic database
       */
      class DbTapePoolCnv : public DbBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        DbTapePoolCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~DbTapePoolCnv() throw();
      ...
      private:
        ...
        castor::db::IDbStatement *m_insertSvcClassStatement;
...
#endif // CASTOR_DB_CNV_TAPEPOOL_HPP
