...
const std::string castor::db::cnv::DbTapeCnv::s_remoteUpdateErrorHistoryStatementString =
...
void castor::db::cnv::DbTapeCnv::fillRepStream(castor::stager::Tape* obj)
  ...
  if (rset->next()) {
    ...
    if (0 != streamId &&
      ...
      m_deleteStreamStatement->setInt64(1, streamId);
  ...
  if (0 != obj->stream()) {
    ...
    // retrieve the object from the database
    m_checkStreamExistStatement->setInt64(1, obj->stream()->id());
    ...
    if (!rset->next()) {
      ...
      m_remoteUpdateStreamStatement->setInt64(2, obj->stream()->id());
  ...
  // Update local object
  m_updateStreamStatement->setInt64(1, 0 == obj->stream() ? 0 : obj->stream()->id());
  m_updateStreamStatement->setInt64(2, obj->id());
...
// fillRepErrorHistory
//------------------------------------------------------------------------------
void castor::db::cnv::DbTapeCnv::fillRepErrorHistory(castor::stager::Tape* obj)
  throw (castor::exception::Exception) {
...
// fillObjErrorHistory
//------------------------------------------------------------------------------
void castor::db::cnv::DbTapeCnv::fillObjErrorHistory(castor::stager::Tape* obj)
  throw (castor::exception::Exception) {
  // Check select statement
  if (0 == m_selectErrorHistoryStatement) {
    m_selectErrorHistoryStatement = createStatement(s_selectErrorHistoryStatementString);
...
void castor::db::cnv::DbTapeCnv::createRep(castor::IAddress* address,
  ...
  try {
    ...
    m_insertStatement->setInt64(8, (type == OBJ_Stream && obj->stream() != 0) ? obj->stream()->id() : 0);
