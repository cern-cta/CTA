...
namespace castor {
  ...
  namespace db {
    ...
    namespace cnv {
      ...
      /**
       * class DbPutFailedCnv
       * A converter for storing/retrieving PutFailed into/from a generic database
       */
      class DbPutFailedCnv : public DbBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        DbPutFailedCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~DbPutFailedCnv() throw();
