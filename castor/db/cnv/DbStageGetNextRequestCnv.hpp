...
/******************************************************************************
 *                      castor/db/cnv/DbStageGetNextRequestCnv.hpp
 *
...
#ifndef CASTOR_DB_CNV_STAGEGETNEXTREQUEST_HPP
#define CASTOR_DB_CNV_STAGEGETNEXTREQUEST_HPP
...
namespace castor {
  ...
  namespace db {
    ...
    namespace cnv {
      ...
      /**
       * class DbStageGetNextRequestCnv
       * A converter for storing/retrieving StageGetNextRequest into/from a generic
       */
      class DbStageGetNextRequestCnv : public DbBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        DbStageGetNextRequestCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~DbStageGetNextRequestCnv() throw();
      ...
      }; // end of class DbStageGetNextRequestCnv
...
#endif // CASTOR_DB_CNV_STAGEGETNEXTREQUEST_HPP
