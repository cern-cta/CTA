...
const std::string castor::db::cnv::DbVdqmTapeCnv::s_bulkInsertStatementString =
"INSERT /* bulk */ INTO VdqmTape (vid, id) VALUES (:1,ids_seq.nextval) RETURNING id INTO :2";
...
const std::string castor::db::cnv::DbVdqmTapeCnv::s_storeTypeBulkStatementString =
