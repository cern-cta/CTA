...
/******************************************************************************
 *                      castor/db/cnv/DbStageUpdateNextRequestCnv.cpp
 *
...
// Include Files
#include "DbStageUpdateNextRequestCnv.hpp"
...
//------------------------------------------------------------------------------
static castor::CnvFactory<castor::db::cnv::DbStageUpdateNextRequestCnv>* s_factoryDbStageUpdateNextRequestCnv =
  new castor::CnvFactory<castor::db::cnv::DbStageUpdateNextRequestCnv>();

//------------------------------------------------------------------------------
// Static constants initialization
//------------------------------------------------------------------------------
/// SQL statement for request insertion
const std::string castor::db::cnv::DbStageUpdateNextRequestCnv::s_insertStatementString =
...
const std::string castor::db::cnv::DbStageUpdateNextRequestCnv::s_deleteStatementString =
"DELETE FROM StageUpdateNextRequest WHERE id = :1";

/// SQL statement for request selection
const std::string castor::db::cnv::DbStageUpdateNextRequestCnv::s_selectStatementString =
...
const std::string castor::db::cnv::DbStageUpdateNextRequestCnv::s_bulkSelectStatementString =
"DECLARE \
   TYPE CurType IS REF CURSOR RETURN StageUpdateNextRequest%ROWTYPE; \
   ...
   BEGIN \
     ...
     OPEN objs FOR SELECT parentUuid, flags, userName, euid, egid, mask, pid, machine, svcClassName, userTag, reqId, creationTime, lastModificationTime, id, parent, svcClass, client \
                     FROM StageUpdateNextRequest t, bulkSelectHelper h \
                    WHERE t.id = h.objId; \
...
const std::string castor::db::cnv::DbStageUpdateNextRequestCnv::s_updateStatementString =
...
const std::string castor::db::cnv::DbStageUpdateNextRequestCnv::s_storeTypeStatementString =
"INSERT /* StageUpdateNextRequest class */ INTO Id2Type (id, type) VALUES (:1, :2)";

/// SQL statement for type deletion
const std::string castor::db::cnv::DbStageUpdateNextRequestCnv::s_deleteTypeStatementString =
"DELETE FROM Id2Type WHERE id = :1";

/// SQL statement for request insertion into newRequests table
const std::string castor::db::cnv::DbStageUpdateNextRequestCnv::s_insertNewReqStatementString =
"INSERT INTO newRequests (id, type, creation) VALUES (:1, :2, SYSDATE)";

/// SQL update statement for member parent
const std::string castor::db::cnv::DbStageUpdateNextRequestCnv::s_updateFileRequestStatementString =
"UPDATE StageUpdateNextRequest SET parent = :1 WHERE id = :2";

/// SQL existence statement for member svcClass
const std::string castor::db::cnv::DbStageUpdateNextRequestCnv::s_checkSvcClassExistStatementString =
"SELECT id FROM SvcClass WHERE id = :1";

/// SQL update statement for member svcClass
const std::string castor::db::cnv::DbStageUpdateNextRequestCnv::s_updateSvcClassStatementString =
"UPDATE StageUpdateNextRequest SET svcClass = :1 WHERE id = :2";

/// SQL update statement for member client
const std::string castor::db::cnv::DbStageUpdateNextRequestCnv::s_updateIClientStatementString =
"UPDATE StageUpdateNextRequest SET client = :1 WHERE id = :2";

//------------------------------------------------------------------------------
// Constructor
//------------------------------------------------------------------------------
castor::db::cnv::DbStageUpdateNextRequestCnv::DbStageUpdateNextRequestCnv(castor::ICnvSvc* cnvSvc) :
  DbBaseCnv(cnvSvc),
  m_insertStatement(0),
  m_deleteStatement(0),
  m_selectStatement(0),
...
// Destructor
//------------------------------------------------------------------------------
castor::db::cnv::DbStageUpdateNextRequestCnv::~DbStageUpdateNextRequestCnv() throw() {
  reset();
}
...
// reset
//------------------------------------------------------------------------------
void castor::db::cnv::DbStageUpdateNextRequestCnv::reset() throw() {
...
// ObjType
//------------------------------------------------------------------------------
const unsigned int castor::db::cnv::DbStageUpdateNextRequestCnv::ObjType() {
...
// objType
//------------------------------------------------------------------------------
const unsigned int castor::db::cnv::DbStageUpdateNextRequestCnv::objType() const {
  return ObjType();
}
...
// fillRep
//------------------------------------------------------------------------------
void castor::db::cnv::DbStageUpdateNextRequestCnv::fillRep(castor::IAddress* address,
...
// fillRepFileRequest
//------------------------------------------------------------------------------
void castor::db::cnv::DbStageUpdateNextRequestCnv::fillRepFileRequest(castor::stager::StageUpdateNextRequest* obj)
  throw (castor::exception::Exception) {
...
// fillRepSvcClass
//------------------------------------------------------------------------------
void castor::db::cnv::DbStageUpdateNextRequestCnv::fillRepSvcClass(castor::stager::StageUpdateNextRequest* obj)
  throw (castor::exception::Exception) {
  if (0 != obj->svcClass()) {
...
// fillRepIClient
//------------------------------------------------------------------------------
void castor::db::cnv::DbStageUpdateNextRequestCnv::fillRepIClient(castor::stager::StageUpdateNextRequest* obj)
  throw (castor::exception::Exception) {
  // Check update statement
...
// fillObj
//------------------------------------------------------------------------------
void castor::db::cnv::DbStageUpdateNextRequestCnv::fillObj(castor::IAddress* address,
                                                           castor::IObject* object,
                                                           unsigned int type,
                                                           bool endTransaction)
  throw (castor::exception::Exception) {
...
// fillObjFileRequest
//------------------------------------------------------------------------------
void castor::db::cnv::DbStageUpdateNextRequestCnv::fillObjFileRequest(castor::stager::StageUpdateNextRequest* obj)
  throw (castor::exception::Exception) {
...
// fillObjSvcClass
//------------------------------------------------------------------------------
void castor::db::cnv::DbStageUpdateNextRequestCnv::fillObjSvcClass(castor::stager::StageUpdateNextRequest* obj)
  throw (castor::exception::Exception) {
  // Check whether the statement is ok
  if (0 == m_selectStatement) {
    m_selectStatement = createStatement(s_selectStatementString);
...
// fillObjIClient
//------------------------------------------------------------------------------
void castor::db::cnv::DbStageUpdateNextRequestCnv::fillObjIClient(castor::stager::StageUpdateNextRequest* obj)
  throw (castor::exception::Exception) {
  // Check whether the statement is ok
  if (0 == m_selectStatement) {
    m_selectStatement = createStatement(s_selectStatementString);
...
// createRep
//------------------------------------------------------------------------------
void castor::db::cnv::DbStageUpdateNextRequestCnv::createRep(castor::IAddress* address,
                                                             castor::IObject* object,
                                                             bool endTransaction,
                                                             unsigned int type)
  throw (castor::exception::Exception) {
...
// bulkCreateRep
//------------------------------------------------------------------------------
void castor::db::cnv::DbStageUpdateNextRequestCnv::bulkCreateRep(castor::IAddress* address,
  ...
  if (0 == nb) return;
  // Casts all objects
  std::vector<castor::stager::StageUpdateNextRequest*> objs;
  for (int i = 0; i < nb; i++) {
    objs.push_back(dynamic_cast<castor::stager::StageUpdateNextRequest*>(objects[i]));
  }
...
// updateRep
//------------------------------------------------------------------------------
void castor::db::cnv::DbStageUpdateNextRequestCnv::updateRep(castor::IAddress* address,
                                                             castor::IObject* object,
                                                             bool endTransaction)
  throw (castor::exception::Exception) {
  castor::stager::StageUpdateNextRequest* obj = 
...
// deleteRep
//------------------------------------------------------------------------------
void castor::db::cnv::DbStageUpdateNextRequestCnv::deleteRep(castor::IAddress* address,
                                                             castor::IObject* object,
                                                             bool endTransaction)
  throw (castor::exception::Exception) {
  castor::stager::StageUpdateNextRequest* obj = 
...
// createObj
//------------------------------------------------------------------------------
castor::IObject* castor::db::cnv::DbStageUpdateNextRequestCnv::createObj(castor::IAddress* address)
  throw (castor::exception::Exception) {
  castor::BaseAddress* ad = 
...
castor::db::cnv::DbStageUpdateNextRequestCnv::bulkCreateObj(castor::IAddress* address)
  throw (castor::exception::Exception) {
  // Prepare result
...
// updateObj
//------------------------------------------------------------------------------
void castor::db::cnv::DbStageUpdateNextRequestCnv::updateObj(castor::IObject* obj)
  throw (castor::exception::Exception) {
  try {
    // Check whether the statement is ok
    if (0 == m_selectStatement) {
