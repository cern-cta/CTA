...
/******************************************************************************
 *                      castor/db/cnv/DbStageUpdateNextRequestCnv.hpp
 *
...
#ifndef CASTOR_DB_CNV_STAGEUPDATENEXTREQUEST_HPP
#define CASTOR_DB_CNV_STAGEUPDATENEXTREQUEST_HPP
...
namespace castor {
  ...
  namespace db {
    ...
    namespace cnv {
      ...
      /**
       * class DbStageUpdateNextRequestCnv
       * A converter for storing/retrieving StageUpdateNextRequest into/from a generic
       * database
       */
      class DbStageUpdateNextRequestCnv : public DbBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        DbStageUpdateNextRequestCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~DbStageUpdateNextRequestCnv() throw();
      ...
      }; // end of class DbStageUpdateNextRequestCnv
...
#endif // CASTOR_DB_CNV_STAGEUPDATENEXTREQUEST_HPP
