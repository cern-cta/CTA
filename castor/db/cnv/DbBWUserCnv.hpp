...
#ifndef CASTOR_DB_CNV_BWUSER_HPP
#define CASTOR_DB_CNV_BWUSER_HPP
...
namespace castor {
  ...
  namespace db {
    ...
    namespace cnv {
      ...
      /**
       * class DbBWUserCnv
       * A converter for storing/retrieving BWUser into/from a generic database
       */
      class DbBWUserCnv : public DbBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        DbBWUserCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~DbBWUserCnv() throw();
      ...
      private:
        ...
        static const std::string s_checkChangePrivilegeExistStatementString;

        /// SQL checkExist statement object for member request
        castor::db::IDbStatement *m_checkChangePrivilegeExistStatement;

        /// SQL update statement for member request
        static const std::string s_updateChangePrivilegeStatementString;

        /// SQL update statement object for member request
        castor::db::IDbStatement *m_updateChangePrivilegeStatement;

      }; // end of class DbBWUserCnv
...
#endif // CASTOR_DB_CNV_BWUSER_HPP
