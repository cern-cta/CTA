...
/******************************************************************************
 *                      castor/db/cnv/DbStageFindRequestRequestCnv.hpp
 *
...
#ifndef CASTOR_DB_CNV_STAGEFINDREQUESTREQUEST_HPP
#define CASTOR_DB_CNV_STAGEFINDREQUESTREQUEST_HPP
...
namespace castor {
  ...
  namespace db {
    ...
    namespace cnv {
      ...
      /**
       * class DbStageFindRequestRequestCnv
       * A converter for storing/retrieving StageFindRequestRequest into/from a generic
       * database
       */
      class DbStageFindRequestRequestCnv : public DbBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        DbStageFindRequestRequestCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~DbStageFindRequestRequestCnv() throw();
      ...
      }; // end of class DbStageFindRequestRequestCnv
...
#endif // CASTOR_DB_CNV_STAGEFINDREQUESTREQUEST_HPP
