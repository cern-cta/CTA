...
/******************************************************************************
 *                      castor/db/cnv/DbDisk2DiskCopyStartRequestCnv.hpp
 *
...
#ifndef CASTOR_DB_CNV_DISK2DISKCOPYSTARTREQUEST_HPP
#define CASTOR_DB_CNV_DISK2DISKCOPYSTARTREQUEST_HPP
...
namespace castor {
  ...
  namespace db {
    ...
    namespace cnv {
      ...
      /**
       * class DbDisk2DiskCopyStartRequestCnv
       * A converter for storing/retrieving Disk2DiskCopyStartRequest into/from a generic
       * database
       */
      class DbDisk2DiskCopyStartRequestCnv : public DbBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        DbDisk2DiskCopyStartRequestCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~DbDisk2DiskCopyStartRequestCnv() throw();
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillRepSvcClass(castor::stager::Disk2DiskCopyStartRequest* obj)
          throw (castor::exception::Exception);
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillRepIClient(castor::stager::Disk2DiskCopyStartRequest* obj)
          throw (castor::exception::Exception);
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillObjSvcClass(castor::stager::Disk2DiskCopyStartRequest* obj)
          throw (castor::exception::Exception);
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillObjIClient(castor::stager::Disk2DiskCopyStartRequest* obj)
          throw (castor::exception::Exception);
      ...
      }; // end of class DbDisk2DiskCopyStartRequestCnv
...
#endif // CASTOR_DB_CNV_DISK2DISKCOPYSTARTREQUEST_HPP
