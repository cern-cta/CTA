...
"INSERT INTO TapeRequestState (accessMode, startTime, lastVdqmPingTime, vdqmVolReqId, nbRetry, lastFseq, id, streamMigration, tapeRecall, status) VALUES (:1,:2,:3,:4,:5,:6,ids_seq.nextval,:7,:8,:9) RETURNING id INTO :10";
...
"SELECT accessMode, startTime, lastVdqmPingTime, vdqmVolReqId, nbRetry, lastFseq, id, streamMigration, tapeRecall, status FROM TapeRequestState WHERE id = :1";
...
"UPDATE TapeRequestState SET accessMode = :1, startTime = :2, lastVdqmPingTime = :3, vdqmVolReqId = :4, nbRetry = :5, lastFseq = :6, status = :7 WHERE id = :8";

/// SQL statement for type storage
const std::string castor::db::cnv::DbTapeRequestStateCnv::s_storeTypeStatementString =
"INSERT /* TapeRequestState class */ INTO Id2Type (id, type) VALUES (:1, :2)";
