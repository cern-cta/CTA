...
/******************************************************************************
 *                      castor/db/cnv/DbFilesDeletionFailedCnv.hpp
 *
...
#ifndef CASTOR_DB_CNV_FILESDELETIONFAILED_HPP
#define CASTOR_DB_CNV_FILESDELETIONFAILED_HPP
...
namespace castor {
  ...
  namespace db {
    ...
    namespace cnv {
      ...
      /**
       * class DbFilesDeletionFailedCnv
       * A converter for storing/retrieving FilesDeletionFailed into/from a generic
       * database
       */
      class DbFilesDeletionFailedCnv : public DbBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        DbFilesDeletionFailedCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~DbFilesDeletionFailedCnv() throw();
      ...
      }; // end of class DbFilesDeletionFailedCnv
...
#endif // CASTOR_DB_CNV_FILESDELETIONFAILED_HPP
