...
/******************************************************************************
 *                      castor/db/cnv/DbStageReleaseFilesRequestCnv.cpp
 *
...
// Include Files
#include "DbStageReleaseFilesRequestCnv.hpp"
...
//------------------------------------------------------------------------------
static castor::CnvFactory<castor::db::cnv::DbStageReleaseFilesRequestCnv>* s_factoryDbStageReleaseFilesRequestCnv =
  new castor::CnvFactory<castor::db::cnv::DbStageReleaseFilesRequestCnv>();

//------------------------------------------------------------------------------
// Static constants initialization
//------------------------------------------------------------------------------
/// SQL statement for request insertion
const std::string castor::db::cnv::DbStageReleaseFilesRequestCnv::s_insertStatementString =
...
const std::string castor::db::cnv::DbStageReleaseFilesRequestCnv::s_deleteStatementString =
"DELETE FROM StageReleaseFilesRequest WHERE id = :1";

/// SQL statement for request selection
const std::string castor::db::cnv::DbStageReleaseFilesRequestCnv::s_selectStatementString =
...
const std::string castor::db::cnv::DbStageReleaseFilesRequestCnv::s_bulkSelectStatementString =
"DECLARE \
   TYPE CurType IS REF CURSOR RETURN StageReleaseFilesRequest%ROWTYPE; \
   ...
   BEGIN \
     ...
     OPEN objs FOR SELECT flags, userName, euid, egid, mask, pid, machine, svcClassName, userTag, reqId, creationTime, lastModificationTime, id, svcClass, client \
                     FROM StageReleaseFilesRequest t, bulkSelectHelper h \
                    WHERE t.id = h.objId; \
...
const std::string castor::db::cnv::DbStageReleaseFilesRequestCnv::s_updateStatementString =
...
const std::string castor::db::cnv::DbStageReleaseFilesRequestCnv::s_storeTypeStatementString =
"INSERT /* StageReleaseFilesRequest class */ INTO Id2Type (id, type) VALUES (:1, :2)";

/// SQL statement for type deletion
const std::string castor::db::cnv::DbStageReleaseFilesRequestCnv::s_deleteTypeStatementString =
"DELETE FROM Id2Type WHERE id = :1";

/// SQL select statement for member subRequests
const std::string castor::db::cnv::DbStageReleaseFilesRequestCnv::s_selectSubRequestStatementString =
"SELECT id FROM SubRequest WHERE request = :1 FOR UPDATE";

/// SQL delete statement for member subRequests
const std::string castor::db::cnv::DbStageReleaseFilesRequestCnv::s_deleteSubRequestStatementString =
"UPDATE SubRequest SET request = 0 WHERE id = :1";

/// SQL remote update statement for member subRequests
const std::string castor::db::cnv::DbStageReleaseFilesRequestCnv::s_remoteUpdateSubRequestStatementString =
"UPDATE SubRequest SET request = :1 WHERE id = :2";

/// SQL existence statement for member svcClass
const std::string castor::db::cnv::DbStageReleaseFilesRequestCnv::s_checkSvcClassExistStatementString =
"SELECT id FROM SvcClass WHERE id = :1";

/// SQL update statement for member svcClass
const std::string castor::db::cnv::DbStageReleaseFilesRequestCnv::s_updateSvcClassStatementString =
"UPDATE StageReleaseFilesRequest SET svcClass = :1 WHERE id = :2";

/// SQL update statement for member client
const std::string castor::db::cnv::DbStageReleaseFilesRequestCnv::s_updateIClientStatementString =
"UPDATE StageReleaseFilesRequest SET client = :1 WHERE id = :2";

//------------------------------------------------------------------------------
// Constructor
//------------------------------------------------------------------------------
castor::db::cnv::DbStageReleaseFilesRequestCnv::DbStageReleaseFilesRequestCnv(castor::ICnvSvc* cnvSvc) :
  DbBaseCnv(cnvSvc),
  m_insertStatement(0),
  m_deleteStatement(0),
  m_selectStatement(0),
...
// Destructor
//------------------------------------------------------------------------------
castor::db::cnv::DbStageReleaseFilesRequestCnv::~DbStageReleaseFilesRequestCnv() throw() {
  reset();
}
...
// reset
//------------------------------------------------------------------------------
void castor::db::cnv::DbStageReleaseFilesRequestCnv::reset() throw() {
...
// ObjType
//------------------------------------------------------------------------------
const unsigned int castor::db::cnv::DbStageReleaseFilesRequestCnv::ObjType() {
...
// objType
//------------------------------------------------------------------------------
const unsigned int castor::db::cnv::DbStageReleaseFilesRequestCnv::objType() const {
  return ObjType();
}
...
// fillRep
//------------------------------------------------------------------------------
void castor::db::cnv::DbStageReleaseFilesRequestCnv::fillRep(castor::IAddress* address,
...
// fillRepSubRequest
//------------------------------------------------------------------------------
void castor::db::cnv::DbStageReleaseFilesRequestCnv::fillRepSubRequest(castor::stager::StageReleaseFilesRequest* obj)
  throw (castor::exception::Exception) {
...
// fillRepSvcClass
//------------------------------------------------------------------------------
void castor::db::cnv::DbStageReleaseFilesRequestCnv::fillRepSvcClass(castor::stager::StageReleaseFilesRequest* obj)
  throw (castor::exception::Exception) {
  if (0 != obj->svcClass()) {
...
// fillRepIClient
//------------------------------------------------------------------------------
void castor::db::cnv::DbStageReleaseFilesRequestCnv::fillRepIClient(castor::stager::StageReleaseFilesRequest* obj)
  throw (castor::exception::Exception) {
  // Check update statement
...
// fillObj
//------------------------------------------------------------------------------
void castor::db::cnv::DbStageReleaseFilesRequestCnv::fillObj(castor::IAddress* address,
                                                             castor::IObject* object,
                                                             unsigned int type,
                                                             bool endTransaction)
  throw (castor::exception::Exception) {
...
// fillObjSubRequest
//------------------------------------------------------------------------------
void castor::db::cnv::DbStageReleaseFilesRequestCnv::fillObjSubRequest(castor::stager::StageReleaseFilesRequest* obj)
  throw (castor::exception::Exception) {
  // Check select statement
  if (0 == m_selectSubRequestStatement) {
    m_selectSubRequestStatement = createStatement(s_selectSubRequestStatementString);
...
// fillObjSvcClass
//------------------------------------------------------------------------------
void castor::db::cnv::DbStageReleaseFilesRequestCnv::fillObjSvcClass(castor::stager::StageReleaseFilesRequest* obj)
  throw (castor::exception::Exception) {
...
// fillObjIClient
//------------------------------------------------------------------------------
void castor::db::cnv::DbStageReleaseFilesRequestCnv::fillObjIClient(castor::stager::StageReleaseFilesRequest* obj)
  throw (castor::exception::Exception) {
  // Check whether the statement is ok
  if (0 == m_selectStatement) {
    m_selectStatement = createStatement(s_selectStatementString);
...
// createRep
//------------------------------------------------------------------------------
void castor::db::cnv::DbStageReleaseFilesRequestCnv::createRep(castor::IAddress* address,
                                                               castor::IObject* object,
                                                               bool endTransaction,
                                                               unsigned int type)
  throw (castor::exception::Exception) {
...
// bulkCreateRep
//------------------------------------------------------------------------------
void castor::db::cnv::DbStageReleaseFilesRequestCnv::bulkCreateRep(castor::IAddress* address,
  ...
  if (0 == nb) return;
  // Casts all objects
  std::vector<castor::stager::StageReleaseFilesRequest*> objs;
  for (int i = 0; i < nb; i++) {
    objs.push_back(dynamic_cast<castor::stager::StageReleaseFilesRequest*>(objects[i]));
  }
...
// updateRep
//------------------------------------------------------------------------------
void castor::db::cnv::DbStageReleaseFilesRequestCnv::updateRep(castor::IAddress* address,
                                                               castor::IObject* object,
                                                               bool endTransaction)
  throw (castor::exception::Exception) {
  castor::stager::StageReleaseFilesRequest* obj = 
...
// deleteRep
//------------------------------------------------------------------------------
void castor::db::cnv::DbStageReleaseFilesRequestCnv::deleteRep(castor::IAddress* address,
                                                               castor::IObject* object,
                                                               bool endTransaction)
  throw (castor::exception::Exception) {
  castor::stager::StageReleaseFilesRequest* obj = 
...
// createObj
//------------------------------------------------------------------------------
castor::IObject* castor::db::cnv::DbStageReleaseFilesRequestCnv::createObj(castor::IAddress* address)
  throw (castor::exception::Exception) {
  castor::BaseAddress* ad = 
...
castor::db::cnv::DbStageReleaseFilesRequestCnv::bulkCreateObj(castor::IAddress* address)
  throw (castor::exception::Exception) {
  // Prepare result
...
// updateObj
//------------------------------------------------------------------------------
void castor::db::cnv::DbStageReleaseFilesRequestCnv::updateObj(castor::IObject* obj)
  throw (castor::exception::Exception) {
  try {
    // Check whether the statement is ok
    if (0 == m_selectStatement) {
