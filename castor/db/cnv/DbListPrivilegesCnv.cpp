...
void castor::db::cnv::DbListPrivilegesCnv::bulkCreateRep(castor::IAddress* address,
  ...
  try {
    ...
    m_insertStatement->setDataBuffer
      (13, userIdBuffer, DBTYPE_INT, sizeof(userIdBuffer[0]), userIdBufLens);
    ...
    m_insertStatement->setDataBuffer
      (14, groupIdBuffer, DBTYPE_INT, sizeof(groupIdBuffer[0]), groupIdBufLens);
    ...
    m_insertStatement->setDataBuffer
      (15, requestTypeBuffer, DBTYPE_INT, sizeof(requestTypeBuffer[0]), requestTypeBufLens);
