...
namespace castor {
  ...
  namespace db {
    ...
    namespace cnv {
      ...
      /**
       * class DbStageGetRequestCnv
       * A converter for storing/retrieving StageGetRequest into/from a generic database
       */
      class DbStageGetRequestCnv : public DbBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        DbStageGetRequestCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~DbStageGetRequestCnv() throw();
      ...
      }; // end of class DbStageGetRequestCnv
