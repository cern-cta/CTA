  ...
  namespace db {
    ...
    namespace cnv {
      ...
      public:
         ...
         * Constructor
         */
        DbTapeAccessSpecificationCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~DbTapeAccessSpecificationCnv() throw();
      ...
      private:
        ...
        /// SQL remote update statement object for member 
        castor::db::IDbStatement *m_remoteUpdateTapeDriveCompatibilityStatement;
