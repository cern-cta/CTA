...
namespace castor {
  ...
  namespace db {
    ...
    namespace cnv {
      ...
      /**
       * class DbGetUpdateStartRequestCnv
       * A converter for storing/retrieving GetUpdateStartRequest into/from a generic
       * database
       */
      class DbGetUpdateStartRequestCnv : public DbBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        DbGetUpdateStartRequestCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~DbGetUpdateStartRequestCnv() throw();
