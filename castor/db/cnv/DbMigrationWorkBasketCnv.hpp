...
/******************************************************************************
 *                      castor/db/cnv/DbMigrationWorkBasketCnv.hpp
 *
...
#ifndef CASTOR_DB_CNV_MIGRATIONWORKBASKET_HPP
#define CASTOR_DB_CNV_MIGRATIONWORKBASKET_HPP
...
namespace castor {
  ...
  namespace db {
    ...
    namespace cnv {
      ...
      /**
       * class DbMigrationWorkBasketCnv
       * A converter for storing/retrieving MigrationWorkBasket into/from a generic
       * database
       */
      class DbMigrationWorkBasketCnv : public DbBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        DbMigrationWorkBasketCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~DbMigrationWorkBasketCnv() throw();
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillRepTapeCopy(castor::tape::tapegateway::MigrationWorkBasket* obj)
          throw (castor::exception::Exception);

        /**
         * Fill the database with objects of type TapeRequestState refered by a given
         * object.
         * @param obj the original object
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillRepTapeRequestState(castor::tape::tapegateway::MigrationWorkBasket* obj)
          throw (castor::exception::Exception);
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillObjTapeCopy(castor::tape::tapegateway::MigrationWorkBasket* obj)
          throw (castor::exception::Exception);

        /**
         * Retrieve from the database objects of type TapeRequestState refered by a given
         * object.
         * @param obj the original object
         * @exception Exception throws an Exception in case of error
         */
      ...
      private:
        ...
        /// SQL checkExist statement for member tapecopy
        static const std::string s_checkTapeCopyExistStatementString;

        /// SQL checkExist statement object for member tapecopy
        ...
        /// SQL update statement object for member tapecopy
        castor::db::IDbStatement *m_updateTapeCopyStatement;

        /// SQL checkExist statement for member tapeRequest
        static const std::string s_checkTapeRequestStateExistStatementString;

        /// SQL checkExist statement object for member tapeRequest
        castor::db::IDbStatement *m_checkTapeRequestStateExistStatement;

        /// SQL update statement for member tapeRequest
        static const std::string s_updateTapeRequestStateStatementString;
...
#endif // CASTOR_DB_CNV_MIGRATIONWORKBASKET_HPP
