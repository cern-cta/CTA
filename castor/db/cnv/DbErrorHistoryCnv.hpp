...
/******************************************************************************
 *                      castor/db/cnv/DbErrorHistoryCnv.hpp
 *
...
#ifndef CASTOR_DB_CNV_ERRORHISTORY_HPP
#define CASTOR_DB_CNV_ERRORHISTORY_HPP
...
namespace castor {
  ...
  namespace db {
    ...
    namespace cnv {
      ...
      /**
       * class DbErrorHistoryCnv
       * A converter for storing/retrieving ErrorHistory into/from a generic database
       */
      class DbErrorHistoryCnv : public DbBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        DbErrorHistoryCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~DbErrorHistoryCnv() throw();
...
#endif // CASTOR_DB_CNV_ERRORHISTORY_HPP
