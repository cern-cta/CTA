...
namespace castor {
  ...
  namespace db {
    ...
    namespace cnv {
      ...
      /**
       * class DbVdqmTapeCnv
       * A converter for storing/retrieving VdqmTape into/from a generic database
       */
      class DbVdqmTapeCnv : public DbBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        DbVdqmTapeCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~DbVdqmTapeCnv() throw();
