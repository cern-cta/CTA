...
namespace castor {
  ...
  namespace db {
    ...
    namespace cnv {
      ...
      /**
       * class DbStageAbortRequestCnv
       * A converter for storing/retrieving StageAbortRequest into/from a generic
       * database
       */
      class DbStageAbortRequestCnv : public DbBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        DbStageAbortRequestCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~DbStageAbortRequestCnv() throw();
      ...
      private:
        ...
        static const std::string s_selectNsFileIdStatementString;

        /// SQL select statement object for member files
        castor::db::IDbStatement *m_selectNsFileIdStatement;

        /// SQL delete statement for member files
        static const std::string s_deleteNsFileIdStatementString;

        /// SQL delete statement object for member files
        castor::db::IDbStatement *m_deleteNsFileIdStatement;

        /// SQL remote update statement for member files
        static const std::string s_remoteUpdateNsFileIdStatementString;

        /// SQL remote update statement object for member files
        castor::db::IDbStatement *m_remoteUpdateNsFileIdStatement;

      }; // end of class DbStageAbortRequestCnv
