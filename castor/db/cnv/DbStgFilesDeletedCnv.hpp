...
namespace castor {
  ...
  namespace db {
    ...
    namespace cnv {
      ...
      /**
       * class DbStgFilesDeletedCnv
       * A converter for storing/retrieving StgFilesDeleted into/from a generic database
       */
      class DbStgFilesDeletedCnv : public DbBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        DbStgFilesDeletedCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~DbStgFilesDeletedCnv() throw();
      ...
      private:
        ...
        static const std::string s_selectGCFileStatementString;

        /// SQL select statement object for member files
        castor::db::IDbStatement *m_selectGCFileStatement;

        /// SQL delete statement for member files
        static const std::string s_deleteGCFileStatementString;

        /// SQL delete statement object for member files
        castor::db::IDbStatement *m_deleteGCFileStatement;

        /// SQL remote update statement for member files
        static const std::string s_remoteUpdateGCFileStatementString;

        /// SQL remote update statement object for member files
        castor::db::IDbStatement *m_remoteUpdateGCFileStatement;
      ...
      }; // end of class DbStgFilesDeletedCnv
