...
/******************************************************************************
 *                      castor/db/cnv/DbGetUpdateDoneCnv.hpp
 *
...
#ifndef CASTOR_DB_CNV_GETUPDATEDONE_HPP
#define CASTOR_DB_CNV_GETUPDATEDONE_HPP
...
namespace castor {
  ...
  namespace db {
    ...
    namespace cnv {
      ...
      /**
       * class DbGetUpdateDoneCnv
       * A converter for storing/retrieving GetUpdateDone into/from a generic database
       */
      class DbGetUpdateDoneCnv : public DbBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        DbGetUpdateDoneCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~DbGetUpdateDoneCnv() throw();
      ...
      }; // end of class DbGetUpdateDoneCnv
...
#endif // CASTOR_DB_CNV_GETUPDATEDONE_HPP
