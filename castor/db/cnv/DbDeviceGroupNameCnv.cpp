...
/******************************************************************************
 *                      castor/db/cnv/DbDeviceGroupNameCnv.cpp
 *
...
// Include Files
#include "DbDeviceGroupNameCnv.hpp"
...
//------------------------------------------------------------------------------
static castor::CnvFactory<castor::db::cnv::DbDeviceGroupNameCnv>* s_factoryDbDeviceGroupNameCnv =
  new castor::CnvFactory<castor::db::cnv::DbDeviceGroupNameCnv>();

//------------------------------------------------------------------------------
// Static constants initialization
//------------------------------------------------------------------------------
/// SQL statement for request insertion
const std::string castor::db::cnv::DbDeviceGroupNameCnv::s_insertStatementString =
...
const std::string castor::db::cnv::DbDeviceGroupNameCnv::s_bulkInsertStatementString =
"INSERT /* bulk */ INTO DeviceGroupName (dgName, libraryName, id) VALUES (:1,:2,ids_seq.nextval) RETURNING id INTO :3";

/// SQL statement for request deletion
const std::string castor::db::cnv::DbDeviceGroupNameCnv::s_deleteStatementString =
"DELETE FROM DeviceGroupName WHERE id = :1";

/// SQL statement for request selection
const std::string castor::db::cnv::DbDeviceGroupNameCnv::s_selectStatementString =
"SELECT dgName, libraryName, id FROM DeviceGroupName WHERE id = :1";

/// SQL statement for bulk request selection
const std::string castor::db::cnv::DbDeviceGroupNameCnv::s_bulkSelectStatementString =
"DECLARE \
   TYPE RecordType IS RECORD (dgName VARCHAR2(2048), libraryName VARCHAR2(2048), id INTEGER); \
   ...
   BEGIN \
     ...
     OPEN objs FOR SELECT dgName, libraryName, id \
                     FROM DeviceGroupName t, bulkSelectHelper h \
                    WHERE t.id = h.objId; \
...
const std::string castor::db::cnv::DbDeviceGroupNameCnv::s_updateStatementString =
"UPDATE DeviceGroupName SET dgName = :1, libraryName = :2 WHERE id = :3";

/// SQL statement for type storage
const std::string castor::db::cnv::DbDeviceGroupNameCnv::s_storeTypeStatementString =
"INSERT INTO Id2Type (id, type) VALUES (:1, :2)";

const std::string castor::db::cnv::DbDeviceGroupNameCnv::s_storeTypeBulkStatementString =
"INSERT /* bulk */ INTO Id2Type (id, type) VALUES (:1, :2)";

/// SQL statement for type deletion
const std::string castor::db::cnv::DbDeviceGroupNameCnv::s_deleteTypeStatementString =
"DELETE FROM Id2Type WHERE id = :1";

//------------------------------------------------------------------------------
// Constructor
//------------------------------------------------------------------------------
castor::db::cnv::DbDeviceGroupNameCnv::DbDeviceGroupNameCnv(castor::ICnvSvc* cnvSvc) :
  DbBaseCnv(cnvSvc),
  m_insertStatement(0),
...
void castor::db::cnv::DbDeviceGroupNameCnv::bulkCreateRep(castor::IAddress*,
  ...
  if (0 == nb) return;
  // Casts all objects
  std::vector<castor::vdqm::DeviceGroupName*> objs;
  for (int i = 0; i < nb; i++) {
    objs.push_back(dynamic_cast<castor::vdqm::DeviceGroupName*>(objects[i]));
  }
  ...
  try {
    ...
    if (0 == m_bulkInsertStatement) {
      ...
      m_bulkInsertStatement->registerOutParam(3, castor::db::DBTYPE_UINT64);
    }
    if (0 == m_storeTypeStatement) {
      m_storeTypeStatement = createStatement(s_storeTypeStatementString);
      m_storeTypeBulkStatement = createStatement(s_storeTypeBulkStatementString);
    ...
    m_bulkInsertStatement->setDataBuffer
      (1, dgNameBuffer, castor::db::DBTYPE_STRING, dgNameMaxLen, dgNameBufLens);
    ...
    if (libraryNameBuffer == 0) {
      castor::exception::OutOfMemory e;
      throw e;
    }
    allocMem.push_back(libraryNameBuffer);
    unsigned short* libraryNameBufLens = (unsigned short*) malloc(nb * sizeof(unsigned short));
    if (libraryNameBufLens == 0) {
      castor::exception::OutOfMemory e;
      throw e;
    }
    allocMem.push_back(libraryNameBufLens);
    for (int i = 0; i < nb; i++) {
    ...
    m_bulkInsertStatement->setDataBuffer
      (2, libraryNameBuffer, castor::db::DBTYPE_STRING, libraryNameMaxLen, libraryNameBufLens);
