...
namespace castor {
  ...
  namespace db {
    ...
    namespace cnv {
      ...
      /**
       * class DbMoverCloseRequestCnv
       * A converter for storing/retrieving MoverCloseRequest into/from a generic
       * database
       */
      class DbMoverCloseRequestCnv : public DbBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        DbMoverCloseRequestCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~DbMoverCloseRequestCnv() throw();
      ...
      }; // end of class DbMoverCloseRequestCnv
