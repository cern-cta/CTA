...
/******************************************************************************
 *                      castor/db/cnv/DbTapeCopyCnv.hpp
 *
...
#ifndef CASTOR_DB_CNV_TAPECOPY_HPP
#define CASTOR_DB_CNV_TAPECOPY_HPP
...
namespace castor {
  ...
  namespace db {
    ...
    namespace cnv {
      ...
      /**
       * class DbTapeCopyCnv
       * A converter for storing/retrieving TapeCopy into/from a generic database
       */
      class DbTapeCopyCnv : public DbBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        DbTapeCopyCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~DbTapeCopyCnv() throw();
      ...
      private:
        ...
        castor::db::IDbStatement *m_insertStreamStatement;
...
#endif // CASTOR_DB_CNV_TAPECOPY_HPP
