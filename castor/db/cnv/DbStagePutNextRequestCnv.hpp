...
/******************************************************************************
 *                      castor/db/cnv/DbStagePutNextRequestCnv.hpp
 *
...
#ifndef CASTOR_DB_CNV_STAGEPUTNEXTREQUEST_HPP
#define CASTOR_DB_CNV_STAGEPUTNEXTREQUEST_HPP
...
namespace castor {
  ...
  namespace db {
    ...
    namespace cnv {
      ...
      /**
       * class DbStagePutNextRequestCnv
       * A converter for storing/retrieving StagePutNextRequest into/from a generic
       */
      class DbStagePutNextRequestCnv : public DbBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        DbStagePutNextRequestCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~DbStagePutNextRequestCnv() throw();
      ...
      }; // end of class DbStagePutNextRequestCnv
...
#endif // CASTOR_DB_CNV_STAGEPUTNEXTREQUEST_HPP
