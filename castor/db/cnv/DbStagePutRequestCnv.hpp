...
namespace castor {
  ...
  namespace db {
    ...
    namespace cnv {
      ...
      /**
       * class DbStagePutRequestCnv
       * A converter for storing/retrieving StagePutRequest into/from a generic database
       */
      class DbStagePutRequestCnv : public DbBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        DbStagePutRequestCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~DbStagePutRequestCnv() throw();
      ...
      }; // end of class DbStagePutRequestCnv
