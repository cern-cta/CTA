...
static castor::CnvFactory<castor::db::cnv::DbStagePutNextRequestCnv>* s_factoryDbStagePutNextRequestCnv =
  new castor::CnvFactory<castor::db::cnv::DbStagePutNextRequestCnv>();
...
const std::string castor::db::cnv::DbStagePutNextRequestCnv::s_bulkSelectStatementString =
"DECLARE \
   TYPE CurType IS REF CURSOR RETURN StagePutNextRequest%ROWTYPE; \
   ...
   BEGIN \
     ...
     OPEN objs FOR SELECT parentUuid, flags, userName, euid, egid, mask, pid, machine, svcClassName, userTag, reqId, creationTime, lastModificationTime, id, parent, svcClass, client \
                     FROM StagePutNextRequest t, bulkSelectHelper h \
                    WHERE t.id = h.objId; \
...
"INSERT /* StagePutNextRequest class */ INTO Id2Type (id, type) VALUES (:1, :2)";
...
// ObjType
//------------------------------------------------------------------------------
unsigned int castor::db::cnv::DbStagePutNextRequestCnv::ObjType() {
...
// objType
//------------------------------------------------------------------------------
unsigned int castor::db::cnv::DbStagePutNextRequestCnv::objType() const {
  return ObjType();
}
...
// fillRep
//------------------------------------------------------------------------------
void castor::db::cnv::DbStagePutNextRequestCnv::fillRep(castor::IAddress*,
...
// fillObj
//------------------------------------------------------------------------------
void castor::db::cnv::DbStagePutNextRequestCnv::fillObj(castor::IAddress*,
                                                        castor::IObject* object,
                                                        unsigned int type,
                                                        bool endTransaction)
  throw (castor::exception::Exception) {
...
// createRep
//------------------------------------------------------------------------------
void castor::db::cnv::DbStagePutNextRequestCnv::createRep(castor::IAddress*,
                                                          castor::IObject* object,
                                                          bool endTransaction,
                                                          unsigned int type)
  throw (castor::exception::Exception) {
...
// bulkCreateRep
//------------------------------------------------------------------------------
void castor::db::cnv::DbStagePutNextRequestCnv::bulkCreateRep(castor::IAddress*,
  ...
  if (0 == nb) return;
  // Casts all objects
  std::vector<castor::stager::StagePutNextRequest*> objs;
  for (int i = 0; i < nb; i++) {
    objs.push_back(dynamic_cast<castor::stager::StagePutNextRequest*>(objects[i]));
  }
...
// updateRep
//------------------------------------------------------------------------------
void castor::db::cnv::DbStagePutNextRequestCnv::updateRep(castor::IAddress*,
                                                          castor::IObject* object,
                                                          bool endTransaction)
  throw (castor::exception::Exception) {
  castor::stager::StagePutNextRequest* obj = 
...
// deleteRep
//------------------------------------------------------------------------------
void castor::db::cnv::DbStagePutNextRequestCnv::deleteRep(castor::IAddress*,
                                                          castor::IObject* object,
                                                          bool endTransaction)
  throw (castor::exception::Exception) {
  castor::stager::StagePutNextRequest* obj = 
...
castor::db::cnv::DbStagePutNextRequestCnv::bulkCreateObj(castor::IAddress* address)
  throw (castor::exception::Exception) {
  // Prepare result
