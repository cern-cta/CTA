...
/******************************************************************************
 *                      castor/db/cnv/DbChangePrivilegeCnv.hpp
 *
...
#ifndef CASTOR_DB_CNV_CHANGEPRIVILEGE_HPP
#define CASTOR_DB_CNV_CHANGEPRIVILEGE_HPP
...
namespace castor {
  ...
  namespace db {
    ...
    namespace cnv {
      ...
      /**
       * class DbChangePrivilegeCnv
       * A converter for storing/retrieving ChangePrivilege into/from a generic database
       */
      class DbChangePrivilegeCnv : public DbBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        DbChangePrivilegeCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~DbChangePrivilegeCnv() throw();
      ...
      private:
        ...
        static const std::string s_selectBWUserStatementString;

        /// SQL select statement object for member users
        castor::db::IDbStatement *m_selectBWUserStatement;

        /// SQL delete statement for member users
        static const std::string s_deleteBWUserStatementString;

        /// SQL delete statement object for member users
        castor::db::IDbStatement *m_deleteBWUserStatement;

        /// SQL remote update statement for member users
        static const std::string s_remoteUpdateBWUserStatementString;

        /// SQL remote update statement object for member users
        castor::db::IDbStatement *m_remoteUpdateBWUserStatement;

        /// SQL select statement for member requestTypes
        static const std::string s_selectRequestTypeStatementString;

        /// SQL select statement object for member requestTypes
        castor::db::IDbStatement *m_selectRequestTypeStatement;

        /// SQL delete statement for member requestTypes
        static const std::string s_deleteRequestTypeStatementString;

        /// SQL delete statement object for member requestTypes
        castor::db::IDbStatement *m_deleteRequestTypeStatement;

        /// SQL remote update statement for member requestTypes
        static const std::string s_remoteUpdateRequestTypeStatementString;

        /// SQL remote update statement object for member requestTypes
        castor::db::IDbStatement *m_remoteUpdateRequestTypeStatement;

      }; // end of class DbChangePrivilegeCnv
...
#endif // CASTOR_DB_CNV_CHANGEPRIVILEGE_HPP
