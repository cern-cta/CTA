...
namespace castor {
  ...
  namespace db {
    ...
    namespace cnv {
      ...
      /**
       * class DbStagePutDoneRequestCnv
       * A converter for storing/retrieving StagePutDoneRequest into/from a generic
       */
      class DbStagePutDoneRequestCnv : public DbBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        DbStagePutDoneRequestCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~DbStagePutDoneRequestCnv() throw();
      ...
      }; // end of class DbStagePutDoneRequestCnv
