...
/******************************************************************************
 *                      castor/db/cnv/DbRecallJobCnv.hpp
 *
...
#ifndef CASTOR_DB_CNV_RECALLJOB_HPP
#define CASTOR_DB_CNV_RECALLJOB_HPP
...
namespace castor {
  ...
  namespace db {
    ...
    namespace cnv {
      ...
      /**
       * class DbRecallJobCnv
       * A converter for storing/retrieving RecallJob into/from a generic database
       */
      class DbRecallJobCnv : public DbBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        DbRecallJobCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~DbRecallJobCnv() throw();
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillRepSegment(castor::stager::RecallJob* obj)
          throw (castor::exception::Exception);
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillRepCastorFile(castor::stager::RecallJob* obj)
          throw (castor::exception::Exception);
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillObjSegment(castor::stager::RecallJob* obj)
          throw (castor::exception::Exception);
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillObjCastorFile(castor::stager::RecallJob* obj)
          throw (castor::exception::Exception);
      ...
      private:
        ...
        castor::db::IDbStatement *m_selectSegmentStatement;
        ...
        castor::db::IDbStatement *m_deleteSegmentStatement;
        ...
        castor::db::IDbStatement *m_remoteUpdateSegmentStatement;
...
#endif // CASTOR_DB_CNV_RECALLJOB_HPP
