...
namespace castor {
  ...
  namespace db {
    ...
    namespace cnv {
      ...
      /**
       * class DbTapeDriveDedicationCnv
       * A converter for storing/retrieving TapeDriveDedication into/from a generic
       */
      class DbTapeDriveDedicationCnv : public DbBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        DbTapeDriveDedicationCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~DbTapeDriveDedicationCnv() throw();
      ...
      }; // end of class DbTapeDriveDedicationCnv
