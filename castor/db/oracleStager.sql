...
CREATE OR REPLACE PACKAGE castor AS
  ...
  REQUESTQUERYTYPE_FILENAME        CONSTANT PLS_INTEGER := 0;
  REQUESTQUERYTYPE_REQID           CONSTANT PLS_INTEGER := 1;
  REQUESTQUERYTYPE_USERTAG         CONSTANT PLS_INTEGER := 2;
  REQUESTQUERYTYPE_FILEID          CONSTANT PLS_INTEGER := 3;
  REQUESTQUERYTYPE_REQID_GETNEXT   CONSTANT PLS_INTEGER := 4;
  REQUESTQUERYTYPE_USERTAG_GETNEXT CONSTANT PLS_INTEGER := 5;
