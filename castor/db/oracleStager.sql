...
CREATE OR REPLACE PACKAGE castor AS
  ...
  REQUESTQRYTYPE_FILENAME        CONSTANT PLS_INTEGER := 0;
  REQUESTQRYTYPE_REQID           CONSTANT PLS_INTEGER := 1;
  REQUESTQRYTYPE_USERTAG         CONSTANT PLS_INTEGER := 2;
  REQUESTQRYTYPE_FILEID          CONSTANT PLS_INTEGER := 3;
  REQUESTQRYTYPE_REQID_GETNEXT   CONSTANT PLS_INTEGER := 4;
  REQUESTQRYTYPE_USERTAG_GETNEXT CONSTANT PLS_INTEGER := 5;
