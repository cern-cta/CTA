...
CREATE OR REPLACE PACKAGE castor AS
  ...
  -- Definition of PL/SQL constants
  -- SEGMENT
  ...
  -- STREAMDIRECTION
  STREAMDIRECTION_READ      CONSTANT PLS_INTEGER := 0;
  STREAMDIRECTION_WRITE     CONSTANT PLS_INTEGER := 1;
  STREAMDIRECTION_READWRITE CONSTANT PLS_INTEGER := 2;
  -- TAPEDRIVE
  TAPEDRIVE_UNIT_UP        CONSTANT PLS_INTEGER := 0;
  TAPEDRIVE_UNIT_ASSIGN    CONSTANT PLS_INTEGER := 2;
  TAPEDRIVE_FORCE_UNMOUNT  CONSTANT PLS_INTEGER := 4;
  TAPEDRIVE_UNIT_DOWN      CONSTANT PLS_INTEGER := 5;
  TAPEDRIVE_STATUS_UNKNOWN CONSTANT PLS_INTEGER := 7;
  -- TAPEREQUEST
