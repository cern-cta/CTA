...
create or replace
PROCEDURE fileMigrationUpdate (transactionId IN NUMBER, inputFileId  IN NUMBER,inputNsHost IN VARCHAR2, inputCopyNb IN INTEGER, inputErrorCode IN INTEGER, streamReport OUT castor.StreamReport_Cur) AS
tcNumb INTEGER;
dcId NUMBER;
cfId NUMBER;
reqId NUMBER;
