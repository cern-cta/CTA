...
CREATE TABLE BaseAddress (objType INT, cnvSvcName VARCHAR(2048), cnvSvcType INT, target BIGINT, id BIGINT, PRIMARY KEY (id));
...
CREATE TABLE Disk2DiskCopyDoneRequest (flags BIGINT, userName VARCHAR(2048), euid INT, egid INT, mask INT, pid INT, machine VARCHAR(2048), svcClassName VARCHAR(2048), userTag VARCHAR(2048), reqId VARCHAR(2048), creationTime BIGINT, lastModificationTime BIGINT, diskCopyId BIGINT, status INT, id BIGINT, PRIMARY KEY (id), svcClass INTEGER, client INTEGER);

/* SQL statements for type GetUpdateDone */
DROP TABLE GetUpdateDone;
CREATE TABLE GetUpdateDone (flags BIGINT, userName VARCHAR(2048), euid INT, egid INT, mask INT, pid INT, machine VARCHAR(2048), svcClassName VARCHAR(2048), userTag VARCHAR(2048), reqId VARCHAR(2048), creationTime BIGINT, lastModificationTime BIGINT, subReqId BIGINT, id BIGINT, PRIMARY KEY (id), svcClass INTEGER, client INTEGER);

/* SQL statements for type GetUpdateFailed */
DROP TABLE GetUpdateFailed;
CREATE TABLE GetUpdateFailed (flags BIGINT, userName VARCHAR(2048), euid INT, egid INT, mask INT, pid INT, machine VARCHAR(2048), svcClassName VARCHAR(2048), userTag VARCHAR(2048), reqId VARCHAR(2048), creationTime BIGINT, lastModificationTime BIGINT, subReqId BIGINT, id BIGINT, PRIMARY KEY (id), svcClass INTEGER, client INTEGER);

/* SQL statements for type PutFailed */
DROP TABLE PutFailed;
CREATE TABLE PutFailed (flags BIGINT, userName VARCHAR(2048), euid INT, egid INT, mask INT, pid INT, machine VARCHAR(2048), svcClassName VARCHAR(2048), userTag VARCHAR(2048), reqId VARCHAR(2048), creationTime BIGINT, lastModificationTime BIGINT, subReqId BIGINT, id BIGINT, PRIMARY KEY (id), svcClass INTEGER, client INTEGER);

/* SQL statements for type Files2Delete */
DROP TABLE Files2Delete;
CREATE TABLE Files2Delete (flags BIGINT, userName VARCHAR(2048), euid INT, egid INT, mask INT, pid INT, machine VARCHAR(2048), svcClassName VARCHAR(2048), userTag VARCHAR(2048), reqId VARCHAR(2048), creationTime BIGINT, lastModificationTime BIGINT, diskServer VARCHAR(2048), id BIGINT, PRIMARY KEY (id), svcClass INTEGER, client INTEGER);

/* SQL statements for type FilesDeleted */
DROP TABLE FilesDeleted;
CREATE TABLE FilesDeleted (flags BIGINT, userName VARCHAR(2048), euid INT, egid INT, mask INT, pid INT, machine VARCHAR(2048), svcClassName VARCHAR(2048), userTag VARCHAR(2048), reqId VARCHAR(2048), creationTime BIGINT, lastModificationTime BIGINT, id BIGINT, PRIMARY KEY (id), svcClass INTEGER, client INTEGER);

/* SQL statements for type FilesDeletionFailed */
DROP TABLE FilesDeletionFailed;
CREATE TABLE FilesDeletionFailed (flags BIGINT, userName VARCHAR(2048), euid INT, egid INT, mask INT, pid INT, machine VARCHAR(2048), svcClassName VARCHAR(2048), userTag VARCHAR(2048), reqId VARCHAR(2048), creationTime BIGINT, lastModificationTime BIGINT, id BIGINT, PRIMARY KEY (id), svcClass INTEGER, client INTEGER);

/* SQL statements for type GCFile */
DROP TABLE GCFile;
CREATE TABLE GCFile (diskCopyId BIGINT, id BIGINT, PRIMARY KEY (id), request INTEGER);

/* SQL statements for type GCLocalFile */
DROP TABLE GCLocalFile;
CREATE TABLE GCLocalFile (fileName VARCHAR(2048), diskCopyId BIGINT, id BIGINT, PRIMARY KEY (id));

/* SQL statements for type MoverCloseRequest */
DROP TABLE MoverCloseRequest;
CREATE TABLE MoverCloseRequest (flags BIGINT, userName VARCHAR(2048), euid INT, egid INT, mask INT, pid INT, machine VARCHAR(2048), svcClassName VARCHAR(2048), userTag VARCHAR(2048), reqId VARCHAR(2048), creationTime BIGINT, lastModificationTime BIGINT, subReqId BIGINT, fileSize BIGINT, id BIGINT, PRIMARY KEY (id), svcClass INTEGER, client INTEGER);

/* SQL statements for type PutStartRequest */
DROP TABLE PutStartRequest;
CREATE TABLE PutStartRequest (subreqId BIGINT, diskServer VARCHAR(2048), fileSystem VARCHAR(2048), flags BIGINT, userName VARCHAR(2048), euid INT, egid INT, mask INT, pid INT, machine VARCHAR(2048), svcClassName VARCHAR(2048), userTag VARCHAR(2048), reqId VARCHAR(2048), creationTime BIGINT, lastModificationTime BIGINT, id BIGINT, PRIMARY KEY (id), svcClass INTEGER, client INTEGER);
...
CREATE TABLE QueryParameter (value VARCHAR(2048), id BIGINT, PRIMARY KEY (id), query INTEGER, queryType INTEGER);

/* SQL statements for type StagePrepareToGetRequest */
DROP TABLE StagePrepareToGetRequest;
CREATE TABLE StagePrepareToGetRequest (flags BIGINT, userName VARCHAR(2048), euid INT, egid INT, mask INT, pid INT, machine VARCHAR(2048), svcClassName VARCHAR(2048), userTag VARCHAR(2048), reqId VARCHAR(2048), creationTime BIGINT, lastModificationTime BIGINT, id BIGINT, PRIMARY KEY (id), svcClass INTEGER, client INTEGER);

/* SQL statements for type StagePrepareToPutRequest */
DROP TABLE StagePrepareToPutRequest;
CREATE TABLE StagePrepareToPutRequest (flags BIGINT, userName VARCHAR(2048), euid INT, egid INT, mask INT, pid INT, machine VARCHAR(2048), svcClassName VARCHAR(2048), userTag VARCHAR(2048), reqId VARCHAR(2048), creationTime BIGINT, lastModificationTime BIGINT, id BIGINT, PRIMARY KEY (id), svcClass INTEGER, client INTEGER);

/* SQL statements for type StagePrepareToUpdateRequest */
DROP TABLE StagePrepareToUpdateRequest;
CREATE TABLE StagePrepareToUpdateRequest (flags BIGINT, userName VARCHAR(2048), euid INT, egid INT, mask INT, pid INT, machine VARCHAR(2048), svcClassName VARCHAR(2048), userTag VARCHAR(2048), reqId VARCHAR(2048), creationTime BIGINT, lastModificationTime BIGINT, id BIGINT, PRIMARY KEY (id), svcClass INTEGER, client INTEGER);

/* SQL statements for type StageGetRequest */
DROP TABLE StageGetRequest;
CREATE TABLE StageGetRequest (flags BIGINT, userName VARCHAR(2048), euid INT, egid INT, mask INT, pid INT, machine VARCHAR(2048), svcClassName VARCHAR(2048), userTag VARCHAR(2048), reqId VARCHAR(2048), creationTime BIGINT, lastModificationTime BIGINT, id BIGINT, PRIMARY KEY (id), svcClass INTEGER, client INTEGER);

/* SQL statements for type StagePutRequest */
DROP TABLE StagePutRequest;
CREATE TABLE StagePutRequest (flags BIGINT, userName VARCHAR(2048), euid INT, egid INT, mask INT, pid INT, machine VARCHAR(2048), svcClassName VARCHAR(2048), userTag VARCHAR(2048), reqId VARCHAR(2048), creationTime BIGINT, lastModificationTime BIGINT, id BIGINT, PRIMARY KEY (id), svcClass INTEGER, client INTEGER);

/* SQL statements for type StageUpdateRequest */
DROP TABLE StageUpdateRequest;
CREATE TABLE StageUpdateRequest (flags BIGINT, userName VARCHAR(2048), euid INT, egid INT, mask INT, pid INT, machine VARCHAR(2048), svcClassName VARCHAR(2048), userTag VARCHAR(2048), reqId VARCHAR(2048), creationTime BIGINT, lastModificationTime BIGINT, id BIGINT, PRIMARY KEY (id), svcClass INTEGER, client INTEGER);

/* SQL statements for type StageRmRequest */
DROP TABLE StageRmRequest;
CREATE TABLE StageRmRequest (flags BIGINT, userName VARCHAR(2048), euid INT, egid INT, mask INT, pid INT, machine VARCHAR(2048), svcClassName VARCHAR(2048), userTag VARCHAR(2048), reqId VARCHAR(2048), creationTime BIGINT, lastModificationTime BIGINT, id BIGINT, PRIMARY KEY (id), svcClass INTEGER, client INTEGER);

/* SQL statements for type StagePutDoneRequest */
DROP TABLE StagePutDoneRequest;
CREATE TABLE StagePutDoneRequest (flags BIGINT, userName VARCHAR(2048), euid INT, egid INT, mask INT, pid INT, machine VARCHAR(2048), svcClassName VARCHAR(2048), userTag VARCHAR(2048), reqId VARCHAR(2048), creationTime BIGINT, lastModificationTime BIGINT, parentUuid VARCHAR(2048), id BIGINT, PRIMARY KEY (id), svcClass INTEGER, client INTEGER, parent INTEGER);

/* SQL statements for type StageFileQueryRequest */
DROP TABLE StageFileQueryRequest;
CREATE TABLE StageFileQueryRequest (flags BIGINT, userName VARCHAR(2048), euid INT, egid INT, mask INT, pid INT, machine VARCHAR(2048), svcClassName VARCHAR(2048), userTag VARCHAR(2048), reqId VARCHAR(2048), creationTime BIGINT, lastModificationTime BIGINT, fileName VARCHAR(2048), id BIGINT, PRIMARY KEY (id), svcClass INTEGER, client INTEGER);

/* SQL statements for type StageRequestQueryRequest */
DROP TABLE StageRequestQueryRequest;
CREATE TABLE StageRequestQueryRequest (flags BIGINT, userName VARCHAR(2048), euid INT, egid INT, mask INT, pid INT, machine VARCHAR(2048), svcClassName VARCHAR(2048), userTag VARCHAR(2048), reqId VARCHAR(2048), creationTime BIGINT, lastModificationTime BIGINT, id BIGINT, PRIMARY KEY (id), svcClass INTEGER, client INTEGER);

/* SQL statements for type StageFindRequestRequest */
DROP TABLE StageFindRequestRequest;
CREATE TABLE StageFindRequestRequest (flags BIGINT, userName VARCHAR(2048), euid INT, egid INT, mask INT, pid INT, machine VARCHAR(2048), svcClassName VARCHAR(2048), userTag VARCHAR(2048), reqId VARCHAR(2048), creationTime BIGINT, lastModificationTime BIGINT, id BIGINT, PRIMARY KEY (id), svcClass INTEGER, client INTEGER);

/* SQL statements for type SubRequest */
DROP TABLE SubRequest;
CREATE TABLE SubRequest (retryCounter INT, fileName VARCHAR(2048), protocol VARCHAR(2048), xsize BIGINT, priority INT, subreqId VARCHAR(2048), flags INT, modeBits INT, creationTime BIGINT, lastModificationTime BIGINT, id BIGINT, PRIMARY KEY (id), diskcopy INTEGER, castorFile INTEGER, parent INTEGER, status INTEGER, request INTEGER);

/* SQL statements for type StageReleaseFilesRequest */
DROP TABLE StageReleaseFilesRequest;
CREATE TABLE StageReleaseFilesRequest (flags BIGINT, userName VARCHAR(2048), euid INT, egid INT, mask INT, pid INT, machine VARCHAR(2048), svcClassName VARCHAR(2048), userTag VARCHAR(2048), reqId VARCHAR(2048), creationTime BIGINT, lastModificationTime BIGINT, id BIGINT, PRIMARY KEY (id), svcClass INTEGER, client INTEGER);

/* SQL statements for type StageAbortRequest */
DROP TABLE StageAbortRequest;
CREATE TABLE StageAbortRequest (parentUuid VARCHAR(2048), flags BIGINT, userName VARCHAR(2048), euid INT, egid INT, mask INT, pid INT, machine VARCHAR(2048), svcClassName VARCHAR(2048), userTag VARCHAR(2048), reqId VARCHAR(2048), creationTime BIGINT, lastModificationTime BIGINT, id BIGINT, PRIMARY KEY (id), parent INTEGER, svcClass INTEGER, client INTEGER);

/* SQL statements for type StageGetNextRequest */
DROP TABLE StageGetNextRequest;
CREATE TABLE StageGetNextRequest (parentUuid VARCHAR(2048), flags BIGINT, userName VARCHAR(2048), euid INT, egid INT, mask INT, pid INT, machine VARCHAR(2048), svcClassName VARCHAR(2048), userTag VARCHAR(2048), reqId VARCHAR(2048), creationTime BIGINT, lastModificationTime BIGINT, id BIGINT, PRIMARY KEY (id), parent INTEGER, svcClass INTEGER, client INTEGER);

/* SQL statements for type StagePutNextRequest */
DROP TABLE StagePutNextRequest;
CREATE TABLE StagePutNextRequest (parentUuid VARCHAR(2048), flags BIGINT, userName VARCHAR(2048), euid INT, egid INT, mask INT, pid INT, machine VARCHAR(2048), svcClassName VARCHAR(2048), userTag VARCHAR(2048), reqId VARCHAR(2048), creationTime BIGINT, lastModificationTime BIGINT, id BIGINT, PRIMARY KEY (id), parent INTEGER, svcClass INTEGER, client INTEGER);

/* SQL statements for type StageUpdateNextRequest */
DROP TABLE StageUpdateNextRequest;
CREATE TABLE StageUpdateNextRequest (parentUuid VARCHAR(2048), flags BIGINT, userName VARCHAR(2048), euid INT, egid INT, mask INT, pid INT, machine VARCHAR(2048), svcClassName VARCHAR(2048), userTag VARCHAR(2048), reqId VARCHAR(2048), creationTime BIGINT, lastModificationTime BIGINT, id BIGINT, PRIMARY KEY (id), parent INTEGER, svcClass INTEGER, client INTEGER);

/* SQL statements for type Tape */
DROP TABLE Tape;
CREATE TABLE Tape (vid VARCHAR(2048), side INT, tpmode INT, errMsgTxt VARCHAR(2048), errorCode INT, severity INT, vwAddress VARCHAR(2048), id BIGINT, PRIMARY KEY (id), stream INTEGER, status INTEGER);

/* SQL statements for type Segment */
DROP TABLE Segment;
CREATE TABLE Segment (fseq INT, offset BIGINT, bytes_in BIGINT, bytes_out BIGINT, host_bytes BIGINT, segmCksumAlgorithm VARCHAR(2048), segmCksum INT, errMsgTxt VARCHAR(2048), errorCode INT, severity INT, blockId0 INT, blockId1 INT, blockId2 INT, blockId3 INT, id BIGINT, PRIMARY KEY (id), tape INTEGER, copy INTEGER, status INTEGER);

/* SQL statements for type TapePool */
DROP TABLE TapePool;
CREATE TABLE TapePool (name VARCHAR(2048), id BIGINT, PRIMARY KEY (id));

/* SQL statements for type TapeCopy */
DROP TABLE TapeCopy;
CREATE TABLE TapeCopy (copyNb INT, id BIGINT, PRIMARY KEY (id), castorFile INTEGER, status INTEGER);

/* SQL statements for type CastorFile */
DROP TABLE CastorFile;
CREATE TABLE CastorFile (fileId BIGINT, nsHost VARCHAR(2048), fileSize BIGINT, creationTime BIGINT, lastAccessTime BIGINT, nbAccesses INT, id BIGINT, PRIMARY KEY (id), svcClass INTEGER, fileClass INTEGER);

/* SQL statements for type DiskCopy */
DROP TABLE DiskCopy;
CREATE TABLE DiskCopy (path VARCHAR(2048), gcWeight float, creationTime BIGINT, id BIGINT, PRIMARY KEY (id), fileSystem INTEGER, castorFile INTEGER, status INTEGER);

/* SQL statements for type FileSystem */
DROP TABLE FileSystem;
CREATE TABLE FileSystem (free BIGINT, weight float, fsDeviation float, mountPoint VARCHAR(2048), deltaWeight float, deltaFree INT, reservedSpace INT, id BIGINT, PRIMARY KEY (id), diskPool INTEGER, diskserver INTEGER, status INTEGER);

/* SQL statements for type SvcClass */
DROP TABLE SvcClass;
CREATE TABLE SvcClass (nbDrives INT, name VARCHAR(2048), defaultFileSize BIGINT, maxReplicaNb INT, replicationPolicy VARCHAR(2048), gcPolicy VARCHAR(2048), migratorPolicy VARCHAR(2048), recallerPolicy VARCHAR(2048), id BIGINT, PRIMARY KEY (id));
...
DROP TABLE DiskPool;
CREATE TABLE DiskPool (name VARCHAR(2048), id BIGINT, PRIMARY KEY (id));
...
DROP TABLE Stream;
CREATE TABLE Stream (initialSizeToTransfer BIGINT, id BIGINT, PRIMARY KEY (id), tape INTEGER, tapePool INTEGER, status INTEGER);
...
CREATE TABLE FileClass (name VARCHAR(2048), minFileSize BIGINT, maxFileSize BIGINT, nbCopies INT, id BIGINT, PRIMARY KEY (id));

/* SQL statements for type DiskServer */
DROP TABLE DiskServer;
CREATE TABLE DiskServer (name VARCHAR(2048), id BIGINT, PRIMARY KEY (id), status INTEGER);
