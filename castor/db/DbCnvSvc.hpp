...
namespace castor {
  ...
  namespace db {
      ...
      public:
         ...
         */
        void registerCnv(castor::db::DbBaseObj* cnv)
          throw() { m_registeredCnvs.insert(cnv); }

        /**
         * Unregistration of DB converters.
         */
        void unregisterCnv(castor::db::DbBaseObj* cnv)
      ...
      private:
        ...
        std::set<castor::db::DbBaseObj*> m_registeredCnvs;
