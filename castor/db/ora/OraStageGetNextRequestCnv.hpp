/******************************************************************************
 *                      castor/db/ora/OraStageGetNextRequestCnv.hpp
 *
...
#ifndef CASTOR_DB_ORA_STAGEGETNEXTREQUEST_HPP
...
namespace castor {
  ...
  namespace db {
    ...
    namespace ora {
      ...
      /**
       * class OraStageGetNextRequestCnv
       * A converter for storing/retrieving StageGetNextRequest into/from an Oracle
       * database
       */
      class OraStageGetNextRequestCnv : public OraBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        OraStageGetNextRequestCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~OraStageGetNextRequestCnv() throw();
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillRepFileRequest(castor::stager::StageGetNextRequest* obj)
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillObjFileRequest(castor::stager::StageGetNextRequest* obj)
          throw (castor::exception::Exception);
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillObjIClient(castor::stager::StageGetNextRequest* obj)
          throw (castor::exception::Exception);
