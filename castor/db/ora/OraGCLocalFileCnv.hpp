/******************************************************************************
 *                      castor/db/ora/OraGCLocalFileCnv.hpp
 *
...
#ifndef CASTOR_DB_ORA_GCLOCALFILE_HPP
#define CASTOR_DB_ORA_GCLOCALFILE_HPP
...
namespace castor {
  ...
  namespace db {
    ...
    namespace ora {
      ...
      /**
       * class OraGCLocalFileCnv
       * A converter for storing/retrieving GCLocalFile into/from an Oracle database
       */
      class OraGCLocalFileCnv : public OraBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        OraGCLocalFileCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~OraGCLocalFileCnv() throw();
      ...
      }; // end of class OraGCLocalFileCnv
...
#endif // CASTOR_DB_ORA_GCLOCALFILE_HPP
