 ...
 *
 * @(#)$RCSfile: OraStagerSvc.cpp,v $ $Revision: 1.112 $ $Release$ $Date: 2005/01/25 08:42:32 $ $Author: sponcec3 $
 *
...
(castor::stager::CastorFile *castorFile,
 ...
 unsigned long egid)
  ...
  for (int i = 0; i < nbNsSegments; i++) {
    ...
    segment->setBytes_in(nsSegmentAttrs[i].segsize);
