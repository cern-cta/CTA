/******************************************************************************
 *                      castor/db/ora/OraStageRmRequestCnv.hpp
 *
...
#ifndef CASTOR_DB_ORA_STAGERMREQUEST_HPP
#define CASTOR_DB_ORA_STAGERMREQUEST_HPP
...
namespace castor {
  ...
  namespace db {
    ...
    namespace ora {
      ...
      /**
       * class OraStageRmRequestCnv
       * A converter for storing/retrieving StageRmRequest into/from an Oracle database
       */
      class OraStageRmRequestCnv : public OraBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        OraStageRmRequestCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~OraStageRmRequestCnv() throw();
      ...
      }; // end of class OraStageRmRequestCnv
...
#endif // CASTOR_DB_ORA_STAGERMREQUEST_HPP
