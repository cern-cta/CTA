/******************************************************************************
 *                      castor/db/ora/OraFileClassCnv.hpp
 *
...
#ifndef CASTOR_DB_ORA_FILECLASS_HPP
#define CASTOR_DB_ORA_FILECLASS_HPP
...
namespace castor {
  ...
  namespace db {
    ...
    namespace ora {
      ...
      /**
       * class OraFileClassCnv
       * A converter for storing/retrieving FileClass into/from an Oracle database
       */
      class OraFileClassCnv : public OraBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        OraFileClassCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~OraFileClassCnv() throw();
