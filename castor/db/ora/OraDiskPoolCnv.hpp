/******************************************************************************
 *                      castor/db/ora/OraDiskPoolCnv.hpp
 *
...
#ifndef CASTOR_DB_ORA_DISKPOOL_HPP
#define CASTOR_DB_ORA_DISKPOOL_HPP
...
namespace castor {
  ...
  namespace db {
    ...
    namespace ora {
      ...
      /**
       * class OraDiskPoolCnv
       * A converter for storing/retrieving DiskPool into/from an Oracle database
       */
      class OraDiskPoolCnv : public OraBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        OraDiskPoolCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~OraDiskPoolCnv() throw();
...
#endif // CASTOR_DB_ORA_DISKPOOL_HPP
