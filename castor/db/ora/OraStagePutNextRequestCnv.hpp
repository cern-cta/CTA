/******************************************************************************
 *                      castor/db/ora/OraStagePutNextRequestCnv.hpp
 *
...
#ifndef CASTOR_DB_ORA_STAGEPUTNEXTREQUEST_HPP
#define CASTOR_DB_ORA_STAGEPUTNEXTREQUEST_HPP
...
namespace castor {
  ...
  namespace db {
    ...
    namespace ora {
      ...
      /**
       * class OraStagePutNextRequestCnv
       * A converter for storing/retrieving StagePutNextRequest into/from an Oracle
       * database
       */
      class OraStagePutNextRequestCnv : public OraBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        OraStagePutNextRequestCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~OraStagePutNextRequestCnv() throw();
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillRepFileRequest(castor::stager::StagePutNextRequest* obj)
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillRepSvcClass(castor::stager::StagePutNextRequest* obj)
          throw (castor::exception::Exception, oracle::occi::SQLException);
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillRepIClient(castor::stager::StagePutNextRequest* obj)
          throw (castor::exception::Exception, oracle::occi::SQLException);
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillObjFileRequest(castor::stager::StagePutNextRequest* obj)
          throw (castor::exception::Exception);
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillObjSvcClass(castor::stager::StagePutNextRequest* obj)
          throw (castor::exception::Exception);
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillObjIClient(castor::stager::StagePutNextRequest* obj)
          throw (castor::exception::Exception);
      ...
      }; // end of class OraStagePutNextRequestCnv
...
#endif // CASTOR_DB_ORA_STAGEPUTNEXTREQUEST_HPP
