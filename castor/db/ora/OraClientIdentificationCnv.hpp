...
/******************************************************************************
 *                      castor/db/ora/OraClientIdentificationCnv.hpp
 *
...
#ifndef CASTOR_DB_ORA_CLIENTIDENTIFICATION_HPP
#define CASTOR_DB_ORA_CLIENTIDENTIFICATION_HPP
...
namespace castor {
  ...
  namespace db {
    ...
    namespace ora {
      ...
      /**
       * class OraClientIdentificationCnv
       * A converter for storing/retrieving ClientIdentification into/from an Oracle
       * database
       */
      class OraClientIdentificationCnv : public OraBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        OraClientIdentificationCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~OraClientIdentificationCnv() throw();
      ...
      }; // end of class OraClientIdentificationCnv
...
#endif // CASTOR_DB_ORA_CLIENTIDENTIFICATION_HPP
