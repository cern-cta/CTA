/******************************************************************************
 *                      castor/db/ora/OraGetUpdateStartRequestCnv.hpp
 *
...
#ifndef CASTOR_DB_ORA_GETUPDATESTARTREQUEST_HPP
#define CASTOR_DB_ORA_GETUPDATESTARTREQUEST_HPP
  ...
  namespace db {
    ...
    namespace ora {
      ...
      public:
         ...
         * Constructor
         */
        OraGetUpdateStartRequestCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~OraGetUpdateStartRequestCnv() throw();
      ...
      }; // end of class OraGetUpdateStartRequestCnv
...
#endif // CASTOR_DB_ORA_GETUPDATESTARTREQUEST_HPP
