...
<<<<<<< OraRepackSegmentCnv.hpp
/******************************************************************************
 *                      castor/db/ora/OraRepackSegmentCnv.hpp
 *
...
=======
>>>>>>> 1.3.4.1
#ifndef CASTOR_DB_ORA_REPACKSEGMENT_HPP
#define CASTOR_DB_ORA_REPACKSEGMENT_HPP
...
namespace castor {
  ...
  namespace db {
    ...
    namespace ora {
      ...
      /**
       * class OraRepackSegmentCnv
       * A converter for storing/retrieving RepackSegment into/from an Oracle database
       */
      class OraRepackSegmentCnv : public OraBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        OraRepackSegmentCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~OraRepackSegmentCnv() throw();
      ...
      private:
        ...
        oracle::occi::Statement *m_checkRepackSubRequestExistStatement;
        ...
        oracle::occi::Statement *m_updateRepackSubRequestStatement;

      }; // end of class OraRepackSegmentCnv
...
#endif // CASTOR_DB_ORA_REPACKSEGMENT_HPP
