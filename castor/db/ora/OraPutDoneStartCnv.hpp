...
/******************************************************************************
 *                      castor/db/ora/OraPutDoneStartCnv.hpp
 *
...
#ifndef CASTOR_DB_ORA_PUTDONESTART_HPP
#define CASTOR_DB_ORA_PUTDONESTART_HPP
...
namespace castor {
  ...
  namespace db {
    ...
    namespace ora {
      ...
      /**
       * class OraPutDoneStartCnv
       * A converter for storing/retrieving PutDoneStart into/from an Oracle database
       */
      class OraPutDoneStartCnv : public OraBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        OraPutDoneStartCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~OraPutDoneStartCnv() throw();
      ...
      }; // end of class OraPutDoneStartCnv
...
#endif // CASTOR_DB_ORA_PUTDONESTART_HPP
