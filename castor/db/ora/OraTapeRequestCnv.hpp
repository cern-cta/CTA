  ...
  namespace db {
    ...
    namespace ora {
      ...
      public:
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillRepExtendedDeviceGroup(castor::vdqm::TapeRequest* obj)
          throw (castor::exception::Exception, oracle::occi::SQLException);
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillObjExtendedDeviceGroup(castor::vdqm::TapeRequest* obj)
          throw (castor::exception::Exception);
      ...
      private:
        ...
        /// SQL checkExist statement object for member reqExtDevGrp
        oracle::occi::Statement *m_checkExtendedDeviceGroupExistStatement;

        /// SQL update statement for member reqExtDevGrp
        static const std::string s_updateExtendedDeviceGroupStatementString;

        /// SQL update statement object for member reqExtDevGrp
        oracle::occi::Statement *m_updateExtendedDeviceGroupStatement;
