...
/******************************************************************************
 *                      castor/db/ora/OraSetFileGCWeightCnv.hpp
 *
...
#ifndef CASTOR_DB_ORA_SETFILEGCWEIGHT_HPP
#define CASTOR_DB_ORA_SETFILEGCWEIGHT_HPP
...
namespace castor {
  ...
  namespace db {
    ...
    namespace ora {
      ...
      /**
       * class OraSetFileGCWeightCnv
       * A converter for storing/retrieving SetFileGCWeight into/from an Oracle database
       */
      class OraSetFileGCWeightCnv : public OraBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        OraSetFileGCWeightCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~OraSetFileGCWeightCnv() throw();
      ...
      }; // end of class OraSetFileGCWeightCnv
...
#endif // CASTOR_DB_ORA_SETFILEGCWEIGHT_HPP
