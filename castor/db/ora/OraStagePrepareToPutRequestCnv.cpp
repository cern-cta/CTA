...
const castor::IFactory<castor::IConverter>& OraStagePrepareToPutRequestCnvFactory = 
...
// Constructor
//------------------------------------------------------------------------------
castor::db::ora::OraStagePrepareToPutRequestCnv::OraStagePrepareToPutRequestCnv() :
  OraBaseCnv(),
  m_insertStatement(0),
  m_deleteStatement(0),
  m_selectStatement(0),
