/******************************************************************************
 *                      castor/db/ora/OraStageOutRequestCnv.hpp
 *
 ...
 *
 * @(#)$RCSfile: OraStageOutRequestCnv.hpp,v $ $Revision: 1.13 $ $Release$ $Date: 2004/11/05 17:47:22 $ $Author: sponcec3 $
 *
 * 
 *
...
#ifndef CASTOR_DB_ORA_STAGEOUTREQUEST_HPP
#define CASTOR_DB_ORA_STAGEOUTREQUEST_HPP
...
namespace castor {
  ...
  namespace db {
    ...
    namespace ora {
      ...
      /**
       * class OraStageOutRequestCnv
       * A converter for storing/retrieving StageOutRequest into/from an Oracle database
       */
      class OraStageOutRequestCnv : public OraBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        OraStageOutRequestCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~OraStageOutRequestCnv() throw();
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillObjSvcClass(castor::stager::StageOutRequest* obj)
          throw (castor::exception::Exception);
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillObjSubRequest(castor::stager::StageOutRequest* obj)
          throw (castor::exception::Exception);
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillObjIClient(castor::stager::StageOutRequest* obj)
          throw (castor::exception::Exception);
...
#endif // CASTOR_DB_ORA_STAGEOUTREQUEST_HPP
