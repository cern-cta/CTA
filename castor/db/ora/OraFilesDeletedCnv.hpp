/******************************************************************************
 *                      castor/db/ora/OraFilesDeletedCnv.hpp
 *
...
#ifndef CASTOR_DB_ORA_FILESDELETED_HPP
#define CASTOR_DB_ORA_FILESDELETED_HPP
...
namespace castor {
  ...
  namespace db {
    ...
    namespace ora {
      ...
      /**
       * class OraFilesDeletedCnv
       * A converter for storing/retrieving FilesDeleted into/from an Oracle database
       */
      class OraFilesDeletedCnv : public OraBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        OraFilesDeletedCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~OraFilesDeletedCnv() throw();
        ...
        /**
         * Fill the database with objects of type GCRemovedFile refered by a given object.
         * @param obj the original object
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillRepGCRemovedFile(castor::stager::FilesDeleted* obj)
          throw (castor::exception::Exception, oracle::occi::SQLException);
        ...
        /**
         * Retrieve from the database objects of type GCRemovedFile refered by a given
         * object.
         * @param obj the original object
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillObjGCRemovedFile(castor::stager::FilesDeleted* obj)
          throw (castor::exception::Exception);
      ...
      private:
        ...
        static const std::string s_selectGCRemovedFileStatementString;

        /// SQL select statement object for member files
        oracle::occi::Statement *m_selectGCRemovedFileStatement;

        /// SQL delete statement for member files
        static const std::string s_deleteGCRemovedFileStatementString;

        /// SQL delete statement object for member files
        oracle::occi::Statement *m_deleteGCRemovedFileStatement;

        /// SQL remote update statement for member files
        static const std::string s_remoteUpdateGCRemovedFileStatementString;

        /// SQL remote update statement object for member files
        oracle::occi::Statement *m_remoteUpdateGCRemovedFileStatement;
