/******************************************************************************
 *                      castor/db/ora/OraStageUpdateRequestCnv.hpp
 *
...
#ifndef CASTOR_DB_ORA_STAGEUPDATEREQUEST_HPP
#define CASTOR_DB_ORA_STAGEUPDATEREQUEST_HPP
...
namespace castor {
  ...
  namespace db {
    ...
    namespace ora {
      ...
      /**
       * class OraStageUpdateRequestCnv
       * A converter for storing/retrieving StageUpdateRequest into/from an Oracle
       * database
       */
      class OraStageUpdateRequestCnv : public OraBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        OraStageUpdateRequestCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~OraStageUpdateRequestCnv() throw();
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillRepSubRequest(castor::stager::StageUpdateRequest* obj)
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillRepSvcClass(castor::stager::StageUpdateRequest* obj)
          throw (castor::exception::Exception, oracle::occi::SQLException);
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillRepIClient(castor::stager::StageUpdateRequest* obj)
          throw (castor::exception::Exception, oracle::occi::SQLException);
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillObjSubRequest(castor::stager::StageUpdateRequest* obj)
          throw (castor::exception::Exception);
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillObjSvcClass(castor::stager::StageUpdateRequest* obj)
          throw (castor::exception::Exception);
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillObjIClient(castor::stager::StageUpdateRequest* obj)
          throw (castor::exception::Exception);
      ...
      }; // end of class OraStageUpdateRequestCnv
...
#endif // CASTOR_DB_ORA_STAGEUPDATEREQUEST_HPP
