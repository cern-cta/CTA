...
/******************************************************************************
 *                      castor/db/ora/OraErrorHistoryCnv.hpp
 *
...
#ifndef CASTOR_DB_ORA_ERRORHISTORY_HPP
#define CASTOR_DB_ORA_ERRORHISTORY_HPP
...
namespace castor {
  ...
  namespace db {
    ...
    namespace ora {
      ...
      /**
       * class OraErrorHistoryCnv
       * A converter for storing/retrieving ErrorHistory into/from an Oracle database
       */
      class OraErrorHistoryCnv : public OraBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        OraErrorHistoryCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~OraErrorHistoryCnv() throw();
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillRepTapeDrive(castor::vdqm::ErrorHistory* obj)
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillObjTapeDrive(castor::vdqm::ErrorHistory* obj)
          throw (castor::exception::Exception);
      ...
      }; // end of class OraErrorHistoryCnv
...
#endif // CASTOR_DB_ORA_ERRORHISTORY_HPP
