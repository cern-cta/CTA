/******************************************************************************
 *                      castor/db/ora/OraGCRemovedFileCnv.hpp
 *
...
#ifndef CASTOR_DB_ORA_GCREMOVEDFILE_HPP
#define CASTOR_DB_ORA_GCREMOVEDFILE_HPP
...
namespace castor {
  ...
  namespace db {
    ...
    namespace ora {
      ...
      /**
       * class OraGCRemovedFileCnv
       * A converter for storing/retrieving GCRemovedFile into/from an Oracle database
       */
      class OraGCRemovedFileCnv : public OraBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        OraGCRemovedFileCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~OraGCRemovedFileCnv() throw();
...
#endif // CASTOR_DB_ORA_GCREMOVEDFILE_HPP
