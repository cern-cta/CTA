...
static castor::CnvFactory<castor::db::ora::OraCastorFileCnv>* s_factoryOraCastorFileCnv =
  new castor::CnvFactory<castor::db::ora::OraCastorFileCnv>();
...
void castor::db::ora::OraCastorFileCnv::fillObjFileClass(castor::stager::CastorFile* obj)
  ...
  u_signed64 fileClassId = (u_signed64)rset->getDouble(11);
  // Close ResultSet
  m_selectStatement->closeResultSet(rset);
  // Check whether something should be deleted
  if (0 != obj->fileClass() &&
...
void castor::db::ora::OraCastorFileCnv::createRep(castor::IAddress* address,
  ...
  try {
    ...
    m_insertStatement->setDouble(6, obj->lastUpdateTime());
    m_insertStatement->setDouble(7, (type == OBJ_SvcClass && obj->svcClass() != 0) ? obj->svcClass()->id() : 0);
    m_insertStatement->setDouble(8, (type == OBJ_FileClass && obj->fileClass() != 0) ? obj->fileClass()->id() : 0);
  ...
  void castor::db::ora::OraCastorFileCnv::updateRep(castor::IAddress* address,
    ...
    try {
      ...
      m_updateStatement->setDouble(5, obj->lastUpdateTime());
    ...
    void castor::db::ora::OraCastorFileCnv::deleteRep(castor::IAddress* address,
      ...
      castor::IObject* castor::db::ora::OraCastorFileCnv::createObj(castor::IAddress* address)
        ...
        try {
          ...
          object->setLastUpdateTime((u_signed64)rset->getDouble(8));
