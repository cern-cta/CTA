  ...
  namespace db {
    ...
    namespace ora {
      ...
      public:
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillRepSubRequest(castor::stager::StageFileQueryRequest* obj)
          throw (castor::exception::Exception, oracle::occi::SQLException);
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillObjSubRequest(castor::stager::StageFileQueryRequest* obj)
          throw (castor::exception::Exception);
