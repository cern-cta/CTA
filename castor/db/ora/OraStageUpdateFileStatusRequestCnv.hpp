/******************************************************************************
 *                      castor/db/ora/OraStageUpdateFileStatusRequestCnv.hpp
 *
 ...
 *
 * @(#)$RCSfile: OraStageUpdateFileStatusRequestCnv.hpp,v $ $Revision: 1.6 $ $Release$ $Date: 2005/02/03 17:49:40 $ $Author: sponcec3 $
 *
 * 
 *
...
#ifndef CASTOR_DB_ORA_STAGEUPDATEFILESTATUSREQUEST_HPP
#define CASTOR_DB_ORA_STAGEUPDATEFILESTATUSREQUEST_HPP
...
namespace castor {
  ...
  namespace db {
    ...
    namespace ora {
      ...
      /**
       * class OraStageUpdateFileStatusRequestCnv
       * A converter for storing/retrieving StageUpdateFileStatusRequest into/from an
       * Oracle database
       */
      class OraStageUpdateFileStatusRequestCnv : public OraBaseCnv {
      ...
      public:
         ...
         * Destructor
         */
        virtual ~OraStageUpdateFileStatusRequestCnv() throw();
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillRepIClient(castor::stager::StageUpdateFileStatusRequest* obj)
          throw (castor::exception::Exception, oracle::occi::SQLException);
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillObjIClient(castor::stager::StageUpdateFileStatusRequest* obj)
          throw (castor::exception::Exception);
      ...
      }; // end of class OraStageUpdateFileStatusRequestCnv
...
#endif // CASTOR_DB_ORA_STAGEUPDATEFILESTATUSREQUEST_HPP
