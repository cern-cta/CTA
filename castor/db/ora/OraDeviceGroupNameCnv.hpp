...
/******************************************************************************
 *                      castor/db/ora/OraDeviceGroupNameCnv.hpp
 *
...
#ifndef CASTOR_DB_ORA_DEVICEGROUPNAME_HPP
#define CASTOR_DB_ORA_DEVICEGROUPNAME_HPP
...
namespace castor {
  ...
  namespace db {
    ...
    namespace ora {
      ...
      /**
       * class OraDeviceGroupNameCnv
       * A converter for storing/retrieving DeviceGroupName into/from an Oracle database
       */
      class OraDeviceGroupNameCnv : public OraBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        OraDeviceGroupNameCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~OraDeviceGroupNameCnv() throw();
      ...
      }; // end of class OraDeviceGroupNameCnv
...
#endif // CASTOR_DB_ORA_DEVICEGROUPNAME_HPP
