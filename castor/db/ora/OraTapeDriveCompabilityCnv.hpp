...
/******************************************************************************
 *                      castor/db/ora/OraTapeDriveCompabilityCnv.hpp
 *
...
#ifndef CASTOR_DB_ORA_TAPEDRIVECOMPABILITY_HPP
#define CASTOR_DB_ORA_TAPEDRIVECOMPABILITY_HPP
...
namespace castor {
  ...
  namespace db {
    ...
    namespace ora {
      ...
      /**
       * class OraTapeDriveCompabilityCnv
       * A converter for storing/retrieving TapeDriveCompability into/from an Oracle
       * database
       */
      class OraTapeDriveCompabilityCnv : public OraBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        OraTapeDriveCompabilityCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~OraTapeDriveCompabilityCnv() throw();
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillRepTapeAccessSpecification(castor::vdqm::TapeDriveCompability* obj)
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillObjTapeAccessSpecification(castor::vdqm::TapeDriveCompability* obj)
          throw (castor::exception::Exception);
      ...
      private:
        ...
        /// SQL checkExist statement for member tapeAccessSpecifications
        static const std::string s_checkTapeAccessSpecificationExistStatementString;

        /// SQL checkExist statement object for member tapeAccessSpecifications
        ...
        /// SQL update statement object for member tapeAccessSpecifications
        oracle::occi::Statement *m_updateTapeAccessSpecificationStatement;

      }; // end of class OraTapeDriveCompabilityCnv
...
#endif // CASTOR_DB_ORA_TAPEDRIVECOMPABILITY_HPP
