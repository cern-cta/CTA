 ...
 *
 * @(#)$RCSfile: OraStageOutRequestCnv.cpp,v $ $Revision: 1.22 $ $Release$ $Date: 2004/11/05 17:47:22 $ $Author: sponcec3 $
 *
 * 
 *
...
const castor::ICnvFactory& OraStageOutRequestCnvFactory = 
...
// Constructor
//------------------------------------------------------------------------------
castor::db::ora::OraStageOutRequestCnv::OraStageOutRequestCnv(castor::ICnvSvc* cnvSvc) :
  OraBaseCnv(cnvSvc),
  m_insertStatement(0),
  m_deleteStatement(0),
  m_selectStatement(0),
