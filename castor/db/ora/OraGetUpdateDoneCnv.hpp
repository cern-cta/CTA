/******************************************************************************
 *                      castor/db/ora/OraGetUpdateDoneCnv.hpp
 *
...
#ifndef CASTOR_DB_ORA_GETUPDATEDONE_HPP
#define CASTOR_DB_ORA_GETUPDATEDONE_HPP
...
namespace castor {
  ...
  namespace db {
    ...
    namespace ora {
      ...
      /**
       * class OraGetUpdateDoneCnv
       * A converter for storing/retrieving GetUpdateDone into/from an Oracle database
       */
      class OraGetUpdateDoneCnv : public OraBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        OraGetUpdateDoneCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~OraGetUpdateDoneCnv() throw();
      ...
      }; // end of class OraGetUpdateDoneCnv
...
#endif // CASTOR_DB_ORA_GETUPDATEDONE_HPP
