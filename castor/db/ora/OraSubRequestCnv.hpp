/******************************************************************************
 *                      castor/db/ora/OraSubRequestCnv.hpp
 *
...
#ifndef CASTOR_DB_ORA_SUBREQUEST_HPP
#define CASTOR_DB_ORA_SUBREQUEST_HPP
...
namespace castor {
  ...
  namespace db {
    ...
    namespace ora {
      ...
      /**
       * class OraSubRequestCnv
       * A converter for storing/retrieving SubRequest into/from an Oracle database
       */
      class OraSubRequestCnv : public OraBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        OraSubRequestCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~OraSubRequestCnv() throw();
...
#endif // CASTOR_DB_ORA_SUBREQUEST_HPP
