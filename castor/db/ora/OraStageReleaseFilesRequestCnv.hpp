/******************************************************************************
 *                      castor/db/ora/OraStageReleaseFilesRequestCnv.hpp
 *
...
#ifndef CASTOR_DB_ORA_STAGERELEASEFILESREQUEST_HPP
#define CASTOR_DB_ORA_STAGERELEASEFILESREQUEST_HPP
...
namespace castor {
  ...
  namespace db {
    ...
    namespace ora {
      ...
      /**
       * class OraStageReleaseFilesRequestCnv
       * A converter for storing/retrieving StageReleaseFilesRequest into/from an Oracle
       * database
       */
      class OraStageReleaseFilesRequestCnv : public OraBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        OraStageReleaseFilesRequestCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~OraStageReleaseFilesRequestCnv() throw();
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillRepSubRequest(castor::stager::StageReleaseFilesRequest* obj)
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillRepSvcClass(castor::stager::StageReleaseFilesRequest* obj)
          throw (castor::exception::Exception, oracle::occi::SQLException);
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillRepIClient(castor::stager::StageReleaseFilesRequest* obj)
          throw (castor::exception::Exception, oracle::occi::SQLException);
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillObjSubRequest(castor::stager::StageReleaseFilesRequest* obj)
          throw (castor::exception::Exception);
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillObjSvcClass(castor::stager::StageReleaseFilesRequest* obj)
          throw (castor::exception::Exception);
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillObjIClient(castor::stager::StageReleaseFilesRequest* obj)
          throw (castor::exception::Exception);
      ...
      }; // end of class OraStageReleaseFilesRequestCnv
...
#endif // CASTOR_DB_ORA_STAGERELEASEFILESREQUEST_HPP
