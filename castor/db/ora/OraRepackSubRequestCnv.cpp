...
<<<<<<< OraRepackSubRequestCnv.cpp
  u_signed64 requestIDId = (u_signed64)rset->getDouble(9);
=======
...
<<<<<<< OraRepackSubRequestCnv.cpp
    ...
    m_insertStatement->setDouble(8, (type == OBJ_RepackRequest && obj->requestID() != 0) ? obj->requestID()->id() : 0);
=======
