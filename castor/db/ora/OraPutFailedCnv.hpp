/******************************************************************************
 *                      castor/db/ora/OraPutFailedCnv.hpp
 *
...
#ifndef CASTOR_DB_ORA_PUTFAILED_HPP
#define CASTOR_DB_ORA_PUTFAILED_HPP
...
namespace castor {
  ...
  namespace db {
    ...
    namespace ora {
      ...
      /**
       * class OraPutFailedCnv
       * A converter for storing/retrieving PutFailed into/from an Oracle database
       */
      class OraPutFailedCnv : public OraBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        OraPutFailedCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~OraPutFailedCnv() throw();
...
#endif // CASTOR_DB_ORA_PUTFAILED_HPP
