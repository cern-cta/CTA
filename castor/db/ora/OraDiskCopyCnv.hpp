/******************************************************************************
 *                      castor/db/ora/OraDiskCopyCnv.hpp
 *
...
#ifndef CASTOR_DB_ORA_DISKCOPY_HPP
#define CASTOR_DB_ORA_DISKCOPY_HPP
...
namespace castor {
  ...
  namespace db {
    ...
    namespace ora {
      ...
      /**
       * class OraDiskCopyCnv
       * A converter for storing/retrieving DiskCopy into/from an Oracle database
       */
      class OraDiskCopyCnv : public OraBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        OraDiskCopyCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~OraDiskCopyCnv() throw();
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillRepFileSystem(castor::stager::DiskCopy* obj)
          throw (castor::exception::Exception, oracle::occi::SQLException);
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillRepCastorFile(castor::stager::DiskCopy* obj)
          throw (castor::exception::Exception, oracle::occi::SQLException);
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillObjFileSystem(castor::stager::DiskCopy* obj)
          throw (castor::exception::Exception);
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillObjCastorFile(castor::stager::DiskCopy* obj)
          throw (castor::exception::Exception);
...
#endif // CASTOR_DB_ORA_DISKCOPY_HPP
