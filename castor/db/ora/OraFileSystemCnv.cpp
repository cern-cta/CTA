...
void castor::db::ora::OraFileSystemCnv::fillObjDiskPool(castor::stager::FileSystem* obj)
  ...
  u_signed64 diskPoolId = (u_signed64)rset->getDouble(13);
  // Close ResultSet
...
void castor::db::ora::OraFileSystemCnv::fillObjDiskServer(castor::stager::FileSystem* obj)
  ...
  u_signed64 diskserverId = (u_signed64)rset->getDouble(14);
  // Close ResultSet
  m_selectStatement->closeResultSet(rset);
  // Check whether something should be deleted
  if (0 != obj->diskserver() &&
...
void castor::db::ora::OraFileSystemCnv::createRep(castor::IAddress* address,
  ...
  try {
    ...
    m_insertStatement->setDouble(11, obj->totalSize());
    m_insertStatement->setDouble(12, (type == OBJ_DiskPool && obj->diskPool() != 0) ? obj->diskPool()->id() : 0);
    m_insertStatement->setDouble(13, (type == OBJ_DiskServer && obj->diskserver() != 0) ? obj->diskserver()->id() : 0);
...
void castor::db::ora::OraFileSystemCnv::updateRep(castor::IAddress* address,
  ...
  try {
    ...
    m_updateStatement->setDouble(11, obj->totalSize());
...
castor::IObject* castor::db::ora::OraFileSystemCnv::createObj(castor::IAddress* address)
  ...
  try {
    ...
    object->setTotalSize((u_signed64)rset->getDouble(11));
