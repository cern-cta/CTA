...
/******************************************************************************
 *                      castor/db/ora/OraTapeServerCnv.hpp
 *
...
#ifndef CASTOR_DB_ORA_TAPESERVER_HPP
#define CASTOR_DB_ORA_TAPESERVER_HPP
...
namespace castor {
  ...
  namespace db {
    ...
    namespace ora {
      ...
      /**
       * class OraTapeServerCnv
       * A converter for storing/retrieving TapeServer into/from an Oracle database
       */
      class OraTapeServerCnv : public OraBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        OraTapeServerCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~OraTapeServerCnv() throw();
