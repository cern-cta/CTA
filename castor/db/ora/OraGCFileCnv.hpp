...
/******************************************************************************
 *                      castor/db/ora/OraGCFileCnv.hpp
 *
...
#ifndef CASTOR_DB_ORA_GCFILE_HPP
#define CASTOR_DB_ORA_GCFILE_HPP
...
namespace castor {
  ...
  namespace db {
    ...
    namespace ora {
      ...
      /**
       * class OraGCFileCnv
       * A converter for storing/retrieving GCFile into/from an Oracle database
       */
      class OraGCFileCnv : public OraBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        OraGCFileCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~OraGCFileCnv() throw();
        ...
        /**
         * Retrieve from the database objects of type GCFileList refered by a given object.
         * @param obj the original object
         * @exception Exception throws an Exception in case of error
         */
      ...
      private:
        ...
        oracle::occi::Statement *m_updateGCFileListStatement;
