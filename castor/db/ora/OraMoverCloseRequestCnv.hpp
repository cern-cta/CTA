/******************************************************************************
 *                      castor/db/ora/OraMoverCloseRequestCnv.hpp
 *
...
#ifndef CASTOR_DB_ORA_MOVERCLOSEREQUEST_HPP
#define CASTOR_DB_ORA_MOVERCLOSEREQUEST_HPP
...
namespace castor {
  ...
  namespace db {
    ...
    namespace ora {
      ...
      /**
       * class OraMoverCloseRequestCnv
       * A converter for storing/retrieving MoverCloseRequest into/from an Oracle
       * database
       */
      class OraMoverCloseRequestCnv : public OraBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        OraMoverCloseRequestCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~OraMoverCloseRequestCnv() throw();
      ...
      }; // end of class OraMoverCloseRequestCnv
...
#endif // CASTOR_DB_ORA_MOVERCLOSEREQUEST_HPP
