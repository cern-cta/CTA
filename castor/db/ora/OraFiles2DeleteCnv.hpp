/******************************************************************************
 *                      castor/db/ora/OraFiles2DeleteCnv.hpp
 *
...
#ifndef CASTOR_DB_ORA_FILES2DELETE_HPP
#define CASTOR_DB_ORA_FILES2DELETE_HPP
...
namespace castor {
  ...
  namespace db {
    ...
    namespace ora {
      ...
      /**
       * class OraFiles2DeleteCnv
       * A converter for storing/retrieving Files2Delete into/from an Oracle database
       */
      class OraFiles2DeleteCnv : public OraBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        OraFiles2DeleteCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~OraFiles2DeleteCnv() throw();
      ...
      }; // end of class OraFiles2DeleteCnv
...
#endif // CASTOR_DB_ORA_FILES2DELETE_HPP
