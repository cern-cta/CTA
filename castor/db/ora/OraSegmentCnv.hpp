/******************************************************************************
 *                      castor/db/ora/OraSegmentCnv.hpp
 *
...
#ifndef CASTOR_DB_ORA_SEGMENT_HPP
#define CASTOR_DB_ORA_SEGMENT_HPP
...
namespace castor {
  ...
  namespace db {
    ...
    namespace ora {
      ...
      /**
       * class OraSegmentCnv
       * A converter for storing/retrieving Segment into/from an Oracle database
       */
      class OraSegmentCnv : public OraBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        OraSegmentCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~OraSegmentCnv() throw();
...
#endif // CASTOR_DB_ORA_SEGMENT_HPP
