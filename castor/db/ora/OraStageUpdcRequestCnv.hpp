 ...
 *
 * @(#)$RCSfile: OraStageUpdcRequestCnv.hpp,v $ $Revision: 1.5 $ $Release$ $Date: 2004/10/13 09:01:54 $ $Author: sponcec3 $
 *
 * 
 *
  ...
  namespace db {
    ...
    namespace ora {
      ...
      private:
        ...
        /// SQL insert statement object for member reqids
        ...
        static const std::string s_ReqIdRequest2ReqIdStatementString;

        /// SQL select statement object for member reqids
        oracle::occi::Statement *m_ReqIdRequest2ReqIdStatement;
