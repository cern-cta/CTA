/******************************************************************************
 *                      castor/db/ora/OraStageUpdcRequestCnv.hpp
 *
 ...
 *
 * @(#)$RCSfile: OraStageUpdcRequestCnv.hpp,v $ $Revision: 1.13 $ $Release$ $Date: 2004/11/05 17:47:23 $ $Author: sponcec3 $
 *
 * 
 *
...
#ifndef CASTOR_DB_ORA_STAGEUPDCREQUEST_HPP
#define CASTOR_DB_ORA_STAGEUPDCREQUEST_HPP
...
namespace castor {
  ...
  namespace db {
    ...
    namespace ora {
      ...
      /**
       * class OraStageUpdcRequestCnv
       * A converter for storing/retrieving StageUpdcRequest into/from an Oracle database
       */
      class OraStageUpdcRequestCnv : public OraBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        OraStageUpdcRequestCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~OraStageUpdcRequestCnv() throw();
        ...
        /**
         * Fill the database with objects of type ReqId refered by a given object.
         * @param obj the original object
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillRepReqId(castor::stager::StageUpdcRequest* obj)
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillRepSvcClass(castor::stager::StageUpdcRequest* obj)
          throw (castor::exception::Exception, oracle::occi::SQLException);
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillRepSubRequest(castor::stager::StageUpdcRequest* obj)
          throw (castor::exception::Exception, oracle::occi::SQLException);
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillRepIClient(castor::stager::StageUpdcRequest* obj)
          throw (castor::exception::Exception, oracle::occi::SQLException);
        ...
        /**
         * Retrieve from the database objects of type ReqId refered by a given object.
         * @param obj the original object
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillObjReqId(castor::stager::StageUpdcRequest* obj)
          throw (castor::exception::Exception);
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillObjSvcClass(castor::stager::StageUpdcRequest* obj)
          throw (castor::exception::Exception);
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillObjSubRequest(castor::stager::StageUpdcRequest* obj)
          throw (castor::exception::Exception);
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillObjIClient(castor::stager::StageUpdcRequest* obj)
          throw (castor::exception::Exception);
      ...
      private:
        ...
        static const std::string s_selectReqIdStatementString;

        /// SQL select statement object for member reqids
        oracle::occi::Statement *m_selectReqIdStatement;

        /// SQL delete statement for member reqids
        static const std::string s_deleteReqIdStatementString;

        /// SQL delete statement object for member reqids
        oracle::occi::Statement *m_deleteReqIdStatement;

        /// SQL remote update statement for member reqids
        static const std::string s_remoteUpdateReqIdStatementString;

        /// SQL remote update statement object for member reqids
        oracle::occi::Statement *m_remoteUpdateReqIdStatement;
      ...
      }; // end of class OraStageUpdcRequestCnv
...
#endif // CASTOR_DB_ORA_STAGEUPDCREQUEST_HPP
