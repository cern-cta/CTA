/******************************************************************************
 *                      castor/db/ora/OraGetUpdateFailedCnv.hpp
 *
...
#ifndef CASTOR_DB_ORA_GETUPDATEFAILED_HPP
#define CASTOR_DB_ORA_GETUPDATEFAILED_HPP
...
namespace castor {
  ...
  namespace db {
    ...
    namespace ora {
      ...
      /**
       * class OraGetUpdateFailedCnv
       * A converter for storing/retrieving GetUpdateFailed into/from an Oracle database
       */
      class OraGetUpdateFailedCnv : public OraBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        OraGetUpdateFailedCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~OraGetUpdateFailedCnv() throw();
      ...
      }; // end of class OraGetUpdateFailedCnv
...
#endif // CASTOR_DB_ORA_GETUPDATEFAILED_HPP
