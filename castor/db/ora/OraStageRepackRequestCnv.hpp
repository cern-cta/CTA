...
/******************************************************************************
 *                      castor/db/ora/OraStageRepackRequestCnv.hpp
 *
...
#ifndef CASTOR_DB_ORA_STAGEREPACKREQUEST_HPP
#define CASTOR_DB_ORA_STAGEREPACKREQUEST_HPP
...
namespace castor {
  ...
  namespace db {
    ...
    namespace ora {
      ...
      /**
       * class OraStageRepackRequestCnv
       * A converter for storing/retrieving StageRepackRequest into/from an Oracle
       * database
       */
      class OraStageRepackRequestCnv : public OraBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        OraStageRepackRequestCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~OraStageRepackRequestCnv() throw();
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillRepSubRequest(castor::stager::StageRepackRequest* obj)
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillRepSvcClass(castor::stager::StageRepackRequest* obj)
          throw (castor::exception::Exception, oracle::occi::SQLException);
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillRepIClient(castor::stager::StageRepackRequest* obj)
          throw (castor::exception::Exception, oracle::occi::SQLException);
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillObjSubRequest(castor::stager::StageRepackRequest* obj)
          throw (castor::exception::Exception);
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillObjSvcClass(castor::stager::StageRepackRequest* obj)
          throw (castor::exception::Exception);
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillObjIClient(castor::stager::StageRepackRequest* obj)
          throw (castor::exception::Exception);
      ...
      }; // end of class OraStageRepackRequestCnv
...
#endif // CASTOR_DB_ORA_STAGEREPACKREQUEST_HPP
