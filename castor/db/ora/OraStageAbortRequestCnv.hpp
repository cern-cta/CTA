/******************************************************************************
 *                      castor/db/ora/OraStageAbortRequestCnv.hpp
 *
...
#ifndef CASTOR_DB_ORA_STAGEABORTREQUEST_HPP
#define CASTOR_DB_ORA_STAGEABORTREQUEST_HPP
...
namespace castor {
  ...
  namespace db {
    ...
    namespace ora {
      ...
      /**
       * class OraStageAbortRequestCnv
       * A converter for storing/retrieving StageAbortRequest into/from an Oracle
       * database
       */
      class OraStageAbortRequestCnv : public OraBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        OraStageAbortRequestCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~OraStageAbortRequestCnv() throw();
      ...
      }; // end of class OraStageAbortRequestCnv
...
#endif // CASTOR_DB_ORA_STAGEABORTREQUEST_HPP
