/******************************************************************************
 *                      castor/db/ora/OraStageGetRequestCnv.hpp
 *
...
#ifndef CASTOR_DB_ORA_STAGEGETREQUEST_HPP
#define CASTOR_DB_ORA_STAGEGETREQUEST_HPP
...
namespace castor {
  ...
  namespace db {
    ...
    namespace ora {
      ...
      /**
       * class OraStageGetRequestCnv
       * A converter for storing/retrieving StageGetRequest into/from an Oracle database
       */
      class OraStageGetRequestCnv : public OraBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        OraStageGetRequestCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~OraStageGetRequestCnv() throw();
      ...
      }; // end of class OraStageGetRequestCnv
...
#endif // CASTOR_DB_ORA_STAGEGETREQUEST_HPP
