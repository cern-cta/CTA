 ...
 *
 * @(#)$RCSfile: OraStageInRequestCnv.cpp,v $ $Revision: 1.9 $ $Release$ $Date: 2004/10/14 09:40:15 $ $Author: sponcec3 $
 *
 * 
 *
...
"UPDATE rh_StageInRequest SET flags = :1, userName = :2, euid = :3, egid = :4, mask = :5, pid = :6, machine = :7, svcClassName = :8, openflags = :9, svcClass = :10, client = :11 WHERE id = :12";
...
const std::string castor::db::ora::OraStageInRequestCnv::s_insertRequest2SubRequestStatementString =
"INSERT INTO rh_Request2SubRequest (Parent, Child) VALUES (:1, :2)";

/// SQL delete statement for member subRequests
const std::string castor::db::ora::OraStageInRequestCnv::s_deleteRequest2SubRequestStatementString =
"DELETE FROM rh_Request2SubRequest WHERE Parent = :1 AND Child = :2";

/// SQL select statement for member subRequests
const std::string castor::db::ora::OraStageInRequestCnv::s_Request2SubRequestStatementString =
"SELECT Child from rh_Request2SubRequest WHERE Parent = :1";

/// SQL insert statement for member client
const std::string castor::db::ora::OraStageInRequestCnv::s_insertRequest2IClientStatementString =
"INSERT INTO rh_Request2IClient (Parent, Child) VALUES (:1, :2)";

/// SQL delete statement for member client
const std::string castor::db::ora::OraStageInRequestCnv::s_deleteRequest2IClientStatementString =
"DELETE FROM rh_Request2IClient WHERE Parent = :1 AND Child = :2";

/// SQL select statement for member client
const std::string castor::db::ora::OraStageInRequestCnv::s_Request2IClientStatementString =
...
void castor::db::ora::OraStageInRequestCnv::createRep(castor::IAddress* address,
  ...
  try {
    ...
    m_insertStatement->setDouble(11, obj->svcClass() ? obj->svcClass()->id() : 0);
    m_insertStatement->setDouble(12, obj->client() ? obj->client()->id() : 0);
...
void castor::db::ora::OraStageInRequestCnv::updateRep(castor::IAddress* address,
  ...
  try {
    ...
    m_updateStatement->setDouble(10, obj->svcClass() ? obj->svcClass()->id() : 0);
    m_updateStatement->setDouble(11, obj->client() ? obj->client()->id() : 0);
