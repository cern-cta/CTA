/******************************************************************************
 *                      castor/db/ora/OraBaseAddressCnv.hpp
 *
...
#ifndef CASTOR_DB_ORA_BASEADDRESS_HPP
#define CASTOR_DB_ORA_BASEADDRESS_HPP
...
namespace castor {
  ...
  namespace db {
    ...
    namespace ora {
      ...
      /**
       * class OraBaseAddressCnv
       * A converter for storing/retrieving BaseAddress into/from an Oracle database
       */
      class OraBaseAddressCnv : public OraBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        OraBaseAddressCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~OraBaseAddressCnv() throw();
      ...
      }; // end of class OraBaseAddressCnv
...
#endif // CASTOR_DB_ORA_BASEADDRESS_HPP
