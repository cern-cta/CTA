...
/******************************************************************************
 *                      castor/db/ora/OraExtendedDeviceGroupCnv.hpp
 *
...
#ifndef CASTOR_DB_ORA_EXTENDEDDEVICEGROUP_HPP
#define CASTOR_DB_ORA_EXTENDEDDEVICEGROUP_HPP
...
namespace castor {
  ...
  namespace db {
    ...
    namespace ora {
      ...
      /**
       * class OraExtendedDeviceGroupCnv
       * A converter for storing/retrieving ExtendedDeviceGroup into/from an Oracle
       * database
       */
      class OraExtendedDeviceGroupCnv : public OraBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        OraExtendedDeviceGroupCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~OraExtendedDeviceGroupCnv() throw();
      ...
      private:
        ...
        oracle::occi::Statement *m_insertTapeDriveStatement;
      ...
      }; // end of class OraExtendedDeviceGroupCnv
...
#endif // CASTOR_DB_ORA_EXTENDEDDEVICEGROUP_HPP
