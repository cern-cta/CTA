/******************************************************************************
 *                      castor/db/ora/OraTapeCopyCnv.hpp
 *
...
#ifndef CASTOR_DB_ORA_TAPECOPY_HPP
#define CASTOR_DB_ORA_TAPECOPY_HPP
...
namespace castor {
  ...
  namespace db {
    ...
    namespace ora {
      ...
      /**
       * class OraTapeCopyCnv
       * A converter for storing/retrieving TapeCopy into/from an Oracle database
       */
      class OraTapeCopyCnv : public OraBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        OraTapeCopyCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~OraTapeCopyCnv() throw();
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillRepSegment(castor::stager::TapeCopy* obj)
          throw (castor::exception::Exception, oracle::occi::SQLException);
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillRepCastorFile(castor::stager::TapeCopy* obj)
          throw (castor::exception::Exception, oracle::occi::SQLException);
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillObjSegment(castor::stager::TapeCopy* obj)
          throw (castor::exception::Exception);
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillObjCastorFile(castor::stager::TapeCopy* obj)
          throw (castor::exception::Exception);
      ...
      private:
        ...
        static const std::string s_insertStreamStatementString;

        /// SQL insert statement object for member stream
        oracle::occi::Statement *m_insertStreamStatement;
        ...
        static const std::string s_remoteUpdateSegmentStatementString;

        /// SQL remote update statement object for member segments
        oracle::occi::Statement *m_remoteUpdateSegmentStatement;
...
#endif // CASTOR_DB_ORA_TAPECOPY_HPP
