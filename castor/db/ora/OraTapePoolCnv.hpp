/******************************************************************************
 *                      castor/db/ora/OraTapePoolCnv.hpp
 *
...
#ifndef CASTOR_DB_ORA_TAPEPOOL_HPP
#define CASTOR_DB_ORA_TAPEPOOL_HPP
...
namespace castor {
  ...
  namespace db {
    ...
    namespace ora {
      ...
      /**
       * class OraTapePoolCnv
       * A converter for storing/retrieving TapePool into/from an Oracle database
       */
      class OraTapePoolCnv : public OraBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        OraTapePoolCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~OraTapePoolCnv() throw();
...
#endif // CASTOR_DB_ORA_TAPEPOOL_HPP
