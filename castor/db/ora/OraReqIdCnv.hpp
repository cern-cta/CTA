 ...
 *
 * @(#)$RCSfile: OraReqIdCnv.hpp,v $ $Revision: 1.11 $ $Release$ $Date: 2004/11/05 17:47:21 $ $Author: sponcec3 $
 *
 * 
 *
...
#ifndef CASTOR_DB_ORA_REQID_HPP
...
namespace castor {
  ...
  namespace db {
    ...
    namespace ora {
      ...
      /**
       * class OraReqIdCnv
       * A converter for storing/retrieving ReqId into/from an Oracle database
       */
      class OraReqIdCnv : public OraBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        OraReqIdCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~OraReqIdCnv() throw();
        ...
        /**
         * Fill the database with objects of type ReqIdRequest refered by a given object.
        ...
        /**
         * Retrieve from the database objects of type ReqIdRequest refered by a given
         * object.
         * @param obj the original object
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillObjReqIdRequest(castor::stager::ReqId* obj)
          throw (castor::exception::Exception);
