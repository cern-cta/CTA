...
"INSERT INTO DiskCopy (path, diskcopyId, gcWeight, id, fileSystem, castorFile, status) VALUES (:1,:2,:3,ids_seq.nextval,:4,:5,:6) RETURNING id INTO :7";
...
"SELECT path, diskcopyId, gcWeight, id, fileSystem, castorFile, status FROM DiskCopy WHERE id = :1";

/// SQL statement for request update
const std::string castor::db::ora::OraDiskCopyCnv::s_updateStatementString =
"UPDATE DiskCopy SET path = :1, diskcopyId = :2, gcWeight = :3, status = :4 WHERE id = :5";
