...
static castor::CnvFactory<castor::db::ora::OraFilesDeletedCnv>* s_factoryOraFilesDeletedCnv =
  new castor::CnvFactory<castor::db::ora::OraFilesDeletedCnv>();
...
const std::string castor::db::ora::OraFilesDeletedCnv::s_selectGCFileStatementString =
"SELECT id from GCFile WHERE request = :1 FOR UPDATE";

/// SQL delete statement for member files
const std::string castor::db::ora::OraFilesDeletedCnv::s_deleteGCFileStatementString =
"UPDATE GCFile SET request = 0 WHERE id = :1";

/// SQL remote update statement for member files
const std::string castor::db::ora::OraFilesDeletedCnv::s_remoteUpdateGCFileStatementString =
...
// fillRepGCFile
//------------------------------------------------------------------------------
void castor::db::ora::OraFilesDeletedCnv::fillRepGCFile(castor::stager::FilesDeleted* obj)
...
// fillObjGCFile
//------------------------------------------------------------------------------
void castor::db::ora::OraFilesDeletedCnv::fillObjGCFile(castor::stager::FilesDeleted* obj)
  throw (castor::exception::Exception) {
  // Check select statement
  if (0 == m_selectGCFileStatement) {
    m_selectGCFileStatement = createStatement(s_selectGCFileStatementString);
