 ...
 *
 * @(#)$RCSfile: OraStageQryRequestCnv.cpp,v $ $Revision: 1.9 $ $Release$ $Date: 2004/10/14 09:40:16 $ $Author: sponcec3 $
 *
 * 
 *
...
"UPDATE rh_StageQryRequest SET flags = :1, userName = :2, euid = :3, egid = :4, mask = :5, pid = :6, machine = :7, svcClassName = :8, svcClass = :9, client = :10 WHERE id = :11";
