/******************************************************************************
 *                      castor/db/ora/OraStagePutDoneRequestCnv.hpp
 *
...
#ifndef CASTOR_DB_ORA_STAGEPUTDONEREQUEST_HPP
#define CASTOR_DB_ORA_STAGEPUTDONEREQUEST_HPP
...
namespace castor {
  ...
  namespace db {
    ...
    namespace ora {
      ...
      /**
       * class OraStagePutDoneRequestCnv
       * A converter for storing/retrieving StagePutDoneRequest into/from an Oracle
       * database
       */
      class OraStagePutDoneRequestCnv : public OraBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        OraStagePutDoneRequestCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~OraStagePutDoneRequestCnv() throw();
...
#endif // CASTOR_DB_ORA_STAGEPUTDONEREQUEST_HPP
