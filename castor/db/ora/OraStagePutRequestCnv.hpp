/******************************************************************************
 *                      castor/db/ora/OraStagePutRequestCnv.hpp
 *
...
#ifndef CASTOR_DB_ORA_STAGEPUTREQUEST_HPP
#define CASTOR_DB_ORA_STAGEPUTREQUEST_HPP
...
namespace castor {
  ...
  namespace db {
    ...
    namespace ora {
      ...
      /**
       * class OraStagePutRequestCnv
       * A converter for storing/retrieving StagePutRequest into/from an Oracle database
       */
      class OraStagePutRequestCnv : public OraBaseCnv {
      ...
      public:
         ...
         * Destructor
         */
        virtual ~OraStagePutRequestCnv() throw();
      ...
      }; // end of class OraStagePutRequestCnv
...
#endif // CASTOR_DB_ORA_STAGEPUTREQUEST_HPP
