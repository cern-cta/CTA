/******************************************************************************
 *                      castor/db/ora/OraStageInRequestCnv.hpp
 *
 ...
 *
 * @(#)$RCSfile: OraStageInRequestCnv.hpp,v $ $Revision: 1.13 $ $Release$ $Date: 2004/11/05 17:47:22 $ $Author: sponcec3 $
 *
 * 
 *
...
#ifndef CASTOR_DB_ORA_STAGEINREQUEST_HPP
#define CASTOR_DB_ORA_STAGEINREQUEST_HPP
...
namespace castor {
  ...
  namespace db {
    ...
    namespace ora {
      ...
      /**
       * class OraStageInRequestCnv
       * A converter for storing/retrieving StageInRequest into/from an Oracle database
       */
      class OraStageInRequestCnv : public OraBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        OraStageInRequestCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~OraStageInRequestCnv() throw();
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillRepSvcClass(castor::stager::StageInRequest* obj)
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillRepSubRequest(castor::stager::StageInRequest* obj)
          throw (castor::exception::Exception, oracle::occi::SQLException);
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillRepIClient(castor::stager::StageInRequest* obj)
          throw (castor::exception::Exception, oracle::occi::SQLException);
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillObjSvcClass(castor::stager::StageInRequest* obj)
          throw (castor::exception::Exception);
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillObjSubRequest(castor::stager::StageInRequest* obj)
          throw (castor::exception::Exception);
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillObjIClient(castor::stager::StageInRequest* obj)
          throw (castor::exception::Exception);
      ...
      }; // end of class OraStageInRequestCnv
...
#endif // CASTOR_DB_ORA_STAGEINREQUEST_HPP
