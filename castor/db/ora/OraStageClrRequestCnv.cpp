 ...
 *
 * @(#)$RCSfile: OraStageClrRequestCnv.cpp,v $ $Revision: 1.15 $ $Release$ $Date: 2004/10/26 14:48:14 $ $Author: sponcec3 $
 *
 * 
 *
...
"UPDATE rh_StageClrRequest SET flags = :1, userName = :2, euid = :3, egid = :4, mask = :5, pid = :6, machine = :7, svcClassName = :8 WHERE id = :9";
