/******************************************************************************
 *                      castor/db/ora/OraFileSystemCnv.hpp
 *
...
#ifndef CASTOR_DB_ORA_FILESYSTEM_HPP
#define CASTOR_DB_ORA_FILESYSTEM_HPP
...
namespace castor {
  ...
  namespace db {
    ...
    namespace ora {
      ...
      /**
       * class OraFileSystemCnv
       * A converter for storing/retrieving FileSystem into/from an Oracle database
       */
      class OraFileSystemCnv : public OraBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        OraFileSystemCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~OraFileSystemCnv() throw();
