...
/******************************************************************************
 *                      castor/db/ora/OraDiskPoolQueryCnv.hpp
 *
...
#ifndef CASTOR_DB_ORA_DISKPOOLQUERY_HPP
#define CASTOR_DB_ORA_DISKPOOLQUERY_HPP
...
namespace castor {
  ...
  namespace db {
    ...
    namespace ora {
      ...
      /**
       * class OraDiskPoolQueryCnv
       * A converter for storing/retrieving DiskPoolQuery into/from an Oracle database
       */
      class OraDiskPoolQueryCnv : public OraBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        OraDiskPoolQueryCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~OraDiskPoolQueryCnv() throw();
      ...
      }; // end of class OraDiskPoolQueryCnv
...
#endif // CASTOR_DB_ORA_DISKPOOLQUERY_HPP
