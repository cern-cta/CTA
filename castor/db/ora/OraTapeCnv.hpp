  ...
  namespace db {
    ...
    namespace ora {
      ...
      private:
        ...
        static const std::string s_insertTapePool2TapeStatementString;

        /// SQL insert statement object for member pool
        oracle::occi::Statement *m_insertTapePool2TapeStatement;

        /// SQL delete statement for member pool
        static const std::string s_deleteTapePool2TapeStatementString;

        /// SQL delete statement object for member pool
        oracle::occi::Statement *m_deleteTapePool2TapeStatement;
