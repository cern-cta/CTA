...
/******************************************************************************
 *                      castor/db/ora/OraTapeDriveDedicationCnv.hpp
 *
...
#ifndef CASTOR_DB_ORA_TAPEDRIVEDEDICATION_HPP
#define CASTOR_DB_ORA_TAPEDRIVEDEDICATION_HPP
...
namespace castor {
  ...
  namespace db {
    ...
    namespace ora {
      ...
      /**
       * class OraTapeDriveDedicationCnv
       * A converter for storing/retrieving TapeDriveDedication into/from an Oracle
       * database
       */
      class OraTapeDriveDedicationCnv : public OraBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        OraTapeDriveDedicationCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~OraTapeDriveDedicationCnv() throw();
      ...
      }; // end of class OraTapeDriveDedicationCnv
...
#endif // CASTOR_DB_ORA_TAPEDRIVEDEDICATION_HPP
