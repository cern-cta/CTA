/******************************************************************************
 *                      castor/db/ora/OraStageClrRequestCnv.hpp
 *
 ...
 *
 * @(#)$RCSfile: OraStageClrRequestCnv.hpp,v $ $Revision: 1.13 $ $Release$ $Date: 2004/11/05 17:47:21 $ $Author: sponcec3 $
 *
 * 
 *
...
#ifndef CASTOR_DB_ORA_STAGECLRREQUEST_HPP
#define CASTOR_DB_ORA_STAGECLRREQUEST_HPP
...
namespace castor {
  ...
  namespace db {
    ...
    namespace ora {
      ...
      /**
       * class OraStageClrRequestCnv
       * A converter for storing/retrieving StageClrRequest into/from an Oracle database
       */
      class OraStageClrRequestCnv : public OraBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        OraStageClrRequestCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~OraStageClrRequestCnv() throw();
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillRepSubRequest(castor::stager::StageClrRequest* obj)
          throw (castor::exception::Exception, oracle::occi::SQLException);
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillRepIClient(castor::stager::StageClrRequest* obj)
          throw (castor::exception::Exception, oracle::occi::SQLException);
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillObjSubRequest(castor::stager::StageClrRequest* obj)
          throw (castor::exception::Exception);
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillObjIClient(castor::stager::StageClrRequest* obj)
          throw (castor::exception::Exception);
      ...
      }; // end of class OraStageClrRequestCnv
...
#endif // CASTOR_DB_ORA_STAGECLRREQUEST_HPP
