...
const castor::ICnvFactory& OraTapeServerCnvFactory = 
  s_factoryOraTapeServerCnv;
...
"INSERT INTO TapeServer (serverName, status, id) VALUES (:1,:2,ids_seq.nextval) RETURNING id INTO :3";
...
"SELECT serverName, status, id FROM TapeServer WHERE id = :1";

/// SQL statement for request update
const std::string castor::db::ora::OraTapeServerCnv::s_updateStatementString =
"UPDATE TapeServer SET serverName = :1, status = :2 WHERE id = :3";
