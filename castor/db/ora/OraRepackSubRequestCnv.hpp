...
/******************************************************************************
 *                      castor/db/ora/OraRepackSubRequestCnv.hpp
 *
...
#ifndef CASTOR_DB_ORA_REPACKSUBREQUEST_HPP
#define CASTOR_DB_ORA_REPACKSUBREQUEST_HPP
...
namespace castor {
  ...
  namespace db {
    ...
    namespace ora {
      ...
      /**
       * class OraRepackSubRequestCnv
       * A converter for storing/retrieving RepackSubRequest into/from an Oracle database
       */
      class OraRepackSubRequestCnv : public OraBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        OraRepackSubRequestCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~OraRepackSubRequestCnv() throw();
      ...
      private:
        ...
        oracle::occi::Statement *m_selectRepackSegmentStatement;
        ...
        oracle::occi::Statement *m_deleteRepackSegmentStatement;
        ...
        oracle::occi::Statement *m_remoteUpdateRepackSegmentStatement;
        ...
        oracle::occi::Statement *m_checkRepackRequestExistStatement;
        ...
        oracle::occi::Statement *m_updateRepackRequestStatement;

      }; // end of class OraRepackSubRequestCnv
...
#endif // CASTOR_DB_ORA_REPACKSUBREQUEST_HPP
