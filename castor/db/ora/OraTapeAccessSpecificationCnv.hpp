...
/******************************************************************************
 *                      castor/db/ora/OraTapeAccessSpecificationCnv.hpp
 *
...
#ifndef CASTOR_DB_ORA_TAPEACCESSSPECIFICATION_HPP
#define CASTOR_DB_ORA_TAPEACCESSSPECIFICATION_HPP
...
namespace castor {
  ...
  namespace db {
    ...
    namespace ora {
      ...
      /**
       * class OraTapeAccessSpecificationCnv
       * A converter for storing/retrieving TapeAccessSpecification into/from an Oracle
       * database
       */
      class OraTapeAccessSpecificationCnv : public OraBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        OraTapeAccessSpecificationCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~OraTapeAccessSpecificationCnv() throw();
...
#endif // CASTOR_DB_ORA_TAPEACCESSSPECIFICATION_HPP
