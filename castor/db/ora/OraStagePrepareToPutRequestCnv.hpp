/******************************************************************************
 *                      castor/db/ora/OraStagePrepareToPutRequestCnv.hpp
 *
...
#ifndef CASTOR_DB_ORA_STAGEPREPARETOPUTREQUEST_HPP
#define CASTOR_DB_ORA_STAGEPREPARETOPUTREQUEST_HPP
...
namespace castor {
  ...
  namespace db {
    ...
    namespace ora {
      ...
      /**
       * class OraStagePrepareToPutRequestCnv
       * A converter for storing/retrieving StagePrepareToPutRequest into/from an Oracle
       * database
       */
      class OraStagePrepareToPutRequestCnv : public OraBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        OraStagePrepareToPutRequestCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~OraStagePrepareToPutRequestCnv() throw();
      ...
      }; // end of class OraStagePrepareToPutRequestCnv
...
#endif // CASTOR_DB_ORA_STAGEPREPARETOPUTREQUEST_HPP
