/******************************************************************************
 *                      castor/db/ora/OraStreamCnv.hpp
 *
...
#ifndef CASTOR_DB_ORA_STREAM_HPP
#define CASTOR_DB_ORA_STREAM_HPP
...
namespace castor {
  ...
  namespace db {
    ...
    namespace ora {
      ...
      /**
       * class OraStreamCnv
       * A converter for storing/retrieving Stream into/from an Oracle database
       */
      class OraStreamCnv : public OraBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        OraStreamCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~OraStreamCnv() throw();
      ...
      private:
        ...
        oracle::occi::Statement *m_checkTapePoolExistStatement;
