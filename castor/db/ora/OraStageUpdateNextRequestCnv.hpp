/******************************************************************************
 *                      castor/db/ora/OraStageUpdateNextRequestCnv.hpp
 *
...
#ifndef CASTOR_DB_ORA_STAGEUPDATENEXTREQUEST_HPP
#define CASTOR_DB_ORA_STAGEUPDATENEXTREQUEST_HPP
...
namespace castor {
  ...
  namespace db {
    ...
    namespace ora {
      ...
      /**
       * class OraStageUpdateNextRequestCnv
       * A converter for storing/retrieving StageUpdateNextRequest into/from an Oracle
       * database
       */
      class OraStageUpdateNextRequestCnv : public OraBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        OraStageUpdateNextRequestCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~OraStageUpdateNextRequestCnv() throw();
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillRepFileRequest(castor::stager::StageUpdateNextRequest* obj)
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillRepSvcClass(castor::stager::StageUpdateNextRequest* obj)
          throw (castor::exception::Exception, oracle::occi::SQLException);
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillRepIClient(castor::stager::StageUpdateNextRequest* obj)
          throw (castor::exception::Exception, oracle::occi::SQLException);
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillObjFileRequest(castor::stager::StageUpdateNextRequest* obj)
          throw (castor::exception::Exception);
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillObjSvcClass(castor::stager::StageUpdateNextRequest* obj)
          throw (castor::exception::Exception);
         ...
         * @exception Exception throws an Exception in case of error
         */
        virtual void fillObjIClient(castor::stager::StageUpdateNextRequest* obj)
          throw (castor::exception::Exception);
      ...
      }; // end of class OraStageUpdateNextRequestCnv
...
#endif // CASTOR_DB_ORA_STAGEUPDATENEXTREQUEST_HPP
