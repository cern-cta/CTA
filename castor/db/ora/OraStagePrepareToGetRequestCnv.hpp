/******************************************************************************
 *                      castor/db/ora/OraStagePrepareToGetRequestCnv.hpp
 *
...
#ifndef CASTOR_DB_ORA_STAGEPREPARETOGETREQUEST_HPP
#define CASTOR_DB_ORA_STAGEPREPARETOGETREQUEST_HPP
...
namespace castor {
  ...
  namespace db {
    ...
    namespace ora {
      ...
      /**
       * class OraStagePrepareToGetRequestCnv
       * A converter for storing/retrieving StagePrepareToGetRequest into/from an Oracle
       * database
       */
      class OraStagePrepareToGetRequestCnv : public OraBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        OraStagePrepareToGetRequestCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~OraStagePrepareToGetRequestCnv() throw();
      ...
      }; // end of class OraStagePrepareToGetRequestCnv
...
#endif // CASTOR_DB_ORA_STAGEPREPARETOGETREQUEST_HPP
