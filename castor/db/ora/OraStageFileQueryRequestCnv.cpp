...
const std::string castor::db::ora::OraStageFileQueryRequestCnv::s_insertNewReqStatementString =
...
//------------------------------------------------------------------------------
void castor::db::ora::OraStageFileQueryRequestCnv::fillRepQueryParameter(castor::stager::StageFileQueryRequest* obj)
...
//------------------------------------------------------------------------------
void castor::db::ora::OraStageFileQueryRequestCnv::fillObjQueryParameter(castor::stager::StageFileQueryRequest* obj)
  throw (castor::exception::Exception) {
  // Check select statement
  if (0 == m_selectQueryParameterStatement) {
    m_selectQueryParameterStatement = createStatement(s_selectQueryParameterStatementString);
