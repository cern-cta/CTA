...
AS
  ...
  TAPEGATEWAY_TO_BE_RESOLVED     CONSTANT PLS_INTEGER := 0;
  TAPEGATEWAY_TO_BE_SENT_TO_VDQM CONSTANT PLS_INTEGER := 1;
  TAPEGATEWAY_WAITING_TAPESERVER CONSTANT PLS_INTEGER := 2;
  TAPEGATEWAY_ONGOING            CONSTANT PLS_INTEGER := 3;
