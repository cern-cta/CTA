 ...
 */
int Cstager_Segment_offset(struct Cstager_Segment_t* instance, const struct C_u_signed64_t** var);

/**
 * Set the value of offset
 * Start offset in the disk file (if segmented file)
 */
int Cstager_Segment_setOffset(struct Cstager_Segment_t* instance, const struct C_u_signed64_t* new_var);

/**
 * Get the value of bytes_in
 * Size of the tape file (segment) to be copied
 */
int Cstager_Segment_bytes_in(struct Cstager_Segment_t* instance, const struct C_u_signed64_t** var);

/**
 * Set the value of bytes_in
 * Size of the tape file (segment) to be copied
 */
int Cstager_Segment_setBytes_in(struct Cstager_Segment_t* instance, const struct C_u_signed64_t* new_var);

/**
 * Get the value of bytes_out
 */
int Cstager_Segment_bytes_out(struct Cstager_Segment_t* instance, const struct C_u_signed64_t** var);

/**
 * Set the value of bytes_out
 */
int Cstager_Segment_setBytes_out(struct Cstager_Segment_t* instance, const struct C_u_signed64_t* new_var);

/**
 * Get the value of host_bytes
 */
int Cstager_Segment_host_bytes(struct Cstager_Segment_t* instance, const struct C_u_signed64_t** var);

/**
 * Set the value of host_bytes
 */
int Cstager_Segment_setHost_bytes(struct Cstager_Segment_t* instance, const struct C_u_signed64_t* new_var);

/**
 * Get the value of segmCksumAlgorithm
 */
int Cstager_Segment_segmCksumAlgorithm(struct Cstager_Segment_t* instance, const const char*** var);

/**
 * Set the value of segmCksumAlgorithm
 */
int Cstager_Segment_setSegmCksumAlgorithm(struct Cstager_Segment_t* instance, const const char** new_var);
