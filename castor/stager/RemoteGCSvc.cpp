 ...
 *
 * @(#)$RCSfile: RemoteGCSvc.cpp,v $ $Revision: 1.2 $ $Release$ $Date: 2005/07/29 12:32:21 $ $Author: mbraeger $
 *
 *
 *
...
RemoteGCSvcFactory = s_factoryRemoteGCSvc;
...
// -----------------------------------------------------------------------
void
castor::stager::RemoteGCSvc::commit() {}
...
// -----------------------------------------------------------------------
void
castor::stager::RemoteGCSvc::rollback() {}
