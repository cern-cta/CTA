...
/**
 * Add a struct Cstager_Tape_t* object to the tapes list
 */
int Cstager_TapePool_addTapes(struct Cstager_TapePool_t* instance, struct Cstager_Tape_t* obj);

/**
 * Remove a struct Cstager_Tape_t* object from tapes
 */
int Cstager_TapePool_removeTapes(struct Cstager_TapePool_t* instance, struct Cstager_Tape_t* obj);

/**
 * Get the list of struct Cstager_Tape_t* objects held by tapes
 */
int Cstager_TapePool_tapes(struct Cstager_TapePool_t* instance, struct Cstager_Tape_t*** var, int* len);
