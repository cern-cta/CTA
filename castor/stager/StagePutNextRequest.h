 ...
 */
int Cstager_StagePutNextRequest_setId(struct Cstager_StagePutNextRequest_t* instance,
                                      u_signed64 id);

/**
 * gets the id of the object
 */
int Cstager_StagePutNextRequest_id(struct Cstager_StagePutNextRequest_t* instance,
                                   u_signed64* ret);
