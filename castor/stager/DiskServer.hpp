...
namespace castor {
  ...
  namespace stager {
    ...
    public:
      ...
      /**
       * Get the value of m_lastHeartBeatTime
       * last time a heartbeat was received for this DiskServer
       * @return the value of m_lastHeartBeatTime
       */
      u_signed64 lastHeartBeatTime() const {
        return m_lastHeartBeatTime;
      }

      /**
       * Set the value of m_lastHeartBeatTime
       * last time a heartbeat was received for this DiskServer
       * @param new_var the new value of m_lastHeartBeatTime
       */
      void setLastHeartBeatTime(u_signed64 new_var) {
        m_lastHeartBeatTime = new_var;
      }
    ...
    private:
      ...
      /// last time a heartbeat was received for this DiskServer
      u_signed64 m_lastHeartBeatTime;
