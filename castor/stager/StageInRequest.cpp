 ...
 *
 * @(#)$RCSfile: StageInRequest.cpp,v $ $Revision: 1.1 $ $Release$ $Date: 2004/10/01 14:26:25 $ $Author: sponcec3 $
 *
 * 
 *
...
// setId
//------------------------------------------------------------------------------
void castor::stager::StageInRequest::setId(unsigned long id) {
  m_id = id;
}
...
// id
//------------------------------------------------------------------------------
unsigned long castor::stager::StageInRequest::id() const {
  return m_id;
}
