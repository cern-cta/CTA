 ...
 *
 * @(#)$RCSfile: StageQryRequest.cpp,v $ $Revision: 1.3 $ $Release$ $Date: 2004/11/04 10:26:15 $ $Author: sponcec3 $
 *
 * 
 *
...
// setId
//------------------------------------------------------------------------------
void castor::stager::StageQryRequest::setId(u_signed64 id) {
  m_id = id;
}
...
// id
//------------------------------------------------------------------------------
u_signed64 castor::stager::StageQryRequest::id() const {
  return m_id;
}
