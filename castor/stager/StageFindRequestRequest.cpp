/******************************************************************************
 *                      castor/stager/StageFindRequestRequest.cpp
 *
...
void castor::stager::StageFindRequestRequest::print(std::ostream& stream,
  ...
  stream << indent << "[# StageFindRequestRequest #]" << std::endl;
...
// clone
//------------------------------------------------------------------------------
castor::IObject* castor::stager::StageFindRequestRequest::clone() {
  return new StageFindRequestRequest(*this);
}
