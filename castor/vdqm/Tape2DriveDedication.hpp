...
/******************************************************************************
 *                      castor/vdqm/Tape2DriveDedication.hpp
 *
...
namespace castor {
  ...
  namespace vdqm {
     ...
     */
    class Tape2DriveDedication : public virtual castor::IObject {
    ...
    public:
       ...
       * Empty Constructor
       */
      Tape2DriveDedication() throw();

      /**
       * Empty Destructor
       */
      virtual ~Tape2DriveDedication() throw();
    ...
    }; /* end of class Tape2DriveDedication */
