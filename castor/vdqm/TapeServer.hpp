...
namespace castor {
  ...
  namespace vdqm {
    ...
    public:
      ...
      /**
       * Get the value of m_actingMode
       * @return the value of m_actingMode
       */
      TapeServerStatusCodes actingMode() const {
        return m_actingMode;
      }

      /**
       * Set the value of m_actingMode
       * @param new_var the new value of m_actingMode
       */
      void setActingMode(TapeServerStatusCodes new_var) {
        m_actingMode = new_var;
      }
