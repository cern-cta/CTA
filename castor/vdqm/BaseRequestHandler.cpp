...
// Constructor
//------------------------------------------------------------------------------
castor::vdqm::BaseRequestHandler::BaseRequestHandler() 
	throw() {
...
// handleRequest
//------------------------------------------------------------------------------
void castor::vdqm::BaseRequestHandler::handleRequest
...
//------------------------------------------------------------------------------
void castor::vdqm::BaseRequestHandler::deleteRepresentation
(castor::IObject* fr, Cuuid_t cuuid)
  throw (castor::exception::Exception) {
  // Stores it into Oracle
  castor::BaseAddress ad;
