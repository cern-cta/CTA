...
{VDQM_SET_VDQM_PORT, "Set the VDQM listening port"},
{VDQM_SET_UDP_NOTIFY_PORT, "Set the VDQM UDP notification port"},
{VDQM_INVALID_PORT_ENTRY, "The VDQM PORT configuration entry is invalid"},
{VDQM_INVALID_NOTIFY_PORT_ENTRY, "The VDQM NOTIFYPORT configuration entry is invalid"},
{-1, ""}};
