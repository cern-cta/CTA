/* This file was generated by ./VdqmDlfMessagesCodeGenerator on Tue Oct  2 14:19:07 CEST 2012
 */
...
VDQM_WAIT_DOWN_REQUEST_FROM_TAPED_CLIENT=38, /* "WAIT DOWN request from tape daemon client" */
...
VDQM_TPD_STARTED_NOT_SUPPORTED=91, /* "VDQM_TPD_STARTED messages are nor supported" */
VDQM_MAGIC2_ROLLBACK=91, /* "Rollback of whole VDQM_MAGIC2 request" */
VDQM_MAGIC3_ROLLBACK=92, /* "Rollback of whole VDQM_MAGIC3 request" */
VDQM_HANDLE_VDQM3_DEL_DRV=93, /* "Handle VDQM3_DEL_DRVREQ" */
VDQM_HANDLE_VDQM3_DEDICATE=94, /* "Handle VDQM3_DEDICATE" */
VDQM_SET_REQUEST_HANDLER_THREAD_NB=95, /* "Set the number of request handler threads" */
VDQM_SET_SCHEDULER_THREAD_NB=96, /* "Set the number of scheduler threads" */
VDQM_SET_RTCP_JOB_SUBMITTER_THREAD_NB=97, /* "Set the number of RTCP job submitter threads" */
VDQM_INVALID_PORT_ENTRY=98, /* "The VDQM PORT configuration entry is invalid" */
VDQM_SET_VDQMPORT=99, /* "Set the VDQM PORT" */
VDQM_INVALID_NOTIFYPORT_ENTRY=100, /* "The VDQM NOTIFYPORT configuration entry is invalid" */
VDQM_SET_NOTIFYPORT=101, /* "Set the VDQM NOTIFYPORT" */
VDQM_INVALID_SCHEDULERTIMEOUT_ENTRY=102, /* "The VDQM SCHEDULERTIMEOUT configuration entry is invalid" */
VDQM_SET_SCHEDULERTIMEOUT=103, /* "Set VDQM SCHEDULERTIMEOUT" */
VDQM_INVALID_RTCPJOBSUBMITTERTIMEOUT_ENTRY=104, /* "The VDQM RTCPJOBSUBMITTERTIMEOUT configuration entry is invalid" */
VDQM_SET_RTCPJOBSUBMITTERTIMEOUT=105, /* "Set VDQM RTCPJOBSUBMITTERTIMEOUT" */
VDQM_MAGIC4_ROLLBACK=106, /* "Rollback of whole VDQM_MAGIC4 request" */
VDQM_REQUEST_HANDLER_SOCKET_IS_NULL=107, /* "The RequestHandlerThread has been passed a NULL socket pointer" */
VDQM_HANDLE_VDQM4_AGGREGATOR_VOL_REQ=108, /* "Handle VDQM4_AGGREGATOR_VOL_REQ" */
VDQM_FAILED_TO_SUBMIT_REMOTE_COPY_JOB=109, /* "Failed to submit remote copy job" */
VDQM_RESET_DRIVE_AND_REQUEST=110, /* "Reset drive and request" */
VDQM_RESET_DRIVE_AND_REQUEST_DB_WRITE_FAILED=111, /* "Failed to write reset of drive and request to the database" */
VDQM_REQUEST_SUBMITTED_TRANSITION_FAILED=112, /* "Failed to move the state of the request from REQUEST_BEINGSUBMITTED to REQUEST_SUBMITTED" */
VDQM_REQUEST_SUBMITTED_DB_WRITE_FAILED=113, /* "Failed to write request submitted state change to the database" */
VDQM_SEND_AGGREGATOR_JOB=114, /* "Sending job to tape aggregator" */
VDQM_REMOTECONNECTION_DAEMON_ERROR=115, /* "RTCPD or tape aggregator daemon returned an error" */
VDQM_REMOTECONNECTION_MSG_TOO_LARGE=116, /* "RTCPD or tape aggregator daemon message is too large" */
VDQM_STARTED=117, /* "vdqmserver started" */
VDQM_SEND_RTCOPY_JOB=118, /* "Sending remote copy job" */
VDQM_RECEIVED_UNIT_MBCOUNT=119 /* "Received VDQM_UNIT_MBCOUNT" */
