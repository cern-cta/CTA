 ...
 *
 * @(#)$RCSfile: StageClr.hpp,v $ $Revision: 1.2 $ $Release$ $Date: 2004/10/01 14:26:12 $ $Author: sponcec3 $
 *
 * 
 *
...
#ifndef CLIENT_STAGECLR_HPP 
#define CLIENT_STAGECLR_HPP 1
...
namespace castor {
  ...
  namespace client {
    ...
    class StageClr : public BaseCmdLineClient {
