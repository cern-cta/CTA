 ...
 *
 * @(#)$RCSfile: StageUpdc.hpp,v $ $Revision: 1.3 $ $Release$ $Date: 2004/10/01 14:26:12 $ $Author: sponcec3 $
 *
 * 
 *
...
#ifndef CLIENT_STAGEUPDC_HPP 
#define CLIENT_STAGEUPDC_HPP 1
...
namespace castor {
  ...
  namespace client {
    ...
    class StageUpdc : public BaseCmdLineClient {
