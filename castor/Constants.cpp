 ...
 *
 * @(#)$RCSfile: Constants.cpp,v $ $Revision: 1.1 $ $Release$ $Date: 2004/11/22 16:27:35 $ $Author: sponcec3 $
 *
 *
 *
...
// ObjectsIdStrings
//=============================================================================
const char* castor::ObjectsIdStrings[60] = {
  "INVALID",
...
// ServicesIdStrings
//=============================================================================
const char* castor::ServicesIdStrings[8] =  {
  "INVALID",
  "NOMSG",
  "DLFMSG",
  "STDMSG",
