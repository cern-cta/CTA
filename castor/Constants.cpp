 ...
 *
 * @(#)$RCSfile: Constants.cpp,v $ $Revision: 1.7 $ $Release$ $Date: 2004/12/03 10:31:49 $ $Author: sponcec3 $
 *
 *
 *
...
// ObjectsIdStrings
//=============================================================================
const char* castor::ObjectsIdStrings[69] = {
  "INVALID",
...
// ServicesIdStrings
//=============================================================================
const char* castor::ServicesIdStrings[9] =  {
  "INVALID",
  "NOMSG",
  "DLFMSG",
  "STDMSG",
