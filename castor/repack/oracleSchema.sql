...
CREATE TABLE RepackRequest (machine VARCHAR2(2048), userName VARCHAR2(2048), creationTime INTEGER, pool VARCHAR2(2048), pid INTEGER, svcclass VARCHAR2(2048), command NUMBER, stager VARCHAR2(2048), userId NUMBER, groupId NUMBER, retryMax NUMBER, id INTEGER CONSTRAINT I_RepackRequest_Id PRIMARY KEY) INITRANS 50 PCTFREE 50 ENABLE ROW MOVEMENT;
