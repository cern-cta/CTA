 ...
 *
 * @(#)$RCSfile: FileOrganizer.cpp,v $ $Revision: 1.7 $ $Release$ $Date: 2006/02/17 18:59:14 $ $Author: felixehm $
 *
 *
 *
 * @author Felix Ehm
...
//------------------------------------------------------------------------------	
/*
void FileOrganizer::createSvcClass(RepackSubRequest *rsub)
{
