	...
	castor::server::BaseDaemon("repackd")
{
  ...
  castor::dlf::Message messages[] =
    {{ 1, "Could not get Conversion Service for Database"},
     ...
     {21, "RepackFileStager : Submission issued for tape"},
     ...
     {26, "RepackRestarter : Restart of unknown request is impossible"},
     {27, "RepackRestarter : Restart failed because of temporary stager problem"},
