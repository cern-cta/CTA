  ...
  if (!bOk) {
    switch (m_streamState) {
      case StreamState::WRITE: {
        log::ScopedParamContainer params(lc);
        params.add("tag", m_tag);
        lc.log(cta::log::ERR, "In grpc::client::NegotiationRequestHandler::next(): Server has been shut down before "
      ...
      default: {
        log::ScopedParamContainer params(lc);
        params.add("tag", m_tag);
        lc.log(cta::log::ERR, "In grpc::client::NegotiationRequestHandler::next(): Request processing aborted, call is "
