...
private:
  void insertDiskSystemSpinner() {
    ...
    catalogue.DiskInstanceSpace()->createDiskInstanceSpace(m_cliId,
    ...
    catalogue.DiskSystem()->createDiskSystem(m_cliId,
                                             m_diskSystemSpinner.name,
                                             diskInstanceName,
                                             diskInstanceSpaceName,
                                             m_diskSystemSpinner.fileRegexp,
                                             m_diskSystemSpinner.targetedFreeSpace,
                                             m_diskSystemSpinner.sleepTime,
                                             m_diskSystemSpinner.comment);
  }
  ...
  void insertDiskSystemDefault() {
    ...
    catalogue.DiskSystem()->createDiskSystem(m_cliId,
                                             m_diskSystemDefault.name,
                                             diskInstanceName,
                                             diskInstanceSpaceName,
                                             m_diskSystemDefault.fileRegexp,
                                             m_diskSystemDefault.targetedFreeSpace,
                                             m_diskSystemDefault.sleepTime,
                                             m_diskSystemDefault.comment);
  }
};
...
TEST_F(DiskSystemTest, fetchDiskSystemFreeSpace) {
  ...
  catalogue.DiskSystem()->createDiskSystem(m_cliId,
                                           constantFreeSpaceDiskSystem.name,
                                           diskInstanceName,
                                           diskInstanceSpaceName,
                                           constantFreeSpaceDiskSystem.fileRegexp,
                                           constantFreeSpaceDiskSystem.targetedFreeSpace,
                                           constantFreeSpaceDiskSystem.sleepTime,
                                           constantFreeSpaceDiskSystem.comment);
