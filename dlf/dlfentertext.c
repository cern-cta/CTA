...
#ifndef lint
static char sccsid[] = "@(#)$RCSfile: dlfentertext.c,v $ $Revision: 1.3 $ $Date: 2004/10/20 11:22:57 $ CERN IT-ADC/CA Vitaly Motyakov";
#endif /* not lint */
...
char **argv;
{
	...
	if (dlf_entertext(fac_name, msg_no, msg_txt) < 0)
	  exit (SYERR);
