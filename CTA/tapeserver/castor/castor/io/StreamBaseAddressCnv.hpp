...
namespace castor {
  ...
  namespace io {
    ...
    /**
     * class StreamBaseAddressCnv
     * A converter for marshalling/unmarshalling BaseAddress into/from stl streams
     */
    class StreamBaseAddressCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Constructor
       */
      StreamBaseAddressCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamBaseAddressCnv() throw();
