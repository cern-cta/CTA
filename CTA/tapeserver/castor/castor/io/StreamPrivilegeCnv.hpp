...
namespace castor {
  ...
  namespace io {
    ...
    /**
     * class StreamPrivilegeCnv
     * A converter for marshalling/unmarshalling Privilege into/from stl streams
     */
    class StreamPrivilegeCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Constructor
       */
      StreamPrivilegeCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamPrivilegeCnv() throw();
