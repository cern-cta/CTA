...
namespace castor {
  ...
  namespace io {
    ...
    /**
     * class StreamIOResponseCnv
     * A converter for marshalling/unmarshalling IOResponse into/from stl streams
     */
    class StreamIOResponseCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Constructor
       */
      StreamIOResponseCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamIOResponseCnv() throw();
