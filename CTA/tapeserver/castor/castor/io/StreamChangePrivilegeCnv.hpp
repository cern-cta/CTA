...
namespace castor {
  ...
  namespace io {
    ...
    /**
     * class StreamChangePrivilegeCnv
     * A converter for marshalling/unmarshalling ChangePrivilege into/from stl streams
     */
    class StreamChangePrivilegeCnv : public StreamBaseCnv {
    ...
    public:
       ...
       * Constructor
       */
      StreamChangePrivilegeCnv(castor::ICnvSvc* cnvSvc);

      /**
       * Destructor
       */
      virtual ~StreamChangePrivilegeCnv() throw();
