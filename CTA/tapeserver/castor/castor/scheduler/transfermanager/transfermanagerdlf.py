...
msgs = dlf.enum('ABORTEREXCEPTION', 'SYNCHROFAILED', 'SYNCHROEXCEPTION',
                ...
                'D2DENDEXCEPTION', 'D2DENDRUNNINGSRCNOTFOUND', 'D2DENDSRCNOTFOUND',
                'D2DDESTRESTARTERROR', 'INVOKINGTRANSFERBACKTOQUEUE',
...
dlf.addmessages({msgs.ABORTEREXCEPTION : 'Caught exception in Aborter thread',
                 ...
                 msgs.D2DENDRUNNINGSRCNOTFOUND : 'Unable to find transfer in list of running srcs - ignoring deletion',
                 msgs.D2DENDSRCNOTFOUND : 'Unable to find src transfer in list of transfers - ignoring deletion',
