...
namespace castor {
  ...
  namespace db {
    ...
    namespace cnv {
      ...
      /**
       * class DbClientIdentificationCnv
       * A converter for storing/retrieving ClientIdentification into/from a generic
       * database
       */
      class DbClientIdentificationCnv : public DbBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        DbClientIdentificationCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~DbClientIdentificationCnv() throw();
      ...
      }; // end of class DbClientIdentificationCnv
