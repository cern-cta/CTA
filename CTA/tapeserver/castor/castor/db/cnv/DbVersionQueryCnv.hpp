...
namespace castor {
  ...
  namespace db {
    ...
    namespace cnv {
      ...
      /**
       * class DbVersionQueryCnv
       * A converter for storing/retrieving VersionQuery into/from a generic database
       */
      class DbVersionQueryCnv : public DbBaseCnv {
      ...
      public:
         ...
         * Constructor
         */
        DbVersionQueryCnv(castor::ICnvSvc* cnvSvc);

        /**
         * Destructor
         */
        virtual ~DbVersionQueryCnv() throw();
      ...
      }; // end of class DbVersionQueryCnv
