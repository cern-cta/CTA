 ...
 *
 * @(#)$RCSfile: migrator.c,v $ $Revision: 1.39 $ $Release$ $Date: 2005/02/24 15:00:32 $ $Author: obarring $
 *
 * 
 *
 * @author Olof Barring
...
#ifndef lint
static char sccsid[] = "@(#)$RCSfile: migrator.c,v $ $Revision: 1.39 $ $Release$ $Date: 2005/02/24 15:00:32 $ Olof Barring";
#endif /* not lint */
