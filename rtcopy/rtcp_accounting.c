/*
 * Copyright (C) 1999-2001 by CERN IT-PDP/DM Olof Barring
 * All rights reserved
 */

#ifndef lint
static char sccsid[] = "@(#)$RCSfile: rtcp_accounting.c,v $ $Revision: 1.17 $ $Date: 2002/06/26 13:47:54 $ CERN IT-PDP/DM Olof Barring";
#endif /* not lint */
