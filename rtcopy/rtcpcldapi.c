 ...
 *
 * @(#)$RCSfile: rtcpcldapi.c,v $ $Revision: 1.44 $ $Release$ $Date: 2004/08/10 14:15:05 $ $Author: obarring $
 *
 * 
 *
 * @author Olof Barring
...
#ifndef lint
static char sccsid[] = "@(#)$RCSfile: rtcpcldapi.c,v $ $Revision: 1.44 $ $Date: 2004/08/10 14:15:05 $ CERN-IT/ADC Olof Barring";
#endif /* not lint */
