...
public:
  MOCK_METHOD(void,
              reportState,
              (const cta::tape::session::SessionState state,
  ...
  MOCK_METHOD(void, addLogParams, (const std::vector<cta::log::Param>& params), (override));
  MOCK_METHOD(void, deleteLogParams, (const std::vector<std::string>& paramNames), (override));
