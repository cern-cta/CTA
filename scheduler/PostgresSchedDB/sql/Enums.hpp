...
constexpr std::array<std::string_view, 8> const StringsArchiveJobStatus[] = {
  "AJS_ToTransferForUser",
  "AJS_ToReportToUserForTransfer",
  "AJS_Complete",
  "AJS_ToReportToUserForFailure",
...
constexpr std::array<std::string_view, 5> const StringsRetrieveJobStatus = {
  "RJS_ToTransfer"
  "RJS_ToReportToUserForFailure",
  "RJS_Failed",
  "RJS_ToReportToRepackForSuccess",
...
constexpr std::array<std::string_view, 6> const StringsRepackJobStatus = {
  "RRS_Pending",
  "RRS_ToExpand",
  "RRS_Starting",
  "RRS_Running",
