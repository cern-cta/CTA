...
// constructor
//------------------------------------------------------------------------------
DropSchemaCmdLineArgs::DropSchemaCmdLineArgs(const int argc, char* const* const argv) : help(false) {
...
void DropSchemaCmdLineArgs::printUsage(std::ostream& os) {
  os << "Usage:" << std::endl
     << "    cta-scheduler-schema-drop databaseConnectionFile [options]" << std::endl
     << "Where:" << std::endl
