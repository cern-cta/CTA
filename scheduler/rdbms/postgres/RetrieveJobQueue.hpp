...
public:
  ...
  */
  ...
  /**
   * @brief Updates or inserts the last fetch timestamp for a mount in the retrieve job queue.
   *
   ...
   * - If `isRepack` is true: "REPACK_RETRIEVE"
   * - If `isRepack` is false: "RETRIEVE"
   ...
   * @param isRepack Indicates if the queue type is for repack or user retrieve.
   *
