...
struct RetrieveJobQueueRow {
  ...
  */
  ...
  RetrieveJobQueueRow& operator=(const rdbms::Rset& rset) {
    ...
    retrieveRequestId = rset.columnUint64("RETRIEVE_REQUEST_ID");
    ...
    priority = rset.columnUint32("PRIORITY");
    minRetrieveRequestAge = rset.columnUint32("MIN_RETRIEVE_REQUEST_AGE");
    copyNb = rset.columnUint8("COPY_NB");
    fSeq = rset.columnUint64("FSEQ");
    blockId = rset.columnUint64("BLOCK_ID");
    alternateFSeq = rset.columnString("ALTERNATE_FSEQS");
    alternateBlockId = rset.columnString("ALTERNATE_BLOCK_IDS");
    startTime = rset.columnUint64("START_TIME");
    retrieveReportURL = rset.columnString("RETRIEVE_REPORT_URL");
    retrieveErrorReportURL = rset.columnString("RETRIEVE_ERROR_REPORT_URL");
    requesterName = rset.columnString("REQUESTER_NAME");
    requesterGroup = rset.columnString("REQUESTER_GROUP");
    dstURL = rset.columnString("DST_URL");
    retriesWithinMount = rset.columnUint32("RETRIES_WITHIN_MOUNT");
    totalRetries = rset.columnUint32("TOTAL_RETRIES");
    lastMountWithFailure = rset.columnUint64("LAST_MOUNT_WITH_FAILURE");
    maxTotalRetries = rset.columnUint32("MAX_TOTAL_RETRIES");
    maxRetriesWithinMount = rset.columnUint32("MAX_RETRIES_WITHIN_MOUNT");
    maxReportRetries = rset.columnUint32("MAX_REPORT_RETRIES");
    totalReportRetries = rset.columnUint32("TOTAL_REPORT_RETRIES");
    failureLogs = rset.columnOptionalString("FAILURE_LOG");
    reportFailureLogs = rset.columnOptionalString("REPORT_FAILURE_LOG");
    isVerifyOnly = rset.columnBool("IS_VERIFY_ONLY");
    isReporting = rset.columnBool("IS_REPORTING");
    vid = rset.columnString("VID");
    alternateVids = rset.columnString("ALTERNATE_VIDS");
    alternateCopyNbs = rset.columnString("ALTERNATE_COPY_NBS");
    ...
    srrUsername = rset.columnString("SRR_USERNAME");
    srrHost = rset.columnString("SRR_HOST");
    srrTime = rset.columnUint64("SRR_TIME");
    srrMountPolicy = rset.columnString("SRR_MOUNT_POLICY");
    srrActivity = rset.columnString("SRR_ACTIVITY");

    lifecycleTimings_creation_time = rset.columnUint64("LIFECYCLE_CREATION_TIME");
    lifecycleTimings_first_selected_time = rset.columnUint64("LIFECYCLE_FIRST_SELECTED_TIME");
    lifecycleTimings_completed_time = rset.columnUint64("LIFECYCLE_COMPLETED_TIME");

    diskSystemName = rset.columnOptionalString("DISK_SYSTEM_NAME");

    archiveFileID = rset.columnUint64("ARCHIVE_FILE_ID");
    fileSize = rset.columnUint64("SIZE_IN_BYTES");
    checksumBlob.deserialize(std::move(rset.columnBlob("CHECKSUMBLOB")));
    creationTime = rset.columnUint64("CREATION_TIME");
    diskInstance = rset.columnString("DISK_INSTANCE");
    diskFileId = rset.columnString("DISK_FILE_ID");
    diskFileInfoOwnerUid = rset.columnUint32("DISK_FILE_OWNER_UID");
    diskFileInfoGid = rset.columnUint32("DISK_FILE_GID");
    diskFileInfoPath = rset.columnString("DISK_FILE_PATH");
    storageClass = rset.columnString("STORAGE_CLASS");
