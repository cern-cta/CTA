...
CREATE INDEX IDX_ARCHIVE_ACTIVE_QUEUE_MOUNT_ID ON ARCHIVE_ACTIVE_QUEUE (MOUNT_ID);
CREATE INDEX IDX_ARCHIVE_ACTIVE_QUEUE_COMPOSITE ON ARCHIVE_ACTIVE_QUEUE (TAPE_POOL, STATUS, PRIORITY DESC, JOB_ID);
...
CREATE INDEX IDX_REPACK_ARCHIVE_ACTIVE_QUEUE_REPORT_COMPOSITE ON REPACK_ARCHIVE_ACTIVE_QUEUE (ARCHIVE_FILE_ID, STATUS, PRIORITY DESC, JOB_ID);
...
CREATE INDEX IDX_REPACK_ARCHIVE_PENDING_QUEUE_MOUNT_ID_NN ON REPACK_ARCHIVE_PENDING_QUEUE (MOUNT_ID) WHERE MOUNT_ID IS NOT NULL;
CREATE INDEX IDX_REPACK_ARCHIVE_ACTIVE_QUEUE_MOUNT_ID ON REPACK_ARCHIVE_ACTIVE_QUEUE (MOUNT_ID);
...
CREATE INDEX IDX_RETRIEVE_ACTIVE_QUEUE_COMPOSITE ON RETRIEVE_ACTIVE_QUEUE (VID, STATUS, PRIORITY DESC, JOB_ID);
CREATE INDEX IDX_RETRIEVE_PENDING_QUEUE_FILTER_SORT ON RETRIEVE_PENDING_QUEUE (VID, STATUS, PRIORITY DESC, JOB_ID);
CREATE INDEX IDX_RETRIEVE_PENDING_QUEUE_MOUNT_ID ON RETRIEVE_PENDING_QUEUE (MOUNT_ID) WHERE MOUNT_ID IS NOT NULL;
CREATE INDEX IDX_RETRIEVE_ACTIVE_QUEUE_MOUNT_ID ON RETRIEVE_ACTIVE_QUEUE (MOUNT_ID);
...
CREATE INDEX IDX_REPACK_RETRIEVE_ACTIVE_QUEUE_COMPOSITE ON REPACK_RETRIEVE_ACTIVE_QUEUE (VID, STATUS, PRIORITY DESC, JOB_ID);
...
CREATE INDEX IDX_REPACK_RETRIEVE_PENDING_QUEUE_MOUNT_ID ON REPACK_RETRIEVE_PENDING_QUEUE (MOUNT_ID) WHERE MOUNT_ID IS NOT NULL;
CREATE INDEX IDX_REPACK_RETRIEVE_ACTIVE_QUEUE_MOUNT_ID ON REPACK_RETRIEVE_ACTIVE_QUEUE (MOUNT_ID);

CREATE TABLE MOUNT_HEARTBEAT (
