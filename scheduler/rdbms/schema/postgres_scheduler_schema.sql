...
CREATE INDEX IDX_ARCHIVE_PENDING_QUEUE_FILTER_SORT_MOUNT_ID_IS_NULL ON ARCHIVE_PENDING_QUEUE (TAPE_POOL, STATUS, PRIORITY DESC, JOB_ID) WHERE MOUNT_ID IS NULL;
CREATE INDEX IDX_ARCHIVE_PENDING_QUEUE_FILTER_SORT_MOUNT_ID_NN ON ARCHIVE_PENDING_QUEUE (TAPE_POOL, STATUS, MOUNT_ID, PRIORITY DESC, JOB_ID) WHERE MOUNT_ID IS NOT NULL;
...
CREATE INDEX IDX_ARCHIVE_ACTIVE_QUEUE_REPORTING_NEW ON ARCHIVE_ACTIVE_QUEUE (STATUS, PRIORITY DESC, JOB_ID) WHERE IS_REPORTING IS FALSE;
CREATE INDEX IDX_ARCHIVE_ACTIVE_QUEUE_REPORTING_RECYCLE ON ARCHIVE_ACTIVE_QUEUE (STATUS, LAST_UPDATE_TIME, PRIORITY DESC, JOB_ID) WHERE IS_REPORTING IS TRUE;
...
CREATE INDEX IDX_RETRIEVE_PENDING_QUEUE_FILTER_SORT_MOUNT_ID_IS_NULL ON RETRIEVE_PENDING_QUEUE (VID, STATUS, PRIORITY DESC, JOB_ID) WHERE MOUNT_ID IS NULL;;
CREATE INDEX IDX_RETRIEVE_PENDING_QUEUE_FILTER_SORT_MOUNT_ID_NN ON RETRIEVE_PENDING_QUEUE (VID, STATUS, MOUNT_ID, PRIORITY DESC, JOB_ID) WHERE MOUNT_ID IS NOT NULL;
...
CREATE INDEX IDX_RETRIEVE_ACTIVE_QUEUE_REPORTING_NEW ON RETRIEVE_ACTIVE_QUEUE (STATUS, PRIORITY DESC, JOB_ID) WHERE IS_REPORTING IS FALSE;
CREATE INDEX IDX_RETRIEVE_ACTIVE_QUEUE_REPORTING_RECYCLE ON RETRIEVE_ACTIVE_QUEUE (STATUS, LAST_UPDATE_TIME, PRIORITY DESC, JOB_ID) WHERE IS_REPORTING IS TRUE;

CREATE INDEX IDX_REPACK_RETRIEVE_ACTIVE_QUEUE_POP ON REPACK_RETRIEVE_ACTIVE_QUEUE (STATUS, PRIORITY DESC, JOB_ID);

CREATE TABLE REPACK_RETRIEVE_FAILED_QUEUE (LIKE REPACK_ARCHIVE_ACTIVE_QUEUE INCLUDING DEFAULTS INCLUDING CONSTRAINTS INCLUDING GENERATED INCLUDING IDENTITY INCLUDING STATISTICS INCLUDING STORAGE INCLUDING COMMENTS);
