...
CREATE TABLE REPACK_ARCHIVE_FAILED_QUEUE (LIKE ARCHIVE_ACTIVE_QUEUE INCLUDING ALL);
CREATE TABLE REPACK_ARCHIVE_PENDING_QUEUE (LIKE ARCHIVE_ACTIVE_QUEUE INCLUDING ALL);
...
/* COPY_NB is NUMERIC(3, 0), REPACK_REARCHIVE_COPY_NBS is a comma separated list of COPY_NBS therefore VARCHAR(10) is enough */
  REPACK_REARCHIVE_COPY_NBS VARCHAR(10),
  REPACK_REARCHIVE_TAPE_POOLS VARCHAR(2000),
  IS_SLEEPING BOOLEAN DEFAULT FALSE
);
...
CREATE TABLE REPACK_RETRIEVE_FAILED_QUEUE (LIKE RETRIEVE_ACTIVE_QUEUE INCLUDING ALL);
CREATE TABLE REPACK_RETRIEVE_PENDING_QUEUE (LIKE RETRIEVE_ACTIVE_QUEUE INCLUDING ALL);
