...
/* Precomputed scheduling and ordering data */
  ...
  CANDIDATE_RANK BIGINT CONSTRAINT SMC_CR_NN NOT NULL,
/* Tape metadata */
  MEDIA_TYPE VARCHAR(100) CONSTRAINT SMC_MEDIA_TYPE_NN NOT NULL,
  LABEL_FORMAT SMALLINT CONSTRAINT SMC_LABEL_FORMAT_NN NOT NULL,
  VENDOR VARCHAR(100) CONSTRAINT SMC_VENDOR_NN NOT NULL,
  CAPACITY_IN_BYTES BIGINT CONSTRAINT SMC_CIB_NN NOT NULL,
  LAST_FSEQ BIGINT,
...
CREATE INDEX IDX_SCHEDULER_MOUNT_CANDIDATES_PICK
  ON SCHEDULER_MOUNT_CANDIDATES (STATE, CANDIDATE_RANK, CANDIDATE_ID);
...
CREATE UNIQUE INDEX IDX_SCHEDULER_MOUNT_CANDIDATES_VID
  ON SCHEDULER_MOUNT_CANDIDATES (VID)
  WHERE VID IS NOT NULL AND STATE IN ('Available', 'Reserved');
