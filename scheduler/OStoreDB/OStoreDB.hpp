...
public:
  ...
  public:
    ...
    std::unique_ptr<SchedulerDatabase::ArchiveMount>
      createArchiveMount(const common::dataStructures::MountType& mountType,
  ...
  public:
    std::unique_ptr<SchedulerDatabase::ArchiveMount> createArchiveMount(const common::dataStructures::MountType& type,
                                                                        const catalogue::TapeForWriting& tape,
                                                                        const std::string& driveName,
                                                                        const std::string& logicalLibrary,
                                                                        const std::string& hostName) override;
