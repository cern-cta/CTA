<?php 
//".$db_instances[$service]['schema']." taperecalled file distribution
//for specified service class
...
//if no data retrieved print out "no available data" image
$k = 0;
for($i = 0;$i < 8; $i++) {
	if ($fsize[$i] != 0) {
		$k = 1;
...
$graph->title->Set("Filesize Distribution(POOL: ".$p.")");
