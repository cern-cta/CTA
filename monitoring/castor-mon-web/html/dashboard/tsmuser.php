<?php 
//Migrated files timeseries for selected user(last ten minutes)
...
//if no data retrieved then print ou "no data available" image
if(empty($intervals)) {
	No_Data_Image();
	exit();
};
...
$graph->title->Set("Migrations Timeseries($username)");
