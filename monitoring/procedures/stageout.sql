CREATE OR REPLACE PROCEDURE Proc_STAGEOUT AS
    ...
    execute immediate 'truncate table castor_stager.monitoring_STAGEOUT';
    ...
    SELECT * BULK COLLECT INTO a, b, c, d, e, f
      ...
      forall marker in a.first..a.last
        insert into CASTOR_STAGER.monitoring_STAGEOUT values(mytime, a(marker), b(marker), c(marker), d(marker), e(marker), f(marker));
