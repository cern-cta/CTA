CREATE OR REPLACE PROCEDURE Proc_WAITDISK2DISKCOPY AS
    ...
    execute immediate 'truncate table castor_stager.monitoring_WAITDISK2DISKCOPY';
    ...
    SELECT * BULK COLLECT INTO a, b, c, d, e, f
      ...
      forall marker in a.first..a.last
        insert into CASTOR_STAGER.monitoring_WAITDISK2DISKCOPY values(mytime, a(marker), b(marker), c(marker), d(marker), e(marker), f(marker));
      
END Proc_WAITDISK2DISKCOPY;
/ 
