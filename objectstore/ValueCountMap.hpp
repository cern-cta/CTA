...
class ValueCountMap {
public:
  ValueCountMap (Type* valueCountMap);
  void incCount(Key value);
  void decCount(Key value);
  void clear();
  uint64_t total();
  Key minValue();
  Key maxValue();
...
template<typename Type, typename Key>
void ValueCountMap<Type,Key>::decCount(Key value) {
...
template<typename Type, typename Key>
void ValueCountMap<Type,Key>::incCount(Key value) {
