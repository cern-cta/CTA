  ...
  try {
    ...
    if (4 == argc) {
      ...
      auto catalogueFactory =
        cta::catalogue::CatalogueFactoryFactory::create(sl, catalogueLogin, nbConns, nbArchiveFileListingConns);
      ...
      be = std::move(cta::objectstore::BackendFactory::createBackend(
        m_ctaConf.getConfEntString("ObjectStore", "BackendPath", nullptr), sl));
      ...
      throw std::runtime_error(
        "Wrong number of arguments: expected 1 or 3: [objectstoreURL catalogueLoginFile] objectname");
    }
