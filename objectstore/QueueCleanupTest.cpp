...
struct QueueCleanupRoutineTestParams {
  ...
  explicit QueueCleanupRoutineTestParams(cta::SchedulerDatabaseFactory* dbFactory,
                                         std::list<RetrieveRequestSetup>& retrieveRequestSetupList,
                                         std::list<TapeQueueTransition>& tapeQueueTransitionList)
      : dbFactory(*dbFactory),
 ...
 */
class QueueCleanupRoutineTest : public ::testing::TestWithParam<QueueCleanupRoutineTestParams> {
public:
...
TEST_P(QueueCleanupRoutineTest, CleanupRunnerParameterizedTest) {
  ...
  for (auto retrieveRequestSetupList : GetParam().retrieveRequestSetupList) {
    ...
    fillRetrieveRequestsForCleanupRunner(requests,
...
INSTANTIATE_TEST_CASE_P(
  ...
  ::testing::Values(
    ...
    QueueCleanupRoutineTestParams(&OStoreDBFactoryVFS,
