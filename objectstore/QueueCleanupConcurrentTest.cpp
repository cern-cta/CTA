...
struct QueueCleanupConcurrentTestParams {
  ...
  QueueCleanupConcurrentTestParams(cta::SchedulerDatabaseFactory& dbFactory,
                                   std::list<RetrieveRequestSetup>& retrieveRequestSetupList,
                                   std::list<ConcurrentTapeQueueTransition>& tapeQueueTransitionList,
                                   double cleanupTimeout)
      : dbFactory(dbFactory),
 ...
 */
class QueueCleanupConcurrentTest : public ::testing::TestWithParam<QueueCleanupConcurrentTestParams> {
public:
