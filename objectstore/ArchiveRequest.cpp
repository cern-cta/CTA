...
//}
//
//auto cta::objectstore::ArchiveRequest::dumpJobs() -> std::list<ArchiveRequestJobDump> {
//  checkPayloadReadable();
//  std::list<ArchiveRequestJobDump> ret;
//  auto & jl = m_payload.jobs();
//  for (auto j=jl.begin(); j!=jl.end(); j++) {
//    ret.push_back(ArchiveRequestJobDump());
