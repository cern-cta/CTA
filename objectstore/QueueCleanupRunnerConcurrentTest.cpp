...
TEST_P(QueueCleanupRunnerConcurrentTest, CleanupRunnerParameterizedTest) {
  ...
  for (auto& retrieveRequestSetupList : GetParam().retrieveRequestSetupList) {
    ...
    unitTests::fillRetrieveRequestsForCleanupRunner(requests,
                                                    retrieveRequestSetupList.numberOfRequests,
                                                    requestsPtrs,
                                                    allVids,
                                                    activeVid,
                                                    be,
  ...
  {
    cta::objectstore::QueueCleanupRunner qCleanupRunnerBroken(agentForCleanupRef,
                                                              brokenOStore,
                                                              catalogue,
                                                              GetParam().cleanupTimeout);
    cta::objectstore::QueueCleanupRunner qCleanupRunnerOk(agentForCleanupRef,
                                                          oKOStore,
                                                          catalogue,
                                                          GetParam().cleanupTimeout);
