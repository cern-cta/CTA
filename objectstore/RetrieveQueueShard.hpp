...
public:
  ...
  struct RetrieveQueueJobsToAddLess {
    constexpr bool operator()(const RetrieveQueue::JobToAdd& lhs, const RetrieveQueue::JobToAdd& rhs) const {
  ...
  typedef std::multiset<serializers::RetrieveJobPointer, RetrieveQueueSerializedJobsToAddLess> SerializedJobsToAddSet;
