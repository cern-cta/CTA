...
public:
  ...
  inline static const std::set<serializers::ArchiveJobStatus> c_statusesImplyingQueueing = {
    serializers::ArchiveJobStatus::AJS_ToTransferForUser,
    serializers::ArchiveJobStatus::AJS_ToReportToUserForTransfer,
    serializers::ArchiveJobStatus::AJS_ToReportToUserForFailure,
    serializers::ArchiveJobStatus::AJS_Failed,
    serializers::ArchiveJobStatus::AJS_ToTransferForRepack,
    serializers::ArchiveJobStatus::AJS_ToReportToRepackForFailure,
    serializers::ArchiveJobStatus::AJS_ToReportToRepackForSuccess};
  inline static const std::set<serializers::ArchiveJobStatus> c_statusesImplyingQueueingByRepackRequestAddress {
    serializers::ArchiveJobStatus::AJS_ToReportToRepackForFailure,
    serializers::ArchiveJobStatus::AJS_ToReportToRepackForSuccess};
...
public:
  ...
  EnqueueingNextStep addReportFailure(uint32_t copyNumber,
                                      uint64_t sessionId,
                                      const std::string& failureReason,
                                      log::LogContext& lc);  //< returns next step to take with the job
  ...
  AsyncJobOwnerUpdater* asyncUpdateJobOwner(uint32_t copyNumber,
  ...
  AsyncTransferSuccessfulUpdater* asyncUpdateTransferSuccessful(const std::string& destinationVid,
                                                                const uint32_t copyNumber);
