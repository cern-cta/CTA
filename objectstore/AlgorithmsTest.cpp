...
void fillArchiveRequests(typename cta::objectstore::ContainerAlgorithms<
  ...
  for (size_t i = 0; i < 10; i++) {
    ...
    requests.emplace_back(
      ContainerAlgorithms<ArchiveQueue, ArchiveQueueToTransferForUser>::InsertedElement {requestPtrs.back().get(),
                                                                                         1,
                                                                                         aFile,
                                                                                         mp,
                                                                                         std::nullopt});
...
TEST_F(ObjectStore, ArchiveQueueAlgorithms) {
  ...
  for (size_t i = 0; i < 10; i++) {
    ...
    requests.emplace_back(
      ContainerAlgorithms<ArchiveQueue, ArchiveQueueToTransferForUser>::InsertedElement {archiveRequests.back().get(),
                                                                                         1,
                                                                                         aFile,
                                                                                         mp,
                                                                                         std::nullopt});
