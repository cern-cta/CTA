...
//=============================================================================
CppHMyCnvWriter::CppHMyCnvWriter(UMLDoc *parent, const char *name) :
...
// Initialization
//=============================================================================
bool CppHMyCnvWriter::init(UMLClassifier* c, QString fileName) {
...
// writeFillRep
//=============================================================================
void CppHMyCnvWriter::writeFillRep() {
...
// writeFillObj
//=============================================================================
void CppHMyCnvWriter::writeFillObj() {
  // First write the main function, dispatching the requests
  writeDocumentation
...
// writeBasicFillRep
//=============================================================================
void CppHMyCnvWriter::writeBasicFillRep(Assoc* as) {
  writeDocumentation
...
// writeBasicFillObj
//=============================================================================
void CppHMyCnvWriter::writeBasicFillObj(Assoc* as) {
  writeDocumentation
...
void CppHMyCnvWriter::writeClass(UMLClassifier *c) {
  ...
  *m_stream << getIndent(INDENT*ClassIndentLevel)
  ...
  // end of class header
  m_indent--;
  *m_stream << getIndent() << "}; // end of class My"
...
// writeReset
//=============================================================================
void CppHMyCnvWriter::writeReset(UMLClassifier */*c*/) {
...
// writeMembers
//=============================================================================
void CppHMyCnvWriter::writeMembers() {
