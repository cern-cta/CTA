...
#ifndef lint
static char sccsid[] = "@(#)$RCSfile: Ctape_mount.c,v $ $Revision: 1.4 $ $Date: 1999/10/13 14:22:39 $ CERN IT-PDP/DM Jean-Philippe Baud";
#endif /* not lint */
...
Ctape_mount(path, vid, partition, dgn, density, drive, mode, vsn, lbltype)
char *path;
char *vid;
int partition;
char *dgn;
...
char *lbltype;
{
	...
	if (c == 0) {
		...
		setdevinfo (fullpath, devtype, den, lblcode);
	}
	return (c);
}
