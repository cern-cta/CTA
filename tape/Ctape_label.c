...
#ifndef lint
static char sccsid[] = "@(#)$RCSfile: Ctape_label.c,v $ $Revision: 1.18 $ $Date: 2000/10/03 07:48:41 $ CERN IT-PDP/DM Jean-Philippe Baud";
#endif /* not lint */
...
Ctape_label(path, vid, partition, dgn, density, drive, vsn, lbltype, nbhdr, flags, vdqm_reqid)
char *path;
char *vid;
int partition;
char *dgn;
