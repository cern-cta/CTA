...
#ifndef lint
static char sccsid[] = "@(#)$RCSfile: tpdump.c,v $ $Revision: 1.28 $ $Date: 2002/04/09 07:43:45 $ CERN IT-PDP/DM Jean-Philippe Baud";
#endif /* not lint */
...
char	**argv;
{
	...
	if (Ctape_position (infil, TPPOSIT_FSEQ, 1, 1, 0, 0, 0, NOCHECKFILE,
