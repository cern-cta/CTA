...
#ifndef lint
static char sccsid[] = "@(#)$RCSfile: cvtden.c,v $ $Revision: 1.7 $ $Date: 2002/11/06 10:11:26 $ CERN IT-PDP/DM Jean-Philippe Baud";
#endif /* not lint */
...
#include "Ctape.h"
#include "serrno.h"
static char adens[23][6] = {"0", "800", "1600", "6250", "38000",
	"8200", "8500", "38KD", "2G", "6G", "10G", "FMT", "RAW", "DDS",
	"20G", "25G", "35G", "50G", "40G", "60G", "100G", "200G", "110G"};
static char adensc[23][6] = {"", "", "", "", "38KC",
	"8200C", "8500C", "38KDC", "", "", "10GC", "", "", "DDSC",
	"20GC", "25GC", "35GC", "50GC", "40GC", "60GC", "100GC", "200GC", "110GC"};
cvtden(aden)
char	*aden;
{
	int i;
