...
const Option opt_disabled {Option::OPT_BOOL, "--disabled", "-d", R"( <"true" or "false">)"};
...
const Option opt_fromcastor {Option::OPT_BOOL, "--fromcastor", "--fc", R"( <"true" or "false">)"};
const Option opt_dirtybit {Option::OPT_BOOL, "--dirtybit", "--db", R"( <"true" or "false">)"};
...
const Option opt_logicallibrary_disabled {Option::OPT_BOOL, "--disabled", "-d", R"( <"true" or "false">)"};
...
const Option opt_state {
  ...
  std::string(" <\"") + cta::common::dataStructures::Tape::stateToString(cta::common::dataStructures::Tape::ACTIVE) +
    ...
    "\" or \"" + cta::common::dataStructures::Tape::stateToString(cta::common::dataStructures::Tape::EXPORTED) +
    "\" or \"" + cta::common::dataStructures::Tape::stateToString(cta::common::dataStructures::Tape::REPACKING) +
    "\" or \"" +
...
const Option opt_archive_route_type {
  ...
  "--art",
  std::string(R"( <")") +
    cta::common::dataStructures::toString(cta::common::dataStructures::ArchiveRouteType::DEFAULT) + R"(" or ")" +
    cta::common::dataStructures::toString(cta::common::dataStructures::ArchiveRouteType::REPACK) + R"(">)"};
...
:   Bring tape drives up or down, list tape drives or remove tape drives from the CTA system.
  ...
  */
  ...
  {{AdminCmd::CMD_DRIVE, AdminCmd::SUBCMD_LS},                {opt_drivename_cmd.optional(), opt_all.optional()}             },
