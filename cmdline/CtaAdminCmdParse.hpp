...
const Option opt_physical_library_alias       { Option::OPT_STR,      "--name",                      "-n",     " <physical_library>", "--physicallibrary"};
const Option opt_physical_library             { Option::OPT_STR,      "--physicallibrary",           "--pl",   " <physical_library>", "--physicallibrary"};
