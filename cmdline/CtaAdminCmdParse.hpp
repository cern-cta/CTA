...
const std::map<std::string, OptionBoolean::Key> boolOptions = {
   ...
   {"--accessibe",              OptionBoolean::ACCESSIBLE},
...
const std::map<AdminCmd::Cmd, CmdHelp> cmdHelp = {
   ...
   { AdminCmd::CMD_TAPEFILE,             { "tapefile",             "tf",  { "ls", "ch", "rm" },
...
const Option opt_accessible           { Option::OPT_BOOL, "--accessible",            "-a",   " <\"true\" or \"false\">" };
...
const std::map<cmd_key_t, cmd_val_t> cmdOptions = {
   ...
   {{ AdminCmd::CMD_TAPEFILE,             AdminCmd::SUBCMD_CH    },
      { opt_accessible, opt_vid, opt_instance.optional(), opt_fid.optional(), opt_archivefileid.optional(), opt_reason }},
