...
std::list<cta::common::dataStructures::LogicalLibrary> LogicalLibraryLsResponseStream::buildLogicalLibraryList(const admin::AdminCmd& admincmd) {
    ...
    std::list<cta::common::dataStructures::LogicalLibrary> logicalLibraryList = m_catalogue.LogicalLibrary()->getLogicalLibraries();
