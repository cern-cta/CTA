 ...
 *
 * @(#)$RCSfile: repack_2.1.7-3_to_2.1.7-4.sql,v $ $Release: 1.2 $ $Release$ $Date: 2008/04/21 12:17:21 $ $Author: waldron $
 *
 * This script upgrades a CASTOR v2.1.7-3 REPACK database to 2.1.7-4
 *
