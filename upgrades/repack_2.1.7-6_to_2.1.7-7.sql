 ...
 *
 * @(#)$RCSfile: repack_2.1.7-6_to_2.1.7-7.sql,v $ $Release: 1.2 $ $Release$ $Date: 2008/05/20 09:37:23 $ $Author: waldron $
 *
 * This script upgrades a CASTOR v2.1.7-6 REPACK database to 2.1.7-7
 *
