 ...
 *
 * This script upgrades a CASTOR v2.1.9-1 DLF database into v2.1.9-3
 *
...
DECLARE
  unused VARCHAR(100);
BEGIN
  SELECT release INTO unused FROM dlf_version
...
UPDATE dlf_version SET release = '2_1_9_3';
COMMIT;
