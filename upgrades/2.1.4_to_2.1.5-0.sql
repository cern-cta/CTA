 ...
 *
 * @(#)$RCSfile: 2.1.4_to_2.1.5-0.sql,v $ $Release: 1.2 $ $Release$ $Date: 2007/11/20 14:43:19 $ $Author: itglp $
 *
...
-- no change to the CastorVersion, 2.1.5 remains internal and fully 2.1.4 compatible
