 ...
 *
 * This script upgrades a CASTOR v2.1.9-0 DLF database into v2.1.9-1
 *
...
DECLARE
  unused VARCHAR(100);
BEGIN
  SELECT release INTO unused FROM dlf_version WHERE release LIKE '2_1_9_0%';
