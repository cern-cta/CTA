 ...
 *
 * This script upgrades a CASTOR v2.1.12-1 DLF database to v2.1.12-4
 *
...
BEGIN
  SELECT release INTO unused FROM CastorVersion
   WHERE schemaName = 'DLF'
     AND release LIKE '2_1_12_1%';
EXCEPTION WHEN NO_DATA_FOUND THEN
  -- Error, we cannot apply this script
  raise_application_error(-20000, 'PL/SQL release mismatch. Please run previous upgrade scripts for the DLF before this one.');
END;
/

INSERT INTO UpgradeLog (schemaVersion, release, type)
VALUES ('2_1_9_3', '2_1_12_4', 'TRANSPARENT');
COMMIT;
